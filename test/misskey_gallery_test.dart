...
void main() async {
  test("featured", () async {
    ...
    final response = await userClient.gallery.featured(
  ...
  group("post", () {
    ...
    test("delete", () async {
      ...
      await userClient.gallery.posts.delete(
        GalleryPostsDeleteRequest(postId: post.id),
      );
    ...
    test("posts", () async {
      ...
      final response = await userClient.gallery.posts.posts(
        GalleryPostsRequest(),
      );
    ...
    test("show", () async {
      ...
      final response = await userClient.gallery.posts.show(
        GalleryPostsShowRequest(postId: post.id),
      );
    ...
    test("unlike", () async {
      ...
      await userClient.gallery.posts.unlike(
        GalleryPostsUnlikeRequest(postId: post.id),
      );
