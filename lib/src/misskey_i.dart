...
class MisskeyI {
  ...
  Future<Iterable<IAuthorizedAppsItem>> authorizedApps(
    IAuthorizedAppsRequest request,
  ) async {
    ...
    return response.map(
      (e) => IAuthorizedAppsItem.fromJson(e as Map<String, dynamic>),
    );
  }
  ...
  Future<Iterable<NoteFavorite>> favorites(IFavoritesRequest request) async {
    ...
    return response.map(
      (e) => NoteFavorite.fromJson(e as Map<String, dynamic>),
    );
  }
  ...
  Future<Iterable<IPageLikesItem>> pageLikes(IPageLikesRequest request) async {
    ...
    return response.map(
      (e) => IPageLikesItem.fromJson(e as Map<String, dynamic>),
    );
  }
...
class MisskeyIGallery {
  ...
  Future<Iterable<IGalleryLikesItem>> likes(
    ...
    return response.map(
      (e) => IGalleryLikesItem.fromJson(e as Map<String, dynamic>),
    );
  }
...
class MisskeyIRegistry {
  ...
  Future<Iterable<IRegistryScopesWithDomainItem>> scopesWithDomain() async {
    ...
    return response.map(
      (e) => IRegistryScopesWithDomainItem.fromJson(e as Map<String, dynamic>),
    );
  }
