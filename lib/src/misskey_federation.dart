...
class MisskeyFederation {
  ...
  Future<Iterable<Following>> followers(
    FederationFollowersRequest request,
  ) async {
  ...
  Future<Iterable<Following>> following(
    FederationFollowingRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "federation/following",
      request.toJson(),
  ...
  Future<Iterable<FederationInstance>> instances(
    FederationInstancesRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "federation/instances",
      request.toJson(),
    ...
    return response.map(
      (e) => FederationInstance.fromJson(e as Map<String, dynamic>),
    );
  }

  /// federation/show-instance
  Future<FederationInstance> showInstance(
    FederationShowInstanceRequest request,
  ) async {
  ...
  Future<void> updateRemoteUser(
    FederationUpdateRemoteUserRequest request,
  ) async {
  ...
  Future<Iterable<UserDetailedNotMe>> users(
    FederationUsersRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "federation/users",
      request.toJson(),
    ...
    return response.map(
      (e) => UserDetailedNotMe.fromJson(e as Map<String, dynamic>),
    );
  }
}
