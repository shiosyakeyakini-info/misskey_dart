...
class MisskeyAdmin {
  ...
  MisskeyAdmin({required ApiService apiService})
      : _apiService = apiService,
        ...
        avatarDecorations =
            MisskeyAdminAvatarDecorations(apiService: apiService),
  ...
  Future<Iterable<AdminAbuseUserReportsItem>> abuseUserReports(
      AdminAbuseUserReportsRequest request) async {
    final response = await _apiService.post<List>(
        "admin/abuse-user-reports", request.toJson());
    return response.map(
        (e) => AdminAbuseUserReportsItem.fromJson(e as Map<String, dynamic>));
  }
  ...
  Future<void> deleteAllFilesOfAUser(
      AdminDeleteAllFilesOfAUserRequest request) async {
    await _apiService.post<void>(
        "admin/delete-all-files-of-a-user", request.toJson());
  }

  /// admin/forward-abuse-user-report
  Future<void> forwardAbuseUserReport(
      AdminForwardAbuseUserReportRequest request) async {
    await _apiService.post<void>(
        "admin/forward-abuse-user-report", request.toJson());
  }
  ...
  Future<Iterable<AdminGetIndexStatsItem>> getIndexStats() async {
    ...
    return response
        .map((e) => AdminGetIndexStatsItem.fromJson(e as Map<String, dynamic>));
  }

  /// admin/get-table-stats
  Future<Map<String, dynamic>> getTableStats() async {
    final response = await _apiService
        .post<Map<String, dynamic>>("admin/get-table-stats", {});
    return response.cast();
  }

  /// admin/get-user-ips
  Future<Iterable<AdminGetUserIpsItem>> getUserIps(
      AdminGetUserIpsRequest request) async {
    final response =
        await _apiService.post<List>("admin/get-user-ips", request.toJson());
    return response
        .map((e) => AdminGetUserIpsItem.fromJson(e as Map<String, dynamic>));
  }

  /// admin/meta
  Future<AdminMetaResponse> meta() async {
    final response =
        await _apiService.post<Map<String, dynamic>>("admin/meta", {});
    return AdminMetaResponse.fromJson(response);
  }

  /// admin/reset-password
  Future<AdminResetPasswordResponse> resetPassword(
      AdminResetPasswordRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/reset-password", request.toJson());
    return AdminResetPasswordResponse.fromJson(response);
  }

  /// admin/resolve-abuse-user-report
  Future<void> resolveAbuseUserReport(
      AdminResolveAbuseUserReportRequest request) async {
    await _apiService.post<void>(
        "admin/resolve-abuse-user-report", request.toJson());
  }
  ...
  Future<AdminServerInfoResponse> serverInfo() async {
    final response =
        await _apiService.post<Map<String, dynamic>>("admin/server-info", {});
    return AdminServerInfoResponse.fromJson(response);
  }

  /// admin/show-moderation-logs
  Future<Iterable<AdminShowModerationLogsItem>> showModerationLogs(
      AdminShowModerationLogsRequest request) async {
    final response = await _apiService.post<List>(
        "admin/show-moderation-logs", request.toJson());
    return response.map(
        (e) => AdminShowModerationLogsItem.fromJson(e as Map<String, dynamic>));
  }

  /// admin/show-user
  Future<AdminShowUserResponse> showUser(AdminShowUserRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/show-user", request.toJson());
    return AdminShowUserResponse.fromJson(response);
  }

  /// admin/show-users
  Future<Iterable<UserDetailed>> showUsers(
      AdminShowUsersRequest request) async {
    final response =
        await _apiService.post<List>("admin/show-users", request.toJson());
    return response
  ...
  Future<void> updateAbuseUserReport(
      AdminUpdateAbuseUserReportRequest request) async {
    await _apiService.post<void>(
        "admin/update-abuse-user-report", request.toJson());
  }
  ...
  Future<UserDetailed> updateProxyAccount(
      AdminUpdateProxyAccountRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/update-proxy-account", request.toJson());
...
class MisskeyAdminAbuseReport {
  ...
  MisskeyAdminAbuseReport({required ApiService apiService})
      : notificationRecipient = MisskeyAdminAbuseReportNotificationRecipient(
...
class MisskeyAdminAbuseReportNotificationRecipient {
  ...
  Future<AbuseReportNotificationRecipient> create(
      AdminAbuseReportNotificationRecipientCreateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/abuse-report/notification-recipient/create", request.toJson());
    return AbuseReportNotificationRecipient.fromJson(response);
  }

  /// admin/abuse-report/notification-recipient/delete
  Future<void> delete(
      AdminAbuseReportNotificationRecipientDeleteRequest request) async {
    await _apiService.post<void>(
        "admin/abuse-report/notification-recipient/delete", request.toJson());
  }

  /// admin/abuse-report/notification-recipient/list
  Future<Iterable<AbuseReportNotificationRecipient>> list(
      AdminAbuseReportNotificationRecipientListRequest request) async {
    final response = await _apiService.post<List>(
        "admin/abuse-report/notification-recipient/list", request.toJson());
    return response.map((e) =>
        AbuseReportNotificationRecipient.fromJson(e as Map<String, dynamic>));
  }

  /// admin/abuse-report/notification-recipient/show
  Future<AbuseReportNotificationRecipient> show(
      AdminAbuseReportNotificationRecipientShowRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/abuse-report/notification-recipient/show", request.toJson());
    return AbuseReportNotificationRecipient.fromJson(response);
  }

  /// admin/abuse-report/notification-recipient/update
  Future<AbuseReportNotificationRecipient> update(
      AdminAbuseReportNotificationRecipientUpdateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/abuse-report/notification-recipient/update", request.toJson());
    return AbuseReportNotificationRecipient.fromJson(response);
  }
}
...
class MisskeyAdminAccounts {
  ...
  Future<MeDetailed> create(AdminAccountsCreateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/accounts/create", request.toJson());
  ...
  Future<UserDetailedNotMe> findByEmail(
      AdminAccountsFindByEmailRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/accounts/find-by-email", request.toJson());
...
class MisskeyAdminAd {
  ...
  MisskeyAdminAd({required ApiService apiService}) : _apiService = apiService;

  /// admin/ad/create
  Future<Ad> create(AdminAdCreateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/ad/create", request.toJson());
  ...
  Future<Iterable<Ad>> list(AdminAdListRequest request) async {
    final response =
        await _apiService.post<List>("admin/ad/list", request.toJson());
...
class MisskeyAdminAnnouncements {
  ...
  Future<AdminAnnouncementsCreateResponse> create(
      AdminAnnouncementsCreateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/announcements/create", request.toJson());
  ...
  Future<void> delete(AdminAnnouncementsDeleteRequest request) async {
    await _apiService.post<void>(
        "admin/announcements/delete", request.toJson());
  }

  /// admin/announcements/list
  Future<Iterable<AdminAnnouncementsListItem>> list(
      AdminAnnouncementsListRequest request) async {
    final response = await _apiService.post<List>(
        "admin/announcements/list", request.toJson());
    return response.map(
        (e) => AdminAnnouncementsListItem.fromJson(e as Map<String, dynamic>));
  }

  /// admin/announcements/update
  Future<void> update(AdminAnnouncementsUpdateRequest request) async {
    await _apiService.post<void>(
        "admin/announcements/update", request.toJson());
  }
}
...
class MisskeyAdminAvatarDecorations {
  ...
  Future<AdminAvatarDecorationsCreateResponse> create(
      AdminAvatarDecorationsCreateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/avatar-decorations/create", request.toJson());
  ...
  Future<void> delete(AdminAvatarDecorationsDeleteRequest request) async {
    await _apiService.post<void>(
        "admin/avatar-decorations/delete", request.toJson());
  }

  /// admin/avatar-decorations/list
  Future<Iterable<AdminAvatarDecorationsListItem>> list(
      AdminAvatarDecorationsListRequest request) async {
    final response = await _apiService.post<List>(
        "admin/avatar-decorations/list", request.toJson());
    return response.map((e) =>
        AdminAvatarDecorationsListItem.fromJson(e as Map<String, dynamic>));
  }

  /// admin/avatar-decorations/update
  Future<void> update(AdminAvatarDecorationsUpdateRequest request) async {
    await _apiService.post<void>(
        "admin/avatar-decorations/update", request.toJson());
  }
}
...
class MisskeyAdminCaptcha {
  ...
  Future<AdminCaptchaCurrentResponse> current() async {
    final response = await _apiService
        .post<Map<String, dynamic>>("admin/captcha/current", {});
...
class MisskeyAdminDrive {
  ...
  Future<Iterable<DriveFile>> files(AdminDriveFilesRequest request) async {
    final response =
        await _apiService.post<List>("admin/drive/files", request.toJson());
    return response.map((e) => DriveFile.fromJson(e as Map<String, dynamic>));
  }

  /// admin/drive/show-file
  Future<AdminDriveShowFileResponse> showFile(
      AdminDriveShowFileRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/drive/show-file", request.toJson());
...
class MisskeyAdminEmoji {
  ...
  Future<EmojiDetailed> add(AdminEmojiAddRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/emoji/add", request.toJson());
  ...
  Future<void> addAliasesBulk(AdminEmojiAddAliasesBulkRequest request) async {
    await _apiService.post<void>(
        "admin/emoji/add-aliases-bulk", request.toJson());
  }

  /// admin/emoji/copy
  Future<AdminEmojiCopyResponse> copy(AdminEmojiCopyRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/emoji/copy", request.toJson());
  ...
  Future<Iterable<EmojiDetailed>> list(AdminEmojiListRequest request) async {
    final response =
        await _apiService.post<List>("admin/emoji/list", request.toJson());
    return response
        .map((e) => EmojiDetailed.fromJson(e as Map<String, dynamic>));
  }

  /// admin/emoji/list-remote
  Future<Iterable<EmojiDetailed>> listRemote(
      AdminEmojiListRemoteRequest request) async {
    final response = await _apiService.post<List>(
        "admin/emoji/list-remote", request.toJson());
    return response
        .map((e) => EmojiDetailed.fromJson(e as Map<String, dynamic>));
  }
...
class MisskeyAdminFederation {
  ...
  Future<void> deleteAllFiles(
      AdminFederationDeleteAllFilesRequest request) async {
    await _apiService.post<void>(
        "admin/federation/delete-all-files", request.toJson());
  }

  /// admin/federation/refresh-remote-instance-metadata
  Future<void> refreshRemoteInstanceMetadata(
      AdminFederationRefreshRemoteInstanceMetadataRequest request) async {
    await _apiService.post<void>(
        "admin/federation/refresh-remote-instance-metadata", request.toJson());
  }

  /// admin/federation/remove-all-following
  Future<void> removeAllFollowing(
      AdminFederationRemoveAllFollowingRequest request) async {
    await _apiService.post<void>(
        "admin/federation/remove-all-following", request.toJson());
  }

  /// admin/federation/update-instance
  Future<void> updateInstance(
      AdminFederationUpdateInstanceRequest request) async {
    await _apiService.post<void>(
        "admin/federation/update-instance", request.toJson());
  }
}
...
class MisskeyAdminInvite {
  ...
  Future<Iterable<InviteCode>> create(AdminInviteCreateRequest request) async {
    final response =
        await _apiService.post<List>("admin/invite/create", request.toJson());
  ...
  Future<Iterable<InviteCode>> list(AdminInviteListRequest request) async {
    final response =
        await _apiService.post<List>("admin/invite/list", request.toJson());
    return response.map((e) => InviteCode.fromJson(e as Map<String, dynamic>));
  }
}
...
class MisskeyAdminQueue {
  ...
  Future<Iterable<List<dynamic>>> deliverDelayed() async {
    final response =
        await _apiService.post<List>("admin/queue/deliver-delayed", {});
  ...
  Future<Iterable<List<dynamic>>> inboxDelayed() async {
    final response =
        await _apiService.post<List>("admin/queue/inbox-delayed", {});
    return response.cast<List<dynamic>>();
  }
  ...
  Future<Iterable<QueueJob>> jobs(AdminQueueJobsRequest request) async {
    final response =
        await _apiService.post<List>("admin/queue/jobs", request.toJson());
  ...
  Future<AdminQueueQueueStatsResponse> queueStats(
      AdminQueueQueueStatsRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/queue/queue-stats", request.toJson());
  ...
  Future<Iterable<AdminQueueQueuesItem>> queues() async {
    ...
    return response
        .map((e) => AdminQueueQueuesItem.fromJson(e as Map<String, dynamic>));
  }
  ...
  Future<QueueJob> showJob(AdminQueueShowJobRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/queue/show-job", request.toJson());
    return QueueJob.fromJson(response);
  }

  /// admin/queue/show-job-logs
  Future<Iterable<String>> showJobLogs(
      AdminQueueShowJobLogsRequest request) async {
    final response = await _apiService.post<List>(
        "admin/queue/show-job-logs", request.toJson());
  ...
  Future<AdminQueueStatsResponse> stats() async {
    final response =
        await _apiService.post<Map<String, dynamic>>("admin/queue/stats", {});
...
class MisskeyAdminRelays {
  ...
  Future<AdminRelaysAddResponse> add(AdminRelaysAddRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/relays/add", request.toJson());
  ...
  Future<Iterable<AdminRelaysListItem>> list() async {
    ...
    return response
        .map((e) => AdminRelaysListItem.fromJson(e as Map<String, dynamic>));
  }
...
class MisskeyAdminRoles {
  ...
  Future<Role> create(AdminRolesCreateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/roles/create", request.toJson());
  ...
  Future<Role> show(AdminRolesShowRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/roles/show", request.toJson());
    return Role.fromJson(response);
  }
  ...
  Future<void> updateDefaultPolicies(
      AdminRolesUpdateDefaultPoliciesRequest request) async {
    await _apiService.post<void>(
        "admin/roles/update-default-policies", request.toJson());
  }

  /// admin/roles/users
  Future<Iterable<AdminRolesUsersItem>> users(
      AdminRolesUsersRequest request) async {
    final response =
        await _apiService.post<List>("admin/roles/users", request.toJson());
    return response
        .map((e) => AdminRolesUsersItem.fromJson(e as Map<String, dynamic>));
  }
}
...
class MisskeyAdminSystemWebhook {
  ...
  Future<SystemWebhook> create(AdminSystemWebhookCreateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/system-webhook/create", request.toJson());
  ...
  Future<void> delete(AdminSystemWebhookDeleteRequest request) async {
    await _apiService.post<void>(
        "admin/system-webhook/delete", request.toJson());
  }

  /// admin/system-webhook/list
  Future<Iterable<SystemWebhook>> list(
      AdminSystemWebhookListRequest request) async {
    final response = await _apiService.post<List>(
        "admin/system-webhook/list", request.toJson());
    return response
        .map((e) => SystemWebhook.fromJson(e as Map<String, dynamic>));
  }

  /// admin/system-webhook/show
  Future<SystemWebhook> show(AdminSystemWebhookShowRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/system-webhook/show", request.toJson());
    return SystemWebhook.fromJson(response);
  }
  ...
  Future<SystemWebhook> update(AdminSystemWebhookUpdateRequest request) async {
    final response = await _apiService.post<Map<String, dynamic>>(
        "admin/system-webhook/update", request.toJson());
    return SystemWebhook.fromJson(response);
  }
}
