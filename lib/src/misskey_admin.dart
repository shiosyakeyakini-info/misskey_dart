...
class MisskeyAdmin {
  ...
  Future<Iterable<AdminAbuseUserReportsItem>> abuseUserReports(
    AdminAbuseUserReportsRequest request,
  ) async {
  ...
  Future<void> deleteAllFilesOfAUser(
    AdminDeleteAllFilesOfAUserRequest request,
  ) async {
  ...
  Future<void> forwardAbuseUserReport(
    AdminForwardAbuseUserReportRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/forward-abuse-user-report",
      request.toJson(),
  ...
  Future<Iterable<AdminGetIndexStatsItem>> getIndexStats() async {
    ...
    return response.map(
      (e) => AdminGetIndexStatsItem.fromJson(e as Map<String, dynamic>),
    );
  }
  ...
  Future<Iterable<AdminGetUserIpsItem>> getUserIps(
    AdminGetUserIpsRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/get-user-ips",
      request.toJson(),
    ...
    return response.map(
      (e) => AdminGetUserIpsItem.fromJson(e as Map<String, dynamic>),
    );
  }
  ...
  Future<void> resolveAbuseUserReport(
    AdminResolveAbuseUserReportRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/resolve-abuse-user-report",
      request.toJson(),
  ...
  Future<Iterable<AdminShowModerationLogsItem>> showModerationLogs(
    AdminShowModerationLogsRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/show-moderation-logs",
      request.toJson(),
  ...
  Future<void> updateAbuseUserReport(
    AdminUpdateAbuseUserReportRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/update-abuse-user-report",
      request.toJson(),
  ...
  Future<UserDetailed> updateProxyAccount(
    AdminUpdateProxyAccountRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/update-proxy-account",
      request.toJson(),
...
class MisskeyAdminAbuseReportNotificationRecipient {
  ...
  Future<AbuseReportNotificationRecipient> create(
    AdminAbuseReportNotificationRecipientCreateRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/abuse-report/notification-recipient/create",
      request.toJson(),
  ...
  Future<void> delete(
    AdminAbuseReportNotificationRecipientDeleteRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/abuse-report/notification-recipient/delete",
      request.toJson(),
  ...
  Future<Iterable<AbuseReportNotificationRecipient>> list(
    AdminAbuseReportNotificationRecipientListRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/abuse-report/notification-recipient/list",
      request.toJson(),
  ...
  Future<AbuseReportNotificationRecipient> show(
    AdminAbuseReportNotificationRecipientShowRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/abuse-report/notification-recipient/show",
      request.toJson(),
  ...
  Future<AbuseReportNotificationRecipient> update(
    AdminAbuseReportNotificationRecipientUpdateRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/abuse-report/notification-recipient/update",
      request.toJson(),
...
class MisskeyAdminAccounts {
  ...
  Future<UserDetailedNotMe> findByEmail(
    AdminAccountsFindByEmailRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/accounts/find-by-email",
      request.toJson(),
...
class MisskeyAdminAnnouncements {
  ...
  Future<AdminAnnouncementsCreateResponse> create(
    AdminAnnouncementsCreateRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/announcements/create",
      request.toJson(),
  ...
  Future<Iterable<AdminAnnouncementsListItem>> list(
    AdminAnnouncementsListRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/announcements/list",
      request.toJson(),
...
class MisskeyAdminAvatarDecorations {
  ...
  Future<AdminAvatarDecorationsCreateResponse> create(
    AdminAvatarDecorationsCreateRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/avatar-decorations/create",
      request.toJson(),
  ...
  Future<Iterable<AdminAvatarDecorationsListItem>> list(
    AdminAvatarDecorationsListRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/avatar-decorations/list",
      request.toJson(),
    ...
    return response.map(
      (e) => AdminAvatarDecorationsListItem.fromJson(e as Map<String, dynamic>),
    );
  }
...
class MisskeyAdminDrive {
  ...
  Future<AdminDriveShowFileResponse> showFile(
    AdminDriveShowFileRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/drive/show-file",
      request.toJson(),
...
class MisskeyAdminEmoji {
  ...
  Future<Iterable<EmojiDetailed>> list(AdminEmojiListRequest request) async {
    ...
    return response.map(
      (e) => EmojiDetailed.fromJson(e as Map<String, dynamic>),
    );
  }

  /// admin/emoji/list-remote
  Future<Iterable<EmojiDetailed>> listRemote(
    AdminEmojiListRemoteRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/emoji/list-remote",
      request.toJson(),
  ...
  Future<void> removeAliasesBulk(
    AdminEmojiRemoveAliasesBulkRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/emoji/remove-aliases-bulk",
      request.toJson(),
...
class MisskeyAdminFederation {
  ...
  Future<void> deleteAllFiles(
    AdminFederationDeleteAllFilesRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/federation/delete-all-files",
      request.toJson(),
  ...
  Future<void> refreshRemoteInstanceMetadata(
    AdminFederationRefreshRemoteInstanceMetadataRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/federation/refresh-remote-instance-metadata",
      request.toJson(),
  ...
  Future<void> removeAllFollowing(
    AdminFederationRemoveAllFollowingRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/federation/remove-all-following",
      request.toJson(),
  ...
  Future<void> updateInstance(
    AdminFederationUpdateInstanceRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/federation/update-instance",
      request.toJson(),
...
class MisskeyAdminQueue {
  ...
  Future<AdminQueueQueueStatsResponse> queueStats(
    AdminQueueQueueStatsRequest request,
  ) async {
    final response = await _apiService.post<Map<String, dynamic>>(
      "admin/queue/queue-stats",
      request.toJson(),
  ...
  Future<Iterable<AdminQueueQueuesItem>> queues() async {
    ...
    return response.map(
      (e) => AdminQueueQueuesItem.fromJson(e as Map<String, dynamic>),
    );
  }
  ...
  Future<Iterable<String>> showJobLogs(
    AdminQueueShowJobLogsRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/queue/show-job-logs",
      request.toJson(),
...
class MisskeyAdminRelays {
  ...
  Future<Iterable<AdminRelaysListItem>> list() async {
    ...
    return response.map(
      (e) => AdminRelaysListItem.fromJson(e as Map<String, dynamic>),
    );
  }
...
class MisskeyAdminRoles {
  ...
  Future<void> updateDefaultPolicies(
    AdminRolesUpdateDefaultPoliciesRequest request,
  ) async {
    await _apiService.post<void>(
      "admin/roles/update-default-policies",
      request.toJson(),
  ...
  Future<Iterable<AdminRolesUsersItem>> users(
    AdminRolesUsersRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/roles/users",
      request.toJson(),
    ...
    return response.map(
      (e) => AdminRolesUsersItem.fromJson(e as Map<String, dynamic>),
    );
  }
}
...
class MisskeyAdminSystemWebhook {
  ...
  Future<Iterable<SystemWebhook>> list(
    AdminSystemWebhookListRequest request,
  ) async {
    final response = await _apiService.post<List>(
      "admin/system-webhook/list",
      request.toJson(),
    ...
    return response.map(
      (e) => SystemWebhook.fromJson(e as Map<String, dynamic>),
    );
  }
