...
mixin _$MisskeyException {
 ...
 String get id; String get code; String get message; MisskeyExceptionKind get kind; Map<String, dynamic>? get info;
...
@useResult
$Res call({
 String id, String code, String message, MisskeyExceptionKind kind, Map<String, dynamic>? info
});
...
/// Create a copy of MisskeyException
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? code = null,Object? message = null,Object? kind = null,Object? info = freezed,}) {
...
/// Adds pattern-matching-related methods to [MisskeyException].
extension MisskeyExceptionPatterns on MisskeyException {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MisskeyException value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MisskeyException() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MisskeyException value)  $default,){
final _that = this;
switch (_that) {
case _MisskeyException():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MisskeyException value)?  $default,){
final _that = this;
switch (_that) {
case _MisskeyException() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String code,  String message,  MisskeyExceptionKind kind,  Map<String, dynamic>? info)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MisskeyException() when $default != null:
return $default(_that.id,_that.code,_that.message,_that.kind,_that.info);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String code,  String message,  MisskeyExceptionKind kind,  Map<String, dynamic>? info)  $default,) {final _that = this;
switch (_that) {
case _MisskeyException():
return $default(_that.id,_that.code,_that.message,_that.kind,_that.info);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String code,  String message,  MisskeyExceptionKind kind,  Map<String, dynamic>? info)?  $default,) {final _that = this;
switch (_that) {
case _MisskeyException() when $default != null:
return $default(_that.id,_that.code,_that.message,_that.kind,_that.info);case _:
  return null;
...
class _MisskeyException implements MisskeyException {
  const _MisskeyException({required this.id, required this.code, required this.message, required this.kind, final  Map<String, dynamic>? info}): _info = info;
  factory _MisskeyException.fromJson(Map<String, dynamic> json) => _$MisskeyExceptionFromJson(json);

@override final  String id;
@override final  String code;
@override final  String message;
@override final  MisskeyExceptionKind kind;
...
/// Create a copy of MisskeyException
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? code = null,Object? message = null,Object? kind = null,Object? info = freezed,}) {
