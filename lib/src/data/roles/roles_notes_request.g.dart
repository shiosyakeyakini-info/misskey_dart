...
_$_RolesNotesRequest _$$_RolesNotesRequestFromJson(Map<String, dynamic> json) =>
    _$_RolesNotesRequest(
...
Map<String, dynamic> _$$_RolesNotesRequestToJson(
        _$_RolesNotesRequest instance) =>
    <String, dynamic>{
