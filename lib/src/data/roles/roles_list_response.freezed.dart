...
mixin _$RolesListResponse {
 ...
 String get id;@DateTimeConverter() DateTime get createdAt;@DateTimeConverter() DateTime get updatedAt; String get name; String? get description;@NullableColorConverter() int? get color;@NullableUriConverter() Uri? get iconUrl; String? get target; bool get isPublic; bool get isAdministrator; bool get isModerator; bool get isExplorable; bool get asBadge; bool get canEditMembersByModerator; int get displayOrder; int get usersCount;
...
@useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt,@DateTimeConverter() DateTime updatedAt, String name, String? description,@NullableColorConverter() int? color,@NullableUriConverter() Uri? iconUrl, String? target, bool isPublic, bool isAdministrator, bool isModerator, bool isExplorable, bool asBadge, bool canEditMembersByModerator, int displayOrder, int usersCount
});
...
as Uri?,target: freezed == target ? _self.target : target // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt,  String name,  String? description, @NullableColorConverter()  int? color, @NullableUriConverter()  Uri? iconUrl,  String? target,  bool isPublic,  bool isAdministrator,  bool isModerator,  bool isExplorable,  bool asBadge,  bool canEditMembersByModerator,  int displayOrder,  int usersCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RolesListResponse() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.name,_that.description,_that.color,_that.iconUrl,_that.target,_that.isPublic,_that.isAdministrator,_that.isModerator,_that.isExplorable,_that.asBadge,_that.canEditMembersByModerator,_that.displayOrder,_that.usersCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt,  String name,  String? description, @NullableColorConverter()  int? color, @NullableUriConverter()  Uri? iconUrl,  String? target,  bool isPublic,  bool isAdministrator,  bool isModerator,  bool isExplorable,  bool asBadge,  bool canEditMembersByModerator,  int displayOrder,  int usersCount)  $default,) {final _that = this;
switch (_that) {
case _RolesListResponse():
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.name,_that.description,_that.color,_that.iconUrl,_that.target,_that.isPublic,_that.isAdministrator,_that.isModerator,_that.isExplorable,_that.asBadge,_that.canEditMembersByModerator,_that.displayOrder,_that.usersCount);case _:
  throw StateError('Unexpected subclass');
...
class _RolesListResponse implements RolesListResponse {
  const _RolesListResponse({required this.id, @DateTimeConverter() required this.createdAt, @DateTimeConverter() required this.updatedAt, required this.name, this.description, @NullableColorConverter() this.color, @NullableUriConverter() this.iconUrl, this.target, required this.isPublic, required this.isAdministrator, required this.isModerator, required this.isExplorable, required this.asBadge, required this.canEditMembersByModerator, required this.displayOrder, required this.usersCount});
