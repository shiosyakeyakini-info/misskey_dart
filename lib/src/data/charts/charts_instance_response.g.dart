...
_ChartsInstanceResponse _$ChartsInstanceResponseFromJson(
  Map<String, dynamic> json,
) => _ChartsInstanceResponse(
  requests: ChartsInstanceRequests.fromJson(
    json['requests'] as Map<String, dynamic>,
  ),
  notes: ChartsInstanceNotes.fromJson(json['notes'] as Map<String, dynamic>),
  users: ChartsInstanceUsers.fromJson(json['users'] as Map<String, dynamic>),
  ...
  drive: ChartsInstanceDrive.fromJson(json['drive'] as Map<String, dynamic>),
);

Map<String, dynamic> _$ChartsInstanceResponseToJson(
  _ChartsInstanceResponse instance,
) => <String, dynamic>{
