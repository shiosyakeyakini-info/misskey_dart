...
mixin _$ChartsDriveResponse {
  ...
  $ChartsDriveResponseCopyWith<ChartsDriveResponse> get copyWith =>
      _$ChartsDriveResponseCopyWithImpl<ChartsDriveResponse>(
          this as ChartsDriveResponse, _$identity);
...
abstract mixin class $ChartsDriveResponseCopyWith<$Res> {
  factory $ChartsDriveResponseCopyWith(
          ChartsDriveResponse value, $Res Function(ChartsDriveResponse) _then) =
      _$ChartsDriveResponseCopyWithImpl;
  @useResult
...
class _ChartsDriveResponse implements ChartsDriveResponse {
  ...
  factory _ChartsDriveResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChartsDriveResponseCopyWith<_ChartsDriveResponse> get copyWith =>
      __$ChartsDriveResponseCopyWithImpl<_ChartsDriveResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChartsDriveResponseToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ChartsDriveResponseCopyWith<$Res>
    implements $ChartsDriveResponseCopyWith<$Res> {
  factory _$ChartsDriveResponseCopyWith(_ChartsDriveResponse value,
          $Res Function(_ChartsDriveResponse) _then) =
      __$ChartsDriveResponseCopyWithImpl;
  @override
  @useResult
  $Res call({ChartsDriveLocal local, ChartsDriveRemote remote});
