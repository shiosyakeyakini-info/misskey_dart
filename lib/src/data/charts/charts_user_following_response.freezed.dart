...
$ChartsUserFollowingResponseCopyWith<ChartsUserFollowingResponse> get copyWith => _$ChartsUserFollowingResponseCopyWithImpl<ChartsUserFollowingResponse>(this as ChartsUserFollowingResponse, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsUserFollowingResponse&&(identical(other.local, local) || other.local == local)&&(identical(other.remote, remote) || other.remote == remote));
}
...
abstract mixin class $ChartsUserFollowingResponseCopyWith<$Res>  {
  factory $ChartsUserFollowingResponseCopyWith(ChartsUserFollowingResponse value, $Res Function(ChartsUserFollowingResponse) _then) = _$ChartsUserFollowingResponseCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsUserFollowingResponse].
extension ChartsUserFollowingResponsePatterns on ChartsUserFollowingResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsUserFollowingResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsUserFollowingResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsUserFollowingResponse value)  $default,){
final _that = this;
switch (_that) {
case _ChartsUserFollowingResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsUserFollowingResponse value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsUserFollowingResponse() when $default != null:
return $default(_that);case _:
...
class _ChartsUserFollowingResponse implements ChartsUserFollowingResponse {
  const _ChartsUserFollowingResponse({required this.local, required this.remote});
  factory _ChartsUserFollowingResponse.fromJson(Map<String, dynamic> json) => _$ChartsUserFollowingResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsUserFollowingResponseCopyWith<_ChartsUserFollowingResponse> get copyWith => __$ChartsUserFollowingResponseCopyWithImpl<_ChartsUserFollowingResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsUserFollowingResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsUserFollowingResponse&&(identical(other.local, local) || other.local == local)&&(identical(other.remote, remote) || other.remote == remote));
}
...
/// @nodoc
abstract mixin class _$ChartsUserFollowingResponseCopyWith<$Res> implements $ChartsUserFollowingResponseCopyWith<$Res> {
  factory _$ChartsUserFollowingResponseCopyWith(_ChartsUserFollowingResponse value, $Res Function(_ChartsUserFollowingResponse) _then) = __$ChartsUserFollowingResponseCopyWithImpl;
@override @useResult
$Res call({
 ChartsUserFollowingLocal local, ChartsUserFollowingRemote remote
});
