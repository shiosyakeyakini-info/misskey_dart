...
mixin _$ChartsUserReactionsResponse {
  ...
  $ChartsUserReactionsResponseCopyWith<ChartsUserReactionsResponse>
      get copyWith => _$ChartsUserReactionsResponseCopyWithImpl<
              ChartsUserReactionsResponse>(
          this as ChartsUserReactionsResponse, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChartsUserReactionsResponse &&
...
abstract mixin class $ChartsUserReactionsResponseCopyWith<$Res> {
  factory $ChartsUserReactionsResponseCopyWith(
          ChartsUserReactionsResponse value,
          $Res Function(ChartsUserReactionsResponse) _then) =
      _$ChartsUserReactionsResponseCopyWithImpl;
  @useResult
...
class _ChartsUserReactionsResponse implements ChartsUserReactionsResponse {
  const _ChartsUserReactionsResponse(
      {required this.local, required this.remote});
  factory _ChartsUserReactionsResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChartsUserReactionsResponseCopyWith<_ChartsUserReactionsResponse>
      get copyWith => __$ChartsUserReactionsResponseCopyWithImpl<
          _ChartsUserReactionsResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChartsUserReactionsResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChartsUserReactionsResponse &&
            (identical(other.local, local) || other.local == local) &&
            (identical(other.remote, remote) || other.remote == remote));
  }
...
/// @nodoc
abstract mixin class _$ChartsUserReactionsResponseCopyWith<$Res>
    implements $ChartsUserReactionsResponseCopyWith<$Res> {
  factory _$ChartsUserReactionsResponseCopyWith(
          _ChartsUserReactionsResponse value,
          $Res Function(_ChartsUserReactionsResponse) _then) =
      __$ChartsUserReactionsResponseCopyWithImpl;
  @override
  @useResult
  $Res call({ChartsUserReactionsLocal local, ChartsUserReactionsRemote remote});
