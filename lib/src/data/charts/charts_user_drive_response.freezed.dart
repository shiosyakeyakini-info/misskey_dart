...
$ChartsUserDriveResponseCopyWith<ChartsUserDriveResponse> get copyWith => _$ChartsUserDriveResponseCopyWithImpl<ChartsUserDriveResponse>(this as ChartsUserDriveResponse, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsUserDriveResponse&&const DeepCollectionEquality().equals(other.totalCount, totalCount)&&const DeepCollectionEquality().equals(other.totalSize, totalSize)&&const DeepCollectionEquality().equals(other.incCount, incCount)&&const DeepCollectionEquality().equals(other.incSize, incSize)&&const DeepCollectionEquality().equals(other.decCount, decCount)&&const DeepCollectionEquality().equals(other.decSize, decSize));
}
...
abstract mixin class $ChartsUserDriveResponseCopyWith<$Res>  {
  factory $ChartsUserDriveResponseCopyWith(ChartsUserDriveResponse value, $Res Function(ChartsUserDriveResponse) _then) = _$ChartsUserDriveResponseCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsUserDriveResponse].
extension ChartsUserDriveResponsePatterns on ChartsUserDriveResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsUserDriveResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsUserDriveResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsUserDriveResponse value)  $default,){
final _that = this;
switch (_that) {
case _ChartsUserDriveResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsUserDriveResponse value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsUserDriveResponse() when $default != null:
return $default(_that);case _:
...
class _ChartsUserDriveResponse implements ChartsUserDriveResponse {
  const _ChartsUserDriveResponse({required final  List<double> totalCount, required final  List<double> totalSize, required final  List<double> incCount, required final  List<double> incSize, required final  List<double> decCount, required final  List<double> decSize}): _totalCount = totalCount,_totalSize = totalSize,_incCount = incCount,_incSize = incSize,_decCount = decCount,_decSize = decSize;
  factory _ChartsUserDriveResponse.fromJson(Map<String, dynamic> json) => _$ChartsUserDriveResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsUserDriveResponseCopyWith<_ChartsUserDriveResponse> get copyWith => __$ChartsUserDriveResponseCopyWithImpl<_ChartsUserDriveResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsUserDriveResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsUserDriveResponse&&const DeepCollectionEquality().equals(other._totalCount, _totalCount)&&const DeepCollectionEquality().equals(other._totalSize, _totalSize)&&const DeepCollectionEquality().equals(other._incCount, _incCount)&&const DeepCollectionEquality().equals(other._incSize, _incSize)&&const DeepCollectionEquality().equals(other._decCount, _decCount)&&const DeepCollectionEquality().equals(other._decSize, _decSize));
}
...
/// @nodoc
abstract mixin class _$ChartsUserDriveResponseCopyWith<$Res> implements $ChartsUserDriveResponseCopyWith<$Res> {
  factory _$ChartsUserDriveResponseCopyWith(_ChartsUserDriveResponse value, $Res Function(_ChartsUserDriveResponse) _then) = __$ChartsUserDriveResponseCopyWithImpl;
@override @useResult
$Res call({
 List<double> totalCount, List<double> totalSize, List<double> incCount, List<double> incSize, List<double> decCount, List<double> decSize
});
