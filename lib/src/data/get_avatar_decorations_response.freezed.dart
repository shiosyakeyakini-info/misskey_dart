...
mixin _$GetAvatarDecorationsResponse {
 ...
 String get id; String get name; String get description;@UriConverter() Uri get url; List<String> get roleIdsThatCanBeUsedThisDecoration;
...
@useResult
$Res call({
 String id, String name, String description,@UriConverter() Uri url, List<String> roleIdsThatCanBeUsedThisDecoration
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String description, @UriConverter()  Uri url,  List<String> roleIdsThatCanBeUsedThisDecoration)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetAvatarDecorationsResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String description, @UriConverter()  Uri url,  List<String> roleIdsThatCanBeUsedThisDecoration)  $default,) {final _that = this;
switch (_that) {
case _GetAvatarDecorationsResponse():
return $default(_that.id,_that.name,_that.description,_that.url,_that.roleIdsThatCanBeUsedThisDecoration);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String description, @UriConverter()  Uri url,  List<String> roleIdsThatCanBeUsedThisDecoration)?  $default,) {final _that = this;
switch (_that) {
case _GetAvatarDecorationsResponse() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.url,_that.roleIdsThatCanBeUsedThisDecoration);case _:
  return null;
...
class _GetAvatarDecorationsResponse implements GetAvatarDecorationsResponse {
  const _GetAvatarDecorationsResponse({required this.id, required this.name, required this.description, @UriConverter() required this.url, required final  List<String> roleIdsThatCanBeUsedThisDecoration}): _roleIdsThatCanBeUsedThisDecoration = roleIdsThatCanBeUsedThisDecoration;
