...
$ClipsListRequestCopyWith<ClipsListRequest> get copyWith => _$ClipsListRequestCopyWithImpl<ClipsListRequest>(this as ClipsListRequest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClipsListRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
abstract mixin class $ClipsListRequestCopyWith<$Res>  {
  factory $ClipsListRequestCopyWith(ClipsListRequest value, $Res Function(ClipsListRequest) _then) = _$ClipsListRequestCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ClipsListRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ClipsListRequest value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ClipsListRequest value)?  $default,){
final _that = this;
switch (_that) {
case _ClipsListRequest() when $default != null:
return $default(_that);case _:
...
class _ClipsListRequest implements ClipsListRequest {
  const _ClipsListRequest({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _ClipsListRequest.fromJson(Map<String, dynamic> json) => _$ClipsListRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$ClipsListRequestCopyWith<_ClipsListRequest> get copyWith => __$ClipsListRequestCopyWithImpl<_ClipsListRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ClipsListRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ClipsListRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
/// @nodoc
abstract mixin class _$ClipsListRequestCopyWith<$Res> implements $ClipsListRequestCopyWith<$Res> {
  factory _$ClipsListRequestCopyWith(_ClipsListRequest value, $Res Function(_ClipsListRequest) _then) = __$ClipsListRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
