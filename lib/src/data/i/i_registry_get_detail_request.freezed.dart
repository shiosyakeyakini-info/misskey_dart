...
/// Create a copy of IRegistryGetDetailRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? key = freezed,Object? scope = freezed,Object? domain = freezed,}) {
...
class _IRegistryGetDetailRequest implements IRegistryGetDetailRequest {
  const _IRegistryGetDetailRequest({this.key, final  List<String>? scope = const [], this.domain}): _scope = scope;
...
/// Create a copy of IRegistryGetDetailRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? key = freezed,Object? scope = freezed,Object? domain = freezed,}) {
