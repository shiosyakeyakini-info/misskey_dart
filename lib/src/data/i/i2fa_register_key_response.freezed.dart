...
$I2faRegisterKeyResponseCopyWith<I2faRegisterKeyResponse> get copyWith => _$I2faRegisterKeyResponseCopyWithImpl<I2faRegisterKeyResponse>(this as I2faRegisterKeyResponse, _$identity);
...
abstract mixin class $I2faRegisterKeyResponseCopyWith<$Res>  {
  factory $I2faRegisterKeyResponseCopyWith(I2faRegisterKeyResponse value, $Res Function(I2faRegisterKeyResponse) _then) = _$I2faRegisterKeyResponseCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [I2faRegisterKeyResponse].
extension I2faRegisterKeyResponsePatterns on I2faRegisterKeyResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _I2faRegisterKeyResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _I2faRegisterKeyResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _I2faRegisterKeyResponse value)  $default,){
final _that = this;
switch (_that) {
case _I2faRegisterKeyResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _I2faRegisterKeyResponse value)?  $default,){
final _that = this;
switch (_that) {
case _I2faRegisterKeyResponse() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$I2faRegisterKeyResponseCopyWith<_I2faRegisterKeyResponse> get copyWith => __$I2faRegisterKeyResponseCopyWithImpl<_I2faRegisterKeyResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$I2faRegisterKeyResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _I2faRegisterKeyResponse&&(identical(other.rp, rp) || other.rp == rp)&&(identical(other.user, user) || other.user == user)&&(identical(other.challenge, challenge) || other.challenge == challenge)&&const DeepCollectionEquality().equals(other._pubKeyCredParams, _pubKeyCredParams)&&(identical(other.timeout, timeout) || other.timeout == timeout)&&const DeepCollectionEquality().equals(other._excludeCredentials, _excludeCredentials)&&(identical(other.authenticatorSelection, authenticatorSelection) || other.authenticatorSelection == authenticatorSelection)&&(identical(other.attestation, attestation) || other.attestation == attestation)&&(identical(other.extensions, extensions) || other.extensions == extensions));
}
...
/// @nodoc
abstract mixin class _$I2faRegisterKeyResponseCopyWith<$Res> implements $I2faRegisterKeyResponseCopyWith<$Res> {
  factory _$I2faRegisterKeyResponseCopyWith(_I2faRegisterKeyResponse value, $Res Function(_I2faRegisterKeyResponse) _then) = __$I2faRegisterKeyResponseCopyWithImpl;
@override @useResult
$Res call({
 I2faRegisterKeyRp rp, I2faRegisterKeyUser user, String challenge, List<I2faRegisterKeyPubKeyCredParamsItem> pubKeyCredParams, double? timeout, List<I2faRegisterKeyExcludeCredentialsItem>? excludeCredentials, I2faRegisterKeyAuthenticatorSelection? authenticatorSelection,@JsonKey(unknownEnumValue: I2faRegisterKeyAttestation.unknown) I2faRegisterKeyAttestation? attestation, I2faRegisterKeyExtensions? extensions
});
