...
$IFavoritesRequestCopyWith<IFavoritesRequest> get copyWith => _$IFavoritesRequestCopyWithImpl<IFavoritesRequest>(this as IFavoritesRequest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IFavoritesRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
abstract mixin class $IFavoritesRequestCopyWith<$Res>  {
  factory $IFavoritesRequestCopyWith(IFavoritesRequest value, $Res Function(IFavoritesRequest) _then) = _$IFavoritesRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [IFavoritesRequest].
extension IFavoritesRequestPatterns on IFavoritesRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IFavoritesRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IFavoritesRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IFavoritesRequest value)  $default,){
final _that = this;
switch (_that) {
case _IFavoritesRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IFavoritesRequest value)?  $default,){
final _that = this;
switch (_that) {
case _IFavoritesRequest() when $default != null:
return $default(_that);case _:
...
class _IFavoritesRequest implements IFavoritesRequest {
  const _IFavoritesRequest({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _IFavoritesRequest.fromJson(Map<String, dynamic> json) => _$IFavoritesRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$IFavoritesRequestCopyWith<_IFavoritesRequest> get copyWith => __$IFavoritesRequestCopyWithImpl<_IFavoritesRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$IFavoritesRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IFavoritesRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
/// @nodoc
abstract mixin class _$IFavoritesRequestCopyWith<$Res> implements $IFavoritesRequestCopyWith<$Res> {
  factory _$IFavoritesRequestCopyWith(_IFavoritesRequest value, $Res Function(_IFavoritesRequest) _then) = __$IFavoritesRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
