...
mixin _$I2faKeyDoneRequest {
  ...
  $I2faKeyDoneRequestCopyWith<I2faKeyDoneRequest> get copyWith =>
      _$I2faKeyDoneRequestCopyWithImpl<I2faKeyDoneRequest>(
          this as I2faKeyDoneRequest, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, password, token, name,
...
abstract mixin class $I2faKeyDoneRequestCopyWith<$Res> {
  factory $I2faKeyDoneRequestCopyWith(
          I2faKeyDoneRequest value, $Res Function(I2faKeyDoneRequest) _then) =
      _$I2faKeyDoneRequestCopyWithImpl;
  @useResult
  $Res call(
      {String? password,
      String? token,
...
class _I2faKeyDoneRequest implements I2faKeyDoneRequest {
  const _I2faKeyDoneRequest(
      {this.password,
      this.token,
      this.name,
      final Map<String, dynamic>? credential})
      : _credential = credential;
  factory _I2faKeyDoneRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$I2faKeyDoneRequestCopyWith<_I2faKeyDoneRequest> get copyWith =>
      __$I2faKeyDoneRequestCopyWithImpl<_I2faKeyDoneRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$I2faKeyDoneRequestToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$I2faKeyDoneRequestCopyWith<$Res>
    implements $I2faKeyDoneRequestCopyWith<$Res> {
  factory _$I2faKeyDoneRequestCopyWith(
          _I2faKeyDoneRequest value, $Res Function(_I2faKeyDoneRequest) _then) =
      __$I2faKeyDoneRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? password,
