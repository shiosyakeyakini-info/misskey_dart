...
$INotificationsGroupedRequestCopyWith<INotificationsGroupedRequest> get copyWith => _$INotificationsGroupedRequestCopyWithImpl<INotificationsGroupedRequest>(this as INotificationsGroupedRequest, _$identity);
...
abstract mixin class $INotificationsGroupedRequestCopyWith<$Res>  {
  factory $INotificationsGroupedRequestCopyWith(INotificationsGroupedRequest value, $Res Function(INotificationsGroupedRequest) _then) = _$INotificationsGroupedRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [INotificationsGroupedRequest].
extension INotificationsGroupedRequestPatterns on INotificationsGroupedRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _INotificationsGroupedRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _INotificationsGroupedRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _INotificationsGroupedRequest value)  $default,){
final _that = this;
switch (_that) {
case _INotificationsGroupedRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _INotificationsGroupedRequest value)?  $default,){
final _that = this;
switch (_that) {
case _INotificationsGroupedRequest() when $default != null:
return $default(_that);case _:
...
class _INotificationsGroupedRequest implements INotificationsGroupedRequest {
  const _INotificationsGroupedRequest({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.markAsRead = true, final  List<NotificationType>? includeTypes, final  List<NotificationType>? excludeTypes}): _includeTypes = includeTypes,_excludeTypes = excludeTypes;
  factory _INotificationsGroupedRequest.fromJson(Map<String, dynamic> json) => _$INotificationsGroupedRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$INotificationsGroupedRequestCopyWith<_INotificationsGroupedRequest> get copyWith => __$INotificationsGroupedRequestCopyWithImpl<_INotificationsGroupedRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$INotificationsGroupedRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _INotificationsGroupedRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.markAsRead, markAsRead) || other.markAsRead == markAsRead)&&const DeepCollectionEquality().equals(other._includeTypes, _includeTypes)&&const DeepCollectionEquality().equals(other._excludeTypes, _excludeTypes));
}
...
/// @nodoc
abstract mixin class _$INotificationsGroupedRequestCopyWith<$Res> implements $INotificationsGroupedRequestCopyWith<$Res> {
  factory _$INotificationsGroupedRequestCopyWith(_INotificationsGroupedRequest value, $Res Function(_INotificationsGroupedRequest) _then) = __$INotificationsGroupedRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? markAsRead, List<NotificationType>? includeTypes, List<NotificationType>? excludeTypes
});
