...
mixin _$IClaimAchievementRequest {
  ...
  $IClaimAchievementRequestCopyWith<IClaimAchievementRequest> get copyWith =>
      _$IClaimAchievementRequestCopyWithImpl<IClaimAchievementRequest>(
          this as IClaimAchievementRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IClaimAchievementRequest &&
...
abstract mixin class $IClaimAchievementRequestCopyWith<$Res> {
  factory $IClaimAchievementRequestCopyWith(IClaimAchievementRequest value,
...
class _IClaimAchievementRequest implements IClaimAchievementRequest {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IClaimAchievementRequestCopyWith<_IClaimAchievementRequest> get copyWith =>
      __$IClaimAchievementRequestCopyWithImpl<_IClaimAchievementRequest>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IClaimAchievementRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IClaimAchievementRequest &&
            (identical(other.name, name) || other.name == name));
  }
...
/// @nodoc
abstract mixin class _$IClaimAchievementRequestCopyWith<$Res>
    implements $IClaimAchievementRequestCopyWith<$Res> {
  factory _$IClaimAchievementRequestCopyWith(_IClaimAchievementRequest value,
          $Res Function(_IClaimAchievementRequest) _then) =
