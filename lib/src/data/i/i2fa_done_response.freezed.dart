...
$I2faDoneResponseCopyWith<I2faDoneResponse> get copyWith => _$I2faDoneResponseCopyWithImpl<I2faDoneResponse>(this as I2faDoneResponse, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is I2faDoneResponse&&const DeepCollectionEquality().equals(other.backupCodes, backupCodes));
}
...
abstract mixin class $I2faDoneResponseCopyWith<$Res>  {
  factory $I2faDoneResponseCopyWith(I2faDoneResponse value, $Res Function(I2faDoneResponse) _then) = _$I2faDoneResponseCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [I2faDoneResponse].
extension I2faDoneResponsePatterns on I2faDoneResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _I2faDoneResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _I2faDoneResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _I2faDoneResponse value)  $default,){
final _that = this;
switch (_that) {
case _I2faDoneResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _I2faDoneResponse value)?  $default,){
final _that = this;
switch (_that) {
case _I2faDoneResponse() when $default != null:
return $default(_that);case _:
...
class _I2faDoneResponse implements I2faDoneResponse {
  const _I2faDoneResponse({required final  List<String> backupCodes}): _backupCodes = backupCodes;
  factory _I2faDoneResponse.fromJson(Map<String, dynamic> json) => _$I2faDoneResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$I2faDoneResponseCopyWith<_I2faDoneResponse> get copyWith => __$I2faDoneResponseCopyWithImpl<_I2faDoneResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$I2faDoneResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _I2faDoneResponse&&const DeepCollectionEquality().equals(other._backupCodes, _backupCodes));
}
...
/// @nodoc
abstract mixin class _$I2faDoneResponseCopyWith<$Res> implements $I2faDoneResponseCopyWith<$Res> {
  factory _$I2faDoneResponseCopyWith(_I2faDoneResponse value, $Res Function(_I2faDoneResponse) _then) = __$I2faDoneResponseCopyWithImpl;
@override @useResult
$Res call({
 List<String> backupCodes
});
