...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _INotificationsRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _INotificationsRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _INotificationsRequest value)  $default,){
final _that = this;
switch (_that) {
case _INotificationsRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _INotificationsRequest value)?  $default,){
final _that = this;
switch (_that) {
case _INotificationsRequest() when $default != null:
return $default(_that);case _:
...
class _INotificationsRequest implements INotificationsRequest {
  const _INotificationsRequest({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.markAsRead = true, final  List<NotificationType>? includeTypes, final  List<NotificationType>? excludeTypes}): _includeTypes = includeTypes,_excludeTypes = excludeTypes;
  factory _INotificationsRequest.fromJson(Map<String, dynamic> json) => _$INotificationsRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$INotificationsRequestCopyWith<_INotificationsRequest> get copyWith => __$INotificationsRequestCopyWithImpl<_INotificationsRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$INotificationsRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _INotificationsRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.markAsRead, markAsRead) || other.markAsRead == markAsRead)&&const DeepCollectionEquality().equals(other._includeTypes, _includeTypes)&&const DeepCollectionEquality().equals(other._excludeTypes, _excludeTypes));
}
...
/// @nodoc
abstract mixin class _$INotificationsRequestCopyWith<$Res> implements $INotificationsRequestCopyWith<$Res> {
  factory _$INotificationsRequestCopyWith(_INotificationsRequest value, $Res Function(_INotificationsRequest) _then) = __$INotificationsRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? markAsRead, List<NotificationType>? includeTypes, List<NotificationType>? excludeTypes
});
