...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IPagesRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IPagesRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IPagesRequest value)  $default,){
final _that = this;
switch (_that) {
case _IPagesRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IPagesRequest value)?  $default,){
final _that = this;
switch (_that) {
case _IPagesRequest() when $default != null:
return $default(_that);case _:
...
class _IPagesRequest implements IPagesRequest {
  const _IPagesRequest({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _IPagesRequest.fromJson(Map<String, dynamic> json) => _$IPagesRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$IPagesRequestCopyWith<_IPagesRequest> get copyWith => __$IPagesRequestCopyWithImpl<_IPagesRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$IPagesRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IPagesRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
/// @nodoc
abstract mixin class _$IPagesRequestCopyWith<$Res> implements $IPagesRequestCopyWith<$Res> {
  factory _$IPagesRequestCopyWith(_IPagesRequest value, $Res Function(_IPagesRequest) _then) = __$IPagesRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
