...
$IGalleryPostsRequestCopyWith<IGalleryPostsRequest> get copyWith => _$IGalleryPostsRequestCopyWithImpl<IGalleryPostsRequest>(this as IGalleryPostsRequest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IGalleryPostsRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
@override
String toString() {
  return 'IGalleryPostsRequest(limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate)';
}
...
abstract mixin class $IGalleryPostsRequestCopyWith<$Res>  {
  factory $IGalleryPostsRequestCopyWith(IGalleryPostsRequest value, $Res Function(IGalleryPostsRequest) _then) = _$IGalleryPostsRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [IGalleryPostsRequest].
extension IGalleryPostsRequestPatterns on IGalleryPostsRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IGalleryPostsRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IGalleryPostsRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IGalleryPostsRequest value)  $default,){
final _that = this;
switch (_that) {
case _IGalleryPostsRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IGalleryPostsRequest value)?  $default,){
final _that = this;
switch (_that) {
case _IGalleryPostsRequest() when $default != null:
return $default(_that);case _:
...
class _IGalleryPostsRequest implements IGalleryPostsRequest {
  const _IGalleryPostsRequest({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _IGalleryPostsRequest.fromJson(Map<String, dynamic> json) => _$IGalleryPostsRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$IGalleryPostsRequestCopyWith<_IGalleryPostsRequest> get copyWith => __$IGalleryPostsRequestCopyWithImpl<_IGalleryPostsRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$IGalleryPostsRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IGalleryPostsRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
/// @nodoc
abstract mixin class _$IGalleryPostsRequestCopyWith<$Res> implements $IGalleryPostsRequestCopyWith<$Res> {
  factory _$IGalleryPostsRequestCopyWith(_IGalleryPostsRequest value, $Res Function(_IGalleryPostsRequest) _then) = __$IGalleryPostsRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
