...
mixin _$INotificationsResponse {
 ...
 String get id;@DateTimeConverter() DateTime get createdAt;@JsonKey(unknownEnumValue: NotificationType.unknown) NotificationType get type; String? get noteId; String? get followRequestId; String? get reaction; int? get choice; String? get achievement; String? get body; String? get header;@NullableUriConverter() Uri? get icon; String? get appAccessTokenId; ChatJoining? get invitation; String? get userId; UserLite? get user; Note? get note; RolesListResponse? get role; List<INotificationsReaction>? get reactions; List<UserLite>? get users; UserExportableEntities? get exportedEntity; String? get fileId; String? get message;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,type,noteId,followRequestId,reaction,choice,achievement,body,header,icon,appAccessTokenId,invitation,userId,user,note,role,const DeepCollectionEquality().hash(reactions),const DeepCollectionEquality().hash(users),exportedEntity,fileId,message]);
...
@useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt,@JsonKey(unknownEnumValue: NotificationType.unknown) NotificationType type, String? noteId, String? followRequestId, String? reaction, int? choice, String? achievement, String? body, String? header,@NullableUriConverter() Uri? icon, String? appAccessTokenId, ChatJoining? invitation, String? userId, UserLite? user, Note? note, RolesListResponse? role, List<INotificationsReaction>? reactions, List<UserLite>? users, UserExportableEntities? exportedEntity, String? fileId, String? message
});


$ChatJoiningCopyWith<$Res>? get invitation;$UserLiteCopyWith<$Res>? get user;$NoteCopyWith<$Res>? get note;$RolesListResponseCopyWith<$Res>? get role;
...
/// Create a copy of INotificationsResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? type = null,Object? noteId = freezed,Object? followRequestId = freezed,Object? reaction = freezed,Object? choice = freezed,Object? achievement = freezed,Object? body = freezed,Object? header = freezed,Object? icon = freezed,Object? appAccessTokenId = freezed,Object? invitation = freezed,Object? userId = freezed,Object? user = freezed,Object? note = freezed,Object? role = freezed,Object? reactions = freezed,Object? users = freezed,Object? exportedEntity = freezed,Object? fileId = freezed,Object? message = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @DateTimeConverter()  DateTime createdAt, @JsonKey(unknownEnumValue: NotificationType.unknown)  NotificationType type,  String? noteId,  String? followRequestId,  String? reaction,  int? choice,  String? achievement,  String? body,  String? header, @NullableUriConverter()  Uri? icon,  String? appAccessTokenId,  ChatJoining? invitation,  String? userId,  UserLite? user,  Note? note,  RolesListResponse? role,  List<INotificationsReaction>? reactions,  List<UserLite>? users,  UserExportableEntities? exportedEntity,  String? fileId,  String? message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _INotificationsResponse() when $default != null:
return $default(_that.id,_that.createdAt,_that.type,_that.noteId,_that.followRequestId,_that.reaction,_that.choice,_that.achievement,_that.body,_that.header,_that.icon,_that.appAccessTokenId,_that.invitation,_that.userId,_that.user,_that.note,_that.role,_that.reactions,_that.users,_that.exportedEntity,_that.fileId,_that.message);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @DateTimeConverter()  DateTime createdAt, @JsonKey(unknownEnumValue: NotificationType.unknown)  NotificationType type,  String? noteId,  String? followRequestId,  String? reaction,  int? choice,  String? achievement,  String? body,  String? header, @NullableUriConverter()  Uri? icon,  String? appAccessTokenId,  ChatJoining? invitation,  String? userId,  UserLite? user,  Note? note,  RolesListResponse? role,  List<INotificationsReaction>? reactions,  List<UserLite>? users,  UserExportableEntities? exportedEntity,  String? fileId,  String? message)  $default,) {final _that = this;
switch (_that) {
case _INotificationsResponse():
return $default(_that.id,_that.createdAt,_that.type,_that.noteId,_that.followRequestId,_that.reaction,_that.choice,_that.achievement,_that.body,_that.header,_that.icon,_that.appAccessTokenId,_that.invitation,_that.userId,_that.user,_that.note,_that.role,_that.reactions,_that.users,_that.exportedEntity,_that.fileId,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @DateTimeConverter()  DateTime createdAt, @JsonKey(unknownEnumValue: NotificationType.unknown)  NotificationType type,  String? noteId,  String? followRequestId,  String? reaction,  int? choice,  String? achievement,  String? body,  String? header, @NullableUriConverter()  Uri? icon,  String? appAccessTokenId,  ChatJoining? invitation,  String? userId,  UserLite? user,  Note? note,  RolesListResponse? role,  List<INotificationsReaction>? reactions,  List<UserLite>? users,  UserExportableEntities? exportedEntity,  String? fileId,  String? message)?  $default,) {final _that = this;
switch (_that) {
case _INotificationsResponse() when $default != null:
return $default(_that.id,_that.createdAt,_that.type,_that.noteId,_that.followRequestId,_that.reaction,_that.choice,_that.achievement,_that.body,_that.header,_that.icon,_that.appAccessTokenId,_that.invitation,_that.userId,_that.user,_that.note,_that.role,_that.reactions,_that.users,_that.exportedEntity,_that.fileId,_that.message);case _:
  return null;
...
class _INotificationsResponse implements INotificationsResponse {
  const _INotificationsResponse({required this.id, @DateTimeConverter() required this.createdAt, @JsonKey(unknownEnumValue: NotificationType.unknown) required this.type, this.noteId, this.followRequestId, this.reaction, this.choice, this.achievement, this.body, this.header, @NullableUriConverter() this.icon, this.appAccessTokenId, this.invitation, this.userId, this.user, this.note, this.role, final  List<INotificationsReaction>? reactions, final  List<UserLite>? users, this.exportedEntity, this.fileId, this.message}): _reactions = reactions,_users = users;
...
@override final  UserExportableEntities? exportedEntity;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,type,noteId,followRequestId,reaction,choice,achievement,body,header,icon,appAccessTokenId,invitation,userId,user,note,role,const DeepCollectionEquality().hash(_reactions),const DeepCollectionEquality().hash(_users),exportedEntity,fileId,message]);
...
@override $ChatJoiningCopyWith<$Res>? get invitation;@override $UserLiteCopyWith<$Res>? get user;@override $NoteCopyWith<$Res>? get note;@override $RolesListResponseCopyWith<$Res>? get role;
