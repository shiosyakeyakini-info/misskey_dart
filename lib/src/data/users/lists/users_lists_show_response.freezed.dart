...
mixin _$UsersListsShowResponse {
 ...
 bool? get isPublic; int? get likedCount; bool? get isLiked;
...
class _UsersListsShowResponse implements UsersListsShowResponse {
  const _UsersListsShowResponse({required this.id, @DateTimeConverter() required this.createdAt, required this.name, required final  List<String> userIds, this.isPublic, this.likedCount, this.isLiked}): _userIds = userIds;
