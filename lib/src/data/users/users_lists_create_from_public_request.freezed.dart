...
/// Create a copy of UsersListsCreateFromPublicRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? listId = freezed,}) {
...
class _UsersListsCreateFromPublicRequest implements UsersListsCreateFromPublicRequest {
  const _UsersListsCreateFromPublicRequest({this.name, this.listId});
...
/// Create a copy of UsersListsCreateFromPublicRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? listId = freezed,}) {
