...
abstract class AdminShowUserNotificationRecieveConfigChatRoomInvitationReceived with _$AdminShowUserNotificationRecieveConfigChatRoomInvitationReceived {
  ...
  factory AdminShowUserNotificationRecieveConfigChatRoomInvitationReceived.fromJson(Map<String, Object?> json) => _$AdminShowUserNotificationRecieveConfigChatRoomInvitationReceivedFromJson(json);
}
