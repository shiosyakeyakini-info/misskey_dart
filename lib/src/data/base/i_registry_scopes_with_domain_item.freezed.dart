...
mixin _$IRegistryScopesWithDomainItem {
  ...
  $IRegistryScopesWithDomainItemCopyWith<IRegistryScopesWithDomainItem>
      get copyWith => _$IRegistryScopesWithDomainItemCopyWithImpl<
              IRegistryScopesWithDomainItem>(
          this as IRegistryScopesWithDomainItem, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IRegistryScopesWithDomainItem &&
...
abstract mixin class $IRegistryScopesWithDomainItemCopyWith<$Res> {
  factory $IRegistryScopesWithDomainItemCopyWith(
          IRegistryScopesWithDomainItem value,
          $Res Function(IRegistryScopesWithDomainItem) _then) =
      _$IRegistryScopesWithDomainItemCopyWithImpl;
  @useResult
  $Res call({List<dynamic> scopes, String? domain});
}
...
class _IRegistryScopesWithDomainItem implements IRegistryScopesWithDomainItem {
  const _IRegistryScopesWithDomainItem(
      {required final List<dynamic> scopes, this.domain})
      : _scopes = scopes;
  factory _IRegistryScopesWithDomainItem.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IRegistryScopesWithDomainItemCopyWith<_IRegistryScopesWithDomainItem>
      get copyWith => __$IRegistryScopesWithDomainItemCopyWithImpl<
          _IRegistryScopesWithDomainItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IRegistryScopesWithDomainItemToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IRegistryScopesWithDomainItem &&
...
/// @nodoc
abstract mixin class _$IRegistryScopesWithDomainItemCopyWith<$Res>
    implements $IRegistryScopesWithDomainItemCopyWith<$Res> {
  factory _$IRegistryScopesWithDomainItemCopyWith(
          _IRegistryScopesWithDomainItem value,
          $Res Function(_IRegistryScopesWithDomainItem) _then) =
      __$IRegistryScopesWithDomainItemCopyWithImpl;
  @override
  @useResult
  $Res call({List<dynamic> scopes, String? domain});
}
