...
mixin _$AdminSystemWebhookCreate {
  ...
  $AdminSystemWebhookCreateCopyWith<AdminSystemWebhookCreate> get copyWith =>
      _$AdminSystemWebhookCreateCopyWithImpl<AdminSystemWebhookCreate>(
          this as AdminSystemWebhookCreate, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminSystemWebhookCreate &&
...
abstract mixin class $AdminSystemWebhookCreateCopyWith<$Res> {
  factory $AdminSystemWebhookCreateCopyWith(AdminSystemWebhookCreate value,
          $Res Function(AdminSystemWebhookCreate) _then) =
      _$AdminSystemWebhookCreateCopyWithImpl;
  @useResult
  $Res call(
      {bool isActive,
      String name,
...
class _AdminSystemWebhookCreate implements AdminSystemWebhookCreate {
  const _AdminSystemWebhookCreate(
      {required this.isActive,
      required this.name,
      @JsonKey(name: 'on')
      required final List<AdminSystemWebhookCreateOnItem> on_,
      required this.url,
      this.secret = ""})
      : _on_ = on_;
  factory _AdminSystemWebhookCreate.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminSystemWebhookCreateCopyWith<_AdminSystemWebhookCreate> get copyWith =>
      __$AdminSystemWebhookCreateCopyWithImpl<_AdminSystemWebhookCreate>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminSystemWebhookCreateToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminSystemWebhookCreate &&
            (identical(other.isActive, isActive) ||
                other.isActive == isActive) &&
            (identical(other.name, name) || other.name == name) &&
...
/// @nodoc
abstract mixin class _$AdminSystemWebhookCreateCopyWith<$Res>
    implements $AdminSystemWebhookCreateCopyWith<$Res> {
  factory _$AdminSystemWebhookCreateCopyWith(_AdminSystemWebhookCreate value,
          $Res Function(_AdminSystemWebhookCreate) _then) =
      __$AdminSystemWebhookCreateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isActive,
