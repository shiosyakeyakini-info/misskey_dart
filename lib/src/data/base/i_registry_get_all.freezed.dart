...
$IRegistryGetAllCopyWith<IRegistryGetAll> get copyWith => _$IRegistryGetAllCopyWithImpl<IRegistryGetAll>(this as IRegistryGetAll, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IRegistryGetAll&&const DeepCollectionEquality().equals(other.scope, scope)&&(identical(other.domain, domain) || other.domain == domain));
}
...
abstract mixin class $IRegistryGetAllCopyWith<$Res>  {
  factory $IRegistryGetAllCopyWith(IRegistryGetAll value, $Res Function(IRegistryGetAll) _then) = _$IRegistryGetAllCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [IRegistryGetAll].
extension IRegistryGetAllPatterns on IRegistryGetAll {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IRegistryGetAll value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IRegistryGetAll() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IRegistryGetAll value)  $default,){
final _that = this;
switch (_that) {
case _IRegistryGetAll():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IRegistryGetAll value)?  $default,){
final _that = this;
switch (_that) {
case _IRegistryGetAll() when $default != null:
return $default(_that);case _:
...
class _IRegistryGetAll implements IRegistryGetAll {
  const _IRegistryGetAll({final  List<String> scope = const [], this.domain}): _scope = scope;
  factory _IRegistryGetAll.fromJson(Map<String, dynamic> json) => _$IRegistryGetAllFromJson(json);
...
@pragma('vm:prefer-inline')
_$IRegistryGetAllCopyWith<_IRegistryGetAll> get copyWith => __$IRegistryGetAllCopyWithImpl<_IRegistryGetAll>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$IRegistryGetAllToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IRegistryGetAll&&const DeepCollectionEquality().equals(other._scope, _scope)&&(identical(other.domain, domain) || other.domain == domain));
}
...
/// @nodoc
abstract mixin class _$IRegistryGetAllCopyWith<$Res> implements $IRegistryGetAllCopyWith<$Res> {
  factory _$IRegistryGetAllCopyWith(_IRegistryGetAll value, $Res Function(_IRegistryGetAll) _then) = __$IRegistryGetAllCopyWithImpl;
@override @useResult
$Res call({
 List<String> scope, String? domain
});
