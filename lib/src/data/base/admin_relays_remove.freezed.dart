...
mixin _$AdminRelaysRemove {
  ...
  $AdminRelaysRemoveCopyWith<AdminRelaysRemove> get copyWith =>
      _$AdminRelaysRemoveCopyWithImpl<AdminRelaysRemove>(
          this as AdminRelaysRemove, _$identity);
...
abstract mixin class $AdminRelaysRemoveCopyWith<$Res> {
  factory $AdminRelaysRemoveCopyWith(
          AdminRelaysRemove value, $Res Function(AdminRelaysRemove) _then) =
      _$AdminRelaysRemoveCopyWithImpl;
  @useResult
...
class _AdminRelaysRemove implements AdminRelaysRemove {
  ...
  factory _AdminRelaysRemove.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminRelaysRemoveCopyWith<_AdminRelaysRemove> get copyWith =>
      __$AdminRelaysRemoveCopyWithImpl<_AdminRelaysRemove>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminRelaysRemoveToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AdminRelaysRemoveCopyWith<$Res>
    implements $AdminRelaysRemoveCopyWith<$Res> {
  factory _$AdminRelaysRemoveCopyWith(
          _AdminRelaysRemove value, $Res Function(_AdminRelaysRemove) _then) =
      __$AdminRelaysRemoveCopyWithImpl;
  @override
  @useResult
  $Res call({String inbox});
}
