...
mixin _$ChartsDriveRemote {
  ...
  $ChartsDriveRemoteCopyWith<ChartsDriveRemote> get copyWith =>
      _$ChartsDriveRemoteCopyWithImpl<ChartsDriveRemote>(
          this as ChartsDriveRemote, _$identity);
...
abstract mixin class $ChartsDriveRemoteCopyWith<$Res> {
  factory $ChartsDriveRemoteCopyWith(
          ChartsDriveRemote value, $Res Function(ChartsDriveRemote) _then) =
      _$ChartsDriveRemoteCopyWithImpl;
  @useResult
  $Res call(
...
class _ChartsDriveRemote implements ChartsDriveRemote {
  const _ChartsDriveRemote(
      ...
      : _incCount = incCount,
        ...
        _decCount = decCount,
        _decSize = decSize;
  factory _ChartsDriveRemote.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChartsDriveRemoteCopyWith<_ChartsDriveRemote> get copyWith =>
      __$ChartsDriveRemoteCopyWithImpl<_ChartsDriveRemote>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChartsDriveRemoteToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ChartsDriveRemoteCopyWith<$Res>
    implements $ChartsDriveRemoteCopyWith<$Res> {
  factory _$ChartsDriveRemoteCopyWith(
          _ChartsDriveRemote value, $Res Function(_ChartsDriveRemote) _then) =
      __$ChartsDriveRemoteCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<double> incCount,
