...
$AdminAdUpdateCopyWith<AdminAdUpdate> get copyWith => _$AdminAdUpdateCopyWithImpl<AdminAdUpdate>(this as AdminAdUpdate, _$identity);
...
abstract mixin class $AdminAdUpdateCopyWith<$Res>  {
  factory $AdminAdUpdateCopyWith(AdminAdUpdate value, $Res Function(AdminAdUpdate) _then) = _$AdminAdUpdateCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of AdminAdUpdate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? memo = freezed,Object? url = freezed,Object? imageUrl = freezed,Object? place = freezed,Object? priority = freezed,Object? ratio = freezed,Object? expiresAt = freezed,Object? startsAt = freezed,Object? dayOfWeek = freezed,Object? isSensitive = freezed,}) {
...
/// Adds pattern-matching-related methods to [AdminAdUpdate].
extension AdminAdUpdatePatterns on AdminAdUpdate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminAdUpdate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminAdUpdate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminAdUpdate value)  $default,){
final _that = this;
switch (_that) {
case _AdminAdUpdate():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminAdUpdate value)?  $default,){
final _that = this;
switch (_that) {
case _AdminAdUpdate() when $default != null:
return $default(_that);case _:
...
class _AdminAdUpdate implements AdminAdUpdate {
  const _AdminAdUpdate({required this.id, this.memo, this.url, this.imageUrl, this.place, this.priority, this.ratio, this.expiresAt, this.startsAt, this.dayOfWeek, this.isSensitive});
  factory _AdminAdUpdate.fromJson(Map<String, dynamic> json) => _$AdminAdUpdateFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminAdUpdateCopyWith<_AdminAdUpdate> get copyWith => __$AdminAdUpdateCopyWithImpl<_AdminAdUpdate>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminAdUpdateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminAdUpdate&&(identical(other.id, id) || other.id == id)&&(identical(other.memo, memo) || other.memo == memo)&&(identical(other.url, url) || other.url == url)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.place, place) || other.place == place)&&(identical(other.priority, priority) || other.priority == priority)&&(identical(other.ratio, ratio) || other.ratio == ratio)&&(identical(other.expiresAt, expiresAt) || other.expiresAt == expiresAt)&&(identical(other.startsAt, startsAt) || other.startsAt == startsAt)&&(identical(other.dayOfWeek, dayOfWeek) || other.dayOfWeek == dayOfWeek)&&(identical(other.isSensitive, isSensitive) || other.isSensitive == isSensitive));
}
...
/// @nodoc
abstract mixin class _$AdminAdUpdateCopyWith<$Res> implements $AdminAdUpdateCopyWith<$Res> {
  factory _$AdminAdUpdateCopyWith(_AdminAdUpdate value, $Res Function(_AdminAdUpdate) _then) = __$AdminAdUpdateCopyWithImpl;
@override @useResult
$Res call({
 String id, String? memo, String? url, String? imageUrl, String? place, String? priority, int? ratio, int? expiresAt, int? startsAt, int? dayOfWeek, bool? isSensitive
});
...
/// Create a copy of AdminAdUpdate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? memo = freezed,Object? url = freezed,Object? imageUrl = freezed,Object? place = freezed,Object? priority = freezed,Object? ratio = freezed,Object? expiresAt = freezed,Object? startsAt = freezed,Object? dayOfWeek = freezed,Object? isSensitive = freezed,}) {
