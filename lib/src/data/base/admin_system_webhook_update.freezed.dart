...
mixin _$AdminSystemWebhookUpdate {
  ...
  $AdminSystemWebhookUpdateCopyWith<AdminSystemWebhookUpdate> get copyWith =>
      _$AdminSystemWebhookUpdateCopyWithImpl<AdminSystemWebhookUpdate>(
          this as AdminSystemWebhookUpdate, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminSystemWebhookUpdate &&
...
abstract mixin class $AdminSystemWebhookUpdateCopyWith<$Res> {
  factory $AdminSystemWebhookUpdateCopyWith(AdminSystemWebhookUpdate value,
          $Res Function(AdminSystemWebhookUpdate) _then) =
      _$AdminSystemWebhookUpdateCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      bool isActive,
...
class _AdminSystemWebhookUpdate implements AdminSystemWebhookUpdate {
  const _AdminSystemWebhookUpdate(
      {required this.id,
      required this.isActive,
      required this.name,
      @JsonKey(name: 'on')
      required final List<AdminSystemWebhookUpdateOnItem> on_,
      required this.url,
      this.secret = ""})
      : _on_ = on_;
  factory _AdminSystemWebhookUpdate.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminSystemWebhookUpdateCopyWith<_AdminSystemWebhookUpdate> get copyWith =>
      __$AdminSystemWebhookUpdateCopyWithImpl<_AdminSystemWebhookUpdate>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminSystemWebhookUpdateToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminSystemWebhookUpdate &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.isActive, isActive) ||
                other.isActive == isActive) &&
            (identical(other.name, name) || other.name == name) &&
...
/// @nodoc
abstract mixin class _$AdminSystemWebhookUpdateCopyWith<$Res>
    implements $AdminSystemWebhookUpdateCopyWith<$Res> {
  factory _$AdminSystemWebhookUpdateCopyWith(_AdminSystemWebhookUpdate value,
          $Res Function(_AdminSystemWebhookUpdate) _then) =
      __$AdminSystemWebhookUpdateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
