...
mixin _$ChartsUserNotesDiffs {
  ...
  $ChartsUserNotesDiffsCopyWith<ChartsUserNotesDiffs> get copyWith =>
      _$ChartsUserNotesDiffsCopyWithImpl<ChartsUserNotesDiffs>(
          this as ChartsUserNotesDiffs, _$identity);
...
abstract mixin class $ChartsUserNotesDiffsCopyWith<$Res> {
  factory $ChartsUserNotesDiffsCopyWith(ChartsUserNotesDiffs value,
          $Res Function(ChartsUserNotesDiffs) _then) =
      _$ChartsUserNotesDiffsCopyWithImpl;
  @useResult
  $Res call(
      {List<double> normal,
      List<double> reply,
...
class _ChartsUserNotesDiffs implements ChartsUserNotesDiffs {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChartsUserNotesDiffsCopyWith<_ChartsUserNotesDiffs> get copyWith =>
      __$ChartsUserNotesDiffsCopyWithImpl<_ChartsUserNotesDiffs>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChartsUserNotesDiffsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChartsUserNotesDiffs &&
...
/// @nodoc
abstract mixin class _$ChartsUserNotesDiffsCopyWith<$Res>
    implements $ChartsUserNotesDiffsCopyWith<$Res> {
  factory _$ChartsUserNotesDiffsCopyWith(_ChartsUserNotesDiffs value,
          $Res Function(_ChartsUserNotesDiffs) _then) =
      __$ChartsUserNotesDiffsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<double> normal,
