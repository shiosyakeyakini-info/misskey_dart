...
_NoteDraft _$NoteDraftFromJson(Map<String, dynamic> json) => _NoteDraft(
  ...
  visibility: const NoteVisibilityJsonConverter().fromJson(
...
Map<String, dynamic> _$NoteDraftToJson(
  _NoteDraft instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'visibility': const NoteVisibilityJsonConverter().toJson(instance.visibility),
