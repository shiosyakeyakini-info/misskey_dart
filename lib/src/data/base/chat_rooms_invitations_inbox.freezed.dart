...
mixin _$ChatRoomsInvitationsInbox {
  ...
  $ChatRoomsInvitationsInboxCopyWith<ChatRoomsInvitationsInbox> get copyWith =>
      _$ChatRoomsInvitationsInboxCopyWithImpl<ChatRoomsInvitationsInbox>(
          this as ChatRoomsInvitationsInbox, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChatRoomsInvitationsInbox &&
...
abstract mixin class $ChatRoomsInvitationsInboxCopyWith<$Res> {
  factory $ChatRoomsInvitationsInboxCopyWith(ChatRoomsInvitationsInbox value,
          $Res Function(ChatRoomsInvitationsInbox) _then) =
      _$ChatRoomsInvitationsInboxCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _ChatRoomsInvitationsInbox implements ChatRoomsInvitationsInbox {
  const _ChatRoomsInvitationsInbox(
      {this.limit = 30,
      this.sinceId,
      this.untilId,
      this.sinceDate,
      this.untilDate});
  factory _ChatRoomsInvitationsInbox.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChatRoomsInvitationsInboxCopyWith<_ChatRoomsInvitationsInbox>
      get copyWith =>
          __$ChatRoomsInvitationsInboxCopyWithImpl<_ChatRoomsInvitationsInbox>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChatRoomsInvitationsInboxToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChatRoomsInvitationsInbox &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.sinceId, sinceId) || other.sinceId == sinceId) &&
            (identical(other.untilId, untilId) || other.untilId == untilId) &&
            (identical(other.sinceDate, sinceDate) ||
...
/// @nodoc
abstract mixin class _$ChatRoomsInvitationsInboxCopyWith<$Res>
    implements $ChatRoomsInvitationsInboxCopyWith<$Res> {
  factory _$ChatRoomsInvitationsInboxCopyWith(_ChatRoomsInvitationsInbox value,
          $Res Function(_ChatRoomsInvitationsInbox) _then) =
      __$ChatRoomsInvitationsInboxCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
