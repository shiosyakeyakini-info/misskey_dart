...
@freezed
abstract class IUpdateNotificationRecieveConfigMention
    with _$IUpdateNotificationRecieveConfigMention {
  const factory IUpdateNotificationRecieveConfigMention({
    @JsonKey(
        unknownEnumValue: IUpdateNotificationRecieveConfigMentionType.unknown)
    required IUpdateNotificationRecieveConfigMentionType type,
    required String userListId,
  }) = _IUpdateNotificationRecieveConfigMention;

  factory IUpdateNotificationRecieveConfigMention.fromJson(
