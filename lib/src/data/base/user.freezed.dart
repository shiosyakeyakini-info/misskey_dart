...
mixin _$UserLite {
 ...
 String get id; String? get name; String get username; String? get host;@UriConverter() Uri get avatarUrl; String? get avatarBlurhash; List<UserAvatarDecoration> get avatarDecorations; bool get isBot; bool get isCat; UserInstanceInfo? get instance;@EmojisConverter() Map<String, String> get emojis;@OnlineStatusJsonConverter() OnlineStatus? get onlineStatus; List<UserBadgeRole> get badgeRoles; bool? get requireSigninToViewContents;@HideBeforeConverter() HideBefore? get makeNotesFollowersOnlyBefore;@HideBeforeConverter() HideBefore? get makeNotesHiddenBefore;
...
@useResult
$Res call({
 String id, String? name, String username, String? host,@UriConverter() Uri avatarUrl, String? avatarBlurhash, List<UserAvatarDecoration> avatarDecorations, bool isBot, bool isCat, UserInstanceInfo? instance,@EmojisConverter() Map<String, String> emojis,@OnlineStatusJsonConverter() OnlineStatus? onlineStatus, List<UserBadgeRole> badgeRoles, bool? requireSigninToViewContents,@HideBeforeConverter() HideBefore? makeNotesFollowersOnlyBefore,@HideBeforeConverter() HideBefore? makeNotesHiddenBefore
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? name,  String username,  String? host, @UriConverter()  Uri avatarUrl,  String? avatarBlurhash,  List<UserAvatarDecoration> avatarDecorations,  bool isBot,  bool isCat,  UserInstanceInfo? instance, @EmojisConverter()  Map<String, String> emojis, @OnlineStatusJsonConverter()  OnlineStatus? onlineStatus,  List<UserBadgeRole> badgeRoles,  bool? requireSigninToViewContents, @HideBeforeConverter()  HideBefore? makeNotesFollowersOnlyBefore, @HideBeforeConverter()  HideBefore? makeNotesHiddenBefore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserLite() when $default != null:
return $default(_that.id,_that.name,_that.username,_that.host,_that.avatarUrl,_that.avatarBlurhash,_that.avatarDecorations,_that.isBot,_that.isCat,_that.instance,_that.emojis,_that.onlineStatus,_that.badgeRoles,_that.requireSigninToViewContents,_that.makeNotesFollowersOnlyBefore,_that.makeNotesHiddenBefore);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? name,  String username,  String? host, @UriConverter()  Uri avatarUrl,  String? avatarBlurhash,  List<UserAvatarDecoration> avatarDecorations,  bool isBot,  bool isCat,  UserInstanceInfo? instance, @EmojisConverter()  Map<String, String> emojis, @OnlineStatusJsonConverter()  OnlineStatus? onlineStatus,  List<UserBadgeRole> badgeRoles,  bool? requireSigninToViewContents, @HideBeforeConverter()  HideBefore? makeNotesFollowersOnlyBefore, @HideBeforeConverter()  HideBefore? makeNotesHiddenBefore)  $default,) {final _that = this;
switch (_that) {
case _UserLite():
return $default(_that.id,_that.name,_that.username,_that.host,_that.avatarUrl,_that.avatarBlurhash,_that.avatarDecorations,_that.isBot,_that.isCat,_that.instance,_that.emojis,_that.onlineStatus,_that.badgeRoles,_that.requireSigninToViewContents,_that.makeNotesFollowersOnlyBefore,_that.makeNotesHiddenBefore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? name,  String username,  String? host, @UriConverter()  Uri avatarUrl,  String? avatarBlurhash,  List<UserAvatarDecoration> avatarDecorations,  bool isBot,  bool isCat,  UserInstanceInfo? instance, @EmojisConverter()  Map<String, String> emojis, @OnlineStatusJsonConverter()  OnlineStatus? onlineStatus,  List<UserBadgeRole> badgeRoles,  bool? requireSigninToViewContents, @HideBeforeConverter()  HideBefore? makeNotesFollowersOnlyBefore, @HideBeforeConverter()  HideBefore? makeNotesHiddenBefore)?  $default,) {final _that = this;
switch (_that) {
case _UserLite() when $default != null:
return $default(_that.id,_that.name,_that.username,_that.host,_that.avatarUrl,_that.avatarBlurhash,_that.avatarDecorations,_that.isBot,_that.isCat,_that.instance,_that.emojis,_that.onlineStatus,_that.badgeRoles,_that.requireSigninToViewContents,_that.makeNotesFollowersOnlyBefore,_that.makeNotesHiddenBefore);case _:
  return null;
...
class _UserLite implements UserLite {
  const _UserLite({required this.id, this.name, required this.username, this.host, @UriConverter() required this.avatarUrl, this.avatarBlurhash, final  List<UserAvatarDecoration> avatarDecorations = const [], this.isBot = false, this.isCat = false, this.instance, @EmojisConverter() final  Map<String, String> emojis = const {}, @OnlineStatusJsonConverter() this.onlineStatus, final  List<UserBadgeRole> badgeRoles = const [], this.requireSigninToViewContents, @HideBeforeConverter() this.makeNotesFollowersOnlyBefore, @HideBeforeConverter() this.makeNotesHiddenBefore}): _avatarDecorations = avatarDecorations,_emojis = emojis,_badgeRoles = badgeRoles;
...
@override@UriConverter() final  Uri avatarUrl;
...
@override@OnlineStatusJsonConverter() final  OnlineStatus? onlineStatus;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,username,host,avatarUrl,avatarBlurhash,const DeepCollectionEquality().hash(_avatarDecorations),isBot,isCat,instance,const DeepCollectionEquality().hash(_emojis),onlineStatus,const DeepCollectionEquality().hash(_badgeRoles),requireSigninToViewContents,makeNotesFollowersOnlyBefore,makeNotesHiddenBefore);
...
mixin _$UserDetailedNotMe {
 ...
 String get id; String? get name; String get username; String? get host;@UriConverter() Uri get avatarUrl; String? get avatarBlurhash; List<UserAvatarDecoration> get avatarDecorations; bool get isBot; bool get isCat; UserInstanceInfo? get instance;@EmojisConverter() Map<String, String> get emojis;@OnlineStatusJsonConverter() OnlineStatus? get onlineStatus; List<UserBadgeRole> get badgeRoles; bool? get requireSigninToViewContents;@HideBeforeConverter() HideBefore? get makeNotesFollowersOnlyBefore;@HideBeforeConverter() HideBefore? get makeNotesHiddenBefore;@NullableUriConverter() Uri? get url;@NullableUriConverter() Uri? get uri;@NullableUriConverter() Uri? get movedTo; List<String>? get alsoKnownAs;@DateTimeConverter() DateTime get createdAt;@NullableDateTimeConverter() DateTime? get updatedAt;@NullableDateTimeConverter() DateTime? get lastFetchedAt;@NullableUriConverter() Uri? get bannerUrl; String? get bannerBlurhash; bool get isLocked; bool get isSilenced; bool get isSuspended; String? get description; String? get location;@NullableDateTimeConverter() DateTime? get birthday; String? get lang; List<UserField>? get fields; List<String> get verifiedLinks; int get followersCount; int get followingCount; int get notesCount; List<String>? get pinnedNoteIds; List<Note>? get pinnedNotes; String? get pinnedPageId; Map<String, dynamic>? get pinnedPage; bool get publicReactions;@Deprecated("removed at 2023.12.0") FFVisibility? get ffVisibility; FFVisibility? get followersVisibility; FFVisibility? get followingVisibility; ChatScope? get chatScope; bool? get canChat; bool? get twoFactorEnabled; bool? get usePasswordLessLogin; bool? get securityKeys; List<UserRole>? get roles; String? get memo; String? get moderationNote;
...
@useResult
$Res call({
 String id, String? name, String username, String? host,@UriConverter() Uri avatarUrl, String? avatarBlurhash, List<UserAvatarDecoration> avatarDecorations, bool isBot, bool isCat, UserInstanceInfo? instance,@EmojisConverter() Map<String, String> emojis,@OnlineStatusJsonConverter() OnlineStatus? onlineStatus, List<UserBadgeRole> badgeRoles, bool? requireSigninToViewContents,@HideBeforeConverter() HideBefore? makeNotesFollowersOnlyBefore,@HideBeforeConverter() HideBefore? makeNotesHiddenBefore,@NullableUriConverter() Uri? url,@NullableUriConverter() Uri? uri,@NullableUriConverter() Uri? movedTo, List<String>? alsoKnownAs,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? updatedAt,@NullableDateTimeConverter() DateTime? lastFetchedAt,@NullableUriConverter() Uri? bannerUrl, String? bannerBlurhash, bool isLocked, bool isSilenced, bool isSuspended, String? description, String? location,@NullableDateTimeConverter() DateTime? birthday, String? lang, List<UserField>? fields, List<String> verifiedLinks, int followersCount, int followingCount, int notesCount, List<String>? pinnedNoteIds, List<Note>? pinnedNotes, String? pinnedPageId, Map<String, dynamic>? pinnedPage, bool publicReactions,@Deprecated("removed at 2023.12.0") FFVisibility? ffVisibility, FFVisibility? followersVisibility, FFVisibility? followingVisibility, ChatScope? chatScope, bool? canChat, bool? twoFactorEnabled, bool? usePasswordLessLogin, bool? securityKeys, List<UserRole>? roles, String? memo, String? moderationNote
});
...
/// Create a copy of UserDetailedNotMe
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? username = null,Object? host = freezed,Object? avatarUrl = null,Object? avatarBlurhash = freezed,Object? avatarDecorations = null,Object? isBot = null,Object? isCat = null,Object? instance = freezed,Object? emojis = null,Object? onlineStatus = freezed,Object? badgeRoles = null,Object? requireSigninToViewContents = freezed,Object? makeNotesFollowersOnlyBefore = freezed,Object? makeNotesHiddenBefore = freezed,Object? url = freezed,Object? uri = freezed,Object? movedTo = freezed,Object? alsoKnownAs = freezed,Object? createdAt = null,Object? updatedAt = freezed,Object? lastFetchedAt = freezed,Object? bannerUrl = freezed,Object? bannerBlurhash = freezed,Object? isLocked = null,Object? isSilenced = null,Object? isSuspended = null,Object? description = freezed,Object? location = freezed,Object? birthday = freezed,Object? lang = freezed,Object? fields = freezed,Object? verifiedLinks = null,Object? followersCount = null,Object? followingCount = null,Object? notesCount = null,Object? pinnedNoteIds = freezed,Object? pinnedNotes = freezed,Object? pinnedPageId = freezed,Object? pinnedPage = freezed,Object? publicReactions = null,Object? ffVisibility = freezed,Object? followersVisibility = freezed,Object? followingVisibility = freezed,Object? chatScope = freezed,Object? canChat = freezed,Object? twoFactorEnabled = freezed,Object? usePasswordLessLogin = freezed,Object? securityKeys = freezed,Object? roles = freezed,Object? memo = freezed,Object? moderationNote = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,username: null == username ? _self.username : username // ignore: cast_nullable_to_non_nullable
...
as bool?,makeNotesFollowersOnlyBefore: freezed == makeNotesFollowersOnlyBefore ? _self.makeNotesFollowersOnlyBefore : makeNotesFollowersOnlyBefore // ignore: cast_nullable_to_non_nullable
as HideBefore?,makeNotesHiddenBefore: freezed == makeNotesHiddenBefore ? _self.makeNotesHiddenBefore : makeNotesHiddenBefore // ignore: cast_nullable_to_non_nullable
as HideBefore?,url: freezed == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
...
as List<String>,followersCount: null == followersCount ? _self.followersCount : followersCount // ignore: cast_nullable_to_non_nullable
...
as ChatScope?,canChat: freezed == canChat ? _self.canChat : canChat // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? name,  String username,  String? host, @UriConverter()  Uri avatarUrl,  String? avatarBlurhash,  List<UserAvatarDecoration> avatarDecorations,  bool isBot,  bool isCat,  UserInstanceInfo? instance, @EmojisConverter()  Map<String, String> emojis, @OnlineStatusJsonConverter()  OnlineStatus? onlineStatus,  List<UserBadgeRole> badgeRoles,  bool? requireSigninToViewContents, @HideBeforeConverter()  HideBefore? makeNotesFollowersOnlyBefore, @HideBeforeConverter()  HideBefore? makeNotesHiddenBefore, @NullableUriConverter()  Uri? url, @NullableUriConverter()  Uri? uri, @NullableUriConverter()  Uri? movedTo,  List<String>? alsoKnownAs, @DateTimeConverter()  DateTime createdAt, @NullableDateTimeConverter()  DateTime? updatedAt, @NullableDateTimeConverter()  DateTime? lastFetchedAt, @NullableUriConverter()  Uri? bannerUrl,  String? bannerBlurhash,  bool isLocked,  bool isSilenced,  bool isSuspended,  String? description,  String? location, @NullableDateTimeConverter()  DateTime? birthday,  String? lang,  List<UserField>? fields,  List<String> verifiedLinks,  int followersCount,  int followingCount,  int notesCount,  List<String>? pinnedNoteIds,  List<Note>? pinnedNotes,  String? pinnedPageId,  Map<String, dynamic>? pinnedPage,  bool publicReactions, @Deprecated("removed at 2023.12.0")  FFVisibility? ffVisibility,  FFVisibility? followersVisibility,  FFVisibility? followingVisibility,  ChatScope? chatScope,  bool? canChat,  bool? twoFactorEnabled,  bool? usePasswordLessLogin,  bool? securityKeys,  List<UserRole>? roles,  String? memo,  String? moderationNote)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserDetailedNotMe() when $default != null:
return $default(_that.id,_that.name,_that.username,_that.host,_that.avatarUrl,_that.avatarBlurhash,_that.avatarDecorations,_that.isBot,_that.isCat,_that.instance,_that.emojis,_that.onlineStatus,_that.badgeRoles,_that.requireSigninToViewContents,_that.makeNotesFollowersOnlyBefore,_that.makeNotesHiddenBefore,_that.url,_that.uri,_that.movedTo,_that.alsoKnownAs,_that.createdAt,_that.updatedAt,_that.lastFetchedAt,_that.bannerUrl,_that.bannerBlurhash,_that.isLocked,_that.isSilenced,_that.isSuspended,_that.description,_that.location,_that.birthday,_that.lang,_that.fields,_that.verifiedLinks,_that.followersCount,_that.followingCount,_that.notesCount,_that.pinnedNoteIds,_that.pinnedNotes,_that.pinnedPageId,_that.pinnedPage,_that.publicReactions,_that.ffVisibility,_that.followersVisibility,_that.followingVisibility,_that.chatScope,_that.canChat,_that.twoFactorEnabled,_that.usePasswordLessLogin,_that.securityKeys,_that.roles,_that.memo,_that.moderationNote);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? name,  String username,  String? host, @UriConverter()  Uri avatarUrl,  String? avatarBlurhash,  List<UserAvatarDecoration> avatarDecorations,  bool isBot,  bool isCat,  UserInstanceInfo? instance, @EmojisConverter()  Map<String, String> emojis, @OnlineStatusJsonConverter()  OnlineStatus? onlineStatus,  List<UserBadgeRole> badgeRoles,  bool? requireSigninToViewContents, @HideBeforeConverter()  HideBefore? makeNotesFollowersOnlyBefore, @HideBeforeConverter()  HideBefore? makeNotesHiddenBefore, @NullableUriConverter()  Uri? url, @NullableUriConverter()  Uri? uri, @NullableUriConverter()  Uri? movedTo,  List<String>? alsoKnownAs, @DateTimeConverter()  DateTime createdAt, @NullableDateTimeConverter()  DateTime? updatedAt, @NullableDateTimeConverter()  DateTime? lastFetchedAt, @NullableUriConverter()  Uri? bannerUrl,  String? bannerBlurhash,  bool isLocked,  bool isSilenced,  bool isSuspended,  String? description,  String? location, @NullableDateTimeConverter()  DateTime? birthday,  String? lang,  List<UserField>? fields,  List<String> verifiedLinks,  int followersCount,  int followingCount,  int notesCount,  List<String>? pinnedNoteIds,  List<Note>? pinnedNotes,  String? pinnedPageId,  Map<String, dynamic>? pinnedPage,  bool publicReactions, @Deprecated("removed at 2023.12.0")  FFVisibility? ffVisibility,  FFVisibility? followersVisibility,  FFVisibility? followingVisibility,  ChatScope? chatScope,  bool? canChat,  bool? twoFactorEnabled,  bool? usePasswordLessLogin,  bool? securityKeys,  List<UserRole>? roles,  String? memo,  String? moderationNote)  $default,) {final _that = this;
switch (_that) {
case _UserDetailedNotMe():
return $default(_that.id,_that.name,_that.username,_that.host,_that.avatarUrl,_that.avatarBlurhash,_that.avatarDecorations,_that.isBot,_that.isCat,_that.instance,_that.emojis,_that.onlineStatus,_that.badgeRoles,_that.requireSigninToViewContents,_that.makeNotesFollowersOnlyBefore,_that.makeNotesHiddenBefore,_that.url,_that.uri,_that.movedTo,_that.alsoKnownAs,_that.createdAt,_that.updatedAt,_that.lastFetchedAt,_that.bannerUrl,_that.bannerBlurhash,_that.isLocked,_that.isSilenced,_that.isSuspended,_that.description,_that.location,_that.birthday,_that.lang,_that.fields,_that.verifiedLinks,_that.followersCount,_that.followingCount,_that.notesCount,_that.pinnedNoteIds,_that.pinnedNotes,_that.pinnedPageId,_that.pinnedPage,_that.publicReactions,_that.ffVisibility,_that.followersVisibility,_that.followingVisibility,_that.chatScope,_that.canChat,_that.twoFactorEnabled,_that.usePasswordLessLogin,_that.securityKeys,_that.roles,_that.memo,_that.moderationNote);case _:
  throw StateError('Unexpected subclass');
...
class _UserDetailedNotMe implements UserDetailedNotMe {
  const _UserDetailedNotMe({required this.id, this.name, required this.username, this.host, @UriConverter() required this.avatarUrl, this.avatarBlurhash, final  List<UserAvatarDecoration> avatarDecorations = const [], required this.isBot, required this.isCat, this.instance, @EmojisConverter() final  Map<String, String> emojis = const {}, @OnlineStatusJsonConverter() this.onlineStatus, final  List<UserBadgeRole> badgeRoles = const [], this.requireSigninToViewContents, @HideBeforeConverter() this.makeNotesFollowersOnlyBefore, @HideBeforeConverter() this.makeNotesHiddenBefore, @NullableUriConverter() this.url, @NullableUriConverter() this.uri, @NullableUriConverter() this.movedTo, final  List<String>? alsoKnownAs, @DateTimeConverter() required this.createdAt, @NullableDateTimeConverter() this.updatedAt, @NullableDateTimeConverter() this.lastFetchedAt, @NullableUriConverter() this.bannerUrl, this.bannerBlurhash, required this.isLocked, required this.isSilenced, required this.isSuspended, this.description, this.location, @NullableDateTimeConverter() this.birthday, this.lang, final  List<UserField>? fields, final  List<String> verifiedLinks = const [], required this.followersCount, required this.followingCount, required this.notesCount, final  List<String>? pinnedNoteIds, final  List<Note>? pinnedNotes, this.pinnedPageId, final  Map<String, dynamic>? pinnedPage, required this.publicReactions, @Deprecated("removed at 2023.12.0") this.ffVisibility, this.followersVisibility, this.followingVisibility, this.chatScope, this.canChat, this.twoFactorEnabled, this.usePasswordLessLogin, this.securityKeys, final  List<UserRole>? roles, this.memo, this.moderationNote}): _avatarDecorations = avatarDecorations,_emojis = emojis,_badgeRoles = badgeRoles,_alsoKnownAs = alsoKnownAs,_fields = fields,_verifiedLinks = verifiedLinks,_pinnedNoteIds = pinnedNoteIds,_pinnedNotes = pinnedNotes,_pinnedPage = pinnedPage,_roles = roles;
...
@override@Deprecated("removed at 2023.12.0") final  FFVisibility? ffVisibility;
...
mixin _$UserDetailedNotMeWithRelations {
 ...
 String get id; String? get name; String get username; String? get host;@UriConverter() Uri get avatarUrl; String? get avatarBlurhash; List<UserAvatarDecoration> get avatarDecorations; bool get isBot; bool get isCat; UserInstanceInfo? get instance;@EmojisConverter() Map<String, String> get emojis;@OnlineStatusJsonConverter() OnlineStatus? get onlineStatus; List<UserBadgeRole> get badgeRoles; bool? get requireSigninToViewContents;@HideBeforeConverter() HideBefore? get makeNotesFollowersOnlyBefore;@HideBeforeConverter() HideBefore? get makeNotesHiddenBefore;@NullableUriConverter() Uri? get url;@NullableUriConverter() Uri? get uri;@NullableUriConverter() Uri? get movedTo; List<String>? get alsoKnownAs;@DateTimeConverter() DateTime get createdAt;@NullableDateTimeConverter() DateTime? get updatedAt;@NullableDateTimeConverter() DateTime? get lastFetchedAt;@NullableUriConverter() Uri? get bannerUrl; String? get bannerBlurhash; bool get isLocked; bool get isSilenced; bool get isSuspended; String? get description; String? get location;@NullableDateTimeConverter() DateTime? get birthday; String? get lang; List<UserField>? get fields; List<String> get verifiedLinks; int get followersCount; int get followingCount; int get notesCount; List<String>? get pinnedNoteIds; List<Note>? get pinnedNotes; String? get pinnedPageId; Map<String, dynamic>? get pinnedPage; bool get publicReactions;@Deprecated("removed at 2023.12.0") FFVisibility? get ffVisibility; FFVisibility? get followersVisibility; FFVisibility? get followingVisibility; ChatScope? get chatScope; bool? get canChat; bool? get twoFactorEnabled; bool? get usePasswordLessLogin; bool? get securityKeys; List<UserRole>? get roles; String? get memo; String? get moderationNote; bool get isFollowing; bool get isFollowed; bool get hasPendingFollowRequestFromYou; bool get hasPendingFollowRequestToYou; bool get isBlocking; bool get isBlocked; bool get isMuted; bool get isRenoteMuted; Notify? get notify; bool? get withReplies; String? get followedMessage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,username,host,avatarUrl,avatarBlurhash,const DeepCollectionEquality().hash(avatarDecorations),isBot,isCat,instance,const DeepCollectionEquality().hash(emojis),onlineStatus,const DeepCollectionEquality().hash(badgeRoles),requireSigninToViewContents,makeNotesFollowersOnlyBefore,makeNotesHiddenBefore,url,uri,movedTo,const DeepCollectionEquality().hash(alsoKnownAs),createdAt,updatedAt,lastFetchedAt,bannerUrl,bannerBlurhash,isLocked,isSilenced,isSuspended,description,location,birthday,lang,const DeepCollectionEquality().hash(fields),const DeepCollectionEquality().hash(verifiedLinks),followersCount,followingCount,notesCount,const DeepCollectionEquality().hash(pinnedNoteIds),const DeepCollectionEquality().hash(pinnedNotes),pinnedPageId,const DeepCollectionEquality().hash(pinnedPage),publicReactions,ffVisibility,followersVisibility,followingVisibility,chatScope,canChat,twoFactorEnabled,usePasswordLessLogin,securityKeys,const DeepCollectionEquality().hash(roles),memo,moderationNote,isFollowing,isFollowed,hasPendingFollowRequestFromYou,hasPendingFollowRequestToYou,isBlocking,isBlocked,isMuted,isRenoteMuted,notify,withReplies,followedMessage]);
...
@useResult
$Res call({
 String id, String? name, String username, String? host,@UriConverter() Uri avatarUrl, String? avatarBlurhash, List<UserAvatarDecoration> avatarDecorations, bool isBot, bool isCat, UserInstanceInfo? instance,@EmojisConverter() Map<String, String> emojis,@OnlineStatusJsonConverter() OnlineStatus? onlineStatus, List<UserBadgeRole> badgeRoles, bool? requireSigninToViewContents,@HideBeforeConverter() HideBefore? makeNotesFollowersOnlyBefore,@HideBeforeConverter() HideBefore? makeNotesHiddenBefore,@NullableUriConverter() Uri? url,@NullableUriConverter() Uri? uri,@NullableUriConverter() Uri? movedTo, List<String>? alsoKnownAs,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? updatedAt,@NullableDateTimeConverter() DateTime? lastFetchedAt,@NullableUriConverter() Uri? bannerUrl, String? bannerBlurhash, bool isLocked, bool isSilenced, bool isSuspended, String? description, String? location,@NullableDateTimeConverter() DateTime? birthday, String? lang, List<UserField>? fields, List<String> verifiedLinks, int followersCount, int followingCount, int notesCount, List<String>? pinnedNoteIds, List<Note>? pinnedNotes, String? pinnedPageId, Map<String, dynamic>? pinnedPage, bool publicReactions,@Deprecated("removed at 2023.12.0") FFVisibility? ffVisibility, FFVisibility? followersVisibility, FFVisibility? followingVisibility, ChatScope? chatScope, bool? canChat, bool? twoFactorEnabled, bool? usePasswordLessLogin, bool? securityKeys, List<UserRole>? roles, String? memo, String? moderationNote, bool isFollowing, bool isFollowed, bool hasPendingFollowRequestFromYou, bool hasPendingFollowRequestToYou, bool isBlocking, bool isBlocked, bool isMuted, bool isRenoteMuted, Notify? notify, bool? withReplies, String? followedMessage
});
...
class _UserDetailedNotMeWithRelations implements UserDetailedNotMeWithRelations {
  const _UserDetailedNotMeWithRelations({required this.id, this.name, required this.username, this.host, @UriConverter() required this.avatarUrl, this.avatarBlurhash, final  List<UserAvatarDecoration> avatarDecorations = const [], required this.isBot, required this.isCat, this.instance, @EmojisConverter() final  Map<String, String> emojis = const {}, @OnlineStatusJsonConverter() this.onlineStatus, final  List<UserBadgeRole> badgeRoles = const [], this.requireSigninToViewContents, @HideBeforeConverter() this.makeNotesFollowersOnlyBefore, @HideBeforeConverter() this.makeNotesHiddenBefore, @NullableUriConverter() this.url, @NullableUriConverter() this.uri, @NullableUriConverter() this.movedTo, final  List<String>? alsoKnownAs, @DateTimeConverter() required this.createdAt, @NullableDateTimeConverter() this.updatedAt, @NullableDateTimeConverter() this.lastFetchedAt, @NullableUriConverter() this.bannerUrl, this.bannerBlurhash, required this.isLocked, required this.isSilenced, required this.isSuspended, this.description, this.location, @NullableDateTimeConverter() this.birthday, this.lang, final  List<UserField>? fields, final  List<String> verifiedLinks = const [], required this.followersCount, required this.followingCount, required this.notesCount, final  List<String>? pinnedNoteIds, final  List<Note>? pinnedNotes, this.pinnedPageId, final  Map<String, dynamic>? pinnedPage, required this.publicReactions, @Deprecated("removed at 2023.12.0") this.ffVisibility, this.followersVisibility, this.followingVisibility, this.chatScope, this.canChat, this.twoFactorEnabled, this.usePasswordLessLogin, this.securityKeys, final  List<UserRole>? roles, this.memo, this.moderationNote, required this.isFollowing, required this.isFollowed, required this.hasPendingFollowRequestFromYou, required this.hasPendingFollowRequestToYou, required this.isBlocking, required this.isBlocked, required this.isMuted, required this.isRenoteMuted, this.notify, this.withReplies, this.followedMessage}): _avatarDecorations = avatarDecorations,_emojis = emojis,_badgeRoles = badgeRoles,_alsoKnownAs = alsoKnownAs,_fields = fields,_verifiedLinks = verifiedLinks,_pinnedNoteIds = pinnedNoteIds,_pinnedNotes = pinnedNotes,_pinnedPage = pinnedPage,_roles = roles;
...
mixin _$MeDetailed {
 ...
 String get id; String? get name; String get username; String? get host;@UriConverter() Uri get avatarUrl; String? get avatarBlurhash; List<UserAvatarDecoration> get avatarDecorations; bool get isBot; bool get isCat; UserInstanceInfo? get instance;@EmojisConverter() Map<String, String> get emojis;@OnlineStatusJsonConverter() OnlineStatus? get onlineStatus; List<UserBadgeRole> get badgeRoles; bool? get requireSigninToViewContents;@HideBeforeConverter() HideBefore? get makeNotesFollowersOnlyBefore;@HideBeforeConverter() HideBefore? get makeNotesHiddenBefore;@NullableUriConverter() Uri? get url;@NullableUriConverter() Uri? get uri;@NullableUriConverter() Uri? get movedTo; List<String>? get alsoKnownAs;@DateTimeConverter() DateTime get createdAt;@NullableDateTimeConverter() DateTime? get updatedAt;@NullableDateTimeConverter() DateTime? get lastFetchedAt;@NullableUriConverter() Uri? get bannerUrl; String? get bannerBlurhash; bool get isLocked; bool get isSilenced; bool get isSuspended; String? get description; String? get location;@NullableDateTimeConverter() DateTime? get birthday; String? get lang; List<UserField>? get fields; List<String> get verifiedLinks; int get followersCount; int get followingCount; int get notesCount; List<String>? get pinnedNoteIds; List<Note>? get pinnedNotes; String? get pinnedPageId; Map<String, dynamic>? get pinnedPage; bool get publicReactions;@Deprecated("removed at 2023.12.0") FFVisibility? get ffVisibility; FFVisibility? get followersVisibility; FFVisibility? get followingVisibility; ChatScope? get chatScope; bool? get canChat; bool get twoFactorEnabled; bool get usePasswordLessLogin; bool get securityKeys; List<UserRole>? get roles; String? get memo; String? get moderationNote; String? get avatarId; String? get bannerId; String? get followedMessage; bool get isModerator; bool get isAdmin; bool get injectFeaturedNote; bool get receiveAnnouncementEmail; bool get alwaysMarkNsfw; bool get autoSensitive; bool get carefulBot; bool get autoAcceptFollowed; bool? get preventAiLearning; bool get noCrawle; bool get isExplorable; bool get isDeleted; TwoFactorBackupCodesStock? get twoFactorBackupCodesStock; bool get hideOnlineStatus; bool get hasUnreadSpecifiedNotes; bool get hasUnreadMentions; bool get hasUnreadAnnouncement; bool get hasUnreadAntenna; bool get hasUnreadChannel; bool? get hasUnreadChatMessages; bool get hasUnreadNotification; bool get hasPendingReceivedFollowRequest; int? get unreadNotificationsCount; List<AnnouncementsResponse> get unreadAnnouncements;@MuteWordsConverter() List<MuteWord> get mutedWords;@MuteWordsConverter() List<MuteWord> get hardMutedWords; List<String> get mutedInstances;@Deprecated("Deprecated in Misskey 2023.9.2") List<String>? get mutingNotificationTypes; NotificationRecieveConfigs get notificationRecieveConfig; List<String> get emailNotificationTypes; List<UserAchievement> get achievements; int get loggedInDays; UserPolicies get policies;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,username,host,avatarUrl,avatarBlurhash,const DeepCollectionEquality().hash(avatarDecorations),isBot,isCat,instance,const DeepCollectionEquality().hash(emojis),onlineStatus,const DeepCollectionEquality().hash(badgeRoles),requireSigninToViewContents,makeNotesFollowersOnlyBefore,makeNotesHiddenBefore,url,uri,movedTo,const DeepCollectionEquality().hash(alsoKnownAs),createdAt,updatedAt,lastFetchedAt,bannerUrl,bannerBlurhash,isLocked,isSilenced,isSuspended,description,location,birthday,lang,const DeepCollectionEquality().hash(fields),const DeepCollectionEquality().hash(verifiedLinks),followersCount,followingCount,notesCount,const DeepCollectionEquality().hash(pinnedNoteIds),const DeepCollectionEquality().hash(pinnedNotes),pinnedPageId,const DeepCollectionEquality().hash(pinnedPage),publicReactions,ffVisibility,followersVisibility,followingVisibility,chatScope,canChat,twoFactorEnabled,usePasswordLessLogin,securityKeys,const DeepCollectionEquality().hash(roles),memo,moderationNote,avatarId,bannerId,followedMessage,isModerator,isAdmin,injectFeaturedNote,receiveAnnouncementEmail,alwaysMarkNsfw,autoSensitive,carefulBot,autoAcceptFollowed,preventAiLearning,noCrawle,isExplorable,isDeleted,twoFactorBackupCodesStock,hideOnlineStatus,hasUnreadSpecifiedNotes,hasUnreadMentions,hasUnreadAnnouncement,hasUnreadAntenna,hasUnreadChannel,hasUnreadChatMessages,hasUnreadNotification,hasPendingReceivedFollowRequest,unreadNotificationsCount,const DeepCollectionEquality().hash(unreadAnnouncements),const DeepCollectionEquality().hash(mutedWords),const DeepCollectionEquality().hash(hardMutedWords),const DeepCollectionEquality().hash(mutedInstances),const DeepCollectionEquality().hash(mutingNotificationTypes),notificationRecieveConfig,const DeepCollectionEquality().hash(emailNotificationTypes),const DeepCollectionEquality().hash(achievements),loggedInDays,policies]);
...
@useResult
$Res call({
 String id, String? name, String username, String? host,@UriConverter() Uri avatarUrl, String? avatarBlurhash, List<UserAvatarDecoration> avatarDecorations, bool isBot, bool isCat, UserInstanceInfo? instance,@EmojisConverter() Map<String, String> emojis,@OnlineStatusJsonConverter() OnlineStatus? onlineStatus, List<UserBadgeRole> badgeRoles, bool? requireSigninToViewContents,@HideBeforeConverter() HideBefore? makeNotesFollowersOnlyBefore,@HideBeforeConverter() HideBefore? makeNotesHiddenBefore,@NullableUriConverter() Uri? url,@NullableUriConverter() Uri? uri,@NullableUriConverter() Uri? movedTo, List<String>? alsoKnownAs,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? updatedAt,@NullableDateTimeConverter() DateTime? lastFetchedAt,@NullableUriConverter() Uri? bannerUrl, String? bannerBlurhash, bool isLocked, bool isSilenced, bool isSuspended, String? description, String? location,@NullableDateTimeConverter() DateTime? birthday, String? lang, List<UserField>? fields, List<String> verifiedLinks, int followersCount, int followingCount, int notesCount, List<String>? pinnedNoteIds, List<Note>? pinnedNotes, String? pinnedPageId, Map<String, dynamic>? pinnedPage, bool publicReactions,@Deprecated("removed at 2023.12.0") FFVisibility? ffVisibility, FFVisibility? followersVisibility, FFVisibility? followingVisibility, ChatScope? chatScope, bool? canChat, bool twoFactorEnabled, bool usePasswordLessLogin, bool securityKeys, List<UserRole>? roles, String? memo, String? moderationNote, String? avatarId, String? bannerId, String? followedMessage, bool isModerator, bool isAdmin, bool injectFeaturedNote, bool receiveAnnouncementEmail, bool alwaysMarkNsfw, bool autoSensitive, bool carefulBot, bool autoAcceptFollowed, bool? preventAiLearning, bool noCrawle, bool isExplorable, bool isDeleted, TwoFactorBackupCodesStock? twoFactorBackupCodesStock, bool hideOnlineStatus, bool hasUnreadSpecifiedNotes, bool hasUnreadMentions, bool hasUnreadAnnouncement, bool hasUnreadAntenna, bool hasUnreadChannel, bool? hasUnreadChatMessages, bool hasUnreadNotification, bool hasPendingReceivedFollowRequest, int? unreadNotificationsCount, List<AnnouncementsResponse> unreadAnnouncements,@MuteWordsConverter() List<MuteWord> mutedWords,@MuteWordsConverter() List<MuteWord> hardMutedWords, List<String> mutedInstances,@Deprecated("Deprecated in Misskey 2023.9.2") List<String>? mutingNotificationTypes, NotificationRecieveConfigs notificationRecieveConfig, List<String> emailNotificationTypes, List<UserAchievement> achievements, int loggedInDays, UserPolicies policies
});
...
/// Create a copy of MeDetailed
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? username = null,Object? host = freezed,Object? avatarUrl = null,Object? avatarBlurhash = freezed,Object? avatarDecorations = null,Object? isBot = null,Object? isCat = null,Object? instance = freezed,Object? emojis = null,Object? onlineStatus = freezed,Object? badgeRoles = null,Object? requireSigninToViewContents = freezed,Object? makeNotesFollowersOnlyBefore = freezed,Object? makeNotesHiddenBefore = freezed,Object? url = freezed,Object? uri = freezed,Object? movedTo = freezed,Object? alsoKnownAs = freezed,Object? createdAt = null,Object? updatedAt = freezed,Object? lastFetchedAt = freezed,Object? bannerUrl = freezed,Object? bannerBlurhash = freezed,Object? isLocked = null,Object? isSilenced = null,Object? isSuspended = null,Object? description = freezed,Object? location = freezed,Object? birthday = freezed,Object? lang = freezed,Object? fields = freezed,Object? verifiedLinks = null,Object? followersCount = null,Object? followingCount = null,Object? notesCount = null,Object? pinnedNoteIds = freezed,Object? pinnedNotes = freezed,Object? pinnedPageId = freezed,Object? pinnedPage = freezed,Object? publicReactions = null,Object? ffVisibility = freezed,Object? followersVisibility = freezed,Object? followingVisibility = freezed,Object? chatScope = freezed,Object? canChat = freezed,Object? twoFactorEnabled = null,Object? usePasswordLessLogin = null,Object? securityKeys = null,Object? roles = freezed,Object? memo = freezed,Object? moderationNote = freezed,Object? avatarId = freezed,Object? bannerId = freezed,Object? followedMessage = freezed,Object? isModerator = null,Object? isAdmin = null,Object? injectFeaturedNote = null,Object? receiveAnnouncementEmail = null,Object? alwaysMarkNsfw = null,Object? autoSensitive = null,Object? carefulBot = null,Object? autoAcceptFollowed = null,Object? preventAiLearning = freezed,Object? noCrawle = null,Object? isExplorable = null,Object? isDeleted = null,Object? twoFactorBackupCodesStock = freezed,Object? hideOnlineStatus = null,Object? hasUnreadSpecifiedNotes = null,Object? hasUnreadMentions = null,Object? hasUnreadAnnouncement = null,Object? hasUnreadAntenna = null,Object? hasUnreadChannel = null,Object? hasUnreadChatMessages = freezed,Object? hasUnreadNotification = null,Object? hasPendingReceivedFollowRequest = null,Object? unreadNotificationsCount = freezed,Object? unreadAnnouncements = null,Object? mutedWords = null,Object? hardMutedWords = null,Object? mutedInstances = null,Object? mutingNotificationTypes = freezed,Object? notificationRecieveConfig = null,Object? emailNotificationTypes = null,Object? achievements = null,Object? loggedInDays = null,Object? policies = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,username: null == username ? _self.username : username // ignore: cast_nullable_to_non_nullable
...
as bool,usePasswordLessLogin: null == usePasswordLessLogin ? _self.usePasswordLessLogin : usePasswordLessLogin // ignore: cast_nullable_to_non_nullable
as bool,securityKeys: null == securityKeys ? _self.securityKeys : securityKeys // ignore: cast_nullable_to_non_nullable
as bool,roles: freezed == roles ? _self.roles : roles // ignore: cast_nullable_to_non_nullable
as List<UserRole>?,memo: freezed == memo ? _self.memo : memo // ignore: cast_nullable_to_non_nullable
as String?,moderationNote: freezed == moderationNote ? _self.moderationNote : moderationNote // ignore: cast_nullable_to_non_nullable
...
as List<AnnouncementsResponse>,mutedWords: null == mutedWords ? _self.mutedWords : mutedWords // ignore: cast_nullable_to_non_nullable
...
as List<UserAchievement>,loggedInDays: null == loggedInDays ? _self.loggedInDays : loggedInDays // ignore: cast_nullable_to_non_nullable
as int,policies: null == policies ? _self.policies : policies // ignore: cast_nullable_to_non_nullable
as UserPolicies,
  ));
}
/// Create a copy of MeDetailed
...
class _MeDetailed implements MeDetailed {
  const _MeDetailed({required this.id, this.name, required this.username, this.host, @UriConverter() required this.avatarUrl, this.avatarBlurhash, final  List<UserAvatarDecoration> avatarDecorations = const [], required this.isBot, required this.isCat, this.instance, @EmojisConverter() final  Map<String, String> emojis = const {}, @OnlineStatusJsonConverter() this.onlineStatus, final  List<UserBadgeRole> badgeRoles = const [], this.requireSigninToViewContents, @HideBeforeConverter() this.makeNotesFollowersOnlyBefore, @HideBeforeConverter() this.makeNotesHiddenBefore, @NullableUriConverter() this.url, @NullableUriConverter() this.uri, @NullableUriConverter() this.movedTo, final  List<String>? alsoKnownAs, @DateTimeConverter() required this.createdAt, @NullableDateTimeConverter() this.updatedAt, @NullableDateTimeConverter() this.lastFetchedAt, @NullableUriConverter() this.bannerUrl, this.bannerBlurhash, required this.isLocked, required this.isSilenced, required this.isSuspended, this.description, this.location, @NullableDateTimeConverter() this.birthday, this.lang, final  List<UserField>? fields, final  List<String> verifiedLinks = const [], required this.followersCount, required this.followingCount, required this.notesCount, final  List<String>? pinnedNoteIds, final  List<Note>? pinnedNotes, this.pinnedPageId, final  Map<String, dynamic>? pinnedPage, required this.publicReactions, @Deprecated("removed at 2023.12.0") this.ffVisibility, this.followersVisibility, this.followingVisibility, this.chatScope, this.canChat, required this.twoFactorEnabled, required this.usePasswordLessLogin, required this.securityKeys, final  List<UserRole>? roles, this.memo, this.moderationNote, this.avatarId, this.bannerId, this.followedMessage, required this.isModerator, required this.isAdmin, required this.injectFeaturedNote, required this.receiveAnnouncementEmail, required this.alwaysMarkNsfw, required this.autoSensitive, required this.carefulBot, required this.autoAcceptFollowed, this.preventAiLearning, required this.noCrawle, required this.isExplorable, required this.isDeleted, this.twoFactorBackupCodesStock, required this.hideOnlineStatus, required this.hasUnreadSpecifiedNotes, required this.hasUnreadMentions, required this.hasUnreadAnnouncement, required this.hasUnreadAntenna, required this.hasUnreadChannel, this.hasUnreadChatMessages, required this.hasUnreadNotification, required this.hasPendingReceivedFollowRequest, this.unreadNotificationsCount, final  List<AnnouncementsResponse> unreadAnnouncements = const [], @MuteWordsConverter() required final  List<MuteWord> mutedWords, @MuteWordsConverter() final  List<MuteWord> hardMutedWords = const [], required final  List<String> mutedInstances, @Deprecated("Deprecated in Misskey 2023.9.2") final  List<String>? mutingNotificationTypes, this.notificationRecieveConfig = const NotificationRecieveConfigs(), required final  List<String> emailNotificationTypes, required final  List<UserAchievement> achievements, required this.loggedInDays, required this.policies}): _avatarDecorations = avatarDecorations,_emojis = emojis,_badgeRoles = badgeRoles,_alsoKnownAs = alsoKnownAs,_fields = fields,_verifiedLinks = verifiedLinks,_pinnedNoteIds = pinnedNoteIds,_pinnedNotes = pinnedNotes,_pinnedPage = pinnedPage,_roles = roles,_unreadAnnouncements = unreadAnnouncements,_mutedWords = mutedWords,_hardMutedWords = hardMutedWords,_mutedInstances = mutedInstances,_mutingNotificationTypes = mutingNotificationTypes,_emailNotificationTypes = emailNotificationTypes,_achievements = achievements;
...
@override final  TwoFactorBackupCodesStock? twoFactorBackupCodesStock;
@override final  bool hideOnlineStatus;
@override final  bool hasUnreadSpecifiedNotes;
@override final  bool hasUnreadMentions;
@override final  bool hasUnreadAnnouncement;
@override final  bool hasUnreadAntenna;
@override final  bool hasUnreadChannel;
@override final  bool? hasUnreadChatMessages;
@override final  bool hasUnreadNotification;
@override final  bool hasPendingReceivedFollowRequest;
...
@override@JsonKey()@MuteWordsConverter() List<MuteWord> get hardMutedWords {
...
@override@Deprecated("Deprecated in Misskey 2023.9.2") List<String>? get mutingNotificationTypes {
...
as List<AnnouncementsResponse>,mutedWords: null == mutedWords ? _self._mutedWords : mutedWords // ignore: cast_nullable_to_non_nullable
...
mixin _$UserAchievement {
 ...
 String get name;@EpocTimeDateTimeConverter.withMilliSeconds() DateTime get unlockedAt;
...
@useResult
$Res call({
 String name,@EpocTimeDateTimeConverter.withMilliSeconds() DateTime unlockedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name, @EpocTimeDateTimeConverter.withMilliSeconds()  DateTime unlockedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserAchievement() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name, @EpocTimeDateTimeConverter.withMilliSeconds()  DateTime unlockedAt)  $default,) {final _that = this;
switch (_that) {
case _UserAchievement():
return $default(_that.name,_that.unlockedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name, @EpocTimeDateTimeConverter.withMilliSeconds()  DateTime unlockedAt)?  $default,) {final _that = this;
switch (_that) {
case _UserAchievement() when $default != null:
return $default(_that.name,_that.unlockedAt);case _:
  return null;
...
class _UserAchievement implements UserAchievement {
  const _UserAchievement({required this.name, @EpocTimeDateTimeConverter.withMilliSeconds() required this.unlockedAt});
  factory _UserAchievement.fromJson(Map<String, dynamic> json) => _$UserAchievementFromJson(json);

@override final  String name;
@override@EpocTimeDateTimeConverter.withMilliSeconds() final  DateTime unlockedAt;
...
mixin _$UserPolicies {
 ...
 bool get gtlAvailable; bool get ltlAvailable; bool get canPublicNote; int? get mentionLimit; bool get canEditNote; bool get canInvite; double? get inviteLimit; double? get inviteLimitCycle; int? get inviteExpirationTime; bool get canManageCustomEmojis; bool? get canManageAvatarDecorations; bool get canSearchNotes; bool get canUseTranslator; bool get canHideAds; double get driveCapacityMb; int? get maxFileSizeMb; List<String>? get uploadableFileTypes; bool? get alwaysMarkNsfw; bool? get canUpdateBioMedia; double get pinLimit; double get antennaLimit; double get wordMuteLimit; double get webhookLimit; double get clipLimit; double get noteEachClipsLimit; double get userListLimit; double get userEachUserListsLimit; double get rateLimitFactor; double get avatarDecorationLimit; bool? get canImportAntennas; bool? get canImportBlocking; bool? get canImportFollowing; bool? get canImportMuting; bool? get canImportUserLists; ChatAvailability? get chatAvailability; int? get noteDraftLimit; int? get scheduledNoteLimit; bool? get watermarkAvailable;
...
@useResult
$Res call({
 bool gtlAvailable, bool ltlAvailable, bool canPublicNote, int? mentionLimit, bool canEditNote, bool canInvite, double? inviteLimit, double? inviteLimitCycle, int? inviteExpirationTime, bool canManageCustomEmojis, bool? canManageAvatarDecorations, bool canSearchNotes, bool canUseTranslator, bool canHideAds, double driveCapacityMb, int? maxFileSizeMb, List<String>? uploadableFileTypes, bool? alwaysMarkNsfw, bool? canUpdateBioMedia, double pinLimit, double antennaLimit, double wordMuteLimit, double webhookLimit, double clipLimit, double noteEachClipsLimit, double userListLimit, double userEachUserListsLimit, double rateLimitFactor, double avatarDecorationLimit, bool? canImportAntennas, bool? canImportBlocking, bool? canImportFollowing, bool? canImportMuting, bool? canImportUserLists, ChatAvailability? chatAvailability, int? noteDraftLimit, int? scheduledNoteLimit, bool? watermarkAvailable
});
...
/// Create a copy of UserPolicies
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? gtlAvailable = null,Object? ltlAvailable = null,Object? canPublicNote = null,Object? mentionLimit = freezed,Object? canEditNote = null,Object? canInvite = null,Object? inviteLimit = freezed,Object? inviteLimitCycle = freezed,Object? inviteExpirationTime = freezed,Object? canManageCustomEmojis = null,Object? canManageAvatarDecorations = freezed,Object? canSearchNotes = null,Object? canUseTranslator = null,Object? canHideAds = null,Object? driveCapacityMb = null,Object? maxFileSizeMb = freezed,Object? uploadableFileTypes = freezed,Object? alwaysMarkNsfw = freezed,Object? canUpdateBioMedia = freezed,Object? pinLimit = null,Object? antennaLimit = null,Object? wordMuteLimit = null,Object? webhookLimit = null,Object? clipLimit = null,Object? noteEachClipsLimit = null,Object? userListLimit = null,Object? userEachUserListsLimit = null,Object? rateLimitFactor = null,Object? avatarDecorationLimit = null,Object? canImportAntennas = freezed,Object? canImportBlocking = freezed,Object? canImportFollowing = freezed,Object? canImportMuting = freezed,Object? canImportUserLists = freezed,Object? chatAvailability = freezed,Object? noteDraftLimit = freezed,Object? scheduledNoteLimit = freezed,Object? watermarkAvailable = freezed,}) {
  return _then(_self.copyWith(
gtlAvailable: null == gtlAvailable ? _self.gtlAvailable : gtlAvailable // ignore: cast_nullable_to_non_nullable
as bool,ltlAvailable: null == ltlAvailable ? _self.ltlAvailable : ltlAvailable // ignore: cast_nullable_to_non_nullable
as bool,canPublicNote: null == canPublicNote ? _self.canPublicNote : canPublicNote // ignore: cast_nullable_to_non_nullable
as bool,mentionLimit: freezed == mentionLimit ? _self.mentionLimit : mentionLimit // ignore: cast_nullable_to_non_nullable
as int?,canEditNote: null == canEditNote ? _self.canEditNote : canEditNote // ignore: cast_nullable_to_non_nullable
as bool,canInvite: null == canInvite ? _self.canInvite : canInvite // ignore: cast_nullable_to_non_nullable
as bool,inviteLimit: freezed == inviteLimit ? _self.inviteLimit : inviteLimit // ignore: cast_nullable_to_non_nullable
as double?,inviteLimitCycle: freezed == inviteLimitCycle ? _self.inviteLimitCycle : inviteLimitCycle // ignore: cast_nullable_to_non_nullable
as double?,inviteExpirationTime: freezed == inviteExpirationTime ? _self.inviteExpirationTime : inviteExpirationTime // ignore: cast_nullable_to_non_nullable
as int?,canManageCustomEmojis: null == canManageCustomEmojis ? _self.canManageCustomEmojis : canManageCustomEmojis // ignore: cast_nullable_to_non_nullable
...
as bool?,canSearchNotes: null == canSearchNotes ? _self.canSearchNotes : canSearchNotes // ignore: cast_nullable_to_non_nullable
as bool,canUseTranslator: null == canUseTranslator ? _self.canUseTranslator : canUseTranslator // ignore: cast_nullable_to_non_nullable
as bool,canHideAds: null == canHideAds ? _self.canHideAds : canHideAds // ignore: cast_nullable_to_non_nullable
as bool,driveCapacityMb: null == driveCapacityMb ? _self.driveCapacityMb : driveCapacityMb // ignore: cast_nullable_to_non_nullable
as double,maxFileSizeMb: freezed == maxFileSizeMb ? _self.maxFileSizeMb : maxFileSizeMb // ignore: cast_nullable_to_non_nullable
as int?,uploadableFileTypes: freezed == uploadableFileTypes ? _self.uploadableFileTypes : uploadableFileTypes // ignore: cast_nullable_to_non_nullable
as List<String>?,alwaysMarkNsfw: freezed == alwaysMarkNsfw ? _self.alwaysMarkNsfw : alwaysMarkNsfw // ignore: cast_nullable_to_non_nullable
...
as bool?,pinLimit: null == pinLimit ? _self.pinLimit : pinLimit // ignore: cast_nullable_to_non_nullable
as double,antennaLimit: null == antennaLimit ? _self.antennaLimit : antennaLimit // ignore: cast_nullable_to_non_nullable
as double,wordMuteLimit: null == wordMuteLimit ? _self.wordMuteLimit : wordMuteLimit // ignore: cast_nullable_to_non_nullable
as double,webhookLimit: null == webhookLimit ? _self.webhookLimit : webhookLimit // ignore: cast_nullable_to_non_nullable
as double,clipLimit: null == clipLimit ? _self.clipLimit : clipLimit // ignore: cast_nullable_to_non_nullable
as double,noteEachClipsLimit: null == noteEachClipsLimit ? _self.noteEachClipsLimit : noteEachClipsLimit // ignore: cast_nullable_to_non_nullable
as double,userListLimit: null == userListLimit ? _self.userListLimit : userListLimit // ignore: cast_nullable_to_non_nullable
as double,userEachUserListsLimit: null == userEachUserListsLimit ? _self.userEachUserListsLimit : userEachUserListsLimit // ignore: cast_nullable_to_non_nullable
as double,rateLimitFactor: null == rateLimitFactor ? _self.rateLimitFactor : rateLimitFactor // ignore: cast_nullable_to_non_nullable
as double,avatarDecorationLimit: null == avatarDecorationLimit ? _self.avatarDecorationLimit : avatarDecorationLimit // ignore: cast_nullable_to_non_nullable
as double,canImportAntennas: freezed == canImportAntennas ? _self.canImportAntennas : canImportAntennas // ignore: cast_nullable_to_non_nullable
...
as ChatAvailability?,noteDraftLimit: freezed == noteDraftLimit ? _self.noteDraftLimit : noteDraftLimit // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool gtlAvailable,  bool ltlAvailable,  bool canPublicNote,  int? mentionLimit,  bool canEditNote,  bool canInvite,  double? inviteLimit,  double? inviteLimitCycle,  int? inviteExpirationTime,  bool canManageCustomEmojis,  bool? canManageAvatarDecorations,  bool canSearchNotes,  bool canUseTranslator,  bool canHideAds,  double driveCapacityMb,  int? maxFileSizeMb,  List<String>? uploadableFileTypes,  bool? alwaysMarkNsfw,  bool? canUpdateBioMedia,  double pinLimit,  double antennaLimit,  double wordMuteLimit,  double webhookLimit,  double clipLimit,  double noteEachClipsLimit,  double userListLimit,  double userEachUserListsLimit,  double rateLimitFactor,  double avatarDecorationLimit,  bool? canImportAntennas,  bool? canImportBlocking,  bool? canImportFollowing,  bool? canImportMuting,  bool? canImportUserLists,  ChatAvailability? chatAvailability,  int? noteDraftLimit,  int? scheduledNoteLimit,  bool? watermarkAvailable)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserPolicies() when $default != null:
return $default(_that.gtlAvailable,_that.ltlAvailable,_that.canPublicNote,_that.mentionLimit,_that.canEditNote,_that.canInvite,_that.inviteLimit,_that.inviteLimitCycle,_that.inviteExpirationTime,_that.canManageCustomEmojis,_that.canManageAvatarDecorations,_that.canSearchNotes,_that.canUseTranslator,_that.canHideAds,_that.driveCapacityMb,_that.maxFileSizeMb,_that.uploadableFileTypes,_that.alwaysMarkNsfw,_that.canUpdateBioMedia,_that.pinLimit,_that.antennaLimit,_that.wordMuteLimit,_that.webhookLimit,_that.clipLimit,_that.noteEachClipsLimit,_that.userListLimit,_that.userEachUserListsLimit,_that.rateLimitFactor,_that.avatarDecorationLimit,_that.canImportAntennas,_that.canImportBlocking,_that.canImportFollowing,_that.canImportMuting,_that.canImportUserLists,_that.chatAvailability,_that.noteDraftLimit,_that.scheduledNoteLimit,_that.watermarkAvailable);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool gtlAvailable,  bool ltlAvailable,  bool canPublicNote,  int? mentionLimit,  bool canEditNote,  bool canInvite,  double? inviteLimit,  double? inviteLimitCycle,  int? inviteExpirationTime,  bool canManageCustomEmojis,  bool? canManageAvatarDecorations,  bool canSearchNotes,  bool canUseTranslator,  bool canHideAds,  double driveCapacityMb,  int? maxFileSizeMb,  List<String>? uploadableFileTypes,  bool? alwaysMarkNsfw,  bool? canUpdateBioMedia,  double pinLimit,  double antennaLimit,  double wordMuteLimit,  double webhookLimit,  double clipLimit,  double noteEachClipsLimit,  double userListLimit,  double userEachUserListsLimit,  double rateLimitFactor,  double avatarDecorationLimit,  bool? canImportAntennas,  bool? canImportBlocking,  bool? canImportFollowing,  bool? canImportMuting,  bool? canImportUserLists,  ChatAvailability? chatAvailability,  int? noteDraftLimit,  int? scheduledNoteLimit,  bool? watermarkAvailable)  $default,) {final _that = this;
switch (_that) {
case _UserPolicies():
return $default(_that.gtlAvailable,_that.ltlAvailable,_that.canPublicNote,_that.mentionLimit,_that.canEditNote,_that.canInvite,_that.inviteLimit,_that.inviteLimitCycle,_that.inviteExpirationTime,_that.canManageCustomEmojis,_that.canManageAvatarDecorations,_that.canSearchNotes,_that.canUseTranslator,_that.canHideAds,_that.driveCapacityMb,_that.maxFileSizeMb,_that.uploadableFileTypes,_that.alwaysMarkNsfw,_that.canUpdateBioMedia,_that.pinLimit,_that.antennaLimit,_that.wordMuteLimit,_that.webhookLimit,_that.clipLimit,_that.noteEachClipsLimit,_that.userListLimit,_that.userEachUserListsLimit,_that.rateLimitFactor,_that.avatarDecorationLimit,_that.canImportAntennas,_that.canImportBlocking,_that.canImportFollowing,_that.canImportMuting,_that.canImportUserLists,_that.chatAvailability,_that.noteDraftLimit,_that.scheduledNoteLimit,_that.watermarkAvailable);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool gtlAvailable,  bool ltlAvailable,  bool canPublicNote,  int? mentionLimit,  bool canEditNote,  bool canInvite,  double? inviteLimit,  double? inviteLimitCycle,  int? inviteExpirationTime,  bool canManageCustomEmojis,  bool? canManageAvatarDecorations,  bool canSearchNotes,  bool canUseTranslator,  bool canHideAds,  double driveCapacityMb,  int? maxFileSizeMb,  List<String>? uploadableFileTypes,  bool? alwaysMarkNsfw,  bool? canUpdateBioMedia,  double pinLimit,  double antennaLimit,  double wordMuteLimit,  double webhookLimit,  double clipLimit,  double noteEachClipsLimit,  double userListLimit,  double userEachUserListsLimit,  double rateLimitFactor,  double avatarDecorationLimit,  bool? canImportAntennas,  bool? canImportBlocking,  bool? canImportFollowing,  bool? canImportMuting,  bool? canImportUserLists,  ChatAvailability? chatAvailability,  int? noteDraftLimit,  int? scheduledNoteLimit,  bool? watermarkAvailable)?  $default,) {final _that = this;
switch (_that) {
case _UserPolicies() when $default != null:
return $default(_that.gtlAvailable,_that.ltlAvailable,_that.canPublicNote,_that.mentionLimit,_that.canEditNote,_that.canInvite,_that.inviteLimit,_that.inviteLimitCycle,_that.inviteExpirationTime,_that.canManageCustomEmojis,_that.canManageAvatarDecorations,_that.canSearchNotes,_that.canUseTranslator,_that.canHideAds,_that.driveCapacityMb,_that.maxFileSizeMb,_that.uploadableFileTypes,_that.alwaysMarkNsfw,_that.canUpdateBioMedia,_that.pinLimit,_that.antennaLimit,_that.wordMuteLimit,_that.webhookLimit,_that.clipLimit,_that.noteEachClipsLimit,_that.userListLimit,_that.userEachUserListsLimit,_that.rateLimitFactor,_that.avatarDecorationLimit,_that.canImportAntennas,_that.canImportBlocking,_that.canImportFollowing,_that.canImportMuting,_that.canImportUserLists,_that.chatAvailability,_that.noteDraftLimit,_that.scheduledNoteLimit,_that.watermarkAvailable);case _:
  return null;
...
class _UserPolicies implements UserPolicies {
  const _UserPolicies({required this.gtlAvailable, required this.ltlAvailable, required this.canPublicNote, this.mentionLimit, this.canEditNote = false, required this.canInvite, this.inviteLimit, this.inviteLimitCycle, this.inviteExpirationTime, required this.canManageCustomEmojis, this.canManageAvatarDecorations, this.canSearchNotes = false, this.canUseTranslator = false, required this.canHideAds, required this.driveCapacityMb, this.maxFileSizeMb, final  List<String>? uploadableFileTypes, this.alwaysMarkNsfw, this.canUpdateBioMedia, required this.pinLimit, required this.antennaLimit, required this.wordMuteLimit, required this.webhookLimit, required this.clipLimit, required this.noteEachClipsLimit, required this.userListLimit, required this.userEachUserListsLimit, required this.rateLimitFactor, this.avatarDecorationLimit = 1.0, this.canImportAntennas, this.canImportBlocking, this.canImportFollowing, this.canImportMuting, this.canImportUserLists, this.chatAvailability, this.noteDraftLimit, this.scheduledNoteLimit, this.watermarkAvailable}): _uploadableFileTypes = uploadableFileTypes;
...
@override@JsonKey() final  bool canEditNote;
@override final  bool canInvite;
@override final  double? inviteLimit;
@override final  double? inviteLimitCycle;
@override final  int? inviteExpirationTime;
@override final  bool canManageCustomEmojis;
@override final  bool? canManageAvatarDecorations;
@override@JsonKey() final  bool canSearchNotes;
@override@JsonKey() final  bool canUseTranslator;
@override final  bool canHideAds;
@override final  double driveCapacityMb;
@override final  int? maxFileSizeMb;
 final  List<String>? _uploadableFileTypes;
@override List<String>? get uploadableFileTypes {
  final value = _uploadableFileTypes;
  if (value == null) return null;
  if (_uploadableFileTypes is EqualUnmodifiableListView) return _uploadableFileTypes;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
@override final  double pinLimit;
@override final  double antennaLimit;
@override final  double wordMuteLimit;
@override final  double webhookLimit;
@override final  double clipLimit;
@override final  double noteEachClipsLimit;
@override final  double userListLimit;
@override final  double userEachUserListsLimit;
@override final  double rateLimitFactor;
@override@JsonKey() final  double avatarDecorationLimit;
...
@override final  ChatAvailability? chatAvailability;
@override final  int? noteDraftLimit;
@override final  int? scheduledNoteLimit;
@override final  bool? watermarkAvailable;
...
/// Create a copy of UserPolicies
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? gtlAvailable = null,Object? ltlAvailable = null,Object? canPublicNote = null,Object? mentionLimit = freezed,Object? canEditNote = null,Object? canInvite = null,Object? inviteLimit = freezed,Object? inviteLimitCycle = freezed,Object? inviteExpirationTime = freezed,Object? canManageCustomEmojis = null,Object? canManageAvatarDecorations = freezed,Object? canSearchNotes = null,Object? canUseTranslator = null,Object? canHideAds = null,Object? driveCapacityMb = null,Object? maxFileSizeMb = freezed,Object? uploadableFileTypes = freezed,Object? alwaysMarkNsfw = freezed,Object? canUpdateBioMedia = freezed,Object? pinLimit = null,Object? antennaLimit = null,Object? wordMuteLimit = null,Object? webhookLimit = null,Object? clipLimit = null,Object? noteEachClipsLimit = null,Object? userListLimit = null,Object? userEachUserListsLimit = null,Object? rateLimitFactor = null,Object? avatarDecorationLimit = null,Object? canImportAntennas = freezed,Object? canImportBlocking = freezed,Object? canImportFollowing = freezed,Object? canImportMuting = freezed,Object? canImportUserLists = freezed,Object? chatAvailability = freezed,Object? noteDraftLimit = freezed,Object? scheduledNoteLimit = freezed,Object? watermarkAvailable = freezed,}) {
...
as bool,driveCapacityMb: null == driveCapacityMb ? _self.driveCapacityMb : driveCapacityMb // ignore: cast_nullable_to_non_nullable
as double,maxFileSizeMb: freezed == maxFileSizeMb ? _self.maxFileSizeMb : maxFileSizeMb // ignore: cast_nullable_to_non_nullable
as int?,uploadableFileTypes: freezed == uploadableFileTypes ? _self._uploadableFileTypes : uploadableFileTypes // ignore: cast_nullable_to_non_nullable
as List<String>?,alwaysMarkNsfw: freezed == alwaysMarkNsfw ? _self.alwaysMarkNsfw : alwaysMarkNsfw // ignore: cast_nullable_to_non_nullable
as bool?,canUpdateBioMedia: freezed == canUpdateBioMedia ? _self.canUpdateBioMedia : canUpdateBioMedia // ignore: cast_nullable_to_non_nullable
as bool?,pinLimit: null == pinLimit ? _self.pinLimit : pinLimit // ignore: cast_nullable_to_non_nullable
as double,antennaLimit: null == antennaLimit ? _self.antennaLimit : antennaLimit // ignore: cast_nullable_to_non_nullable
...
mixin _$NotificationRecieveConfigs {
 ...
 NotificationRecieveConfig? get note; NotificationRecieveConfig? get follow; NotificationRecieveConfig? get mention; NotificationRecieveConfig? get reply; NotificationRecieveConfig? get renote; NotificationRecieveConfig? get quote; NotificationRecieveConfig? get reaction; NotificationRecieveConfig? get pollEnded; NotificationRecieveConfig? get scheduledNotePosted; NotificationRecieveConfig? get scheduledNotePostFailed; NotificationRecieveConfig? get receiveFollowRequest; NotificationRecieveConfig? get followRequestAccepted; NotificationRecieveConfig? get roleAssigned; NotificationRecieveConfig? get chatRoomInvitationReceived; NotificationRecieveConfig? get achievementEarned; NotificationRecieveConfig? get app; NotificationRecieveConfig? get test;
...
/// Create a copy of NotificationRecieveConfigs
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? note = freezed,Object? follow = freezed,Object? mention = freezed,Object? reply = freezed,Object? renote = freezed,Object? quote = freezed,Object? reaction = freezed,Object? pollEnded = freezed,Object? scheduledNotePosted = freezed,Object? scheduledNotePostFailed = freezed,Object? receiveFollowRequest = freezed,Object? followRequestAccepted = freezed,Object? roleAssigned = freezed,Object? chatRoomInvitationReceived = freezed,Object? achievementEarned = freezed,Object? app = freezed,Object? test = freezed,}) {
  return _then(_self.copyWith(
...
as NotificationRecieveConfig?,scheduledNotePosted: freezed == scheduledNotePosted ? _self.scheduledNotePosted : scheduledNotePosted // ignore: cast_nullable_to_non_nullable
as NotificationRecieveConfig?,scheduledNotePostFailed: freezed == scheduledNotePostFailed ? _self.scheduledNotePostFailed : scheduledNotePostFailed // ignore: cast_nullable_to_non_nullable
...
as NotificationRecieveConfig?,chatRoomInvitationReceived: freezed == chatRoomInvitationReceived ? _self.chatRoomInvitationReceived : chatRoomInvitationReceived // ignore: cast_nullable_to_non_nullable
...
$NotificationRecieveConfigCopyWith<$Res>? get scheduledNotePosted {
  ...
  return $NotificationRecieveConfigCopyWith<$Res>(_self.scheduledNotePosted!, (value) {
...
$NotificationRecieveConfigCopyWith<$Res>? get scheduledNotePostFailed {
  ...
  return $NotificationRecieveConfigCopyWith<$Res>(_self.scheduledNotePostFailed!, (value) {
...
$NotificationRecieveConfigCopyWith<$Res>? get chatRoomInvitationReceived {
  ...
  return $NotificationRecieveConfigCopyWith<$Res>(_self.chatRoomInvitationReceived!, (value) {
...
switch (_that) {
case _NotificationRecieveConfigs() when $default != null:
return $default(_that.note,_that.follow,_that.mention,_that.reply,_that.renote,_that.quote,_that.reaction,_that.pollEnded,_that.scheduledNotePosted,_that.scheduledNotePostFailed,_that.receiveFollowRequest,_that.followRequestAccepted,_that.roleAssigned,_that.chatRoomInvitationReceived,_that.achievementEarned,_that.app,_that.test);case _:
  return orElse();
...
class _NotificationRecieveConfigs implements NotificationRecieveConfigs {
  const _NotificationRecieveConfigs({this.note, this.follow, this.mention, this.reply, this.renote, this.quote, this.reaction, this.pollEnded, this.scheduledNotePosted, this.scheduledNotePostFailed, this.receiveFollowRequest, this.followRequestAccepted, this.roleAssigned, this.chatRoomInvitationReceived, this.achievementEarned, this.app, this.test});
...
@override final  NotificationRecieveConfig? scheduledNotePosted;
@override final  NotificationRecieveConfig? scheduledNotePostFailed;
...
@override final  NotificationRecieveConfig? chatRoomInvitationReceived;
...
/// Create a copy of NotificationRecieveConfigs
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? note = freezed,Object? follow = freezed,Object? mention = freezed,Object? reply = freezed,Object? renote = freezed,Object? quote = freezed,Object? reaction = freezed,Object? pollEnded = freezed,Object? scheduledNotePosted = freezed,Object? scheduledNotePostFailed = freezed,Object? receiveFollowRequest = freezed,Object? followRequestAccepted = freezed,Object? roleAssigned = freezed,Object? chatRoomInvitationReceived = freezed,Object? achievementEarned = freezed,Object? app = freezed,Object? test = freezed,}) {
