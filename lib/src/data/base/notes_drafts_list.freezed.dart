...
$NotesDraftsListCopyWith<NotesDraftsList> get copyWith => _$NotesDraftsListCopyWithImpl<NotesDraftsList>(this as NotesDraftsList, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotesDraftsList&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.scheduled, scheduled) || other.scheduled == scheduled));
}
...
abstract mixin class $NotesDraftsListCopyWith<$Res>  {
  factory $NotesDraftsListCopyWith(NotesDraftsList value, $Res Function(NotesDraftsList) _then) = _$NotesDraftsListCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [NotesDraftsList].
extension NotesDraftsListPatterns on NotesDraftsList {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NotesDraftsList value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _NotesDraftsList() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NotesDraftsList value)  $default,){
final _that = this;
switch (_that) {
case _NotesDraftsList():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NotesDraftsList value)?  $default,){
final _that = this;
switch (_that) {
case _NotesDraftsList() when $default != null:
return $default(_that);case _:
...
class _NotesDraftsList implements NotesDraftsList {
  const _NotesDraftsList({this.limit = 30, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.scheduled});
  factory _NotesDraftsList.fromJson(Map<String, dynamic> json) => _$NotesDraftsListFromJson(json);
...
@pragma('vm:prefer-inline')
_$NotesDraftsListCopyWith<_NotesDraftsList> get copyWith => __$NotesDraftsListCopyWithImpl<_NotesDraftsList>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$NotesDraftsListToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotesDraftsList&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.scheduled, scheduled) || other.scheduled == scheduled));
}
...
/// @nodoc
abstract mixin class _$NotesDraftsListCopyWith<$Res> implements $NotesDraftsListCopyWith<$Res> {
  factory _$NotesDraftsListCopyWith(_NotesDraftsList value, $Res Function(_NotesDraftsList) _then) = __$NotesDraftsListCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? scheduled
});
