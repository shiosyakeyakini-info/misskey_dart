...
$AdminAdListCopyWith<AdminAdList> get copyWith => _$AdminAdListCopyWithImpl<AdminAdList>(this as AdminAdList, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminAdList&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.publishing, publishing) || other.publishing == publishing));
}
...
abstract mixin class $AdminAdListCopyWith<$Res>  {
  factory $AdminAdListCopyWith(AdminAdList value, $Res Function(AdminAdList) _then) = _$AdminAdListCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AdminAdListCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [AdminAdList].
extension AdminAdListPatterns on AdminAdList {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminAdList value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminAdList() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminAdList value)  $default,){
final _that = this;
switch (_that) {
case _AdminAdList():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminAdList value)?  $default,){
final _that = this;
switch (_that) {
case _AdminAdList() when $default != null:
return $default(_that);case _:
...
class _AdminAdList implements AdminAdList {
  const _AdminAdList({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.publishing = null});
  factory _AdminAdList.fromJson(Map<String, dynamic> json) => _$AdminAdListFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminAdListCopyWith<_AdminAdList> get copyWith => __$AdminAdListCopyWithImpl<_AdminAdList>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminAdListToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminAdList&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.publishing, publishing) || other.publishing == publishing));
}
...
/// @nodoc
abstract mixin class _$AdminAdListCopyWith<$Res> implements $AdminAdListCopyWith<$Res> {
  factory _$AdminAdListCopyWith(_AdminAdList value, $Res Function(_AdminAdList) _then) = __$AdminAdListCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? publishing
});
...
/// @nodoc
class __$AdminAdListCopyWithImpl<$Res>
    implements _$AdminAdListCopyWith<$Res> {
