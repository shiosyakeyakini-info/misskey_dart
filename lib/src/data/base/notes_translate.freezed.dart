...
mixin _$NotesTranslate {
  ...
  $NotesTranslateCopyWith<NotesTranslate> get copyWith =>
      _$NotesTranslateCopyWithImpl<NotesTranslate>(
          this as NotesTranslate, _$identity);
...
abstract mixin class $NotesTranslateCopyWith<$Res> {
  factory $NotesTranslateCopyWith(
          NotesTranslate value, $Res Function(NotesTranslate) _then) =
      _$NotesTranslateCopyWithImpl;
  @useResult
...
class _NotesTranslate implements NotesTranslate {
  ...
  factory _NotesTranslate.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotesTranslateCopyWith<_NotesTranslate> get copyWith =>
      __$NotesTranslateCopyWithImpl<_NotesTranslate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotesTranslateToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$NotesTranslateCopyWith<$Res>
    implements $NotesTranslateCopyWith<$Res> {
  factory _$NotesTranslateCopyWith(
          _NotesTranslate value, $Res Function(_NotesTranslate) _then) =
      __$NotesTranslateCopyWithImpl;
  @override
  @useResult
  $Res call({String sourceLang, String text});
}
