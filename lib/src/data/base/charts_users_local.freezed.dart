...
$ChartsUsersLocalCopyWith<ChartsUsersLocal> get copyWith => _$ChartsUsersLocalCopyWithImpl<ChartsUsersLocal>(this as ChartsUsersLocal, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsUsersLocal&&const DeepCollectionEquality().equals(other.total, total)&&const DeepCollectionEquality().equals(other.inc, inc)&&const DeepCollectionEquality().equals(other.dec, dec));
}
...
abstract mixin class $ChartsUsersLocalCopyWith<$Res>  {
  factory $ChartsUsersLocalCopyWith(ChartsUsersLocal value, $Res Function(ChartsUsersLocal) _then) = _$ChartsUsersLocalCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsUsersLocal].
extension ChartsUsersLocalPatterns on ChartsUsersLocal {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsUsersLocal value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsUsersLocal() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsUsersLocal value)  $default,){
final _that = this;
switch (_that) {
case _ChartsUsersLocal():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsUsersLocal value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsUsersLocal() when $default != null:
return $default(_that);case _:
...
class _ChartsUsersLocal implements ChartsUsersLocal {
  const _ChartsUsersLocal({required final  List<double> total, required final  List<double> inc, required final  List<double> dec}): _total = total,_inc = inc,_dec = dec;
  factory _ChartsUsersLocal.fromJson(Map<String, dynamic> json) => _$ChartsUsersLocalFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsUsersLocalCopyWith<_ChartsUsersLocal> get copyWith => __$ChartsUsersLocalCopyWithImpl<_ChartsUsersLocal>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsUsersLocalToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsUsersLocal&&const DeepCollectionEquality().equals(other._total, _total)&&const DeepCollectionEquality().equals(other._inc, _inc)&&const DeepCollectionEquality().equals(other._dec, _dec));
}
...
/// @nodoc
abstract mixin class _$ChartsUsersLocalCopyWith<$Res> implements $ChartsUsersLocalCopyWith<$Res> {
  factory _$ChartsUsersLocalCopyWith(_ChartsUsersLocal value, $Res Function(_ChartsUsersLocal) _then) = __$ChartsUsersLocalCopyWithImpl;
@override @useResult
$Res call({
 List<double> total, List<double> inc, List<double> dec
});
