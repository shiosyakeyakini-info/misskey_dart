...
$ChartsDriveLocalCopyWith<ChartsDriveLocal> get copyWith => _$ChartsDriveLocalCopyWithImpl<ChartsDriveLocal>(this as ChartsDriveLocal, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsDriveLocal&&const DeepCollectionEquality().equals(other.incCount, incCount)&&const DeepCollectionEquality().equals(other.incSize, incSize)&&const DeepCollectionEquality().equals(other.decCount, decCount)&&const DeepCollectionEquality().equals(other.decSize, decSize));
}
...
abstract mixin class $ChartsDriveLocalCopyWith<$Res>  {
  factory $ChartsDriveLocalCopyWith(ChartsDriveLocal value, $Res Function(ChartsDriveLocal) _then) = _$ChartsDriveLocalCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsDriveLocal].
extension ChartsDriveLocalPatterns on ChartsDriveLocal {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsDriveLocal value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsDriveLocal() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsDriveLocal value)  $default,){
final _that = this;
switch (_that) {
case _ChartsDriveLocal():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsDriveLocal value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsDriveLocal() when $default != null:
return $default(_that);case _:
...
class _ChartsDriveLocal implements ChartsDriveLocal {
  const _ChartsDriveLocal({required final  List<double> incCount, required final  List<double> incSize, required final  List<double> decCount, required final  List<double> decSize}): _incCount = incCount,_incSize = incSize,_decCount = decCount,_decSize = decSize;
  factory _ChartsDriveLocal.fromJson(Map<String, dynamic> json) => _$ChartsDriveLocalFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsDriveLocalCopyWith<_ChartsDriveLocal> get copyWith => __$ChartsDriveLocalCopyWithImpl<_ChartsDriveLocal>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsDriveLocalToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsDriveLocal&&const DeepCollectionEquality().equals(other._incCount, _incCount)&&const DeepCollectionEquality().equals(other._incSize, _incSize)&&const DeepCollectionEquality().equals(other._decCount, _decCount)&&const DeepCollectionEquality().equals(other._decSize, _decSize));
}
...
/// @nodoc
abstract mixin class _$ChartsDriveLocalCopyWith<$Res> implements $ChartsDriveLocalCopyWith<$Res> {
  factory _$ChartsDriveLocalCopyWith(_ChartsDriveLocal value, $Res Function(_ChartsDriveLocal) _then) = __$ChartsDriveLocalCopyWithImpl;
@override @useResult
$Res call({
 List<double> incCount, List<double> incSize, List<double> decCount, List<double> decSize
});
