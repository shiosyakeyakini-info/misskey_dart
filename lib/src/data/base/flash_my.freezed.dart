...
$FlashMyCopyWith<FlashMy> get copyWith => _$FlashMyCopyWithImpl<FlashMy>(this as FlashMy, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FlashMy&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
abstract mixin class $FlashMyCopyWith<$Res>  {
  factory $FlashMyCopyWith(FlashMy value, $Res Function(FlashMy) _then) = _$FlashMyCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$FlashMyCopyWithImpl<$Res>
    implements $FlashMyCopyWith<$Res> {
...
/// Adds pattern-matching-related methods to [FlashMy].
extension FlashMyPatterns on FlashMy {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FlashMy value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FlashMy() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FlashMy value)  $default,){
final _that = this;
switch (_that) {
case _FlashMy():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FlashMy value)?  $default,){
final _that = this;
switch (_that) {
case _FlashMy() when $default != null:
return $default(_that);case _:
...
class _FlashMy implements FlashMy {
  const _FlashMy({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _FlashMy.fromJson(Map<String, dynamic> json) => _$FlashMyFromJson(json);
...
@pragma('vm:prefer-inline')
_$FlashMyCopyWith<_FlashMy> get copyWith => __$FlashMyCopyWithImpl<_FlashMy>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FlashMyToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FlashMy&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
abstract mixin class _$FlashMyCopyWith<$Res> implements $FlashMyCopyWith<$Res> {
  factory _$FlashMyCopyWith(_FlashMy value, $Res Function(_FlashMy) _then) = __$FlashMyCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
...
/// @nodoc
class __$FlashMyCopyWithImpl<$Res>
    implements _$FlashMyCopyWith<$Res> {
