...
mixin _$INotifications {
  ...
  $INotificationsCopyWith<INotifications> get copyWith =>
      _$INotificationsCopyWithImpl<INotifications>(
          this as INotifications, _$identity);
...
abstract mixin class $INotificationsCopyWith<$Res> {
  factory $INotificationsCopyWith(
          INotifications value, $Res Function(INotifications) _then) =
      _$INotificationsCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _INotifications implements INotifications {
  ...
  factory _INotifications.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$INotificationsCopyWith<_INotifications> get copyWith =>
      __$INotificationsCopyWithImpl<_INotifications>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$INotificationsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$INotificationsCopyWith<$Res>
    implements $INotificationsCopyWith<$Res> {
  factory _$INotificationsCopyWith(
          _INotifications value, $Res Function(_INotifications) _then) =
      __$INotificationsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
