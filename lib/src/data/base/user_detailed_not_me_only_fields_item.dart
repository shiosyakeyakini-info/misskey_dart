...
@freezed
abstract class UserDetailedNotMeOnlyFieldsItem
    with _$UserDetailedNotMeOnlyFieldsItem {
  const factory UserDetailedNotMeOnlyFieldsItem({
    required String name,
    required String value,
  }) = _UserDetailedNotMeOnlyFieldsItem;

  factory UserDetailedNotMeOnlyFieldsItem.fromJson(Map<String, Object?> json) =>
