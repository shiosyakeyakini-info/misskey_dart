...
mixin _$AdminUpdateAbuseUserReport {
  ...
  $AdminUpdateAbuseUserReportCopyWith<AdminUpdateAbuseUserReport>
      get copyWith =>
          _$AdminUpdateAbuseUserReportCopyWithImpl<AdminUpdateAbuseUserReport>(
              this as AdminUpdateAbuseUserReport, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminUpdateAbuseUserReport &&
...
abstract mixin class $AdminUpdateAbuseUserReportCopyWith<$Res> {
  factory $AdminUpdateAbuseUserReportCopyWith(AdminUpdateAbuseUserReport value,
          $Res Function(AdminUpdateAbuseUserReport) _then) =
      _$AdminUpdateAbuseUserReportCopyWithImpl;
  @useResult
...
class _AdminUpdateAbuseUserReport implements AdminUpdateAbuseUserReport {
  const _AdminUpdateAbuseUserReport(
      {required this.reportId, this.moderationNote});
  factory _AdminUpdateAbuseUserReport.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminUpdateAbuseUserReportCopyWith<_AdminUpdateAbuseUserReport>
      get copyWith => __$AdminUpdateAbuseUserReportCopyWithImpl<
          _AdminUpdateAbuseUserReport>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminUpdateAbuseUserReportToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminUpdateAbuseUserReport &&
            (identical(other.reportId, reportId) ||
                other.reportId == reportId) &&
            (identical(other.moderationNote, moderationNote) ||
                other.moderationNote == moderationNote));
...
/// @nodoc
abstract mixin class _$AdminUpdateAbuseUserReportCopyWith<$Res>
    implements $AdminUpdateAbuseUserReportCopyWith<$Res> {
  factory _$AdminUpdateAbuseUserReportCopyWith(
          _AdminUpdateAbuseUserReport value,
          $Res Function(_AdminUpdateAbuseUserReport) _then) =
      __$AdminUpdateAbuseUserReportCopyWithImpl;
  @override
  @useResult
  $Res call({String reportId, String? moderationNote});
}
