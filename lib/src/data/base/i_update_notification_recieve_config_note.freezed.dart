...
mixin _$IUpdateNotificationRecieveConfigNote {
  ...
  $IUpdateNotificationRecieveConfigNoteCopyWith<
          IUpdateNotificationRecieveConfigNote>
      get copyWith => _$IUpdateNotificationRecieveConfigNoteCopyWithImpl<
              IUpdateNotificationRecieveConfigNote>(
          this as IUpdateNotificationRecieveConfigNote, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IUpdateNotificationRecieveConfigNote &&
...
abstract mixin class $IUpdateNotificationRecieveConfigNoteCopyWith<$Res> {
  factory $IUpdateNotificationRecieveConfigNoteCopyWith(
          IUpdateNotificationRecieveConfigNote value,
    ...
    return _then(_self.copyWith(
      type: null == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as IUpdateNotificationRecieveConfigNoteType,
...
class _IUpdateNotificationRecieveConfigNote
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IUpdateNotificationRecieveConfigNoteCopyWith<
          _IUpdateNotificationRecieveConfigNote>
      get copyWith => __$IUpdateNotificationRecieveConfigNoteCopyWithImpl<
          _IUpdateNotificationRecieveConfigNote>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IUpdateNotificationRecieveConfigNoteToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IUpdateNotificationRecieveConfigNote &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.userListId, userListId) ||
                other.userListId == userListId));
  }
...
/// @nodoc
abstract mixin class _$IUpdateNotificationRecieveConfigNoteCopyWith<$Res>
    implements $IUpdateNotificationRecieveConfigNoteCopyWith<$Res> {
  factory _$IUpdateNotificationRecieveConfigNoteCopyWith(
          _IUpdateNotificationRecieveConfigNote value,
          $Res Function(_IUpdateNotificationRecieveConfigNote) _then) =
