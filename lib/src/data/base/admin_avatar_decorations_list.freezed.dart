...
$AdminAvatarDecorationsListCopyWith<AdminAvatarDecorationsList> get copyWith => _$AdminAvatarDecorationsListCopyWithImpl<AdminAvatarDecorationsList>(this as AdminAvatarDecorationsList, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminAvatarDecorationsList&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.userId, userId) || other.userId == userId));
}
...
abstract mixin class $AdminAvatarDecorationsListCopyWith<$Res>  {
  factory $AdminAvatarDecorationsListCopyWith(AdminAvatarDecorationsList value, $Res Function(AdminAvatarDecorationsList) _then) = _$AdminAvatarDecorationsListCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminAvatarDecorationsList].
extension AdminAvatarDecorationsListPatterns on AdminAvatarDecorationsList {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminAvatarDecorationsList value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminAvatarDecorationsList() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminAvatarDecorationsList value)  $default,){
final _that = this;
switch (_that) {
case _AdminAvatarDecorationsList():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminAvatarDecorationsList value)?  $default,){
final _that = this;
switch (_that) {
case _AdminAvatarDecorationsList() when $default != null:
return $default(_that);case _:
...
class _AdminAvatarDecorationsList implements AdminAvatarDecorationsList {
  const _AdminAvatarDecorationsList({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.userId});
  factory _AdminAvatarDecorationsList.fromJson(Map<String, dynamic> json) => _$AdminAvatarDecorationsListFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminAvatarDecorationsListCopyWith<_AdminAvatarDecorationsList> get copyWith => __$AdminAvatarDecorationsListCopyWithImpl<_AdminAvatarDecorationsList>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminAvatarDecorationsListToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminAvatarDecorationsList&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.userId, userId) || other.userId == userId));
}
...
/// @nodoc
abstract mixin class _$AdminAvatarDecorationsListCopyWith<$Res> implements $AdminAvatarDecorationsListCopyWith<$Res> {
  factory _$AdminAvatarDecorationsListCopyWith(_AdminAvatarDecorationsList value, $Res Function(_AdminAvatarDecorationsList) _then) = __$AdminAvatarDecorationsListCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, String? userId
});
