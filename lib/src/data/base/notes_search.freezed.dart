...
mixin _$NotesSearch {
  ...
  $NotesSearchCopyWith<NotesSearch> get copyWith =>
      _$NotesSearchCopyWithImpl<NotesSearch>(this as NotesSearch, _$identity);
...
abstract mixin class $NotesSearchCopyWith<$Res> {
  factory $NotesSearchCopyWith(
          NotesSearch value, $Res Function(NotesSearch) _then) =
      _$NotesSearchCopyWithImpl;
  @useResult
  $Res call(
      {String query,
      String? sinceId,
...
/// @nodoc
class _$NotesSearchCopyWithImpl<$Res> implements $NotesSearchCopyWith<$Res> {
...
class _NotesSearch implements NotesSearch {
  const _NotesSearch(
      ...
      this.userId = null,
      this.channelId = null});
  factory _NotesSearch.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotesSearchCopyWith<_NotesSearch> get copyWith =>
      __$NotesSearchCopyWithImpl<_NotesSearch>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotesSearchToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$NotesSearchCopyWith<$Res>
    implements $NotesSearchCopyWith<$Res> {
  factory _$NotesSearchCopyWith(
          _NotesSearch value, $Res Function(_NotesSearch) _then) =
      __$NotesSearchCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String query,
...
/// @nodoc
class __$NotesSearchCopyWithImpl<$Res> implements _$NotesSearchCopyWith<$Res> {
