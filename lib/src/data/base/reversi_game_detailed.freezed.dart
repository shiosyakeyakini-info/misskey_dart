...
mixin _$ReversiGameDetailed {
 ...
 String get id;@DateTimeConverter() DateTime get createdAt;@NullableDateTimeConverter() DateTime? get startedAt;@NullableDateTimeConverter() DateTime? get endedAt; bool get isStarted; bool get isEnded; Map<String, dynamic>? get form1; Map<String, dynamic>? get form2; bool get user1Ready; bool get user2Ready; String get user1Id; String get user2Id; UserLite get user1; UserLite get user2; String? get winnerId; Map<String, dynamic>? get winner; String? get surrenderedUserId; String? get timeoutUserId; double? get black; String get bw; bool get noIrregularRules; bool get isLlotheo; bool get canPutEverywhere; bool get loopedBoard; double get timeLimitForEachTurn; List<dynamic> get logs; List<String> get map;
/// Create a copy of ReversiGameDetailed
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ReversiGameDetailedCopyWith<ReversiGameDetailed> get copyWith => _$ReversiGameDetailedCopyWithImpl<ReversiGameDetailed>(this as ReversiGameDetailed, _$identity);
...
abstract mixin class $ReversiGameDetailedCopyWith<$Res>  {
  factory $ReversiGameDetailedCopyWith(ReversiGameDetailed value, $Res Function(ReversiGameDetailed) _then) = _$ReversiGameDetailedCopyWithImpl;
@useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? startedAt,@NullableDateTimeConverter() DateTime? endedAt, bool isStarted, bool isEnded, Map<String, dynamic>? form1, Map<String, dynamic>? form2, bool user1Ready, bool user2Ready, String user1Id, String user2Id, UserLite user1, UserLite user2, String? winnerId, Map<String, dynamic>? winner, String? surrenderedUserId, String? timeoutUserId, double? black, String bw, bool noIrregularRules, bool isLlotheo, bool canPutEverywhere, bool loopedBoard, double timeLimitForEachTurn, List<dynamic> logs, List<String> map
});
...
as bool,form1: freezed == form1 ? _self.form1 : form1 // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,form2: freezed == form2 ? _self.form2 : form2 // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,user1Ready: null == user1Ready ? _self.user1Ready : user1Ready // ignore: cast_nullable_to_non_nullable
...
as double,logs: null == logs ? _self.logs : logs // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [ReversiGameDetailed].
extension ReversiGameDetailedPatterns on ReversiGameDetailed {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ReversiGameDetailed value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ReversiGameDetailed() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ReversiGameDetailed value)  $default,){
final _that = this;
switch (_that) {
case _ReversiGameDetailed():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ReversiGameDetailed value)?  $default,){
final _that = this;
switch (_that) {
case _ReversiGameDetailed() when $default != null:
return $default(_that);case _:
...
class _ReversiGameDetailed implements ReversiGameDetailed {
  const _ReversiGameDetailed({required this.id, @DateTimeConverter() required this.createdAt, @NullableDateTimeConverter() this.startedAt, @NullableDateTimeConverter() this.endedAt, required this.isStarted, required this.isEnded, final  Map<String, dynamic>? form1, final  Map<String, dynamic>? form2, required this.user1Ready, required this.user2Ready, required this.user1Id, required this.user2Id, required this.user1, required this.user2, this.winnerId, final  Map<String, dynamic>? winner, this.surrenderedUserId, this.timeoutUserId, this.black, required this.bw, required this.noIrregularRules, required this.isLlotheo, required this.canPutEverywhere, required this.loopedBoard, required this.timeLimitForEachTurn, required final  List<dynamic> logs, required final  List<String> map}): _form1 = form1,_form2 = form2,_winner = winner,_logs = logs,_map = map;
  factory _ReversiGameDetailed.fromJson(Map<String, dynamic> json) => _$ReversiGameDetailedFromJson(json);
...
@override Map<String, dynamic>? get form1 {
  final value = _form1;
...
@override Map<String, dynamic>? get form2 {
  final value = _form2;
  if (value == null) return null;
...
@pragma('vm:prefer-inline')
_$ReversiGameDetailedCopyWith<_ReversiGameDetailed> get copyWith => __$ReversiGameDetailedCopyWithImpl<_ReversiGameDetailed>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ReversiGameDetailedToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReversiGameDetailed&&(identical(other.id, id) || other.id == id)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.startedAt, startedAt) || other.startedAt == startedAt)&&(identical(other.endedAt, endedAt) || other.endedAt == endedAt)&&(identical(other.isStarted, isStarted) || other.isStarted == isStarted)&&(identical(other.isEnded, isEnded) || other.isEnded == isEnded)&&const DeepCollectionEquality().equals(other._form1, _form1)&&const DeepCollectionEquality().equals(other._form2, _form2)&&(identical(other.user1Ready, user1Ready) || other.user1Ready == user1Ready)&&(identical(other.user2Ready, user2Ready) || other.user2Ready == user2Ready)&&(identical(other.user1Id, user1Id) || other.user1Id == user1Id)&&(identical(other.user2Id, user2Id) || other.user2Id == user2Id)&&(identical(other.user1, user1) || other.user1 == user1)&&(identical(other.user2, user2) || other.user2 == user2)&&(identical(other.winnerId, winnerId) || other.winnerId == winnerId)&&const DeepCollectionEquality().equals(other._winner, _winner)&&(identical(other.surrenderedUserId, surrenderedUserId) || other.surrenderedUserId == surrenderedUserId)&&(identical(other.timeoutUserId, timeoutUserId) || other.timeoutUserId == timeoutUserId)&&(identical(other.black, black) || other.black == black)&&(identical(other.bw, bw) || other.bw == bw)&&(identical(other.noIrregularRules, noIrregularRules) || other.noIrregularRules == noIrregularRules)&&(identical(other.isLlotheo, isLlotheo) || other.isLlotheo == isLlotheo)&&(identical(other.canPutEverywhere, canPutEverywhere) || other.canPutEverywhere == canPutEverywhere)&&(identical(other.loopedBoard, loopedBoard) || other.loopedBoard == loopedBoard)&&(identical(other.timeLimitForEachTurn, timeLimitForEachTurn) || other.timeLimitForEachTurn == timeLimitForEachTurn)&&const DeepCollectionEquality().equals(other._logs, _logs)&&const DeepCollectionEquality().equals(other._map, _map));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,startedAt,endedAt,isStarted,isEnded,const DeepCollectionEquality().hash(_form1),const DeepCollectionEquality().hash(_form2),user1Ready,user2Ready,user1Id,user2Id,user1,user2,winnerId,const DeepCollectionEquality().hash(_winner),surrenderedUserId,timeoutUserId,black,bw,noIrregularRules,isLlotheo,canPutEverywhere,loopedBoard,timeLimitForEachTurn,const DeepCollectionEquality().hash(_logs),const DeepCollectionEquality().hash(_map)]);
...
/// @nodoc
abstract mixin class _$ReversiGameDetailedCopyWith<$Res> implements $ReversiGameDetailedCopyWith<$Res> {
  factory _$ReversiGameDetailedCopyWith(_ReversiGameDetailed value, $Res Function(_ReversiGameDetailed) _then) = __$ReversiGameDetailedCopyWithImpl;
@override @useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? startedAt,@NullableDateTimeConverter() DateTime? endedAt, bool isStarted, bool isEnded, Map<String, dynamic>? form1, Map<String, dynamic>? form2, bool user1Ready, bool user2Ready, String user1Id, String user2Id, UserLite user1, UserLite user2, String? winnerId, Map<String, dynamic>? winner, String? surrenderedUserId, String? timeoutUserId, double? black, String bw, bool noIrregularRules, bool isLlotheo, bool canPutEverywhere, bool loopedBoard, double timeLimitForEachTurn, List<dynamic> logs, List<String> map
});
...
as DateTime?,isStarted: null == isStarted ? _self.isStarted : isStarted // ignore: cast_nullable_to_non_nullable
as bool,isEnded: null == isEnded ? _self.isEnded : isEnded // ignore: cast_nullable_to_non_nullable
as bool,form1: freezed == form1 ? _self._form1 : form1 // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,form2: freezed == form2 ? _self._form2 : form2 // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,user1Ready: null == user1Ready ? _self.user1Ready : user1Ready // ignore: cast_nullable_to_non_nullable
as bool,user2Ready: null == user2Ready ? _self.user2Ready : user2Ready // ignore: cast_nullable_to_non_nullable
as bool,user1Id: null == user1Id ? _self.user1Id : user1Id // ignore: cast_nullable_to_non_nullable
as String,user2Id: null == user2Id ? _self.user2Id : user2Id // ignore: cast_nullable_to_non_nullable
...
as bool,loopedBoard: null == loopedBoard ? _self.loopedBoard : loopedBoard // ignore: cast_nullable_to_non_nullable
as bool,timeLimitForEachTurn: null == timeLimitForEachTurn ? _self.timeLimitForEachTurn : timeLimitForEachTurn // ignore: cast_nullable_to_non_nullable
as double,logs: null == logs ? _self._logs : logs // ignore: cast_nullable_to_non_nullable
