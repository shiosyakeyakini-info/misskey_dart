...
$AdminDriveShowFilePropertiesCopyWith<AdminDriveShowFileProperties> get copyWith => _$AdminDriveShowFilePropertiesCopyWithImpl<AdminDriveShowFileProperties>(this as AdminDriveShowFileProperties, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminDriveShowFileProperties&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.orientation, orientation) || other.orientation == orientation)&&(identical(other.avgColor, avgColor) || other.avgColor == avgColor));
}
...
abstract mixin class $AdminDriveShowFilePropertiesCopyWith<$Res>  {
  factory $AdminDriveShowFilePropertiesCopyWith(AdminDriveShowFileProperties value, $Res Function(AdminDriveShowFileProperties) _then) = _$AdminDriveShowFilePropertiesCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminDriveShowFileProperties].
extension AdminDriveShowFilePropertiesPatterns on AdminDriveShowFileProperties {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminDriveShowFileProperties value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminDriveShowFileProperties() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminDriveShowFileProperties value)  $default,){
final _that = this;
switch (_that) {
case _AdminDriveShowFileProperties():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminDriveShowFileProperties value)?  $default,){
final _that = this;
switch (_that) {
case _AdminDriveShowFileProperties() when $default != null:
return $default(_that);case _:
...
class _AdminDriveShowFileProperties implements AdminDriveShowFileProperties {
  const _AdminDriveShowFileProperties({this.width, this.height, this.orientation, this.avgColor});
  factory _AdminDriveShowFileProperties.fromJson(Map<String, dynamic> json) => _$AdminDriveShowFilePropertiesFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminDriveShowFilePropertiesCopyWith<_AdminDriveShowFileProperties> get copyWith => __$AdminDriveShowFilePropertiesCopyWithImpl<_AdminDriveShowFileProperties>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminDriveShowFilePropertiesToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminDriveShowFileProperties&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.orientation, orientation) || other.orientation == orientation)&&(identical(other.avgColor, avgColor) || other.avgColor == avgColor));
}
...
/// @nodoc
abstract mixin class _$AdminDriveShowFilePropertiesCopyWith<$Res> implements $AdminDriveShowFilePropertiesCopyWith<$Res> {
  factory _$AdminDriveShowFilePropertiesCopyWith(_AdminDriveShowFileProperties value, $Res Function(_AdminDriveShowFileProperties) _then) = __$AdminDriveShowFilePropertiesCopyWithImpl;
@override @useResult
$Res call({
 double? width, double? height, double? orientation, String? avgColor
});
