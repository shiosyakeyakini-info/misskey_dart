...
$IWebhooksTestCopyWith<IWebhooksTest> get copyWith => _$IWebhooksTestCopyWithImpl<IWebhooksTest>(this as IWebhooksTest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IWebhooksTest&&(identical(other.webhookId, webhookId) || other.webhookId == webhookId)&&(identical(other.type, type) || other.type == type)&&(identical(other.override_, override_) || other.override_ == override_));
}
...
abstract mixin class $IWebhooksTestCopyWith<$Res>  {
  factory $IWebhooksTestCopyWith(IWebhooksTest value, $Res Function(IWebhooksTest) _then) = _$IWebhooksTestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [IWebhooksTest].
extension IWebhooksTestPatterns on IWebhooksTest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IWebhooksTest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IWebhooksTest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IWebhooksTest value)  $default,){
final _that = this;
switch (_that) {
case _IWebhooksTest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IWebhooksTest value)?  $default,){
final _that = this;
switch (_that) {
case _IWebhooksTest() when $default != null:
return $default(_that);case _:
...
class _IWebhooksTest implements IWebhooksTest {
  const _IWebhooksTest({required this.webhookId, @JsonKey(unknownEnumValue: IWebhooksTestType.unknown) required this.type, @JsonKey(name: 'override') this.override_});
  factory _IWebhooksTest.fromJson(Map<String, dynamic> json) => _$IWebhooksTestFromJson(json);
...
@pragma('vm:prefer-inline')
_$IWebhooksTestCopyWith<_IWebhooksTest> get copyWith => __$IWebhooksTestCopyWithImpl<_IWebhooksTest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$IWebhooksTestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IWebhooksTest&&(identical(other.webhookId, webhookId) || other.webhookId == webhookId)&&(identical(other.type, type) || other.type == type)&&(identical(other.override_, override_) || other.override_ == override_));
}
...
/// @nodoc
abstract mixin class _$IWebhooksTestCopyWith<$Res> implements $IWebhooksTestCopyWith<$Res> {
  factory _$IWebhooksTestCopyWith(_IWebhooksTest value, $Res Function(_IWebhooksTest) _then) = __$IWebhooksTestCopyWithImpl;
@override @useResult
$Res call({
 String webhookId,@JsonKey(unknownEnumValue: IWebhooksTestType.unknown) IWebhooksTestType type,@JsonKey(name: 'override') IWebhooksTestOverride? override_
});
