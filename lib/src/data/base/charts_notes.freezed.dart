...
$ChartsNotesCopyWith<ChartsNotes> get copyWith => _$ChartsNotesCopyWithImpl<ChartsNotes>(this as ChartsNotes, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsNotes&&(identical(other.local, local) || other.local == local)&&(identical(other.remote, remote) || other.remote == remote));
}
...
abstract mixin class $ChartsNotesCopyWith<$Res>  {
  factory $ChartsNotesCopyWith(ChartsNotes value, $Res Function(ChartsNotes) _then) = _$ChartsNotesCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ChartsNotesCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [ChartsNotes].
extension ChartsNotesPatterns on ChartsNotes {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsNotes value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsNotes() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsNotes value)  $default,){
final _that = this;
switch (_that) {
case _ChartsNotes():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsNotes value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsNotes() when $default != null:
return $default(_that);case _:
...
class _ChartsNotes implements ChartsNotes {
  ...
  factory _ChartsNotes.fromJson(Map<String, dynamic> json) => _$ChartsNotesFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsNotesCopyWith<_ChartsNotes> get copyWith => __$ChartsNotesCopyWithImpl<_ChartsNotes>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsNotesToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsNotes&&(identical(other.local, local) || other.local == local)&&(identical(other.remote, remote) || other.remote == remote));
}
...
/// @nodoc
abstract mixin class _$ChartsNotesCopyWith<$Res> implements $ChartsNotesCopyWith<$Res> {
  factory _$ChartsNotesCopyWith(_ChartsNotes value, $Res Function(_ChartsNotes) _then) = __$ChartsNotesCopyWithImpl;
@override @useResult
$Res call({
 ChartsNotesLocal local, ChartsNotesRemote remote
});
...
/// @nodoc
class __$ChartsNotesCopyWithImpl<$Res>
    implements _$ChartsNotesCopyWith<$Res> {
