...
$ChannelsCreateCopyWith<ChannelsCreate> get copyWith => _$ChannelsCreateCopyWithImpl<ChannelsCreate>(this as ChannelsCreate, _$identity);
...
abstract mixin class $ChannelsCreateCopyWith<$Res>  {
  factory $ChannelsCreateCopyWith(ChannelsCreate value, $Res Function(ChannelsCreate) _then) = _$ChannelsCreateCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of ChannelsCreate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = freezed,Object? bannerId = freezed,Object? color = freezed,Object? isSensitive = freezed,Object? allowRenoteToExternal = freezed,}) {
...
/// Adds pattern-matching-related methods to [ChannelsCreate].
extension ChannelsCreatePatterns on ChannelsCreate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChannelsCreate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChannelsCreate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChannelsCreate value)  $default,){
final _that = this;
switch (_that) {
case _ChannelsCreate():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChannelsCreate value)?  $default,){
final _that = this;
switch (_that) {
case _ChannelsCreate() when $default != null:
return $default(_that);case _:
...
class _ChannelsCreate implements ChannelsCreate {
  const _ChannelsCreate({required this.name, this.description, this.bannerId, this.color, this.isSensitive, this.allowRenoteToExternal});
  factory _ChannelsCreate.fromJson(Map<String, dynamic> json) => _$ChannelsCreateFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChannelsCreateCopyWith<_ChannelsCreate> get copyWith => __$ChannelsCreateCopyWithImpl<_ChannelsCreate>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChannelsCreateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChannelsCreate&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.bannerId, bannerId) || other.bannerId == bannerId)&&(identical(other.color, color) || other.color == color)&&(identical(other.isSensitive, isSensitive) || other.isSensitive == isSensitive)&&(identical(other.allowRenoteToExternal, allowRenoteToExternal) || other.allowRenoteToExternal == allowRenoteToExternal));
}
...
/// @nodoc
abstract mixin class _$ChannelsCreateCopyWith<$Res> implements $ChannelsCreateCopyWith<$Res> {
  factory _$ChannelsCreateCopyWith(_ChannelsCreate value, $Res Function(_ChannelsCreate) _then) = __$ChannelsCreateCopyWithImpl;
@override @useResult
$Res call({
 String name, String? description, String? bannerId, String? color, bool? isSensitive, bool? allowRenoteToExternal
});
...
/// Create a copy of ChannelsCreate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = freezed,Object? bannerId = freezed,Object? color = freezed,Object? isSensitive = freezed,Object? allowRenoteToExternal = freezed,}) {
