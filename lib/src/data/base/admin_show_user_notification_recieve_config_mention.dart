...
@freezed
abstract class AdminShowUserNotificationRecieveConfigMention
    with _$AdminShowUserNotificationRecieveConfigMention {
  ...
  factory AdminShowUserNotificationRecieveConfigMention.fromJson(
