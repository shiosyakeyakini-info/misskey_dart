...
mixin _$NotesHybridTimeline {
  ...
  $NotesHybridTimelineCopyWith<NotesHybridTimeline> get copyWith =>
      _$NotesHybridTimelineCopyWithImpl<NotesHybridTimeline>(
          this as NotesHybridTimeline, _$identity);
...
abstract mixin class $NotesHybridTimelineCopyWith<$Res> {
  factory $NotesHybridTimelineCopyWith(
          NotesHybridTimeline value, $Res Function(NotesHybridTimeline) _then) =
      _$NotesHybridTimelineCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _NotesHybridTimeline implements NotesHybridTimeline {
  ...
  factory _NotesHybridTimeline.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotesHybridTimelineCopyWith<_NotesHybridTimeline> get copyWith =>
      __$NotesHybridTimelineCopyWithImpl<_NotesHybridTimeline>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotesHybridTimelineToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$NotesHybridTimelineCopyWith<$Res>
    implements $NotesHybridTimelineCopyWith<$Res> {
  factory _$NotesHybridTimelineCopyWith(_NotesHybridTimeline value,
          $Res Function(_NotesHybridTimeline) _then) =
      __$NotesHybridTimelineCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
