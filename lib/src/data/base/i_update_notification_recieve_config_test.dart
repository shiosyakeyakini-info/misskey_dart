...
@freezed
abstract class IUpdateNotificationRecieveConfigTest
    with _$IUpdateNotificationRecieveConfigTest {
  const factory IUpdateNotificationRecieveConfigTest({
    @JsonKey(unknownEnumValue: IUpdateNotificationRecieveConfigTestType.unknown)
    required IUpdateNotificationRecieveConfigTestType type,
    required String userListId,
  }) = _IUpdateNotificationRecieveConfigTest;

  factory IUpdateNotificationRecieveConfigTest.fromJson(
