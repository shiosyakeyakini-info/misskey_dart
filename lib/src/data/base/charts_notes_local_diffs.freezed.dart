...
$ChartsNotesLocalDiffsCopyWith<ChartsNotesLocalDiffs> get copyWith => _$ChartsNotesLocalDiffsCopyWithImpl<ChartsNotesLocalDiffs>(this as ChartsNotesLocalDiffs, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsNotesLocalDiffs&&const DeepCollectionEquality().equals(other.normal, normal)&&const DeepCollectionEquality().equals(other.reply, reply)&&const DeepCollectionEquality().equals(other.renote, renote)&&const DeepCollectionEquality().equals(other.withFile, withFile));
}
...
abstract mixin class $ChartsNotesLocalDiffsCopyWith<$Res>  {
  factory $ChartsNotesLocalDiffsCopyWith(ChartsNotesLocalDiffs value, $Res Function(ChartsNotesLocalDiffs) _then) = _$ChartsNotesLocalDiffsCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsNotesLocalDiffs].
extension ChartsNotesLocalDiffsPatterns on ChartsNotesLocalDiffs {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsNotesLocalDiffs value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsNotesLocalDiffs() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsNotesLocalDiffs value)  $default,){
final _that = this;
switch (_that) {
case _ChartsNotesLocalDiffs():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsNotesLocalDiffs value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsNotesLocalDiffs() when $default != null:
return $default(_that);case _:
...
class _ChartsNotesLocalDiffs implements ChartsNotesLocalDiffs {
  const _ChartsNotesLocalDiffs({required final  List<double> normal, required final  List<double> reply, required final  List<double> renote, required final  List<double> withFile}): _normal = normal,_reply = reply,_renote = renote,_withFile = withFile;
  factory _ChartsNotesLocalDiffs.fromJson(Map<String, dynamic> json) => _$ChartsNotesLocalDiffsFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsNotesLocalDiffsCopyWith<_ChartsNotesLocalDiffs> get copyWith => __$ChartsNotesLocalDiffsCopyWithImpl<_ChartsNotesLocalDiffs>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsNotesLocalDiffsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsNotesLocalDiffs&&const DeepCollectionEquality().equals(other._normal, _normal)&&const DeepCollectionEquality().equals(other._reply, _reply)&&const DeepCollectionEquality().equals(other._renote, _renote)&&const DeepCollectionEquality().equals(other._withFile, _withFile));
}
...
/// @nodoc
abstract mixin class _$ChartsNotesLocalDiffsCopyWith<$Res> implements $ChartsNotesLocalDiffsCopyWith<$Res> {
  factory _$ChartsNotesLocalDiffsCopyWith(_ChartsNotesLocalDiffs value, $Res Function(_ChartsNotesLocalDiffs) _then) = __$ChartsNotesLocalDiffsCopyWithImpl;
@override @useResult
$Res call({
 List<double> normal, List<double> reply, List<double> renote, List<double> withFile
});
