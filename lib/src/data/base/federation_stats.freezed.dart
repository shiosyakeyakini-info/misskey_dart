...
$FederationStatsCopyWith<FederationStats> get copyWith => _$FederationStatsCopyWithImpl<FederationStats>(this as FederationStats, _$identity);
...
abstract mixin class $FederationStatsCopyWith<$Res>  {
  factory $FederationStatsCopyWith(FederationStats value, $Res Function(FederationStats) _then) = _$FederationStatsCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [FederationStats].
extension FederationStatsPatterns on FederationStats {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FederationStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FederationStats() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FederationStats value)  $default,){
final _that = this;
switch (_that) {
case _FederationStats():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FederationStats value)?  $default,){
final _that = this;
switch (_that) {
case _FederationStats() when $default != null:
return $default(_that);case _:
...
class _FederationStats implements FederationStats {
  const _FederationStats({required final  List<FederationInstance> topSubInstances, required this.otherFollowersCount, required final  List<FederationInstance> topPubInstances, required this.otherFollowingCount}): _topSubInstances = topSubInstances,_topPubInstances = topPubInstances;
  factory _FederationStats.fromJson(Map<String, dynamic> json) => _$FederationStatsFromJson(json);
...
@pragma('vm:prefer-inline')
_$FederationStatsCopyWith<_FederationStats> get copyWith => __$FederationStatsCopyWithImpl<_FederationStats>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FederationStatsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FederationStats&&const DeepCollectionEquality().equals(other._topSubInstances, _topSubInstances)&&(identical(other.otherFollowersCount, otherFollowersCount) || other.otherFollowersCount == otherFollowersCount)&&const DeepCollectionEquality().equals(other._topPubInstances, _topPubInstances)&&(identical(other.otherFollowingCount, otherFollowingCount) || other.otherFollowingCount == otherFollowingCount));
}
...
/// @nodoc
abstract mixin class _$FederationStatsCopyWith<$Res> implements $FederationStatsCopyWith<$Res> {
  factory _$FederationStatsCopyWith(_FederationStats value, $Res Function(_FederationStats) _then) = __$FederationStatsCopyWithImpl;
@override @useResult
$Res call({
 List<FederationInstance> topSubInstances, double otherFollowersCount, List<FederationInstance> topPubInstances, double otherFollowingCount
});
