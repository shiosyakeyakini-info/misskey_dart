...
_$I2faRegisterKeyExcludeCredentialsItemFromJson(Map<String, dynamic> json) =>
    _I2faRegisterKeyExcludeCredentialsItem(
      ...
      transports: (json['transports'] as List<dynamic>)
          .map(
            (e) => $enumDecode(
              _$I2faRegisterKeyExcludeCredentialsTransportsItemEnumMap,
              e,
            ),
          )
          .toList(),
...
Map<String, dynamic> _$I2faRegisterKeyExcludeCredentialsItemToJson(
  ...
  'transports': instance.transports
      .map((e) => _$I2faRegisterKeyExcludeCredentialsTransportsItemEnumMap[e]!)
      .toList(),
};
