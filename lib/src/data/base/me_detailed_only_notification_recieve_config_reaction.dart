...
@freezed
abstract class MeDetailedOnlyNotificationRecieveConfigReaction
    with _$MeDetailedOnlyNotificationRecieveConfigReaction {
  ...
  factory MeDetailedOnlyNotificationRecieveConfigReaction.fromJson(
