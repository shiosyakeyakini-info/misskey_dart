...
@freezed
abstract class IUpdateNotificationRecieveConfigReceiveFollowRequest
    with _$IUpdateNotificationRecieveConfigReceiveFollowRequest {
  ...
  factory IUpdateNotificationRecieveConfigReceiveFollowRequest.fromJson(
