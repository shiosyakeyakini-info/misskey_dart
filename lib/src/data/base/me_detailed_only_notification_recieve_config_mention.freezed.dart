...
mixin _$MeDetailedOnlyNotificationRecieveConfigMention {
  ...
  $MeDetailedOnlyNotificationRecieveConfigMentionCopyWith<
          MeDetailedOnlyNotificationRecieveConfigMention>
      get copyWith =>
          _$MeDetailedOnlyNotificationRecieveConfigMentionCopyWithImpl<
                  MeDetailedOnlyNotificationRecieveConfigMention>(
              this as MeDetailedOnlyNotificationRecieveConfigMention,
              _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MeDetailedOnlyNotificationRecieveConfigMention &&
...
/// @nodoc
abstract mixin class $MeDetailedOnlyNotificationRecieveConfigMentionCopyWith<
    $Res> {
  factory $MeDetailedOnlyNotificationRecieveConfigMentionCopyWith(
          MeDetailedOnlyNotificationRecieveConfigMention value,
          $Res Function(MeDetailedOnlyNotificationRecieveConfigMention) _then) =
      _$MeDetailedOnlyNotificationRecieveConfigMentionCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(
    ...
    return _then(_self.copyWith(
      type: null == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as MeDetailedOnlyNotificationRecieveConfigMentionType,
...
class _MeDetailedOnlyNotificationRecieveConfigMention
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MeDetailedOnlyNotificationRecieveConfigMentionCopyWith<
          _MeDetailedOnlyNotificationRecieveConfigMention>
      get copyWith =>
          __$MeDetailedOnlyNotificationRecieveConfigMentionCopyWithImpl<
                  _MeDetailedOnlyNotificationRecieveConfigMention>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MeDetailedOnlyNotificationRecieveConfigMentionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MeDetailedOnlyNotificationRecieveConfigMention &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.userListId, userListId) ||
                other.userListId == userListId));
  }
...
/// @nodoc
abstract mixin class _$MeDetailedOnlyNotificationRecieveConfigMentionCopyWith<
        $Res>
    implements $MeDetailedOnlyNotificationRecieveConfigMentionCopyWith<$Res> {
  factory _$MeDetailedOnlyNotificationRecieveConfigMentionCopyWith(
          _MeDetailedOnlyNotificationRecieveConfigMention value,
          $Res Function(_MeDetailedOnlyNotificationRecieveConfigMention)
              _then) =
      __$MeDetailedOnlyNotificationRecieveConfigMentionCopyWithImpl;
  @override
  @useResult
