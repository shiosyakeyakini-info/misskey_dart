...
$AdminEmojiDeleteBulkCopyWith<AdminEmojiDeleteBulk> get copyWith => _$AdminEmojiDeleteBulkCopyWithImpl<AdminEmojiDeleteBulk>(this as AdminEmojiDeleteBulk, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminEmojiDeleteBulk&&const DeepCollectionEquality().equals(other.ids, ids));
}
...
abstract mixin class $AdminEmojiDeleteBulkCopyWith<$Res>  {
  factory $AdminEmojiDeleteBulkCopyWith(AdminEmojiDeleteBulk value, $Res Function(AdminEmojiDeleteBulk) _then) = _$AdminEmojiDeleteBulkCopyWithImpl;
@useResult
$Res call({
 List<String> ids
});
...
/// Adds pattern-matching-related methods to [AdminEmojiDeleteBulk].
extension AdminEmojiDeleteBulkPatterns on AdminEmojiDeleteBulk {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminEmojiDeleteBulk value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminEmojiDeleteBulk() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminEmojiDeleteBulk value)  $default,){
final _that = this;
switch (_that) {
case _AdminEmojiDeleteBulk():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminEmojiDeleteBulk value)?  $default,){
final _that = this;
switch (_that) {
case _AdminEmojiDeleteBulk() when $default != null:
return $default(_that);case _:
...
class _AdminEmojiDeleteBulk implements AdminEmojiDeleteBulk {
  ...
  factory _AdminEmojiDeleteBulk.fromJson(Map<String, dynamic> json) => _$AdminEmojiDeleteBulkFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminEmojiDeleteBulkCopyWith<_AdminEmojiDeleteBulk> get copyWith => __$AdminEmojiDeleteBulkCopyWithImpl<_AdminEmojiDeleteBulk>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminEmojiDeleteBulkToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminEmojiDeleteBulk&&const DeepCollectionEquality().equals(other._ids, _ids));
}
...
/// @nodoc
abstract mixin class _$AdminEmojiDeleteBulkCopyWith<$Res> implements $AdminEmojiDeleteBulkCopyWith<$Res> {
  factory _$AdminEmojiDeleteBulkCopyWith(_AdminEmojiDeleteBulk value, $Res Function(_AdminEmojiDeleteBulk) _then) = __$AdminEmojiDeleteBulkCopyWithImpl;
@override @useResult
$Res call({
 List<String> ids
});
