...
$GalleryPostsCopyWith<GalleryPosts> get copyWith => _$GalleryPostsCopyWithImpl<GalleryPosts>(this as GalleryPosts, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GalleryPosts&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
abstract mixin class $GalleryPostsCopyWith<$Res>  {
  factory $GalleryPostsCopyWith(GalleryPosts value, $Res Function(GalleryPosts) _then) = _$GalleryPostsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$GalleryPostsCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [GalleryPosts].
extension GalleryPostsPatterns on GalleryPosts {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GalleryPosts value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GalleryPosts() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GalleryPosts value)  $default,){
final _that = this;
switch (_that) {
case _GalleryPosts():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GalleryPosts value)?  $default,){
final _that = this;
switch (_that) {
case _GalleryPosts() when $default != null:
return $default(_that);case _:
...
class _GalleryPosts implements GalleryPosts {
  const _GalleryPosts({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _GalleryPosts.fromJson(Map<String, dynamic> json) => _$GalleryPostsFromJson(json);
...
@pragma('vm:prefer-inline')
_$GalleryPostsCopyWith<_GalleryPosts> get copyWith => __$GalleryPostsCopyWithImpl<_GalleryPosts>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GalleryPostsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GalleryPosts&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
/// @nodoc
abstract mixin class _$GalleryPostsCopyWith<$Res> implements $GalleryPostsCopyWith<$Res> {
  factory _$GalleryPostsCopyWith(_GalleryPosts value, $Res Function(_GalleryPosts) _then) = __$GalleryPostsCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
