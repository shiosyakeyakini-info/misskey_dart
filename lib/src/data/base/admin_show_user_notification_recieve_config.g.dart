...
_$AdminShowUserNotificationRecieveConfigFromJson(Map<String, dynamic> json) =>
    _AdminShowUserNotificationRecieveConfig(
      note: json['note'],
      follow: json['follow'],
...
Map<String, dynamic> _$AdminShowUserNotificationRecieveConfigToJson(
  _AdminShowUserNotificationRecieveConfig instance,
) => <String, dynamic>{
  'note': instance.note,
