...
mixin _$AdminPromoCreate {
  ...
  $AdminPromoCreateCopyWith<AdminPromoCreate> get copyWith =>
      _$AdminPromoCreateCopyWithImpl<AdminPromoCreate>(
          this as AdminPromoCreate, _$identity);
...
abstract mixin class $AdminPromoCreateCopyWith<$Res> {
  factory $AdminPromoCreateCopyWith(
          AdminPromoCreate value, $Res Function(AdminPromoCreate) _then) =
      _$AdminPromoCreateCopyWithImpl;
  @useResult
...
class _AdminPromoCreate implements AdminPromoCreate {
  ...
  factory _AdminPromoCreate.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminPromoCreateCopyWith<_AdminPromoCreate> get copyWith =>
      __$AdminPromoCreateCopyWithImpl<_AdminPromoCreate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminPromoCreateToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AdminPromoCreateCopyWith<$Res>
    implements $AdminPromoCreateCopyWith<$Res> {
  factory _$AdminPromoCreateCopyWith(
          _AdminPromoCreate value, $Res Function(_AdminPromoCreate) _then) =
      __$AdminPromoCreateCopyWithImpl;
  @override
  @useResult
  $Res call({String noteId, int expiresAt});
}
