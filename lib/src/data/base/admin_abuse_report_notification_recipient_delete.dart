...
@freezed
abstract class AdminAbuseReportNotificationRecipientDelete
    with _$AdminAbuseReportNotificationRecipientDelete {
  const factory AdminAbuseReportNotificationRecipientDelete({
    required String id,
  }) = _AdminAbuseReportNotificationRecipientDelete;

  factory AdminAbuseReportNotificationRecipientDelete.fromJson(
          Map<String, Object?> json) =>
      _$AdminAbuseReportNotificationRecipientDeleteFromJson(json);
}
