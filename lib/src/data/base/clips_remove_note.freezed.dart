...
$ClipsRemoveNoteCopyWith<ClipsRemoveNote> get copyWith => _$ClipsRemoveNoteCopyWithImpl<ClipsRemoveNote>(this as ClipsRemoveNote, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClipsRemoveNote&&(identical(other.clipId, clipId) || other.clipId == clipId)&&(identical(other.noteId, noteId) || other.noteId == noteId));
}
...
abstract mixin class $ClipsRemoveNoteCopyWith<$Res>  {
  factory $ClipsRemoveNoteCopyWith(ClipsRemoveNote value, $Res Function(ClipsRemoveNote) _then) = _$ClipsRemoveNoteCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ClipsRemoveNote].
extension ClipsRemoveNotePatterns on ClipsRemoveNote {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ClipsRemoveNote value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ClipsRemoveNote() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ClipsRemoveNote value)  $default,){
final _that = this;
switch (_that) {
case _ClipsRemoveNote():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ClipsRemoveNote value)?  $default,){
final _that = this;
switch (_that) {
case _ClipsRemoveNote() when $default != null:
return $default(_that);case _:
...
class _ClipsRemoveNote implements ClipsRemoveNote {
  ...
  factory _ClipsRemoveNote.fromJson(Map<String, dynamic> json) => _$ClipsRemoveNoteFromJson(json);
...
@pragma('vm:prefer-inline')
_$ClipsRemoveNoteCopyWith<_ClipsRemoveNote> get copyWith => __$ClipsRemoveNoteCopyWithImpl<_ClipsRemoveNote>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ClipsRemoveNoteToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ClipsRemoveNote&&(identical(other.clipId, clipId) || other.clipId == clipId)&&(identical(other.noteId, noteId) || other.noteId == noteId));
}
...
/// @nodoc
abstract mixin class _$ClipsRemoveNoteCopyWith<$Res> implements $ClipsRemoveNoteCopyWith<$Res> {
  factory _$ClipsRemoveNoteCopyWith(_ClipsRemoveNote value, $Res Function(_ClipsRemoveNote) _then) = __$ClipsRemoveNoteCopyWithImpl;
@override @useResult
$Res call({
 String clipId, String noteId
});
