...
_$AdminShowUserNotificationRecieveConfigScheduledNotePostFailedToJson(
  _AdminShowUserNotificationRecieveConfigScheduledNotePostFailed instance,
) => <String, dynamic>{
  'type':
      _$AdminShowUserNotificationRecieveConfigScheduledNotePostFailedTypeEnumMap[instance
          .type]!,
...
const _$AdminShowUserNotificationRecieveConfigScheduledNotePostFailedTypeEnumMap =
    {
      AdminShowUserNotificationRecieveConfigScheduledNotePostFailedType.all:
          'all',
      AdminShowUserNotificationRecieveConfigScheduledNotePostFailedType
              .following:
          'following',
