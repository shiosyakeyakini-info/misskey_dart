...
RoleCondFormulaValueNot _$RoleCondFormulaValueNotFromJson(
  ...
  id: json['id'] as String,
  value: RoleCondFormulaValue.fromJson(json['value'] as Map<String, dynamic>),
  $type: json['type'] as String?,
);
...
_$RoleCondFormulaValueNotesLessThanOrEqFromJson(Map<String, dynamic> json) =>
    RoleCondFormulaValueNotesLessThanOrEq(
      id: json['id'] as String,
      value: (json['value'] as num).toDouble(),
      $type: json['type'] as String?,
...
_$RoleCondFormulaValueNotesMoreThanOrEqFromJson(Map<String, dynamic> json) =>
    RoleCondFormulaValueNotesMoreThanOrEq(
      id: json['id'] as String,
      value: (json['value'] as num).toDouble(),
      $type: json['type'] as String?,
