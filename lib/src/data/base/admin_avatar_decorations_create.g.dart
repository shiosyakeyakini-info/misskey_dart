...
_AdminAvatarDecorationsCreate _$AdminAvatarDecorationsCreateFromJson(
...
Map<String, dynamic> _$AdminAvatarDecorationsCreateToJson(
        _AdminAvatarDecorationsCreate instance) =>
    <String, dynamic>{
      'id': instance.id,
