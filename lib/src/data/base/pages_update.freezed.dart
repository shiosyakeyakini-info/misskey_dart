...
$PagesUpdateCopyWith<PagesUpdate> get copyWith => _$PagesUpdateCopyWithImpl<PagesUpdate>(this as PagesUpdate, _$identity);
...
abstract mixin class $PagesUpdateCopyWith<$Res>  {
  factory $PagesUpdateCopyWith(PagesUpdate value, $Res Function(PagesUpdate) _then) = _$PagesUpdateCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PagesUpdateCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [PagesUpdate].
extension PagesUpdatePatterns on PagesUpdate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PagesUpdate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PagesUpdate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PagesUpdate value)  $default,){
final _that = this;
switch (_that) {
case _PagesUpdate():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PagesUpdate value)?  $default,){
final _that = this;
switch (_that) {
case _PagesUpdate() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$PagesUpdateCopyWith<_PagesUpdate> get copyWith => __$PagesUpdateCopyWithImpl<_PagesUpdate>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PagesUpdateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PagesUpdate&&(identical(other.pageId, pageId) || other.pageId == pageId)&&(identical(other.title, title) || other.title == title)&&(identical(other.name, name) || other.name == name)&&(identical(other.summary, summary) || other.summary == summary)&&const DeepCollectionEquality().equals(other._content, _content)&&const DeepCollectionEquality().equals(other._variables, _variables)&&(identical(other.script, script) || other.script == script)&&(identical(other.eyeCatchingImageId, eyeCatchingImageId) || other.eyeCatchingImageId == eyeCatchingImageId)&&(identical(other.font, font) || other.font == font)&&(identical(other.alignCenter, alignCenter) || other.alignCenter == alignCenter)&&(identical(other.hideTitleWhenPinned, hideTitleWhenPinned) || other.hideTitleWhenPinned == hideTitleWhenPinned));
}
...
/// @nodoc
abstract mixin class _$PagesUpdateCopyWith<$Res> implements $PagesUpdateCopyWith<$Res> {
  factory _$PagesUpdateCopyWith(_PagesUpdate value, $Res Function(_PagesUpdate) _then) = __$PagesUpdateCopyWithImpl;
@override @useResult
$Res call({
 String pageId, String? title, String? name, String? summary, List<dynamic>? content, List<dynamic>? variables, String? script, String? eyeCatchingImageId,@JsonKey(unknownEnumValue: PagesUpdateFont.unknown) PagesUpdateFont? font, bool? alignCenter, bool? hideTitleWhenPinned
});
...
/// @nodoc
class __$PagesUpdateCopyWithImpl<$Res>
    implements _$PagesUpdateCopyWith<$Res> {
