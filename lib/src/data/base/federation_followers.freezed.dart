...
$FederationFollowersCopyWith<FederationFollowers> get copyWith => _$FederationFollowersCopyWithImpl<FederationFollowers>(this as FederationFollowers, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FederationFollowers&&(identical(other.host, host) || other.host == host)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.limit, limit) || other.limit == limit));
}
...
abstract mixin class $FederationFollowersCopyWith<$Res>  {
  factory $FederationFollowersCopyWith(FederationFollowers value, $Res Function(FederationFollowers) _then) = _$FederationFollowersCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [FederationFollowers].
extension FederationFollowersPatterns on FederationFollowers {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FederationFollowers value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FederationFollowers() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FederationFollowers value)  $default,){
final _that = this;
switch (_that) {
case _FederationFollowers():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FederationFollowers value)?  $default,){
final _that = this;
switch (_that) {
case _FederationFollowers() when $default != null:
return $default(_that);case _:
...
class _FederationFollowers implements FederationFollowers {
  const _FederationFollowers({required this.host, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.limit = 10});
  factory _FederationFollowers.fromJson(Map<String, dynamic> json) => _$FederationFollowersFromJson(json);
...
@pragma('vm:prefer-inline')
_$FederationFollowersCopyWith<_FederationFollowers> get copyWith => __$FederationFollowersCopyWithImpl<_FederationFollowers>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FederationFollowersToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FederationFollowers&&(identical(other.host, host) || other.host == host)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.limit, limit) || other.limit == limit));
}
...
/// @nodoc
abstract mixin class _$FederationFollowersCopyWith<$Res> implements $FederationFollowersCopyWith<$Res> {
  factory _$FederationFollowersCopyWith(_FederationFollowers value, $Res Function(_FederationFollowers) _then) = __$FederationFollowersCopyWithImpl;
@override @useResult
$Res call({
 String host, String? sinceId, String? untilId, int? sinceDate, int? untilDate, int? limit
});
