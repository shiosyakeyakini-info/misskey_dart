...
mixin _$AdminAbuseReportNotificationRecipientUpdate {
  ...
  $AdminAbuseReportNotificationRecipientUpdateCopyWith<
          AdminAbuseReportNotificationRecipientUpdate>
      get copyWith => _$AdminAbuseReportNotificationRecipientUpdateCopyWithImpl<
              AdminAbuseReportNotificationRecipientUpdate>(
          this as AdminAbuseReportNotificationRecipientUpdate, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminAbuseReportNotificationRecipientUpdate &&
...
/// @nodoc
abstract mixin class $AdminAbuseReportNotificationRecipientUpdateCopyWith<
    $Res> {
  factory $AdminAbuseReportNotificationRecipientUpdateCopyWith(
          AdminAbuseReportNotificationRecipientUpdate value,
          $Res Function(AdminAbuseReportNotificationRecipientUpdate) _then) =
      _$AdminAbuseReportNotificationRecipientUpdateCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      bool isActive,
...
/// @nodoc
@JsonSerializable()
class _AdminAbuseReportNotificationRecipientUpdate
    implements AdminAbuseReportNotificationRecipientUpdate {
  const _AdminAbuseReportNotificationRecipientUpdate(
      {required this.id,
  ...
  factory _AdminAbuseReportNotificationRecipientUpdate.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminAbuseReportNotificationRecipientUpdateCopyWith<
          _AdminAbuseReportNotificationRecipientUpdate>
      get copyWith =>
          __$AdminAbuseReportNotificationRecipientUpdateCopyWithImpl<
              _AdminAbuseReportNotificationRecipientUpdate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminAbuseReportNotificationRecipientUpdateToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminAbuseReportNotificationRecipientUpdate &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.isActive, isActive) ||
                other.isActive == isActive) &&
            (identical(other.name, name) || other.name == name) &&
...
/// @nodoc
abstract mixin class _$AdminAbuseReportNotificationRecipientUpdateCopyWith<$Res>
    implements $AdminAbuseReportNotificationRecipientUpdateCopyWith<$Res> {
  factory _$AdminAbuseReportNotificationRecipientUpdateCopyWith(
          _AdminAbuseReportNotificationRecipientUpdate value,
          $Res Function(_AdminAbuseReportNotificationRecipientUpdate) _then) =
      __$AdminAbuseReportNotificationRecipientUpdateCopyWithImpl;
  @override
  @useResult
  $Res call(
