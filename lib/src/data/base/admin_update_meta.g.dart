...
_AdminUpdateMeta _$AdminUpdateMetaFromJson(Map<String, dynamic> json) =>
    _AdminUpdateMeta(
      ...
      perUserHomeTimelineCacheMax:
          (json['perUserHomeTimelineCacheMax'] as num?)?.toInt(),
      perUserListTimelineCacheMax:
          (json['perUserListTimelineCacheMax'] as num?)?.toInt(),
      ...
      deliverSuspendedSoftware:
          (json['deliverSuspendedSoftware'] as List<dynamic>?)
              ?.map((e) => AdminUpdateMetaDeliverSuspendedSoftwareItem.fromJson(
      ...
      remoteNotesCleaningExpiryDaysForEachNotes:
          (json['remoteNotesCleaningExpiryDaysForEachNotes'] as num?)
              ?.toDouble(),
...
Map<String, dynamic> _$AdminUpdateMetaToJson(_AdminUpdateMeta instance) =>
    <String, dynamic>{
