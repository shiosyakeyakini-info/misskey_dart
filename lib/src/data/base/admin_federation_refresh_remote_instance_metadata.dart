...
@freezed
abstract class AdminFederationRefreshRemoteInstanceMetadata
    with _$AdminFederationRefreshRemoteInstanceMetadata {
  const factory AdminFederationRefreshRemoteInstanceMetadata({
    required String host,
  }) = _AdminFederationRefreshRemoteInstanceMetadata;

  factory AdminFederationRefreshRemoteInstanceMetadata.fromJson(
