...
mixin _$ChannelsUpdate {
  ...
  $ChannelsUpdateCopyWith<ChannelsUpdate> get copyWith =>
      _$ChannelsUpdateCopyWithImpl<ChannelsUpdate>(
          this as ChannelsUpdate, _$identity);
...
abstract mixin class $ChannelsUpdateCopyWith<$Res> {
  factory $ChannelsUpdateCopyWith(
          ChannelsUpdate value, $Res Function(ChannelsUpdate) _then) =
      _$ChannelsUpdateCopyWithImpl;
  @useResult
  $Res call(
      {String channelId,
      String? name,
...
class _ChannelsUpdate implements ChannelsUpdate {
  ...
  factory _ChannelsUpdate.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChannelsUpdateCopyWith<_ChannelsUpdate> get copyWith =>
      __$ChannelsUpdateCopyWithImpl<_ChannelsUpdate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChannelsUpdateToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ChannelsUpdateCopyWith<$Res>
    implements $ChannelsUpdateCopyWith<$Res> {
  factory _$ChannelsUpdateCopyWith(
          _ChannelsUpdate value, $Res Function(_ChannelsUpdate) _then) =
      __$ChannelsUpdateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String channelId,
