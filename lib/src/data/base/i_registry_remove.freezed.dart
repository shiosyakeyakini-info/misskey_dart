...
$IRegistryRemoveCopyWith<IRegistryRemove> get copyWith => _$IRegistryRemoveCopyWithImpl<IRegistryRemove>(this as IRegistryRemove, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IRegistryRemove&&(identical(other.key, key) || other.key == key)&&const DeepCollectionEquality().equals(other.scope, scope)&&(identical(other.domain, domain) || other.domain == domain));
}
...
abstract mixin class $IRegistryRemoveCopyWith<$Res>  {
  factory $IRegistryRemoveCopyWith(IRegistryRemove value, $Res Function(IRegistryRemove) _then) = _$IRegistryRemoveCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [IRegistryRemove].
extension IRegistryRemovePatterns on IRegistryRemove {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IRegistryRemove value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IRegistryRemove() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IRegistryRemove value)  $default,){
final _that = this;
switch (_that) {
case _IRegistryRemove():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IRegistryRemove value)?  $default,){
final _that = this;
switch (_that) {
case _IRegistryRemove() when $default != null:
return $default(_that);case _:
...
class _IRegistryRemove implements IRegistryRemove {
  const _IRegistryRemove({required this.key, final  List<String> scope = const [], this.domain}): _scope = scope;
  factory _IRegistryRemove.fromJson(Map<String, dynamic> json) => _$IRegistryRemoveFromJson(json);
...
@pragma('vm:prefer-inline')
_$IRegistryRemoveCopyWith<_IRegistryRemove> get copyWith => __$IRegistryRemoveCopyWithImpl<_IRegistryRemove>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$IRegistryRemoveToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IRegistryRemove&&(identical(other.key, key) || other.key == key)&&const DeepCollectionEquality().equals(other._scope, _scope)&&(identical(other.domain, domain) || other.domain == domain));
}
...
/// @nodoc
abstract mixin class _$IRegistryRemoveCopyWith<$Res> implements $IRegistryRemoveCopyWith<$Res> {
  factory _$IRegistryRemoveCopyWith(_IRegistryRemove value, $Res Function(_IRegistryRemove) _then) = __$IRegistryRemoveCopyWithImpl;
@override @useResult
$Res call({
 String key, List<String> scope, String? domain
});
