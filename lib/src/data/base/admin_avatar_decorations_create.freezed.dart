...
mixin _$AdminAvatarDecorationsCreate {
  ...
  $AdminAvatarDecorationsCreateCopyWith<AdminAvatarDecorationsCreate>
      get copyWith => _$AdminAvatarDecorationsCreateCopyWithImpl<
              AdminAvatarDecorationsCreate>(
          this as AdminAvatarDecorationsCreate, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminAvatarDecorationsCreate &&
...
abstract mixin class $AdminAvatarDecorationsCreateCopyWith<$Res> {
  factory $AdminAvatarDecorationsCreateCopyWith(
          AdminAvatarDecorationsCreate value,
          $Res Function(AdminAvatarDecorationsCreate) _then) =
      _$AdminAvatarDecorationsCreateCopyWithImpl;
  @useResult
  $Res call(
      {String id,
...
class _AdminAvatarDecorationsCreate implements AdminAvatarDecorationsCreate {
  const _AdminAvatarDecorationsCreate(
      {required this.id,
      ...
      : _roleIdsThatCanBeUsedThisDecoration =
            roleIdsThatCanBeUsedThisDecoration;
  factory _AdminAvatarDecorationsCreate.fromJson(Map<String, dynamic> json) =>
      _$AdminAvatarDecorationsCreateFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminAvatarDecorationsCreateCopyWith<_AdminAvatarDecorationsCreate>
      get copyWith => __$AdminAvatarDecorationsCreateCopyWithImpl<
          _AdminAvatarDecorationsCreate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminAvatarDecorationsCreateToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminAvatarDecorationsCreate &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.createdAt, createdAt) ||
                other.createdAt == createdAt) &&
            (identical(other.updatedAt, updatedAt) ||
...
/// @nodoc
abstract mixin class _$AdminAvatarDecorationsCreateCopyWith<$Res>
    implements $AdminAvatarDecorationsCreateCopyWith<$Res> {
  factory _$AdminAvatarDecorationsCreateCopyWith(
          _AdminAvatarDecorationsCreate value,
          $Res Function(_AdminAvatarDecorationsCreate) _then) =
      __$AdminAvatarDecorationsCreateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
