...
@override
String toString() {
  return 'AdminAvatarDecorationsCreate(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, name: $name, description: $description, url: $url, roleIdsThatCanBeUsedThisDecoration: $roleIdsThatCanBeUsedThisDecoration, category: $category)';
}
