...
@override
String toString() {
  return 'UsersNotes(userId: $userId, withReplies: $withReplies, withRenotes: $withRenotes, withChannelNotes: $withChannelNotes, limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate, allowPartial: $allowPartial, withFiles: $withFiles)';
}
...
/// @nodoc
abstract mixin class $UsersNotesCopyWith<$Res>  {
  factory $UsersNotesCopyWith(UsersNotes value, $Res Function(UsersNotes) _then) = _$UsersNotesCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UsersNotesCopyWithImpl<$Res>
    implements $UsersNotesCopyWith<$Res> {
  _$UsersNotesCopyWithImpl(this._self, this._then);

  final UsersNotes _self;
  final $Res Function(UsersNotes) _then;

/// Create a copy of UsersNotes
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? withReplies = freezed,Object? withRenotes = freezed,Object? withChannelNotes = freezed,Object? limit = freezed,Object? sinceId = freezed,Object? untilId = freezed,Object? sinceDate = freezed,Object? untilDate = freezed,Object? allowPartial = freezed,Object? withFiles = freezed,}) {
...
/// Adds pattern-matching-related methods to [UsersNotes].
extension UsersNotesPatterns on UsersNotes {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UsersNotes value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UsersNotes() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UsersNotes value)  $default,){
final _that = this;
switch (_that) {
case _UsersNotes():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UsersNotes value)?  $default,){
final _that = this;
switch (_that) {
case _UsersNotes() when $default != null:
return $default(_that);case _:
...
class _UsersNotes implements UsersNotes {
  const _UsersNotes({required this.userId, this.withReplies = false, this.withRenotes = true, this.withChannelNotes = false, this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.allowPartial = false, this.withFiles = false});
  factory _UsersNotes.fromJson(Map<String, dynamic> json) => _$UsersNotesFromJson(json);
...
@pragma('vm:prefer-inline')
_$UsersNotesCopyWith<_UsersNotes> get copyWith => __$UsersNotesCopyWithImpl<_UsersNotes>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UsersNotesToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UsersNotes&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.withReplies, withReplies) || other.withReplies == withReplies)&&(identical(other.withRenotes, withRenotes) || other.withRenotes == withRenotes)&&(identical(other.withChannelNotes, withChannelNotes) || other.withChannelNotes == withChannelNotes)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.allowPartial, allowPartial) || other.allowPartial == allowPartial)&&(identical(other.withFiles, withFiles) || other.withFiles == withFiles));
}
...
/// @nodoc
abstract mixin class _$UsersNotesCopyWith<$Res> implements $UsersNotesCopyWith<$Res> {
  factory _$UsersNotesCopyWith(_UsersNotes value, $Res Function(_UsersNotes) _then) = __$UsersNotesCopyWithImpl;
@override @useResult
$Res call({
 String userId, bool? withReplies, bool? withRenotes, bool? withChannelNotes, int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? allowPartial, bool? withFiles
});
...
/// @nodoc
class __$UsersNotesCopyWithImpl<$Res>
    implements _$UsersNotesCopyWith<$Res> {
  __$UsersNotesCopyWithImpl(this._self, this._then);

  final _UsersNotes _self;
  final $Res Function(_UsersNotes) _then;

/// Create a copy of UsersNotes
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? withReplies = freezed,Object? withRenotes = freezed,Object? withChannelNotes = freezed,Object? limit = freezed,Object? sinceId = freezed,Object? untilId = freezed,Object? sinceDate = freezed,Object? untilDate = freezed,Object? allowPartial = freezed,Object? withFiles = freezed,}) {
  return _then(_UsersNotes(
userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,withReplies: freezed == withReplies ? _self.withReplies : withReplies // ignore: cast_nullable_to_non_nullable
as bool?,withRenotes: freezed == withRenotes ? _self.withRenotes : withRenotes // ignore: cast_nullable_to_non_nullable
as bool?,withChannelNotes: freezed == withChannelNotes ? _self.withChannelNotes : withChannelNotes // ignore: cast_nullable_to_non_nullable
