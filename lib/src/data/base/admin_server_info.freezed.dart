...
mixin _$AdminServerInfo {
  ...
  $AdminServerInfoCopyWith<AdminServerInfo> get copyWith =>
      _$AdminServerInfoCopyWithImpl<AdminServerInfo>(
          this as AdminServerInfo, _$identity);
...
abstract mixin class $AdminServerInfoCopyWith<$Res> {
  factory $AdminServerInfoCopyWith(
          AdminServerInfo value, $Res Function(AdminServerInfo) _then) =
      _$AdminServerInfoCopyWithImpl;
  @useResult
  $Res call(
      {String machine,
      String os,
...
class _AdminServerInfo implements AdminServerInfo {
  const _AdminServerInfo(
      ...
      required this.fs,
      required this.net});
  factory _AdminServerInfo.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminServerInfoCopyWith<_AdminServerInfo> get copyWith =>
      __$AdminServerInfoCopyWithImpl<_AdminServerInfo>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminServerInfoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AdminServerInfoCopyWith<$Res>
    implements $AdminServerInfoCopyWith<$Res> {
  factory _$AdminServerInfoCopyWith(
          _AdminServerInfo value, $Res Function(_AdminServerInfo) _then) =
      __$AdminServerInfoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String machine,
