...
@freezed
abstract class UsersGetFrequentlyRepliedUsers
    with _$UsersGetFrequentlyRepliedUsers {
  const factory UsersGetFrequentlyRepliedUsers({
    required String userId,
    @Default(10) int? limit,
  }) = _UsersGetFrequentlyRepliedUsers;

  factory UsersGetFrequentlyRepliedUsers.fromJson(Map<String, Object?> json) =>
