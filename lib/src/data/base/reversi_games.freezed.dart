...
$ReversiGamesCopyWith<ReversiGames> get copyWith => _$ReversiGamesCopyWithImpl<ReversiGames>(this as ReversiGames, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReversiGames&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.my, my) || other.my == my));
}
...
abstract mixin class $ReversiGamesCopyWith<$Res>  {
  factory $ReversiGamesCopyWith(ReversiGames value, $Res Function(ReversiGames) _then) = _$ReversiGamesCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ReversiGamesCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [ReversiGames].
extension ReversiGamesPatterns on ReversiGames {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ReversiGames value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ReversiGames() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ReversiGames value)  $default,){
final _that = this;
switch (_that) {
case _ReversiGames():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ReversiGames value)?  $default,){
final _that = this;
switch (_that) {
case _ReversiGames() when $default != null:
return $default(_that);case _:
...
class _ReversiGames implements ReversiGames {
  const _ReversiGames({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.my = false});
  factory _ReversiGames.fromJson(Map<String, dynamic> json) => _$ReversiGamesFromJson(json);
...
@pragma('vm:prefer-inline')
_$ReversiGamesCopyWith<_ReversiGames> get copyWith => __$ReversiGamesCopyWithImpl<_ReversiGames>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ReversiGamesToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReversiGames&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.my, my) || other.my == my));
}
...
/// @nodoc
abstract mixin class _$ReversiGamesCopyWith<$Res> implements $ReversiGamesCopyWith<$Res> {
  factory _$ReversiGamesCopyWith(_ReversiGames value, $Res Function(_ReversiGames) _then) = __$ReversiGamesCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? my
});
