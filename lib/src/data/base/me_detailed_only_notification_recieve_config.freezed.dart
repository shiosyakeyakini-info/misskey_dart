...
mixin _$MeDetailedOnlyNotificationRecieveConfig {
  ...
  $MeDetailedOnlyNotificationRecieveConfigCopyWith<
          MeDetailedOnlyNotificationRecieveConfig>
      get copyWith => _$MeDetailedOnlyNotificationRecieveConfigCopyWithImpl<
              MeDetailedOnlyNotificationRecieveConfig>(
          this as MeDetailedOnlyNotificationRecieveConfig, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MeDetailedOnlyNotificationRecieveConfig &&
...
abstract mixin class $MeDetailedOnlyNotificationRecieveConfigCopyWith<$Res> {
  factory $MeDetailedOnlyNotificationRecieveConfigCopyWith(
          MeDetailedOnlyNotificationRecieveConfig value,
          $Res Function(MeDetailedOnlyNotificationRecieveConfig) _then) =
      _$MeDetailedOnlyNotificationRecieveConfigCopyWithImpl;
  @useResult
  $Res call(
      {dynamic note,
      dynamic follow,
...
/// @nodoc
@JsonSerializable()
class _MeDetailedOnlyNotificationRecieveConfig
    implements MeDetailedOnlyNotificationRecieveConfig {
  const _MeDetailedOnlyNotificationRecieveConfig(
      {this.note,
      this.follow,
      this.mention,
      this.reply,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MeDetailedOnlyNotificationRecieveConfigCopyWith<
          _MeDetailedOnlyNotificationRecieveConfig>
      get copyWith => __$MeDetailedOnlyNotificationRecieveConfigCopyWithImpl<
          _MeDetailedOnlyNotificationRecieveConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MeDetailedOnlyNotificationRecieveConfigToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MeDetailedOnlyNotificationRecieveConfig &&
            const DeepCollectionEquality().equals(other.note, note) &&
            const DeepCollectionEquality().equals(other.follow, follow) &&
            const DeepCollectionEquality().equals(other.mention, mention) &&
            const DeepCollectionEquality().equals(other.reply, reply) &&
...
/// @nodoc
abstract mixin class _$MeDetailedOnlyNotificationRecieveConfigCopyWith<$Res>
    implements $MeDetailedOnlyNotificationRecieveConfigCopyWith<$Res> {
  factory _$MeDetailedOnlyNotificationRecieveConfigCopyWith(
          _MeDetailedOnlyNotificationRecieveConfig value,
          $Res Function(_MeDetailedOnlyNotificationRecieveConfig) _then) =
      __$MeDetailedOnlyNotificationRecieveConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {dynamic note,
