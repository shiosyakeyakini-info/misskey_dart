...
mixin _$FederationInstance {
  ...
  $FederationInstanceCopyWith<FederationInstance> get copyWith =>
      _$FederationInstanceCopyWithImpl<FederationInstance>(
          this as FederationInstance, _$identity);
...
abstract mixin class $FederationInstanceCopyWith<$Res> {
  factory $FederationInstanceCopyWith(
          FederationInstance value, $Res Function(FederationInstance) _then) =
      _$FederationInstanceCopyWithImpl;
  @useResult
  $Res call(
      {String id,
    ...
    return _then(_self.copyWith(
      ...
      isSilenced: null == isSilenced
          ...
          : isSilenced // ignore: cast_nullable_to_non_nullable
              as bool,
      isMediaSilenced: null == isMediaSilenced
...
class _FederationInstance implements FederationInstance {
  const _FederationInstance(
      ...
      required this.isMediaSilenced,
      @NullableUriConverter() this.iconUrl,
      @NullableUriConverter() this.faviconUrl,
      this.themeColor,
      @NullableDateTimeConverter() this.infoUpdatedAt,
      @NullableDateTimeConverter() this.latestRequestReceivedAt,
      this.moderationNote});
  factory _FederationInstance.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FederationInstanceCopyWith<_FederationInstance> get copyWith =>
      __$FederationInstanceCopyWithImpl<_FederationInstance>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FederationInstanceToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$FederationInstanceCopyWith<$Res>
    implements $FederationInstanceCopyWith<$Res> {
  factory _$FederationInstanceCopyWith(
          _FederationInstance value, $Res Function(_FederationInstance) _then) =
      __$FederationInstanceCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
