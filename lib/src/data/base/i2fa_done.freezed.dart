...
$I2faDoneCopyWith<I2faDone> get copyWith => _$I2faDoneCopyWithImpl<I2faDone>(this as I2faDone, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is I2faDone&&const DeepCollectionEquality().equals(other.backupCodes, backupCodes));
}
...
abstract mixin class $I2faDoneCopyWith<$Res>  {
  factory $I2faDoneCopyWith(I2faDone value, $Res Function(I2faDone) _then) = _$I2faDoneCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$I2faDoneCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [I2faDone].
extension I2faDonePatterns on I2faDone {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _I2faDone value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _I2faDone() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _I2faDone value)  $default,){
final _that = this;
switch (_that) {
case _I2faDone():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _I2faDone value)?  $default,){
final _that = this;
switch (_that) {
case _I2faDone() when $default != null:
return $default(_that);case _:
...
class _I2faDone implements I2faDone {
  const _I2faDone({required final  List<String> backupCodes}): _backupCodes = backupCodes;
  factory _I2faDone.fromJson(Map<String, dynamic> json) => _$I2faDoneFromJson(json);
...
@pragma('vm:prefer-inline')
_$I2faDoneCopyWith<_I2faDone> get copyWith => __$I2faDoneCopyWithImpl<_I2faDone>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$I2faDoneToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _I2faDone&&const DeepCollectionEquality().equals(other._backupCodes, _backupCodes));
}
...
/// @nodoc
abstract mixin class _$I2faDoneCopyWith<$Res> implements $I2faDoneCopyWith<$Res> {
  factory _$I2faDoneCopyWith(_I2faDone value, $Res Function(_I2faDone) _then) = __$I2faDoneCopyWithImpl;
@override @useResult
$Res call({
 List<String> backupCodes
});
...
/// @nodoc
class __$I2faDoneCopyWithImpl<$Res>
    implements _$I2faDoneCopyWith<$Res> {
