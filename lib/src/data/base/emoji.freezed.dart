...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Emoji&&(identical(other.name, name) || other.name == name));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Emoji&&(identical(other.name, name) || other.name == name));
}
