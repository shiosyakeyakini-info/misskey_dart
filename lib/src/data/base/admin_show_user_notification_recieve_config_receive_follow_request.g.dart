...
Map<String, dynamic>
_$AdminShowUserNotificationRecieveConfigReceiveFollowRequestToJson(
  _AdminShowUserNotificationRecieveConfigReceiveFollowRequest instance,
) => <String, dynamic>{
  'type':
      _$AdminShowUserNotificationRecieveConfigReceiveFollowRequestTypeEnumMap[instance
          .type]!,
...
const _$AdminShowUserNotificationRecieveConfigReceiveFollowRequestTypeEnumMap =
    {
      ...
      AdminShowUserNotificationRecieveConfigReceiveFollowRequestType
              .followingOrFollower:
          'followingOrFollower',
      AdminShowUserNotificationRecieveConfigReceiveFollowRequestType.never:
          'never',
      AdminShowUserNotificationRecieveConfigReceiveFollowRequestType.list:
          'list',
      AdminShowUserNotificationRecieveConfigReceiveFollowRequestType.unknown:
          'unknown',
    };
