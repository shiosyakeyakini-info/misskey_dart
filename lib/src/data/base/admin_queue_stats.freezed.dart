...
$AdminQueueStatsCopyWith<AdminQueueStats> get copyWith => _$AdminQueueStatsCopyWithImpl<AdminQueueStats>(this as AdminQueueStats, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminQueueStats&&(identical(other.deliver, deliver) || other.deliver == deliver)&&(identical(other.inbox, inbox) || other.inbox == inbox)&&(identical(other.db, db) || other.db == db)&&(identical(other.objectStorage, objectStorage) || other.objectStorage == objectStorage));
}
...
abstract mixin class $AdminQueueStatsCopyWith<$Res>  {
  factory $AdminQueueStatsCopyWith(AdminQueueStats value, $Res Function(AdminQueueStats) _then) = _$AdminQueueStatsCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminQueueStats].
extension AdminQueueStatsPatterns on AdminQueueStats {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminQueueStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminQueueStats() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminQueueStats value)  $default,){
final _that = this;
switch (_that) {
case _AdminQueueStats():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminQueueStats value)?  $default,){
final _that = this;
switch (_that) {
case _AdminQueueStats() when $default != null:
return $default(_that);case _:
...
class _AdminQueueStats implements AdminQueueStats {
  const _AdminQueueStats({required this.deliver, required this.inbox, required this.db, required this.objectStorage});
  factory _AdminQueueStats.fromJson(Map<String, dynamic> json) => _$AdminQueueStatsFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminQueueStatsCopyWith<_AdminQueueStats> get copyWith => __$AdminQueueStatsCopyWithImpl<_AdminQueueStats>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminQueueStatsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminQueueStats&&(identical(other.deliver, deliver) || other.deliver == deliver)&&(identical(other.inbox, inbox) || other.inbox == inbox)&&(identical(other.db, db) || other.db == db)&&(identical(other.objectStorage, objectStorage) || other.objectStorage == objectStorage));
}
...
/// @nodoc
abstract mixin class _$AdminQueueStatsCopyWith<$Res> implements $AdminQueueStatsCopyWith<$Res> {
  factory _$AdminQueueStatsCopyWith(_AdminQueueStats value, $Res Function(_AdminQueueStats) _then) = __$AdminQueueStatsCopyWithImpl;
@override @useResult
$Res call({
 QueueCount deliver, QueueCount inbox, QueueCount db, QueueCount objectStorage
});
