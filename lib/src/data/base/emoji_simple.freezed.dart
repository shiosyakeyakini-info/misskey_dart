...
mixin _$EmojiSimple {
 ...
 List<String> get aliases; String get name; String? get category; String get url; bool? get localOnly; bool? get isSensitive; List<String>? get roleIdsThatCanBeUsedThisEmojiAsReaction;
...
@useResult
$Res call({
 List<String> aliases, String name, String? category, String url, bool? localOnly, bool? isSensitive, List<String>? roleIdsThatCanBeUsedThisEmojiAsReaction
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<String> aliases,  String name,  String? category,  String url,  bool? localOnly,  bool? isSensitive,  List<String>? roleIdsThatCanBeUsedThisEmojiAsReaction)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EmojiSimple() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<String> aliases,  String name,  String? category,  String url,  bool? localOnly,  bool? isSensitive,  List<String>? roleIdsThatCanBeUsedThisEmojiAsReaction)  $default,) {final _that = this;
switch (_that) {
case _EmojiSimple():
return $default(_that.aliases,_that.name,_that.category,_that.url,_that.localOnly,_that.isSensitive,_that.roleIdsThatCanBeUsedThisEmojiAsReaction);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<String> aliases,  String name,  String? category,  String url,  bool? localOnly,  bool? isSensitive,  List<String>? roleIdsThatCanBeUsedThisEmojiAsReaction)?  $default,) {final _that = this;
switch (_that) {
case _EmojiSimple() when $default != null:
return $default(_that.aliases,_that.name,_that.category,_that.url,_that.localOnly,_that.isSensitive,_that.roleIdsThatCanBeUsedThisEmojiAsReaction);case _:
  return null;
...
class _EmojiSimple implements EmojiSimple {
  const _EmojiSimple({required final  List<String> aliases, required this.name, this.category, required this.url, this.localOnly, this.isSensitive, final  List<String>? roleIdsThatCanBeUsedThisEmojiAsReaction}): _aliases = aliases,_roleIdsThatCanBeUsedThisEmojiAsReaction = roleIdsThatCanBeUsedThisEmojiAsReaction;
