...
$NotesMentionsCopyWith<NotesMentions> get copyWith => _$NotesMentionsCopyWithImpl<NotesMentions>(this as NotesMentions, _$identity);
...
abstract mixin class $NotesMentionsCopyWith<$Res>  {
  factory $NotesMentionsCopyWith(NotesMentions value, $Res Function(NotesMentions) _then) = _$NotesMentionsCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [NotesMentions].
extension NotesMentionsPatterns on NotesMentions {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NotesMentions value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _NotesMentions() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NotesMentions value)  $default,){
final _that = this;
switch (_that) {
case _NotesMentions():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NotesMentions value)?  $default,){
final _that = this;
switch (_that) {
case _NotesMentions() when $default != null:
return $default(_that);case _:
...
class _NotesMentions implements NotesMentions {
  const _NotesMentions({this.following = false, this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.visibility});
  factory _NotesMentions.fromJson(Map<String, dynamic> json) => _$NotesMentionsFromJson(json);
...
@pragma('vm:prefer-inline')
_$NotesMentionsCopyWith<_NotesMentions> get copyWith => __$NotesMentionsCopyWithImpl<_NotesMentions>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$NotesMentionsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotesMentions&&(identical(other.following, following) || other.following == following)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.visibility, visibility) || other.visibility == visibility));
}
...
/// @nodoc
abstract mixin class _$NotesMentionsCopyWith<$Res> implements $NotesMentionsCopyWith<$Res> {
  factory _$NotesMentionsCopyWith(_NotesMentions value, $Res Function(_NotesMentions) _then) = __$NotesMentionsCopyWithImpl;
@override @useResult
$Res call({
 bool? following, int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, String? visibility
});
