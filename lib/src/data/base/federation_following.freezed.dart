...
mixin _$FederationFollowing {
  ...
  $FederationFollowingCopyWith<FederationFollowing> get copyWith =>
      _$FederationFollowingCopyWithImpl<FederationFollowing>(
          this as FederationFollowing, _$identity);
...
abstract mixin class $FederationFollowingCopyWith<$Res> {
  factory $FederationFollowingCopyWith(
          FederationFollowing value, $Res Function(FederationFollowing) _then) =
      _$FederationFollowingCopyWithImpl;
  @useResult
  $Res call(
      {String host,
      String? sinceId,
...
class _FederationFollowing implements FederationFollowing {
  const _FederationFollowing(
      ...
      this.untilDate,
      this.limit = 10});
  factory _FederationFollowing.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FederationFollowingCopyWith<_FederationFollowing> get copyWith =>
      __$FederationFollowingCopyWithImpl<_FederationFollowing>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FederationFollowingToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$FederationFollowingCopyWith<$Res>
    implements $FederationFollowingCopyWith<$Res> {
  factory _$FederationFollowingCopyWith(_FederationFollowing value,
          $Res Function(_FederationFollowing) _then) =
      __$FederationFollowingCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String host,
