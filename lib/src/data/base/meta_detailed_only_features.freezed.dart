...
mixin _$MetaDetailedOnlyFeatures {
  ...
  bool get localTimeline;
  bool get globalTimeline;
  bool get hcaptcha;
  bool get turnstile;
  bool get recaptcha;
  ...
  $MetaDetailedOnlyFeaturesCopyWith<MetaDetailedOnlyFeatures> get copyWith =>
      _$MetaDetailedOnlyFeaturesCopyWithImpl<MetaDetailedOnlyFeatures>(
          this as MetaDetailedOnlyFeatures, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MetaDetailedOnlyFeatures &&
            ...
            (identical(other.localTimeline, localTimeline) ||
                other.localTimeline == localTimeline) &&
            (identical(other.globalTimeline, globalTimeline) ||
                other.globalTimeline == globalTimeline) &&
...
abstract mixin class $MetaDetailedOnlyFeaturesCopyWith<$Res> {
  factory $MetaDetailedOnlyFeaturesCopyWith(MetaDetailedOnlyFeatures value,
          $Res Function(MetaDetailedOnlyFeatures) _then) =
      _$MetaDetailedOnlyFeaturesCopyWithImpl;
  @useResult
  $Res call(
      {bool registration,
...
class _$MetaDetailedOnlyFeaturesCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? localTimeline = null,
    Object? globalTimeline = null,
    ...
    return _then(_self.copyWith(
      ...
      localTimeline: null == localTimeline
          ? _self.localTimeline
          : localTimeline // ignore: cast_nullable_to_non_nullable
              as bool,
      globalTimeline: null == globalTimeline
          ? _self.globalTimeline
          : globalTimeline // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _MetaDetailedOnlyFeatures implements MetaDetailedOnlyFeatures {
  const _MetaDetailedOnlyFeatures(
      ...
      this.miauth = true});
  factory _MetaDetailedOnlyFeatures.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MetaDetailedOnlyFeaturesCopyWith<_MetaDetailedOnlyFeatures> get copyWith =>
      __$MetaDetailedOnlyFeaturesCopyWithImpl<_MetaDetailedOnlyFeatures>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MetaDetailedOnlyFeaturesToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MetaDetailedOnlyFeatures &&
            (identical(other.registration, registration) ||
                other.registration == registration) &&
            (identical(other.emailRequiredForSignup, emailRequiredForSignup) ||
                other.emailRequiredForSignup == emailRequiredForSignup) &&
...
/// @nodoc
abstract mixin class _$MetaDetailedOnlyFeaturesCopyWith<$Res>
    implements $MetaDetailedOnlyFeaturesCopyWith<$Res> {
  factory _$MetaDetailedOnlyFeaturesCopyWith(_MetaDetailedOnlyFeatures value,
          $Res Function(_MetaDetailedOnlyFeatures) _then) =
      __$MetaDetailedOnlyFeaturesCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool registration,
