...
mixin _$IUpdate {
  ...
  String? get bannerId;
  List<IUpdateFieldsItem>? get fields;
  bool? get isLocked;
  ...
  int? get makeNotesFollowersOnlyBefore;
  int? get makeNotesHiddenBefore;
  bool? get isBot;
  bool? get isCat;
  ...
  IUpdateNotificationRecieveConfig? get notificationRecieveConfig;
  ...
  $IUpdateCopyWith<IUpdate> get copyWith =>
      _$IUpdateCopyWithImpl<IUpdate>(this as IUpdate, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.emailNotificationTypes, emailNotificationTypes) &&
            const DeepCollectionEquality()
...
abstract mixin class $IUpdateCopyWith<$Res> {
  factory $IUpdateCopyWith(IUpdate value, $Res Function(IUpdate) _then) =
      _$IUpdateCopyWithImpl;
  @useResult
  $Res call(
      {String? name,
      String? description,
  ...
  $IUpdateNotificationRecieveConfigCopyWith<$Res>?
      get notificationRecieveConfig;
}

/// @nodoc
class _$IUpdateCopyWithImpl<$Res> implements $IUpdateCopyWith<$Res> {
    ...
    return _then(_self.copyWith(
      ...
      avatarDecorations: freezed == avatarDecorations
          ...
          : avatarDecorations // ignore: cast_nullable_to_non_nullable
              as List<IUpdateAvatarDecorationsItem>?,
      ...
      notificationRecieveConfig: freezed == notificationRecieveConfig
          ...
          : notificationRecieveConfig // ignore: cast_nullable_to_non_nullable
              as IUpdateNotificationRecieveConfig?,
  ...
  $IUpdateNotificationRecieveConfigCopyWith<$Res>?
    ...
    return $IUpdateNotificationRecieveConfigCopyWith<$Res>(
...
class _IUpdate implements IUpdate {
  const _IUpdate(
      ...
      this.bannerId,
      final List<IUpdateFieldsItem>? fields,
      this.isLocked,
      this.isExplorable,
  ...
  factory _IUpdate.fromJson(Map<String, dynamic> json) =>
      _$IUpdateFromJson(json);
  ...
  @override
  final IUpdateNotificationRecieveConfig? notificationRecieveConfig;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IUpdateCopyWith<_IUpdate> get copyWith =>
      __$IUpdateCopyWithImpl<_IUpdate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IUpdateToJson(
      this,
    );
  }
...
abstract mixin class _$IUpdateCopyWith<$Res> implements $IUpdateCopyWith<$Res> {
  factory _$IUpdateCopyWith(_IUpdate value, $Res Function(_IUpdate) _then) =
      __$IUpdateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? name,
...
/// @nodoc
class __$IUpdateCopyWithImpl<$Res> implements _$IUpdateCopyWith<$Res> {
