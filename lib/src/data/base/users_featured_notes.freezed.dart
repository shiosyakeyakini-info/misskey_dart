...
mixin _$UsersFeaturedNotes {
  ...
  $UsersFeaturedNotesCopyWith<UsersFeaturedNotes> get copyWith =>
      _$UsersFeaturedNotesCopyWithImpl<UsersFeaturedNotes>(
          this as UsersFeaturedNotes, _$identity);
...
abstract mixin class $UsersFeaturedNotesCopyWith<$Res> {
  factory $UsersFeaturedNotesCopyWith(
          UsersFeaturedNotes value, $Res Function(UsersFeaturedNotes) _then) =
      _$UsersFeaturedNotesCopyWithImpl;
  @useResult
...
class _UsersFeaturedNotes implements UsersFeaturedNotes {
  const _UsersFeaturedNotes(
      {this.limit = 10, this.untilId, required this.userId});
  factory _UsersFeaturedNotes.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsersFeaturedNotesCopyWith<_UsersFeaturedNotes> get copyWith =>
      __$UsersFeaturedNotesCopyWithImpl<_UsersFeaturedNotes>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UsersFeaturedNotesToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$UsersFeaturedNotesCopyWith<$Res>
    implements $UsersFeaturedNotesCopyWith<$Res> {
  factory _$UsersFeaturedNotesCopyWith(
          _UsersFeaturedNotes value, $Res Function(_UsersFeaturedNotes) _then) =
      __$UsersFeaturedNotesCopyWithImpl;
  @override
  @useResult
  $Res call({int? limit, String? untilId, String userId});
}
