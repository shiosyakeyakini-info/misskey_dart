...
$NotesUserListTimelineCopyWith<NotesUserListTimeline> get copyWith => _$NotesUserListTimelineCopyWithImpl<NotesUserListTimeline>(this as NotesUserListTimeline, _$identity);
...
abstract mixin class $NotesUserListTimelineCopyWith<$Res>  {
  factory $NotesUserListTimelineCopyWith(NotesUserListTimeline value, $Res Function(NotesUserListTimeline) _then) = _$NotesUserListTimelineCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [NotesUserListTimeline].
extension NotesUserListTimelinePatterns on NotesUserListTimeline {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NotesUserListTimeline value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _NotesUserListTimeline() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NotesUserListTimeline value)  $default,){
final _that = this;
switch (_that) {
case _NotesUserListTimeline():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NotesUserListTimeline value)?  $default,){
final _that = this;
switch (_that) {
case _NotesUserListTimeline() when $default != null:
return $default(_that);case _:
...
class _NotesUserListTimeline implements NotesUserListTimeline {
  const _NotesUserListTimeline({required this.listId, this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.allowPartial = false, this.includeMyRenotes = true, this.includeRenotedMyNotes = true, this.includeLocalRenotes = true, this.withRenotes = true, this.withFiles = false});
  factory _NotesUserListTimeline.fromJson(Map<String, dynamic> json) => _$NotesUserListTimelineFromJson(json);
...
@pragma('vm:prefer-inline')
_$NotesUserListTimelineCopyWith<_NotesUserListTimeline> get copyWith => __$NotesUserListTimelineCopyWithImpl<_NotesUserListTimeline>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$NotesUserListTimelineToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotesUserListTimeline&&(identical(other.listId, listId) || other.listId == listId)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.allowPartial, allowPartial) || other.allowPartial == allowPartial)&&(identical(other.includeMyRenotes, includeMyRenotes) || other.includeMyRenotes == includeMyRenotes)&&(identical(other.includeRenotedMyNotes, includeRenotedMyNotes) || other.includeRenotedMyNotes == includeRenotedMyNotes)&&(identical(other.includeLocalRenotes, includeLocalRenotes) || other.includeLocalRenotes == includeLocalRenotes)&&(identical(other.withRenotes, withRenotes) || other.withRenotes == withRenotes)&&(identical(other.withFiles, withFiles) || other.withFiles == withFiles));
}
...
/// @nodoc
abstract mixin class _$NotesUserListTimelineCopyWith<$Res> implements $NotesUserListTimelineCopyWith<$Res> {
  factory _$NotesUserListTimelineCopyWith(_NotesUserListTimeline value, $Res Function(_NotesUserListTimeline) _then) = __$NotesUserListTimelineCopyWithImpl;
@override @useResult
$Res call({
 String listId, int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? allowPartial, bool? includeMyRenotes, bool? includeRenotedMyNotes, bool? includeLocalRenotes, bool? withRenotes, bool? withFiles
});
