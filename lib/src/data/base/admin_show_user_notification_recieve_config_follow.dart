...
@freezed
abstract class AdminShowUserNotificationRecieveConfigFollow
    with _$AdminShowUserNotificationRecieveConfigFollow {
  ...
  factory AdminShowUserNotificationRecieveConfigFollow.fromJson(
