...
$RolesUsersCopyWith<RolesUsers> get copyWith => _$RolesUsersCopyWithImpl<RolesUsers>(this as RolesUsers, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RolesUsers&&(identical(other.roleId, roleId) || other.roleId == roleId)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.limit, limit) || other.limit == limit));
}
...
abstract mixin class $RolesUsersCopyWith<$Res>  {
  factory $RolesUsersCopyWith(RolesUsers value, $Res Function(RolesUsers) _then) = _$RolesUsersCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RolesUsersCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [RolesUsers].
extension RolesUsersPatterns on RolesUsers {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RolesUsers value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RolesUsers() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RolesUsers value)  $default,){
final _that = this;
switch (_that) {
case _RolesUsers():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RolesUsers value)?  $default,){
final _that = this;
switch (_that) {
case _RolesUsers() when $default != null:
return $default(_that);case _:
...
class _RolesUsers implements RolesUsers {
  const _RolesUsers({required this.roleId, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.limit = 10});
  factory _RolesUsers.fromJson(Map<String, dynamic> json) => _$RolesUsersFromJson(json);
...
@pragma('vm:prefer-inline')
_$RolesUsersCopyWith<_RolesUsers> get copyWith => __$RolesUsersCopyWithImpl<_RolesUsers>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RolesUsersToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RolesUsers&&(identical(other.roleId, roleId) || other.roleId == roleId)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.limit, limit) || other.limit == limit));
}
...
/// @nodoc
abstract mixin class _$RolesUsersCopyWith<$Res> implements $RolesUsersCopyWith<$Res> {
  factory _$RolesUsersCopyWith(_RolesUsers value, $Res Function(_RolesUsers) _then) = __$RolesUsersCopyWithImpl;
@override @useResult
$Res call({
 String roleId, String? sinceId, String? untilId, int? sinceDate, int? untilDate, int? limit
});
...
/// @nodoc
class __$RolesUsersCopyWithImpl<$Res>
    implements _$RolesUsersCopyWith<$Res> {
