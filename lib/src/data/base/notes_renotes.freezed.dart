...
mixin _$NotesRenotes {
  ...
  $NotesRenotesCopyWith<NotesRenotes> get copyWith =>
      _$NotesRenotesCopyWithImpl<NotesRenotes>(
          this as NotesRenotes, _$identity);
...
abstract mixin class $NotesRenotesCopyWith<$Res> {
  factory $NotesRenotesCopyWith(
          NotesRenotes value, $Res Function(NotesRenotes) _then) =
      _$NotesRenotesCopyWithImpl;
  @useResult
  $Res call(
      {String noteId,
      int? limit,
...
/// @nodoc
class _$NotesRenotesCopyWithImpl<$Res> implements $NotesRenotesCopyWith<$Res> {
...
class _NotesRenotes implements NotesRenotes {
  const _NotesRenotes(
      ...
      this.sinceDate,
      this.untilDate});
  factory _NotesRenotes.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotesRenotesCopyWith<_NotesRenotes> get copyWith =>
      __$NotesRenotesCopyWithImpl<_NotesRenotes>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotesRenotesToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$NotesRenotesCopyWith<$Res>
    implements $NotesRenotesCopyWith<$Res> {
  factory _$NotesRenotesCopyWith(
          _NotesRenotes value, $Res Function(_NotesRenotes) _then) =
      __$NotesRenotesCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String noteId,
