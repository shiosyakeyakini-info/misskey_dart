...
mixin _$DriveFilesMoveBulk {
  ...
  $DriveFilesMoveBulkCopyWith<DriveFilesMoveBulk> get copyWith =>
      _$DriveFilesMoveBulkCopyWithImpl<DriveFilesMoveBulk>(
          this as DriveFilesMoveBulk, _$identity);
...
abstract mixin class $DriveFilesMoveBulkCopyWith<$Res> {
  factory $DriveFilesMoveBulkCopyWith(
          DriveFilesMoveBulk value, $Res Function(DriveFilesMoveBulk) _then) =
      _$DriveFilesMoveBulkCopyWithImpl;
  @useResult
...
class _DriveFilesMoveBulk implements DriveFilesMoveBulk {
  const _DriveFilesMoveBulk(
      {required final List<String> fileIds, this.folderId})
      : _fileIds = fileIds;
  factory _DriveFilesMoveBulk.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DriveFilesMoveBulkCopyWith<_DriveFilesMoveBulk> get copyWith =>
      __$DriveFilesMoveBulkCopyWithImpl<_DriveFilesMoveBulk>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DriveFilesMoveBulkToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$DriveFilesMoveBulkCopyWith<$Res>
    implements $DriveFilesMoveBulkCopyWith<$Res> {
  factory _$DriveFilesMoveBulkCopyWith(
          _DriveFilesMoveBulk value, $Res Function(_DriveFilesMoveBulk) _then) =
      __$DriveFilesMoveBulkCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> fileIds, String? folderId});
}
