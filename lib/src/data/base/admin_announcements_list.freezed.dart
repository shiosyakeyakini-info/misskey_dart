...
mixin _$AdminAnnouncementsList {
  ...
  $AdminAnnouncementsListCopyWith<AdminAnnouncementsList> get copyWith =>
      _$AdminAnnouncementsListCopyWithImpl<AdminAnnouncementsList>(
          this as AdminAnnouncementsList, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminAnnouncementsList &&
...
abstract mixin class $AdminAnnouncementsListCopyWith<$Res> {
  factory $AdminAnnouncementsListCopyWith(AdminAnnouncementsList value,
          $Res Function(AdminAnnouncementsList) _then) =
      _$AdminAnnouncementsListCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _AdminAnnouncementsList implements AdminAnnouncementsList {
  ...
  factory _AdminAnnouncementsList.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminAnnouncementsListCopyWith<_AdminAnnouncementsList> get copyWith =>
      __$AdminAnnouncementsListCopyWithImpl<_AdminAnnouncementsList>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminAnnouncementsListToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminAnnouncementsList &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.sinceId, sinceId) || other.sinceId == sinceId) &&
            (identical(other.untilId, untilId) || other.untilId == untilId) &&
            (identical(other.sinceDate, sinceDate) ||
...
/// @nodoc
abstract mixin class _$AdminAnnouncementsListCopyWith<$Res>
    implements $AdminAnnouncementsListCopyWith<$Res> {
  factory _$AdminAnnouncementsListCopyWith(_AdminAnnouncementsList value,
          $Res Function(_AdminAnnouncementsList) _then) =
      __$AdminAnnouncementsListCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
