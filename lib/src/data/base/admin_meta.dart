...
part 'admin_meta.freezed.dart';
part 'admin_meta.g.dart';

@freezed
abstract class AdminMeta with _$AdminMeta {
  const factory AdminMeta({
    ...
    required AdminMetaSensitiveMediaDetectionSensitivity sensitiveMediaDetectionSensitivity,
  ...
  factory AdminMeta.fromJson(Map<String, Object?> json) => _$AdminMetaFromJson(json);
}
