...
mixin _$SystemWebhook {
  ...
  double? get latestStatus;
  String get name;
  @JsonKey(name: 'on')
  List<SystemWebhookOnItem> get on_;
  String get url;
  String get secret;
  ...
  $SystemWebhookCopyWith<SystemWebhook> get copyWith =>
      _$SystemWebhookCopyWithImpl<SystemWebhook>(
          this as SystemWebhook, _$identity);
...
abstract mixin class $SystemWebhookCopyWith<$Res> {
  factory $SystemWebhookCopyWith(
          SystemWebhook value, $Res Function(SystemWebhook) _then) =
      _$SystemWebhookCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      bool isActive,
      ...
      double? latestStatus,
      String name,
      @JsonKey(name: 'on') List<SystemWebhookOnItem> on_,
      String url,
      String secret});
}
...
class _SystemWebhook implements SystemWebhook {
  const _SystemWebhook(
      ...
      this.latestStatus,
      required this.name,
      @JsonKey(name: 'on') required final List<SystemWebhookOnItem> on_,
      required this.url,
      required this.secret})
      : _on_ = on_;
  factory _SystemWebhook.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SystemWebhookCopyWith<_SystemWebhook> get copyWith =>
      __$SystemWebhookCopyWithImpl<_SystemWebhook>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SystemWebhookToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$SystemWebhookCopyWith<$Res>
    implements $SystemWebhookCopyWith<$Res> {
  factory _$SystemWebhookCopyWith(
          _SystemWebhook value, $Res Function(_SystemWebhook) _then) =
      __$SystemWebhookCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
