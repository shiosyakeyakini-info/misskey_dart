...
mixin _$ChartsInstanceNotesDiffs {
  ...
  $ChartsInstanceNotesDiffsCopyWith<ChartsInstanceNotesDiffs> get copyWith =>
      _$ChartsInstanceNotesDiffsCopyWithImpl<ChartsInstanceNotesDiffs>(
          this as ChartsInstanceNotesDiffs, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChartsInstanceNotesDiffs &&
...
abstract mixin class $ChartsInstanceNotesDiffsCopyWith<$Res> {
  factory $ChartsInstanceNotesDiffsCopyWith(ChartsInstanceNotesDiffs value,
          $Res Function(ChartsInstanceNotesDiffs) _then) =
      _$ChartsInstanceNotesDiffsCopyWithImpl;
  @useResult
  $Res call(
      {List<double> normal,
      List<double> reply,
...
class _ChartsInstanceNotesDiffs implements ChartsInstanceNotesDiffs {
  const _ChartsInstanceNotesDiffs(
      ...
      : _normal = normal,
        ...
        _renote = renote,
        _withFile = withFile;
  factory _ChartsInstanceNotesDiffs.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChartsInstanceNotesDiffsCopyWith<_ChartsInstanceNotesDiffs> get copyWith =>
      __$ChartsInstanceNotesDiffsCopyWithImpl<_ChartsInstanceNotesDiffs>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChartsInstanceNotesDiffsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChartsInstanceNotesDiffs &&
...
/// @nodoc
abstract mixin class _$ChartsInstanceNotesDiffsCopyWith<$Res>
    implements $ChartsInstanceNotesDiffsCopyWith<$Res> {
  factory _$ChartsInstanceNotesDiffsCopyWith(_ChartsInstanceNotesDiffs value,
          $Res Function(_ChartsInstanceNotesDiffs) _then) =
      __$ChartsInstanceNotesDiffsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<double> normal,
