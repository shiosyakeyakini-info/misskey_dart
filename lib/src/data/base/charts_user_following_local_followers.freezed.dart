...
$ChartsUserFollowingLocalFollowersCopyWith<ChartsUserFollowingLocalFollowers> get copyWith => _$ChartsUserFollowingLocalFollowersCopyWithImpl<ChartsUserFollowingLocalFollowers>(this as ChartsUserFollowingLocalFollowers, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsUserFollowingLocalFollowers&&const DeepCollectionEquality().equals(other.total, total)&&const DeepCollectionEquality().equals(other.inc, inc)&&const DeepCollectionEquality().equals(other.dec, dec));
}
...
abstract mixin class $ChartsUserFollowingLocalFollowersCopyWith<$Res>  {
  factory $ChartsUserFollowingLocalFollowersCopyWith(ChartsUserFollowingLocalFollowers value, $Res Function(ChartsUserFollowingLocalFollowers) _then) = _$ChartsUserFollowingLocalFollowersCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsUserFollowingLocalFollowers].
extension ChartsUserFollowingLocalFollowersPatterns on ChartsUserFollowingLocalFollowers {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsUserFollowingLocalFollowers value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsUserFollowingLocalFollowers() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsUserFollowingLocalFollowers value)  $default,){
final _that = this;
switch (_that) {
case _ChartsUserFollowingLocalFollowers():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsUserFollowingLocalFollowers value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsUserFollowingLocalFollowers() when $default != null:
return $default(_that);case _:
...
class _ChartsUserFollowingLocalFollowers implements ChartsUserFollowingLocalFollowers {
  const _ChartsUserFollowingLocalFollowers({required final  List<double> total, required final  List<double> inc, required final  List<double> dec}): _total = total,_inc = inc,_dec = dec;
  factory _ChartsUserFollowingLocalFollowers.fromJson(Map<String, dynamic> json) => _$ChartsUserFollowingLocalFollowersFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsUserFollowingLocalFollowersCopyWith<_ChartsUserFollowingLocalFollowers> get copyWith => __$ChartsUserFollowingLocalFollowersCopyWithImpl<_ChartsUserFollowingLocalFollowers>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsUserFollowingLocalFollowersToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsUserFollowingLocalFollowers&&const DeepCollectionEquality().equals(other._total, _total)&&const DeepCollectionEquality().equals(other._inc, _inc)&&const DeepCollectionEquality().equals(other._dec, _dec));
}
...
/// @nodoc
abstract mixin class _$ChartsUserFollowingLocalFollowersCopyWith<$Res> implements $ChartsUserFollowingLocalFollowersCopyWith<$Res> {
  factory _$ChartsUserFollowingLocalFollowersCopyWith(_ChartsUserFollowingLocalFollowers value, $Res Function(_ChartsUserFollowingLocalFollowers) _then) = __$ChartsUserFollowingLocalFollowersCopyWithImpl;
@override @useResult
$Res call({
 List<double> total, List<double> inc, List<double> dec
});
