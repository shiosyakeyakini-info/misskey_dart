...
mixin _$ChatRoomsMute {
  ...
  $ChatRoomsMuteCopyWith<ChatRoomsMute> get copyWith =>
      _$ChatRoomsMuteCopyWithImpl<ChatRoomsMute>(
          this as ChatRoomsMute, _$identity);
...
abstract mixin class $ChatRoomsMuteCopyWith<$Res> {
  factory $ChatRoomsMuteCopyWith(
          ChatRoomsMute value, $Res Function(ChatRoomsMute) _then) =
      _$ChatRoomsMuteCopyWithImpl;
  @useResult
...
class _ChatRoomsMute implements ChatRoomsMute {
  ...
  factory _ChatRoomsMute.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChatRoomsMuteCopyWith<_ChatRoomsMute> get copyWith =>
      __$ChatRoomsMuteCopyWithImpl<_ChatRoomsMute>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChatRoomsMuteToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ChatRoomsMuteCopyWith<$Res>
    implements $ChatRoomsMuteCopyWith<$Res> {
  factory _$ChatRoomsMuteCopyWith(
          _ChatRoomsMute value, $Res Function(_ChatRoomsMute) _then) =
      __$ChatRoomsMuteCopyWithImpl;
  @override
  @useResult
  $Res call({String roomId, bool mute});
}
