...
mixin _$GalleryPostsLike {
  ...
  $GalleryPostsLikeCopyWith<GalleryPostsLike> get copyWith =>
      _$GalleryPostsLikeCopyWithImpl<GalleryPostsLike>(
          this as GalleryPostsLike, _$identity);
...
abstract mixin class $GalleryPostsLikeCopyWith<$Res> {
  factory $GalleryPostsLikeCopyWith(
          GalleryPostsLike value, $Res Function(GalleryPostsLike) _then) =
      _$GalleryPostsLikeCopyWithImpl;
  @useResult
...
class _GalleryPostsLike implements GalleryPostsLike {
  ...
  factory _GalleryPostsLike.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GalleryPostsLikeCopyWith<_GalleryPostsLike> get copyWith =>
      __$GalleryPostsLikeCopyWithImpl<_GalleryPostsLike>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GalleryPostsLikeToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$GalleryPostsLikeCopyWith<$Res>
    implements $GalleryPostsLikeCopyWith<$Res> {
  factory _$GalleryPostsLikeCopyWith(
          _GalleryPostsLike value, $Res Function(_GalleryPostsLike) _then) =
      __$GalleryPostsLikeCopyWithImpl;
  @override
  @useResult
  $Res call({String postId});
}
