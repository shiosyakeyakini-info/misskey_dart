...
mixin _$NotesReactionsDelete {
  ...
  $NotesReactionsDeleteCopyWith<NotesReactionsDelete> get copyWith =>
      _$NotesReactionsDeleteCopyWithImpl<NotesReactionsDelete>(
          this as NotesReactionsDelete, _$identity);
...
abstract mixin class $NotesReactionsDeleteCopyWith<$Res> {
  factory $NotesReactionsDeleteCopyWith(NotesReactionsDelete value,
          $Res Function(NotesReactionsDelete) _then) =
      _$NotesReactionsDeleteCopyWithImpl;
  @useResult
...
class _NotesReactionsDelete implements NotesReactionsDelete {
  ...
  factory _NotesReactionsDelete.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotesReactionsDeleteCopyWith<_NotesReactionsDelete> get copyWith =>
      __$NotesReactionsDeleteCopyWithImpl<_NotesReactionsDelete>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotesReactionsDeleteToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotesReactionsDelete &&
            (identical(other.noteId, noteId) || other.noteId == noteId));
  }
...
/// @nodoc
abstract mixin class _$NotesReactionsDeleteCopyWith<$Res>
    implements $NotesReactionsDeleteCopyWith<$Res> {
  factory _$NotesReactionsDeleteCopyWith(_NotesReactionsDelete value,
          $Res Function(_NotesReactionsDelete) _then) =
      __$NotesReactionsDeleteCopyWithImpl;
  @override
  @useResult
  $Res call({String noteId});
}
