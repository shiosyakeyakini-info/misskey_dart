...
mixin _$IWebhooksUpdate {
  ...
  $IWebhooksUpdateCopyWith<IWebhooksUpdate> get copyWith =>
      _$IWebhooksUpdateCopyWithImpl<IWebhooksUpdate>(
          this as IWebhooksUpdate, _$identity);
...
abstract mixin class $IWebhooksUpdateCopyWith<$Res> {
  factory $IWebhooksUpdateCopyWith(
          IWebhooksUpdate value, $Res Function(IWebhooksUpdate) _then) =
      _$IWebhooksUpdateCopyWithImpl;
  @useResult
  $Res call(
      {String webhookId,
      String? name,
...
class _IWebhooksUpdate implements IWebhooksUpdate {
  const _IWebhooksUpdate(
      ...
      this.active})
      : _on_ = on_;
  factory _IWebhooksUpdate.fromJson(Map<String, dynamic> json) =>
      _$IWebhooksUpdateFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IWebhooksUpdateCopyWith<_IWebhooksUpdate> get copyWith =>
      __$IWebhooksUpdateCopyWithImpl<_IWebhooksUpdate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IWebhooksUpdateToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$IWebhooksUpdateCopyWith<$Res>
    implements $IWebhooksUpdateCopyWith<$Res> {
  factory _$IWebhooksUpdateCopyWith(
          _IWebhooksUpdate value, $Res Function(_IWebhooksUpdate) _then) =
      __$IWebhooksUpdateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String webhookId,
