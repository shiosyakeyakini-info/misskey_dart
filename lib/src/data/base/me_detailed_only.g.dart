...
_MeDetailedOnly _$MeDetailedOnlyFromJson(Map<String, dynamic> json) =>
    _MeDetailedOnly(
      ...
      twoFactorBackupCodesStock: $enumDecode(_$TwoFactorBackupCodesStockEnumMap,
      ...
      unreadNotificationsCount:
          (json['unreadNotificationsCount'] as num).toDouble(),
      ...
      securityKeysList: (json['securityKeysList'] as List<dynamic>?)
          ?.map((e) => MeDetailedOnlySecurityKeysListItem.fromJson(
              e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$MeDetailedOnlyToJson(_MeDetailedOnly instance) =>
    <String, dynamic>{
      ...
      'securityKeysList':
          instance.securityKeysList?.map((e) => e.toJson()).toList(),
    };
