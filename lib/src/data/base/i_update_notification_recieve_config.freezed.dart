...
/// @nodoc
mixin _$IUpdateNotificationRecieveConfig {
  dynamic? get note;
  dynamic? get follow;
  dynamic? get mention;
  dynamic? get reply;
  ...
  /// Create a copy of IUpdateNotificationRecieveConfig
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $IUpdateNotificationRecieveConfigCopyWith<IUpdateNotificationRecieveConfig>
      get copyWith => _$IUpdateNotificationRecieveConfigCopyWithImpl<
              IUpdateNotificationRecieveConfig>(
          this as IUpdateNotificationRecieveConfig, _$identity);

  /// Serializes this IUpdateNotificationRecieveConfig to a JSON map.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IUpdateNotificationRecieveConfig &&
...
/// @nodoc
class _$IUpdateNotificationRecieveConfigCopyWithImpl<$Res>
    implements $IUpdateNotificationRecieveConfigCopyWith<$Res> {
  _$IUpdateNotificationRecieveConfigCopyWithImpl(this._self, this._then);

  final IUpdateNotificationRecieveConfig _self;
  final $Res Function(IUpdateNotificationRecieveConfig) _then;
...
/// @nodoc
@JsonSerializable()
class _IUpdateNotificationRecieveConfig
    implements IUpdateNotificationRecieveConfig {
  const _IUpdateNotificationRecieveConfig(
      {this.note,
      this.follow,
      this.mention,
      this.reply,
      ...
      this.app,
      this.test});
  factory _IUpdateNotificationRecieveConfig.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IUpdateNotificationRecieveConfigCopyWith<_IUpdateNotificationRecieveConfig>
      get copyWith => __$IUpdateNotificationRecieveConfigCopyWithImpl<
          _IUpdateNotificationRecieveConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IUpdateNotificationRecieveConfigToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IUpdateNotificationRecieveConfig &&
            const DeepCollectionEquality().equals(other.note, note) &&
            const DeepCollectionEquality().equals(other.follow, follow) &&
            const DeepCollectionEquality().equals(other.mention, mention) &&
            const DeepCollectionEquality().equals(other.reply, reply) &&
...
/// @nodoc
abstract mixin class _$IUpdateNotificationRecieveConfigCopyWith<$Res>
    implements $IUpdateNotificationRecieveConfigCopyWith<$Res> {
  factory _$IUpdateNotificationRecieveConfigCopyWith(
          _IUpdateNotificationRecieveConfig value,
          $Res Function(_IUpdateNotificationRecieveConfig) _then) =
      __$IUpdateNotificationRecieveConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {dynamic? note,
...
/// @nodoc
class __$IUpdateNotificationRecieveConfigCopyWithImpl<$Res>
    implements _$IUpdateNotificationRecieveConfigCopyWith<$Res> {
  __$IUpdateNotificationRecieveConfigCopyWithImpl(this._self, this._then);

  final _IUpdateNotificationRecieveConfig _self;
  final $Res Function(_IUpdateNotificationRecieveConfig) _then;
  ...
  $Res call({
    ...
    return _then(_IUpdateNotificationRecieveConfig(
      note: freezed == note
          ? _self.note
          : note // ignore: cast_nullable_to_non_nullable
              as dynamic?,
