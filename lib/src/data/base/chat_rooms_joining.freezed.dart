...
$ChatRoomsJoiningCopyWith<ChatRoomsJoining> get copyWith => _$ChatRoomsJoiningCopyWithImpl<ChatRoomsJoining>(this as ChatRoomsJoining, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatRoomsJoining&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
abstract mixin class $ChatRoomsJoiningCopyWith<$Res>  {
  factory $ChatRoomsJoiningCopyWith(ChatRoomsJoining value, $Res Function(ChatRoomsJoining) _then) = _$ChatRoomsJoiningCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChatRoomsJoining].
extension ChatRoomsJoiningPatterns on ChatRoomsJoining {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChatRoomsJoining value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChatRoomsJoining() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChatRoomsJoining value)  $default,){
final _that = this;
switch (_that) {
case _ChatRoomsJoining():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChatRoomsJoining value)?  $default,){
final _that = this;
switch (_that) {
case _ChatRoomsJoining() when $default != null:
return $default(_that);case _:
...
class _ChatRoomsJoining implements ChatRoomsJoining {
  const _ChatRoomsJoining({this.limit = 30, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _ChatRoomsJoining.fromJson(Map<String, dynamic> json) => _$ChatRoomsJoiningFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChatRoomsJoiningCopyWith<_ChatRoomsJoining> get copyWith => __$ChatRoomsJoiningCopyWithImpl<_ChatRoomsJoining>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChatRoomsJoiningToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatRoomsJoining&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
/// @nodoc
abstract mixin class _$ChatRoomsJoiningCopyWith<$Res> implements $ChatRoomsJoiningCopyWith<$Res> {
  factory _$ChatRoomsJoiningCopyWith(_ChatRoomsJoining value, $Res Function(_ChatRoomsJoining) _then) = __$ChatRoomsJoiningCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
