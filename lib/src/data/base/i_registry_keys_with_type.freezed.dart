...
mixin _$IRegistryKeysWithType {
  ...
  $IRegistryKeysWithTypeCopyWith<IRegistryKeysWithType> get copyWith =>
      _$IRegistryKeysWithTypeCopyWithImpl<IRegistryKeysWithType>(
          this as IRegistryKeysWithType, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IRegistryKeysWithType &&
...
abstract mixin class $IRegistryKeysWithTypeCopyWith<$Res> {
  factory $IRegistryKeysWithTypeCopyWith(IRegistryKeysWithType value,
          $Res Function(IRegistryKeysWithType) _then) =
      _$IRegistryKeysWithTypeCopyWithImpl;
  @useResult
...
class _IRegistryKeysWithType implements IRegistryKeysWithType {
  const _IRegistryKeysWithType(
      {final List<String> scope = const [], this.domain})
      : _scope = scope;
  factory _IRegistryKeysWithType.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IRegistryKeysWithTypeCopyWith<_IRegistryKeysWithType> get copyWith =>
      __$IRegistryKeysWithTypeCopyWithImpl<_IRegistryKeysWithType>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IRegistryKeysWithTypeToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IRegistryKeysWithType &&
...
/// @nodoc
abstract mixin class _$IRegistryKeysWithTypeCopyWith<$Res>
    implements $IRegistryKeysWithTypeCopyWith<$Res> {
  factory _$IRegistryKeysWithTypeCopyWith(_IRegistryKeysWithType value,
          $Res Function(_IRegistryKeysWithType) _then) =
      __$IRegistryKeysWithTypeCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> scope, String? domain});
}
