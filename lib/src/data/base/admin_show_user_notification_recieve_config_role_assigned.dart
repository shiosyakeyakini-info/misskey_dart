...
abstract class AdminShowUserNotificationRecieveConfigRoleAssigned with _$AdminShowUserNotificationRecieveConfigRoleAssigned {
  ...
  factory AdminShowUserNotificationRecieveConfigRoleAssigned.fromJson(Map<String, Object?> json) => _$AdminShowUserNotificationRecieveConfigRoleAssignedFromJson(json);
}
