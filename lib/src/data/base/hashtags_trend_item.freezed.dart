...
mixin _$HashtagsTrendItem {
  ...
  $HashtagsTrendItemCopyWith<HashtagsTrendItem> get copyWith =>
      _$HashtagsTrendItemCopyWithImpl<HashtagsTrendItem>(
          this as HashtagsTrendItem, _$identity);
...
abstract mixin class $HashtagsTrendItemCopyWith<$Res> {
  factory $HashtagsTrendItemCopyWith(
          HashtagsTrendItem value, $Res Function(HashtagsTrendItem) _then) =
      _$HashtagsTrendItemCopyWithImpl;
  @useResult
  $Res call({String tag, List<double> chart, int usersCount});
}
...
class _HashtagsTrendItem implements HashtagsTrendItem {
  const _HashtagsTrendItem(
      {required this.tag,
      required final List<double> chart,
      required this.usersCount})
      : _chart = chart;
  factory _HashtagsTrendItem.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$HashtagsTrendItemCopyWith<_HashtagsTrendItem> get copyWith =>
      __$HashtagsTrendItemCopyWithImpl<_HashtagsTrendItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$HashtagsTrendItemToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$HashtagsTrendItemCopyWith<$Res>
    implements $HashtagsTrendItemCopyWith<$Res> {
  factory _$HashtagsTrendItemCopyWith(
          _HashtagsTrendItem value, $Res Function(_HashtagsTrendItem) _then) =
      __$HashtagsTrendItemCopyWithImpl;
  @override
  @useResult
  $Res call({String tag, List<double> chart, int usersCount});
}
