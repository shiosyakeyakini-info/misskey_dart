...
@freezed
abstract class I2faRegisterKeyExcludeCredentialsItem with _$I2faRegisterKeyExcludeCredentialsItem {
  ...
  factory I2faRegisterKeyExcludeCredentialsItem.fromJson(Map<String, Object?> json) => _$I2faRegisterKeyExcludeCredentialsItemFromJson(json);
}
