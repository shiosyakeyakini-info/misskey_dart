...
mixin _$IUpdateNotificationRecieveConfigRoleAssigned {
  ...
  $IUpdateNotificationRecieveConfigRoleAssignedCopyWith<
          IUpdateNotificationRecieveConfigRoleAssigned>
      get copyWith =>
          _$IUpdateNotificationRecieveConfigRoleAssignedCopyWithImpl<
                  IUpdateNotificationRecieveConfigRoleAssigned>(
              this as IUpdateNotificationRecieveConfigRoleAssigned, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IUpdateNotificationRecieveConfigRoleAssigned &&
...
/// @nodoc
abstract mixin class $IUpdateNotificationRecieveConfigRoleAssignedCopyWith<
    $Res> {
  factory $IUpdateNotificationRecieveConfigRoleAssignedCopyWith(
          IUpdateNotificationRecieveConfigRoleAssigned value,
          $Res Function(IUpdateNotificationRecieveConfigRoleAssigned) _then) =
      _$IUpdateNotificationRecieveConfigRoleAssignedCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(
    ...
    return _then(_self.copyWith(
      type: null == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as IUpdateNotificationRecieveConfigRoleAssignedType,
...
class _IUpdateNotificationRecieveConfigRoleAssigned
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IUpdateNotificationRecieveConfigRoleAssignedCopyWith<
          _IUpdateNotificationRecieveConfigRoleAssigned>
      get copyWith =>
          __$IUpdateNotificationRecieveConfigRoleAssignedCopyWithImpl<
              _IUpdateNotificationRecieveConfigRoleAssigned>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IUpdateNotificationRecieveConfigRoleAssignedToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IUpdateNotificationRecieveConfigRoleAssigned &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.userListId, userListId) ||
                other.userListId == userListId));
  }
...
/// @nodoc
abstract mixin class _$IUpdateNotificationRecieveConfigRoleAssignedCopyWith<
        $Res>
    implements $IUpdateNotificationRecieveConfigRoleAssignedCopyWith<$Res> {
  factory _$IUpdateNotificationRecieveConfigRoleAssignedCopyWith(
          _IUpdateNotificationRecieveConfigRoleAssigned value,
          $Res Function(_IUpdateNotificationRecieveConfigRoleAssigned) _then) =
      __$IUpdateNotificationRecieveConfigRoleAssignedCopyWithImpl;
  @override
  @useResult
  $Res call(
