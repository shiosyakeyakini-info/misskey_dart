...
$ChannelsTimelineCopyWith<ChannelsTimeline> get copyWith => _$ChannelsTimelineCopyWithImpl<ChannelsTimeline>(this as ChannelsTimeline, _$identity);
...
abstract mixin class $ChannelsTimelineCopyWith<$Res>  {
  factory $ChannelsTimelineCopyWith(ChannelsTimeline value, $Res Function(ChannelsTimeline) _then) = _$ChannelsTimelineCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChannelsTimeline].
extension ChannelsTimelinePatterns on ChannelsTimeline {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChannelsTimeline value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChannelsTimeline() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChannelsTimeline value)  $default,){
final _that = this;
switch (_that) {
case _ChannelsTimeline():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChannelsTimeline value)?  $default,){
final _that = this;
switch (_that) {
case _ChannelsTimeline() when $default != null:
return $default(_that);case _:
...
class _ChannelsTimeline implements ChannelsTimeline {
  const _ChannelsTimeline({required this.channelId, this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.allowPartial = false});
  factory _ChannelsTimeline.fromJson(Map<String, dynamic> json) => _$ChannelsTimelineFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChannelsTimelineCopyWith<_ChannelsTimeline> get copyWith => __$ChannelsTimelineCopyWithImpl<_ChannelsTimeline>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChannelsTimelineToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChannelsTimeline&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.allowPartial, allowPartial) || other.allowPartial == allowPartial));
}
...
/// @nodoc
abstract mixin class _$ChannelsTimelineCopyWith<$Res> implements $ChannelsTimelineCopyWith<$Res> {
  factory _$ChannelsTimelineCopyWith(_ChannelsTimeline value, $Res Function(_ChannelsTimeline) _then) = __$ChannelsTimelineCopyWithImpl;
@override @useResult
$Res call({
 String channelId, int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, bool? allowPartial
});
