...
$SwRegisterCopyWith<SwRegister> get copyWith => _$SwRegisterCopyWithImpl<SwRegister>(this as SwRegister, _$identity);
...
abstract mixin class $SwRegisterCopyWith<$Res>  {
  factory $SwRegisterCopyWith(SwRegister value, $Res Function(SwRegister) _then) = _$SwRegisterCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$SwRegisterCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [SwRegister].
extension SwRegisterPatterns on SwRegister {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SwRegister value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SwRegister() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SwRegister value)  $default,){
final _that = this;
switch (_that) {
case _SwRegister():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SwRegister value)?  $default,){
final _that = this;
switch (_that) {
case _SwRegister() when $default != null:
return $default(_that);case _:
...
class _SwRegister implements SwRegister {
  const _SwRegister({@JsonKey(unknownEnumValue: SwRegisterState.unknown) this.state, this.key, required this.userId, required this.endpoint, required this.sendReadMessage});
  factory _SwRegister.fromJson(Map<String, dynamic> json) => _$SwRegisterFromJson(json);
...
@pragma('vm:prefer-inline')
_$SwRegisterCopyWith<_SwRegister> get copyWith => __$SwRegisterCopyWithImpl<_SwRegister>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SwRegisterToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SwRegister&&(identical(other.state, state) || other.state == state)&&(identical(other.key, key) || other.key == key)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.endpoint, endpoint) || other.endpoint == endpoint)&&(identical(other.sendReadMessage, sendReadMessage) || other.sendReadMessage == sendReadMessage));
}
...
/// @nodoc
abstract mixin class _$SwRegisterCopyWith<$Res> implements $SwRegisterCopyWith<$Res> {
  factory _$SwRegisterCopyWith(_SwRegister value, $Res Function(_SwRegister) _then) = __$SwRegisterCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(unknownEnumValue: SwRegisterState.unknown) SwRegisterState? state, String? key, String userId, String endpoint, bool sendReadMessage
});
...
/// @nodoc
class __$SwRegisterCopyWithImpl<$Res>
    implements _$SwRegisterCopyWith<$Res> {
