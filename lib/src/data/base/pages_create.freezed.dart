...
$PagesCreateCopyWith<PagesCreate> get copyWith => _$PagesCreateCopyWithImpl<PagesCreate>(this as PagesCreate, _$identity);
...
abstract mixin class $PagesCreateCopyWith<$Res>  {
  factory $PagesCreateCopyWith(PagesCreate value, $Res Function(PagesCreate) _then) = _$PagesCreateCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PagesCreateCopyWithImpl<$Res>
...
as List<dynamic>,variables: null == variables ? _self.variables : variables // ignore: cast_nullable_to_non_nullable
as List<dynamic>,script: null == script ? _self.script : script // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [PagesCreate].
extension PagesCreatePatterns on PagesCreate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PagesCreate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PagesCreate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PagesCreate value)  $default,){
final _that = this;
switch (_that) {
case _PagesCreate():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PagesCreate value)?  $default,){
final _that = this;
switch (_that) {
case _PagesCreate() when $default != null:
return $default(_that);case _:
...
class _PagesCreate implements PagesCreate {
  const _PagesCreate({required this.title, required this.name, this.summary, required final  List<dynamic> content, required final  List<dynamic> variables, required this.script, this.eyeCatchingImageId, @JsonKey(unknownEnumValue: PagesCreateFont.unknown) this.font = PagesCreateFont.sansSerif, this.alignCenter = false, this.hideTitleWhenPinned = false}): _content = content,_variables = variables;
  factory _PagesCreate.fromJson(Map<String, dynamic> json) => _$PagesCreateFromJson(json);
...
@pragma('vm:prefer-inline')
_$PagesCreateCopyWith<_PagesCreate> get copyWith => __$PagesCreateCopyWithImpl<_PagesCreate>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PagesCreateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PagesCreate&&(identical(other.title, title) || other.title == title)&&(identical(other.name, name) || other.name == name)&&(identical(other.summary, summary) || other.summary == summary)&&const DeepCollectionEquality().equals(other._content, _content)&&const DeepCollectionEquality().equals(other._variables, _variables)&&(identical(other.script, script) || other.script == script)&&(identical(other.eyeCatchingImageId, eyeCatchingImageId) || other.eyeCatchingImageId == eyeCatchingImageId)&&(identical(other.font, font) || other.font == font)&&(identical(other.alignCenter, alignCenter) || other.alignCenter == alignCenter)&&(identical(other.hideTitleWhenPinned, hideTitleWhenPinned) || other.hideTitleWhenPinned == hideTitleWhenPinned));
}
...
/// @nodoc
abstract mixin class _$PagesCreateCopyWith<$Res> implements $PagesCreateCopyWith<$Res> {
  factory _$PagesCreateCopyWith(_PagesCreate value, $Res Function(_PagesCreate) _then) = __$PagesCreateCopyWithImpl;
@override @useResult
$Res call({
 String title, String name, String? summary, List<dynamic> content, List<dynamic> variables, String script, String? eyeCatchingImageId,@JsonKey(unknownEnumValue: PagesCreateFont.unknown) PagesCreateFont? font, bool? alignCenter, bool? hideTitleWhenPinned
});
...
/// @nodoc
class __$PagesCreateCopyWithImpl<$Res>
    implements _$PagesCreateCopyWith<$Res> {
...
as List<dynamic>,variables: null == variables ? _self._variables : variables // ignore: cast_nullable_to_non_nullable
as List<dynamic>,script: null == script ? _self.script : script // ignore: cast_nullable_to_non_nullable
as String,eyeCatchingImageId: freezed == eyeCatchingImageId ? _self.eyeCatchingImageId : eyeCatchingImageId // ignore: cast_nullable_to_non_nullable
as String?,font: freezed == font ? _self.font : font // ignore: cast_nullable_to_non_nullable
as PagesCreateFont?,alignCenter: freezed == alignCenter ? _self.alignCenter : alignCenter // ignore: cast_nullable_to_non_nullable
