...
mixin _$Clip {
 ...
 String get id;@DateTimeConverter() DateTime get createdAt;@NullableDateTimeConverter() DateTime? get lastClippedAt; String get userId; UserLite get user; String get name; String? get description; bool get isPublic; double get favoritedCount; bool? get isFavorited; int? get notesCount;
...
@useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? lastClippedAt, String userId, UserLite user, String name, String? description, bool isPublic, double favoritedCount, bool? isFavorited, int? notesCount
});
...
/// Create a copy of Clip
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? lastClippedAt = freezed,Object? userId = null,Object? user = null,Object? name = null,Object? description = freezed,Object? isPublic = null,Object? favoritedCount = null,Object? isFavorited = freezed,Object? notesCount = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @DateTimeConverter()  DateTime createdAt, @NullableDateTimeConverter()  DateTime? lastClippedAt,  String userId,  UserLite user,  String name,  String? description,  bool isPublic,  double favoritedCount,  bool? isFavorited,  int? notesCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Clip() when $default != null:
return $default(_that.id,_that.createdAt,_that.lastClippedAt,_that.userId,_that.user,_that.name,_that.description,_that.isPublic,_that.favoritedCount,_that.isFavorited,_that.notesCount);case _:
  return orElse();
...
class _Clip implements Clip {
  const _Clip({required this.id, @DateTimeConverter() required this.createdAt, @NullableDateTimeConverter() this.lastClippedAt, required this.userId, required this.user, required this.name, this.description, required this.isPublic, required this.favoritedCount, this.isFavorited, this.notesCount});
  factory _Clip.fromJson(Map<String, dynamic> json) => _$ClipFromJson(json);

@override final  String id;
@override@DateTimeConverter() final  DateTime createdAt;
@override@NullableDateTimeConverter() final  DateTime? lastClippedAt;
@override final  String userId;
@override final  UserLite user;
@override final  String name;
@override final  String? description;
@override final  bool isPublic;
@override final  double favoritedCount;
...
/// Create a copy of Clip
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? lastClippedAt = freezed,Object? userId = null,Object? user = null,Object? name = null,Object? description = freezed,Object? isPublic = null,Object? favoritedCount = null,Object? isFavorited = freezed,Object? notesCount = freezed,}) {
  return _then(_Clip(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,lastClippedAt: freezed == lastClippedAt ? _self.lastClippedAt : lastClippedAt // ignore: cast_nullable_to_non_nullable
