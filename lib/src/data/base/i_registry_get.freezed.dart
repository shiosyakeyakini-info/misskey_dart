...
mixin _$IRegistryGet {
  ...
  $IRegistryGetCopyWith<IRegistryGet> get copyWith =>
      _$IRegistryGetCopyWithImpl<IRegistryGet>(
          this as IRegistryGet, _$identity);
...
abstract mixin class $IRegistryGetCopyWith<$Res> {
  factory $IRegistryGetCopyWith(
          IRegistryGet value, $Res Function(IRegistryGet) _then) =
      _$IRegistryGetCopyWithImpl;
  @useResult
  $Res call({String key, List<String> scope, String? domain});
}

/// @nodoc
class _$IRegistryGetCopyWithImpl<$Res> implements $IRegistryGetCopyWith<$Res> {
...
class _IRegistryGet implements IRegistryGet {
  const _IRegistryGet(
      ...
      : _scope = scope;
  factory _IRegistryGet.fromJson(Map<String, dynamic> json) =>
      _$IRegistryGetFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IRegistryGetCopyWith<_IRegistryGet> get copyWith =>
      __$IRegistryGetCopyWithImpl<_IRegistryGet>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IRegistryGetToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$IRegistryGetCopyWith<$Res>
    implements $IRegistryGetCopyWith<$Res> {
  factory _$IRegistryGetCopyWith(
          _IRegistryGet value, $Res Function(_IRegistryGet) _then) =
      __$IRegistryGetCopyWithImpl;
  @override
  @useResult
  $Res call({String key, List<String> scope, String? domain});
}
