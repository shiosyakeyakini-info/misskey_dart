...
mixin _$FetchRssResponse {
  ...
  $FetchRssResponseCopyWith<FetchRssResponse> get copyWith =>
      _$FetchRssResponseCopyWithImpl<FetchRssResponse>(
          this as FetchRssResponse, _$identity);
...
abstract mixin class $FetchRssResponseCopyWith<$Res> {
  factory $FetchRssResponseCopyWith(
          FetchRssResponse value, $Res Function(FetchRssResponse) _then) =
      _$FetchRssResponseCopyWithImpl;
  @useResult
  $Res call(
      {FetchRssImage? image,
...
class _FetchRssResponse implements FetchRssResponse {
  const _FetchRssResponse(
      ...
      this.itunes})
      : _items = items;
  factory _FetchRssResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FetchRssResponseCopyWith<_FetchRssResponse> get copyWith =>
      __$FetchRssResponseCopyWithImpl<_FetchRssResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FetchRssResponseToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$FetchRssResponseCopyWith<$Res>
    implements $FetchRssResponseCopyWith<$Res> {
  factory _$FetchRssResponseCopyWith(
          _FetchRssResponse value, $Res Function(_FetchRssResponse) _then) =
      __$FetchRssResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {FetchRssImage? image,
