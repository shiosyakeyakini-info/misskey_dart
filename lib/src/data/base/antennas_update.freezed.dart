...
mixin _$AntennasUpdate {
  ...
  $AntennasUpdateCopyWith<AntennasUpdate> get copyWith =>
      _$AntennasUpdateCopyWithImpl<AntennasUpdate>(
          this as AntennasUpdate, _$identity);
...
abstract mixin class $AntennasUpdateCopyWith<$Res> {
  factory $AntennasUpdateCopyWith(
          AntennasUpdate value, $Res Function(AntennasUpdate) _then) =
      _$AntennasUpdateCopyWithImpl;
  @useResult
  $Res call(
      {String antennaId,
      String? name,
...
class _AntennasUpdate implements AntennasUpdate {
  const _AntennasUpdate(
      ...
      : _keywords = keywords,
        ...
        _users = users;
  factory _AntennasUpdate.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AntennasUpdateCopyWith<_AntennasUpdate> get copyWith =>
      __$AntennasUpdateCopyWithImpl<_AntennasUpdate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AntennasUpdateToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AntennasUpdateCopyWith<$Res>
    implements $AntennasUpdateCopyWith<$Res> {
  factory _$AntennasUpdateCopyWith(
          _AntennasUpdate value, $Res Function(_AntennasUpdate) _then) =
      __$AntennasUpdateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String antennaId,
