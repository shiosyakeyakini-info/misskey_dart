...
$FetchRssCopyWith<FetchRss> get copyWith => _$FetchRssCopyWithImpl<FetchRss>(this as FetchRss, _$identity);
...
abstract mixin class $FetchRssCopyWith<$Res>  {
  factory $FetchRssCopyWith(FetchRss value, $Res Function(FetchRss) _then) = _$FetchRssCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$FetchRssCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [FetchRss].
extension FetchRssPatterns on FetchRss {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FetchRss value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FetchRss() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FetchRss value)  $default,){
final _that = this;
switch (_that) {
case _FetchRss():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FetchRss value)?  $default,){
final _that = this;
switch (_that) {
case _FetchRss() when $default != null:
return $default(_that);case _:
...
class _FetchRss implements FetchRss {
  const _FetchRss({this.image, this.paginationLinks, this.link, this.title, required final  List<FetchRssItem> items, this.feedUrl, this.description, this.itunes}): _items = items;
  factory _FetchRss.fromJson(Map<String, dynamic> json) => _$FetchRssFromJson(json);
...
@pragma('vm:prefer-inline')
_$FetchRssCopyWith<_FetchRss> get copyWith => __$FetchRssCopyWithImpl<_FetchRss>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FetchRssToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FetchRss&&(identical(other.image, image) || other.image == image)&&(identical(other.paginationLinks, paginationLinks) || other.paginationLinks == paginationLinks)&&(identical(other.link, link) || other.link == link)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.feedUrl, feedUrl) || other.feedUrl == feedUrl)&&(identical(other.description, description) || other.description == description)&&(identical(other.itunes, itunes) || other.itunes == itunes));
}
...
/// @nodoc
abstract mixin class _$FetchRssCopyWith<$Res> implements $FetchRssCopyWith<$Res> {
  factory _$FetchRssCopyWith(_FetchRss value, $Res Function(_FetchRss) _then) = __$FetchRssCopyWithImpl;
@override @useResult
$Res call({
 FetchRssImage? image, FetchRssPaginationLinks? paginationLinks, String? link, String? title, List<FetchRssItem> items, String? feedUrl, String? description, FetchRssItunes? itunes
});
...
/// @nodoc
class __$FetchRssCopyWithImpl<$Res>
    implements _$FetchRssCopyWith<$Res> {
