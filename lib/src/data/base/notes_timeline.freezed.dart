...
mixin _$NotesTimeline {
  ...
  $NotesTimelineCopyWith<NotesTimeline> get copyWith =>
      _$NotesTimelineCopyWithImpl<NotesTimeline>(
          this as NotesTimeline, _$identity);
...
abstract mixin class $NotesTimelineCopyWith<$Res> {
  factory $NotesTimelineCopyWith(
          NotesTimeline value, $Res Function(NotesTimeline) _then) =
      _$NotesTimelineCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _NotesTimeline implements NotesTimeline {
  ...
  factory _NotesTimeline.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotesTimelineCopyWith<_NotesTimeline> get copyWith =>
      __$NotesTimelineCopyWithImpl<_NotesTimeline>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotesTimelineToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$NotesTimelineCopyWith<$Res>
    implements $NotesTimelineCopyWith<$Res> {
  factory _$NotesTimelineCopyWith(
          _NotesTimeline value, $Res Function(_NotesTimeline) _then) =
      __$NotesTimelineCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
