...
$ChartsUsersRemoteCopyWith<ChartsUsersRemote> get copyWith => _$ChartsUsersRemoteCopyWithImpl<ChartsUsersRemote>(this as ChartsUsersRemote, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsUsersRemote&&const DeepCollectionEquality().equals(other.total, total)&&const DeepCollectionEquality().equals(other.inc, inc)&&const DeepCollectionEquality().equals(other.dec, dec));
}
...
abstract mixin class $ChartsUsersRemoteCopyWith<$Res>  {
  factory $ChartsUsersRemoteCopyWith(ChartsUsersRemote value, $Res Function(ChartsUsersRemote) _then) = _$ChartsUsersRemoteCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsUsersRemote].
extension ChartsUsersRemotePatterns on ChartsUsersRemote {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsUsersRemote value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsUsersRemote() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsUsersRemote value)  $default,){
final _that = this;
switch (_that) {
case _ChartsUsersRemote():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsUsersRemote value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsUsersRemote() when $default != null:
return $default(_that);case _:
...
class _ChartsUsersRemote implements ChartsUsersRemote {
  const _ChartsUsersRemote({required final  List<double> total, required final  List<double> inc, required final  List<double> dec}): _total = total,_inc = inc,_dec = dec;
  factory _ChartsUsersRemote.fromJson(Map<String, dynamic> json) => _$ChartsUsersRemoteFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsUsersRemoteCopyWith<_ChartsUsersRemote> get copyWith => __$ChartsUsersRemoteCopyWithImpl<_ChartsUsersRemote>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsUsersRemoteToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsUsersRemote&&const DeepCollectionEquality().equals(other._total, _total)&&const DeepCollectionEquality().equals(other._inc, _inc)&&const DeepCollectionEquality().equals(other._dec, _dec));
}
...
/// @nodoc
abstract mixin class _$ChartsUsersRemoteCopyWith<$Res> implements $ChartsUsersRemoteCopyWith<$Res> {
  factory _$ChartsUsersRemoteCopyWith(_ChartsUsersRemote value, $Res Function(_ChartsUsersRemote) _then) = __$ChartsUsersRemoteCopyWithImpl;
@override @useResult
$Res call({
 List<double> total, List<double> inc, List<double> dec
});
