...
@freezed
abstract class IUpdateNotificationRecieveConfigReply
    with _$IUpdateNotificationRecieveConfigReply {
  ...
  factory IUpdateNotificationRecieveConfigReply.fromJson(
