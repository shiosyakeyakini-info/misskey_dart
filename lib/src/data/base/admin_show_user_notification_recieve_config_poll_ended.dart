...
@freezed
abstract class AdminShowUserNotificationRecieveConfigPollEnded
    with _$AdminShowUserNotificationRecieveConfigPollEnded {
  ...
  factory AdminShowUserNotificationRecieveConfigPollEnded.fromJson(
