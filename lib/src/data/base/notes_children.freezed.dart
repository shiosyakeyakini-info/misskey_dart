...
mixin _$NotesChildren {
  ...
  $NotesChildrenCopyWith<NotesChildren> get copyWith =>
      _$NotesChildrenCopyWithImpl<NotesChildren>(
          this as NotesChildren, _$identity);
...
abstract mixin class $NotesChildrenCopyWith<$Res> {
  factory $NotesChildrenCopyWith(
          NotesChildren value, $Res Function(NotesChildren) _then) =
      _$NotesChildrenCopyWithImpl;
  @useResult
  $Res call(
      {String noteId,
      int? limit,
...
class _NotesChildren implements NotesChildren {
  const _NotesChildren(
      ...
      this.sinceDate,
      this.untilDate});
  factory _NotesChildren.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotesChildrenCopyWith<_NotesChildren> get copyWith =>
      __$NotesChildrenCopyWithImpl<_NotesChildren>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotesChildrenToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$NotesChildrenCopyWith<$Res>
    implements $NotesChildrenCopyWith<$Res> {
  factory _$NotesChildrenCopyWith(
          _NotesChildren value, $Res Function(_NotesChildren) _then) =
      __$NotesChildrenCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String noteId,
