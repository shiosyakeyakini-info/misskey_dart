...
mixin _$Note {
 ...
 String get id;@DateTimeConverter() DateTime get createdAt;@NullableDateTimeConverter() DateTime? get deletedAt; String? get text; String? get cw; String get userId; UserLite get user; String? get replyId; String? get renoteId; Map<String, dynamic>? get reply; Map<String, dynamic>? get renote; bool? get isHidden;@JsonKey(unknownEnumValue: NoteVisibility.unknown) NoteVisibility get visibility; List<String>? get mentions; List<String>? get visibleUserIds; List<String>? get fileIds; List<DriveFile>? get files; List<String>? get tags; NotePoll? get poll;@EmojisConverter() Map<String, String> get emojis; String? get channelId; NoteChannelInfo? get channel; bool? get localOnly;@JsonKey(unknownEnumValue: ReactionAcceptance.unknown) ReactionAcceptance? get reactionAcceptance;@EmojisConverter() Map<String, String> get reactionEmojis; Map<String, dynamic> get reactions; int get reactionCount; int get renoteCount; int get repliesCount; String? get uri; String? get url; List<String>? get reactionAndUserPairCache; int? get clippedCount; String? get myReaction; bool? get hasPoll;
...
@useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? deletedAt, String? text, String? cw, String userId, UserLite user, String? replyId, String? renoteId, Map<String, dynamic>? reply, Map<String, dynamic>? renote, bool? isHidden,@JsonKey(unknownEnumValue: NoteVisibility.unknown) NoteVisibility visibility, List<String>? mentions, List<String>? visibleUserIds, List<String>? fileIds, List<DriveFile>? files, List<String>? tags, NotePoll? poll,@EmojisConverter() Map<String, String> emojis, String? channelId, NoteChannelInfo? channel, bool? localOnly,@JsonKey(unknownEnumValue: ReactionAcceptance.unknown) ReactionAcceptance? reactionAcceptance,@EmojisConverter() Map<String, String> reactionEmojis, Map<String, dynamic> reactions, int reactionCount, int renoteCount, int repliesCount, String? uri, String? url, List<String>? reactionAndUserPairCache, int? clippedCount, String? myReaction, bool? hasPoll
});


$UserLiteCopyWith<$Res> get user;$NotePollCopyWith<$Res>? get poll;$NoteChannelInfoCopyWith<$Res>? get channel;
...
as Map<String, dynamic>?,renote: freezed == renote ? _self.renote : renote // ignore: cast_nullable_to_non_nullable
...
as Map<String, dynamic>,reactionCount: null == reactionCount ? _self.reactionCount : reactionCount // ignore: cast_nullable_to_non_nullable
...
as String?,reactionAndUserPairCache: freezed == reactionAndUserPairCache ? _self.reactionAndUserPairCache : reactionAndUserPairCache // ignore: cast_nullable_to_non_nullable
...
class _Note implements Note {
  const _Note({required this.id, @DateTimeConverter() required this.createdAt, @NullableDateTimeConverter() this.deletedAt, this.text, this.cw, required this.userId, required this.user, this.replyId, this.renoteId, final  Map<String, dynamic>? reply, final  Map<String, dynamic>? renote, this.isHidden, @JsonKey(unknownEnumValue: NoteVisibility.unknown) required this.visibility, final  List<String>? mentions = const [], final  List<String>? visibleUserIds = const [], final  List<String>? fileIds, final  List<DriveFile>? files, final  List<String>? tags, this.poll, @EmojisConverter() final  Map<String, String> emojis = const {}, this.channelId, this.channel, this.localOnly, @JsonKey(unknownEnumValue: ReactionAcceptance.unknown) this.reactionAcceptance, @EmojisConverter() required final  Map<String, String> reactionEmojis, required final  Map<String, dynamic> reactions, required this.reactionCount, required this.renoteCount, required this.repliesCount, this.uri, this.url, final  List<String>? reactionAndUserPairCache = const [], this.clippedCount, this.myReaction, this.hasPoll}): _reply = reply,_renote = renote,_mentions = mentions,_visibleUserIds = visibleUserIds,_fileIds = fileIds,_files = files,_tags = tags,_emojis = emojis,_reactionEmojis = reactionEmojis,_reactions = reactions,_reactionAndUserPairCache = reactionAndUserPairCache;
...
@override Map<String, dynamic>? get reply {
  final value = _reply;
...
@override Map<String, dynamic>? get renote {
  final value = _renote;
  if (value == null) return null;
...
@override $UserLiteCopyWith<$Res> get user;@override $NotePollCopyWith<$Res>? get poll;@override $NoteChannelInfoCopyWith<$Res>? get channel;
...
as UserLite,replyId: freezed == replyId ? _self.replyId : replyId // ignore: cast_nullable_to_non_nullable
as String?,renoteId: freezed == renoteId ? _self.renoteId : renoteId // ignore: cast_nullable_to_non_nullable
as String?,reply: freezed == reply ? _self._reply : reply // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,renote: freezed == renote ? _self._renote : renote // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,isHidden: freezed == isHidden ? _self.isHidden : isHidden // ignore: cast_nullable_to_non_nullable
as bool?,visibility: null == visibility ? _self.visibility : visibility // ignore: cast_nullable_to_non_nullable
...
as int,uri: freezed == uri ? _self.uri : uri // ignore: cast_nullable_to_non_nullable
as String?,url: freezed == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String?,reactionAndUserPairCache: freezed == reactionAndUserPairCache ? _self._reactionAndUserPairCache : reactionAndUserPairCache // ignore: cast_nullable_to_non_nullable
as List<String>?,clippedCount: freezed == clippedCount ? _self.clippedCount : clippedCount // ignore: cast_nullable_to_non_nullable
as int?,myReaction: freezed == myReaction ? _self.myReaction : myReaction // ignore: cast_nullable_to_non_nullable
as String?,hasPoll: freezed == hasPoll ? _self.hasPoll : hasPoll // ignore: cast_nullable_to_non_nullable
as bool?,
