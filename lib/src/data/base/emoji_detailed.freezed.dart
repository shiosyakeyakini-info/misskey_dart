...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EmojiDetailed value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EmojiDetailed value)  $default,){
final _that = this;
switch (_that) {
case _EmojiDetailed():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EmojiDetailed value)?  $default,){
final _that = this;
switch (_that) {
case _EmojiDetailed() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$EmojiDetailedCopyWith<_EmojiDetailed> get copyWith => __$EmojiDetailedCopyWithImpl<_EmojiDetailed>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EmojiDetailedToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EmojiDetailed&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._aliases, _aliases)&&(identical(other.name, name) || other.name == name)&&(identical(other.category, category) || other.category == category)&&(identical(other.host, host) || other.host == host)&&(identical(other.url, url) || other.url == url)&&(identical(other.license, license) || other.license == license)&&(identical(other.isSensitive, isSensitive) || other.isSensitive == isSensitive)&&(identical(other.localOnly, localOnly) || other.localOnly == localOnly)&&const DeepCollectionEquality().equals(other._roleIdsThatCanBeUsedThisEmojiAsReaction, _roleIdsThatCanBeUsedThisEmojiAsReaction));
}
...
/// @nodoc
abstract mixin class _$EmojiDetailedCopyWith<$Res> implements $EmojiDetailedCopyWith<$Res> {
