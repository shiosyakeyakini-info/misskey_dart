...
mixin _$ChartsNotesRemoteDiffs {
  ...
  $ChartsNotesRemoteDiffsCopyWith<ChartsNotesRemoteDiffs> get copyWith =>
      _$ChartsNotesRemoteDiffsCopyWithImpl<ChartsNotesRemoteDiffs>(
          this as ChartsNotesRemoteDiffs, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChartsNotesRemoteDiffs &&
...
abstract mixin class $ChartsNotesRemoteDiffsCopyWith<$Res> {
  factory $ChartsNotesRemoteDiffsCopyWith(ChartsNotesRemoteDiffs value,
          $Res Function(ChartsNotesRemoteDiffs) _then) =
      _$ChartsNotesRemoteDiffsCopyWithImpl;
  @useResult
  $Res call(
      {List<double> normal,
      List<double> reply,
...
class _ChartsNotesRemoteDiffs implements ChartsNotesRemoteDiffs {
  const _ChartsNotesRemoteDiffs(
      ...
      : _normal = normal,
        ...
        _renote = renote,
        _withFile = withFile;
  factory _ChartsNotesRemoteDiffs.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChartsNotesRemoteDiffsCopyWith<_ChartsNotesRemoteDiffs> get copyWith =>
      __$ChartsNotesRemoteDiffsCopyWithImpl<_ChartsNotesRemoteDiffs>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChartsNotesRemoteDiffsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChartsNotesRemoteDiffs &&
...
/// @nodoc
abstract mixin class _$ChartsNotesRemoteDiffsCopyWith<$Res>
    implements $ChartsNotesRemoteDiffsCopyWith<$Res> {
  factory _$ChartsNotesRemoteDiffsCopyWith(_ChartsNotesRemoteDiffs value,
          $Res Function(_ChartsNotesRemoteDiffs) _then) =
      __$ChartsNotesRemoteDiffsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<double> normal,
