...
$ChartsInstanceCopyWith<ChartsInstance> get copyWith => _$ChartsInstanceCopyWithImpl<ChartsInstance>(this as ChartsInstance, _$identity);
...
abstract mixin class $ChartsInstanceCopyWith<$Res>  {
  factory $ChartsInstanceCopyWith(ChartsInstance value, $Res Function(ChartsInstance) _then) = _$ChartsInstanceCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsInstance].
extension ChartsInstancePatterns on ChartsInstance {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsInstance value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsInstance() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsInstance value)  $default,){
final _that = this;
switch (_that) {
case _ChartsInstance():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsInstance value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsInstance() when $default != null:
return $default(_that);case _:
...
class _ChartsInstance implements ChartsInstance {
  const _ChartsInstance({required this.requests, required this.notes, required this.users, required this.following, required this.followers, required this.drive});
  factory _ChartsInstance.fromJson(Map<String, dynamic> json) => _$ChartsInstanceFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsInstanceCopyWith<_ChartsInstance> get copyWith => __$ChartsInstanceCopyWithImpl<_ChartsInstance>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsInstanceToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsInstance&&(identical(other.requests, requests) || other.requests == requests)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.users, users) || other.users == users)&&(identical(other.following, following) || other.following == following)&&(identical(other.followers, followers) || other.followers == followers)&&(identical(other.drive, drive) || other.drive == drive));
}
...
/// @nodoc
abstract mixin class _$ChartsInstanceCopyWith<$Res> implements $ChartsInstanceCopyWith<$Res> {
  factory _$ChartsInstanceCopyWith(_ChartsInstance value, $Res Function(_ChartsInstance) _then) = __$ChartsInstanceCopyWithImpl;
@override @useResult
$Res call({
 ChartsInstanceRequests requests, ChartsInstanceNotes notes, ChartsInstanceUsers users, ChartsInstanceFollowing following, ChartsInstanceFollowers followers, ChartsInstanceDrive drive
});
