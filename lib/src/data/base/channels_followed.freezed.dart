...
$ChannelsFollowedCopyWith<ChannelsFollowed> get copyWith => _$ChannelsFollowedCopyWithImpl<ChannelsFollowed>(this as ChannelsFollowed, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChannelsFollowed&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.limit, limit) || other.limit == limit));
}
...
abstract mixin class $ChannelsFollowedCopyWith<$Res>  {
  factory $ChannelsFollowedCopyWith(ChannelsFollowed value, $Res Function(ChannelsFollowed) _then) = _$ChannelsFollowedCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChannelsFollowed].
extension ChannelsFollowedPatterns on ChannelsFollowed {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChannelsFollowed value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChannelsFollowed() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChannelsFollowed value)  $default,){
final _that = this;
switch (_that) {
case _ChannelsFollowed():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChannelsFollowed value)?  $default,){
final _that = this;
switch (_that) {
case _ChannelsFollowed() when $default != null:
return $default(_that);case _:
...
class _ChannelsFollowed implements ChannelsFollowed {
  const _ChannelsFollowed({this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.limit = 5});
  factory _ChannelsFollowed.fromJson(Map<String, dynamic> json) => _$ChannelsFollowedFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChannelsFollowedCopyWith<_ChannelsFollowed> get copyWith => __$ChannelsFollowedCopyWithImpl<_ChannelsFollowed>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChannelsFollowedToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChannelsFollowed&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.limit, limit) || other.limit == limit));
}
...
/// @nodoc
abstract mixin class _$ChannelsFollowedCopyWith<$Res> implements $ChannelsFollowedCopyWith<$Res> {
  factory _$ChannelsFollowedCopyWith(_ChannelsFollowed value, $Res Function(_ChannelsFollowed) _then) = __$ChannelsFollowedCopyWithImpl;
@override @useResult
$Res call({
 String? sinceId, String? untilId, int? sinceDate, int? untilDate, int? limit
});
