...
abstract class MeDetailedOnlyNotificationRecieveConfigRoleAssigned with _$MeDetailedOnlyNotificationRecieveConfigRoleAssigned {
  ...
  factory MeDetailedOnlyNotificationRecieveConfigRoleAssigned.fromJson(Map<String, Object?> json) => _$MeDetailedOnlyNotificationRecieveConfigRoleAssignedFromJson(json);
}
