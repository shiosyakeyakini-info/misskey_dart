...
@freezed
abstract class UsersGetFollowingUsersByBirthdayBirthdayBegin
    with _$UsersGetFollowingUsersByBirthdayBirthdayBegin {
  const factory UsersGetFollowingUsersByBirthdayBirthdayBegin({
    required int month,
    required int day,
  }) = _UsersGetFollowingUsersByBirthdayBirthdayBegin;

  factory UsersGetFollowingUsersByBirthdayBirthdayBegin.fromJson(
    Map<String, Object?> json,
  ) => _$UsersGetFollowingUsersByBirthdayBirthdayBeginFromJson(json);
}
