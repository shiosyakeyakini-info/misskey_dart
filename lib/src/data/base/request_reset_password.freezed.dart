...
mixin _$RequestResetPassword {
  ...
  $RequestResetPasswordCopyWith<RequestResetPassword> get copyWith =>
      _$RequestResetPasswordCopyWithImpl<RequestResetPassword>(
          this as RequestResetPassword, _$identity);
...
abstract mixin class $RequestResetPasswordCopyWith<$Res> {
  factory $RequestResetPasswordCopyWith(RequestResetPassword value,
          $Res Function(RequestResetPassword) _then) =
      _$RequestResetPasswordCopyWithImpl;
  @useResult
...
class _RequestResetPassword implements RequestResetPassword {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RequestResetPasswordCopyWith<_RequestResetPassword> get copyWith =>
      __$RequestResetPasswordCopyWithImpl<_RequestResetPassword>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RequestResetPasswordToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RequestResetPassword &&
            (identical(other.username, username) ||
                other.username == username) &&
            (identical(other.email, email) || other.email == email));
  }
...
/// @nodoc
abstract mixin class _$RequestResetPasswordCopyWith<$Res>
    implements $RequestResetPasswordCopyWith<$Res> {
  factory _$RequestResetPasswordCopyWith(_RequestResetPassword value,
          $Res Function(_RequestResetPassword) _then) =
      __$RequestResetPasswordCopyWithImpl;
  @override
  @useResult
  $Res call({String username, String email});
}
