...
@freezed
abstract class IUpdateNotificationRecieveConfigQuote
    with _$IUpdateNotificationRecieveConfigQuote {
  const factory IUpdateNotificationRecieveConfigQuote({
    @JsonKey(
        unknownEnumValue: IUpdateNotificationRecieveConfigQuoteType.unknown)
    required IUpdateNotificationRecieveConfigQuoteType type,
    required String userListId,
  }) = _IUpdateNotificationRecieveConfigQuote;

  factory IUpdateNotificationRecieveConfigQuote.fromJson(
