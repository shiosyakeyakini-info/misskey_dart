...
_$IUpdateNotificationRecieveConfigReplyFromJson(Map<String, dynamic> json) =>
    _IUpdateNotificationRecieveConfigReply(
      type: $enumDecode(
        _$IUpdateNotificationRecieveConfigReplyTypeEnumMap,
        json['type'],
...
Map<String, dynamic> _$IUpdateNotificationRecieveConfigReplyToJson(
  ...
  'type': _$IUpdateNotificationRecieveConfigReplyTypeEnumMap[instance.type]!,
