...
$AdminRolesUpdateCopyWith<AdminRolesUpdate> get copyWith => _$AdminRolesUpdateCopyWithImpl<AdminRolesUpdate>(this as AdminRolesUpdate, _$identity);
...
abstract mixin class $AdminRolesUpdateCopyWith<$Res>  {
  factory $AdminRolesUpdateCopyWith(AdminRolesUpdate value, $Res Function(AdminRolesUpdate) _then) = _$AdminRolesUpdateCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminRolesUpdate].
extension AdminRolesUpdatePatterns on AdminRolesUpdate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminRolesUpdate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminRolesUpdate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminRolesUpdate value)  $default,){
final _that = this;
switch (_that) {
case _AdminRolesUpdate():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminRolesUpdate value)?  $default,){
final _that = this;
switch (_that) {
case _AdminRolesUpdate() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$AdminRolesUpdateCopyWith<_AdminRolesUpdate> get copyWith => __$AdminRolesUpdateCopyWithImpl<_AdminRolesUpdate>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminRolesUpdateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminRolesUpdate&&(identical(other.roleId, roleId) || other.roleId == roleId)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.color, color) || other.color == color)&&(identical(other.iconUrl, iconUrl) || other.iconUrl == iconUrl)&&(identical(other.target, target) || other.target == target)&&const DeepCollectionEquality().equals(other._condFormula, _condFormula)&&(identical(other.isPublic, isPublic) || other.isPublic == isPublic)&&(identical(other.isModerator, isModerator) || other.isModerator == isModerator)&&(identical(other.isAdministrator, isAdministrator) || other.isAdministrator == isAdministrator)&&(identical(other.isExplorable, isExplorable) || other.isExplorable == isExplorable)&&(identical(other.asBadge, asBadge) || other.asBadge == asBadge)&&(identical(other.preserveAssignmentOnMoveAccount, preserveAssignmentOnMoveAccount) || other.preserveAssignmentOnMoveAccount == preserveAssignmentOnMoveAccount)&&(identical(other.canEditMembersByModerator, canEditMembersByModerator) || other.canEditMembersByModerator == canEditMembersByModerator)&&(identical(other.displayOrder, displayOrder) || other.displayOrder == displayOrder)&&const DeepCollectionEquality().equals(other._policies, _policies));
}
...
/// @nodoc
abstract mixin class _$AdminRolesUpdateCopyWith<$Res> implements $AdminRolesUpdateCopyWith<$Res> {
  factory _$AdminRolesUpdateCopyWith(_AdminRolesUpdate value, $Res Function(_AdminRolesUpdate) _then) = __$AdminRolesUpdateCopyWithImpl;
@override @useResult
$Res call({
 String roleId, String? name, String? description, String? color, String? iconUrl,@JsonKey(unknownEnumValue: AdminRolesUpdateTarget.unknown) AdminRolesUpdateTarget? target, Map<String, dynamic>? condFormula, bool? isPublic, bool? isModerator, bool? isAdministrator, bool? isExplorable, bool? asBadge, bool? preserveAssignmentOnMoveAccount, bool? canEditMembersByModerator, double? displayOrder, Map<String, dynamic>? policies
});
...
/// Create a copy of AdminRolesUpdate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? roleId = null,Object? name = freezed,Object? description = freezed,Object? color = freezed,Object? iconUrl = freezed,Object? target = freezed,Object? condFormula = freezed,Object? isPublic = freezed,Object? isModerator = freezed,Object? isAdministrator = freezed,Object? isExplorable = freezed,Object? asBadge = freezed,Object? preserveAssignmentOnMoveAccount = freezed,Object? canEditMembersByModerator = freezed,Object? displayOrder = freezed,Object? policies = freezed,}) {
