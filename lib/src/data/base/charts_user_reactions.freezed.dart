...
$ChartsUserReactionsCopyWith<ChartsUserReactions> get copyWith => _$ChartsUserReactionsCopyWithImpl<ChartsUserReactions>(this as ChartsUserReactions, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChartsUserReactions&&(identical(other.local, local) || other.local == local)&&(identical(other.remote, remote) || other.remote == remote));
}
...
abstract mixin class $ChartsUserReactionsCopyWith<$Res>  {
  factory $ChartsUserReactionsCopyWith(ChartsUserReactions value, $Res Function(ChartsUserReactions) _then) = _$ChartsUserReactionsCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChartsUserReactions].
extension ChartsUserReactionsPatterns on ChartsUserReactions {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChartsUserReactions value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChartsUserReactions() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChartsUserReactions value)  $default,){
final _that = this;
switch (_that) {
case _ChartsUserReactions():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChartsUserReactions value)?  $default,){
final _that = this;
switch (_that) {
case _ChartsUserReactions() when $default != null:
return $default(_that);case _:
...
class _ChartsUserReactions implements ChartsUserReactions {
  ...
  factory _ChartsUserReactions.fromJson(Map<String, dynamic> json) => _$ChartsUserReactionsFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChartsUserReactionsCopyWith<_ChartsUserReactions> get copyWith => __$ChartsUserReactionsCopyWithImpl<_ChartsUserReactions>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChartsUserReactionsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChartsUserReactions&&(identical(other.local, local) || other.local == local)&&(identical(other.remote, remote) || other.remote == remote));
}
...
/// @nodoc
abstract mixin class _$ChartsUserReactionsCopyWith<$Res> implements $ChartsUserReactionsCopyWith<$Res> {
  factory _$ChartsUserReactionsCopyWith(_ChartsUserReactions value, $Res Function(_ChartsUserReactions) _then) = __$ChartsUserReactionsCopyWithImpl;
@override @useResult
$Res call({
 ChartsUserReactionsLocal local, ChartsUserReactionsRemote remote
});
