...
mixin _$IUpdateNotificationRecieveConfigScheduledNotePosted {
  ...
  $IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith<
          IUpdateNotificationRecieveConfigScheduledNotePosted>
      get copyWith =>
          _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl<
                  IUpdateNotificationRecieveConfigScheduledNotePosted>(
              this as IUpdateNotificationRecieveConfigScheduledNotePosted,
              _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IUpdateNotificationRecieveConfigScheduledNotePosted &&
...
/// @nodoc
abstract mixin class $IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith<
    $Res> {
  factory $IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith(
          IUpdateNotificationRecieveConfigScheduledNotePosted value,
          $Res Function(IUpdateNotificationRecieveConfigScheduledNotePosted)
              _then) =
      _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl;
  @useResult
  $Res call(
...
class _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl<$Res>
    implements
        $IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith<$Res> {
  _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl(
      this._self, this._then);

  final IUpdateNotificationRecieveConfigScheduledNotePosted _self;
  final $Res Function(IUpdateNotificationRecieveConfigScheduledNotePosted)
      _then;
    ...
    return _then(_self.copyWith(
      type: null == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as IUpdateNotificationRecieveConfigScheduledNotePostedType,
...
class _IUpdateNotificationRecieveConfigScheduledNotePosted
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith<
          _IUpdateNotificationRecieveConfigScheduledNotePosted>
      get copyWith =>
          __$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl<
                  _IUpdateNotificationRecieveConfigScheduledNotePosted>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IUpdateNotificationRecieveConfigScheduledNotePostedToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IUpdateNotificationRecieveConfigScheduledNotePosted &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.userListId, userListId) ||
                other.userListId == userListId));
  }
...
/// @nodoc
abstract mixin class _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith<
        $Res>
    implements
        $IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith<$Res> {
  factory _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith(
          _IUpdateNotificationRecieveConfigScheduledNotePosted value,
          $Res Function(_IUpdateNotificationRecieveConfigScheduledNotePosted)
              _then) =
      __$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl;
  @override
  @useResult
...
class __$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl<$Res>
    implements
        _$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWith<$Res> {
  __$IUpdateNotificationRecieveConfigScheduledNotePostedCopyWithImpl(
      this._self, this._then);

  final _IUpdateNotificationRecieveConfigScheduledNotePosted _self;
  final $Res Function(_IUpdateNotificationRecieveConfigScheduledNotePosted)
      _then;
