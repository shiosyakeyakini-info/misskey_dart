...
$AdminRolesCreateCopyWith<AdminRolesCreate> get copyWith => _$AdminRolesCreateCopyWithImpl<AdminRolesCreate>(this as AdminRolesCreate, _$identity);
...
abstract mixin class $AdminRolesCreateCopyWith<$Res>  {
  factory $AdminRolesCreateCopyWith(AdminRolesCreate value, $Res Function(AdminRolesCreate) _then) = _$AdminRolesCreateCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of AdminRolesCreate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = null,Object? color = freezed,Object? iconUrl = freezed,Object? target = null,Object? condFormula = null,Object? isPublic = null,Object? isModerator = null,Object? isAdministrator = null,Object? isExplorable = freezed,Object? asBadge = null,Object? preserveAssignmentOnMoveAccount = freezed,Object? canEditMembersByModerator = null,Object? displayOrder = null,Object? policies = null,}) {
...
as AdminRolesCreateTarget,condFormula: null == condFormula ? _self.condFormula : condFormula // ignore: cast_nullable_to_non_nullable
...
as double,policies: null == policies ? _self.policies : policies // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [AdminRolesCreate].
extension AdminRolesCreatePatterns on AdminRolesCreate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminRolesCreate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminRolesCreate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminRolesCreate value)  $default,){
final _that = this;
switch (_that) {
case _AdminRolesCreate():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminRolesCreate value)?  $default,){
final _that = this;
switch (_that) {
case _AdminRolesCreate() when $default != null:
return $default(_that);case _:
...
class _AdminRolesCreate implements AdminRolesCreate {
  const _AdminRolesCreate({required this.name, required this.description, this.color, this.iconUrl, @JsonKey(unknownEnumValue: AdminRolesCreateTarget.unknown) required this.target, required final  Map<String, dynamic> condFormula, required this.isPublic, required this.isModerator, required this.isAdministrator, this.isExplorable = false, required this.asBadge, this.preserveAssignmentOnMoveAccount, required this.canEditMembersByModerator, required this.displayOrder, required final  Map<String, dynamic> policies}): _condFormula = condFormula,_policies = policies;
  factory _AdminRolesCreate.fromJson(Map<String, dynamic> json) => _$AdminRolesCreateFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminRolesCreateCopyWith<_AdminRolesCreate> get copyWith => __$AdminRolesCreateCopyWithImpl<_AdminRolesCreate>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminRolesCreateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminRolesCreate&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.color, color) || other.color == color)&&(identical(other.iconUrl, iconUrl) || other.iconUrl == iconUrl)&&(identical(other.target, target) || other.target == target)&&const DeepCollectionEquality().equals(other._condFormula, _condFormula)&&(identical(other.isPublic, isPublic) || other.isPublic == isPublic)&&(identical(other.isModerator, isModerator) || other.isModerator == isModerator)&&(identical(other.isAdministrator, isAdministrator) || other.isAdministrator == isAdministrator)&&(identical(other.isExplorable, isExplorable) || other.isExplorable == isExplorable)&&(identical(other.asBadge, asBadge) || other.asBadge == asBadge)&&(identical(other.preserveAssignmentOnMoveAccount, preserveAssignmentOnMoveAccount) || other.preserveAssignmentOnMoveAccount == preserveAssignmentOnMoveAccount)&&(identical(other.canEditMembersByModerator, canEditMembersByModerator) || other.canEditMembersByModerator == canEditMembersByModerator)&&(identical(other.displayOrder, displayOrder) || other.displayOrder == displayOrder)&&const DeepCollectionEquality().equals(other._policies, _policies));
}
...
/// @nodoc
abstract mixin class _$AdminRolesCreateCopyWith<$Res> implements $AdminRolesCreateCopyWith<$Res> {
  factory _$AdminRolesCreateCopyWith(_AdminRolesCreate value, $Res Function(_AdminRolesCreate) _then) = __$AdminRolesCreateCopyWithImpl;
@override @useResult
$Res call({
 String name, String description, String? color, String? iconUrl,@JsonKey(unknownEnumValue: AdminRolesCreateTarget.unknown) AdminRolesCreateTarget target, Map<String, dynamic> condFormula, bool isPublic, bool isModerator, bool isAdministrator, bool? isExplorable, bool asBadge, bool? preserveAssignmentOnMoveAccount, bool canEditMembersByModerator, double displayOrder, Map<String, dynamic> policies
});
...
/// Create a copy of AdminRolesCreate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = null,Object? color = freezed,Object? iconUrl = freezed,Object? target = null,Object? condFormula = null,Object? isPublic = null,Object? isModerator = null,Object? isAdministrator = null,Object? isExplorable = freezed,Object? asBadge = null,Object? preserveAssignmentOnMoveAccount = freezed,Object? canEditMembersByModerator = null,Object? displayOrder = null,Object? policies = null,}) {
...
as String?,iconUrl: freezed == iconUrl ? _self.iconUrl : iconUrl // ignore: cast_nullable_to_non_nullable
as String?,target: null == target ? _self.target : target // ignore: cast_nullable_to_non_nullable
as AdminRolesCreateTarget,condFormula: null == condFormula ? _self._condFormula : condFormula // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>,isPublic: null == isPublic ? _self.isPublic : isPublic // ignore: cast_nullable_to_non_nullable
as bool,isModerator: null == isModerator ? _self.isModerator : isModerator // ignore: cast_nullable_to_non_nullable
as bool,isAdministrator: null == isAdministrator ? _self.isAdministrator : isAdministrator // ignore: cast_nullable_to_non_nullable
as bool,isExplorable: freezed == isExplorable ? _self.isExplorable : isExplorable // ignore: cast_nullable_to_non_nullable
...
as bool?,canEditMembersByModerator: null == canEditMembersByModerator ? _self.canEditMembersByModerator : canEditMembersByModerator // ignore: cast_nullable_to_non_nullable
as bool,displayOrder: null == displayOrder ? _self.displayOrder : displayOrder // ignore: cast_nullable_to_non_nullable
as double,policies: null == policies ? _self._policies : policies // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>,
  ));
}
