...
$ChannelsUpdateRequestCopyWith<ChannelsUpdateRequest> get copyWith => _$ChannelsUpdateRequestCopyWithImpl<ChannelsUpdateRequest>(this as ChannelsUpdateRequest, _$identity);
...
abstract mixin class $ChannelsUpdateRequestCopyWith<$Res>  {
  factory $ChannelsUpdateRequestCopyWith(ChannelsUpdateRequest value, $Res Function(ChannelsUpdateRequest) _then) = _$ChannelsUpdateRequestCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of ChannelsUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? channelId = freezed,Object? name = freezed,Object? description = freezed,Object? bannerId = freezed,Object? isArchived = freezed,Object? pinnedNoteIds = freezed,Object? color = freezed,Object? isSensitive = freezed,Object? allowRenoteToExternal = freezed,}) {
...
/// Adds pattern-matching-related methods to [ChannelsUpdateRequest].
extension ChannelsUpdateRequestPatterns on ChannelsUpdateRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChannelsUpdateRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChannelsUpdateRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChannelsUpdateRequest value)  $default,){
final _that = this;
switch (_that) {
case _ChannelsUpdateRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChannelsUpdateRequest value)?  $default,){
final _that = this;
switch (_that) {
case _ChannelsUpdateRequest() when $default != null:
return $default(_that);case _:
...
class _ChannelsUpdateRequest implements ChannelsUpdateRequest {
  const _ChannelsUpdateRequest({this.channelId, this.name, this.description, this.bannerId, this.isArchived, final  List<String>? pinnedNoteIds, this.color, this.isSensitive, this.allowRenoteToExternal}): _pinnedNoteIds = pinnedNoteIds;
...
@pragma('vm:prefer-inline')
_$ChannelsUpdateRequestCopyWith<_ChannelsUpdateRequest> get copyWith => __$ChannelsUpdateRequestCopyWithImpl<_ChannelsUpdateRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChannelsUpdateRequestToJson(this, );
}
...
/// @nodoc
abstract mixin class _$ChannelsUpdateRequestCopyWith<$Res> implements $ChannelsUpdateRequestCopyWith<$Res> {
  factory _$ChannelsUpdateRequestCopyWith(_ChannelsUpdateRequest value, $Res Function(_ChannelsUpdateRequest) _then) = __$ChannelsUpdateRequestCopyWithImpl;
@override @useResult
$Res call({
 String? channelId, String? name, String? description, String? bannerId, bool? isArchived, List<String>? pinnedNoteIds, String? color, bool? isSensitive, bool? allowRenoteToExternal
});
...
/// Create a copy of ChannelsUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? channelId = freezed,Object? name = freezed,Object? description = freezed,Object? bannerId = freezed,Object? isArchived = freezed,Object? pinnedNoteIds = freezed,Object? color = freezed,Object? isSensitive = freezed,Object? allowRenoteToExternal = freezed,}) {
