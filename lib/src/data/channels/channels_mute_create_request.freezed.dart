...
mixin _$ChannelsMuteCreateRequest {
  ...
  $ChannelsMuteCreateRequestCopyWith<ChannelsMuteCreateRequest> get copyWith =>
      _$ChannelsMuteCreateRequestCopyWithImpl<ChannelsMuteCreateRequest>(
          this as ChannelsMuteCreateRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChannelsMuteCreateRequest &&
...
abstract mixin class $ChannelsMuteCreateRequestCopyWith<$Res> {
  factory $ChannelsMuteCreateRequestCopyWith(ChannelsMuteCreateRequest value,
          $Res Function(ChannelsMuteCreateRequest) _then) =
      _$ChannelsMuteCreateRequestCopyWithImpl;
  @useResult
...
class _ChannelsMuteCreateRequest implements ChannelsMuteCreateRequest {
  ...
  factory _ChannelsMuteCreateRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChannelsMuteCreateRequestCopyWith<_ChannelsMuteCreateRequest>
      get copyWith =>
          __$ChannelsMuteCreateRequestCopyWithImpl<_ChannelsMuteCreateRequest>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChannelsMuteCreateRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChannelsMuteCreateRequest &&
            (identical(other.channelId, channelId) ||
                other.channelId == channelId) &&
            (identical(other.expiresAt, expiresAt) ||
                other.expiresAt == expiresAt));
...
/// @nodoc
abstract mixin class _$ChannelsMuteCreateRequestCopyWith<$Res>
    implements $ChannelsMuteCreateRequestCopyWith<$Res> {
  factory _$ChannelsMuteCreateRequestCopyWith(_ChannelsMuteCreateRequest value,
          $Res Function(_ChannelsMuteCreateRequest) _then) =
      __$ChannelsMuteCreateRequestCopyWithImpl;
  @override
  @useResult
  $Res call({String? channelId, int? expiresAt});
}
