...
mixin _$InviteListRequest {
  ...
  $InviteListRequestCopyWith<InviteListRequest> get copyWith =>
      _$InviteListRequestCopyWithImpl<InviteListRequest>(
          this as InviteListRequest, _$identity);
...
abstract mixin class $InviteListRequestCopyWith<$Res> {
  factory $InviteListRequestCopyWith(
          InviteListRequest value, $Res Function(InviteListRequest) _then) =
      _$InviteListRequestCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _InviteListRequest implements InviteListRequest {
  const _InviteListRequest(
      {this.limit = 30,
      this.sinceId,
      this.untilId,
      this.sinceDate,
      this.untilDate});
  factory _InviteListRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$InviteListRequestCopyWith<_InviteListRequest> get copyWith =>
      __$InviteListRequestCopyWithImpl<_InviteListRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$InviteListRequestToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$InviteListRequestCopyWith<$Res>
    implements $InviteListRequestCopyWith<$Res> {
  factory _$InviteListRequestCopyWith(
          _InviteListRequest value, $Res Function(_InviteListRequest) _then) =
      __$InviteListRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
