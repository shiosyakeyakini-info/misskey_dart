...
mixin _$ChatRoomsOwnedRequest {
  ...
  $ChatRoomsOwnedRequestCopyWith<ChatRoomsOwnedRequest> get copyWith =>
      _$ChatRoomsOwnedRequestCopyWithImpl<ChatRoomsOwnedRequest>(
          this as ChatRoomsOwnedRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChatRoomsOwnedRequest &&
  ...
  @override
  String toString() {
    return 'ChatRoomsOwnedRequest(limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate)';
  }
}
...
abstract mixin class $ChatRoomsOwnedRequestCopyWith<$Res> {
  factory $ChatRoomsOwnedRequestCopyWith(ChatRoomsOwnedRequest value,
          $Res Function(ChatRoomsOwnedRequest) _then) =
      _$ChatRoomsOwnedRequestCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _ChatRoomsOwnedRequest implements ChatRoomsOwnedRequest {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChatRoomsOwnedRequestCopyWith<_ChatRoomsOwnedRequest> get copyWith =>
      __$ChatRoomsOwnedRequestCopyWithImpl<_ChatRoomsOwnedRequest>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChatRoomsOwnedRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChatRoomsOwnedRequest &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.sinceId, sinceId) || other.sinceId == sinceId) &&
            (identical(other.untilId, untilId) || other.untilId == untilId) &&
            (identical(other.sinceDate, sinceDate) ||
...
/// @nodoc
abstract mixin class _$ChatRoomsOwnedRequestCopyWith<$Res>
    implements $ChatRoomsOwnedRequestCopyWith<$Res> {
  factory _$ChatRoomsOwnedRequestCopyWith(_ChatRoomsOwnedRequest value,
          $Res Function(_ChatRoomsOwnedRequest) _then) =
      __$ChatRoomsOwnedRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
