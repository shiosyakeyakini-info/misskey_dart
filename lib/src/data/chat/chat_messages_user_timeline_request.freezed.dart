...
$ChatMessagesUserTimelineRequestCopyWith<ChatMessagesUserTimelineRequest> get copyWith => _$ChatMessagesUserTimelineRequestCopyWithImpl<ChatMessagesUserTimelineRequest>(this as ChatMessagesUserTimelineRequest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatMessagesUserTimelineRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.userId, userId) || other.userId == userId));
}
...
abstract mixin class $ChatMessagesUserTimelineRequestCopyWith<$Res>  {
  factory $ChatMessagesUserTimelineRequestCopyWith(ChatMessagesUserTimelineRequest value, $Res Function(ChatMessagesUserTimelineRequest) _then) = _$ChatMessagesUserTimelineRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [ChatMessagesUserTimelineRequest].
extension ChatMessagesUserTimelineRequestPatterns on ChatMessagesUserTimelineRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChatMessagesUserTimelineRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChatMessagesUserTimelineRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChatMessagesUserTimelineRequest value)  $default,){
final _that = this;
switch (_that) {
case _ChatMessagesUserTimelineRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChatMessagesUserTimelineRequest value)?  $default,){
final _that = this;
switch (_that) {
case _ChatMessagesUserTimelineRequest() when $default != null:
return $default(_that);case _:
...
class _ChatMessagesUserTimelineRequest implements ChatMessagesUserTimelineRequest {
  const _ChatMessagesUserTimelineRequest({this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.userId});
  factory _ChatMessagesUserTimelineRequest.fromJson(Map<String, dynamic> json) => _$ChatMessagesUserTimelineRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$ChatMessagesUserTimelineRequestCopyWith<_ChatMessagesUserTimelineRequest> get copyWith => __$ChatMessagesUserTimelineRequestCopyWithImpl<_ChatMessagesUserTimelineRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ChatMessagesUserTimelineRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatMessagesUserTimelineRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.userId, userId) || other.userId == userId));
}
...
/// @nodoc
abstract mixin class _$ChatMessagesUserTimelineRequestCopyWith<$Res> implements $ChatMessagesUserTimelineRequestCopyWith<$Res> {
  factory _$ChatMessagesUserTimelineRequestCopyWith(_ChatMessagesUserTimelineRequest value, $Res Function(_ChatMessagesUserTimelineRequest) _then) = __$ChatMessagesUserTimelineRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, String? userId
});
