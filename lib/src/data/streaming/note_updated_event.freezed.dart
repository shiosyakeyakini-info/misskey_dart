...
mixin _$NoteUpdatedEvent {
 ...
 String get id;@NoteUpdatedEventTypeJsonConverter() NoteUpdatedEventType get type; Map<String, dynamic> get body;
...
@useResult
$Res call({
 String id,@NoteUpdatedEventTypeJsonConverter() NoteUpdatedEventType type, Map<String, dynamic> body
});
...
/// Create a copy of NoteUpdatedEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? body = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @NoteUpdatedEventTypeJsonConverter()  NoteUpdatedEventType type,  Map<String, dynamic> body)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteUpdatedEvent() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @NoteUpdatedEventTypeJsonConverter()  NoteUpdatedEventType type,  Map<String, dynamic> body)  $default,) {final _that = this;
switch (_that) {
case _NoteUpdatedEvent():
return $default(_that.id,_that.type,_that.body);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @NoteUpdatedEventTypeJsonConverter()  NoteUpdatedEventType type,  Map<String, dynamic> body)?  $default,) {final _that = this;
switch (_that) {
case _NoteUpdatedEvent() when $default != null:
return $default(_that.id,_that.type,_that.body);case _:
  return null;
...
class _NoteUpdatedEvent implements NoteUpdatedEvent {
  const _NoteUpdatedEvent({required this.id, @NoteUpdatedEventTypeJsonConverter() required this.type, required final  Map<String, dynamic> body}): _body = body;
  factory _NoteUpdatedEvent.fromJson(Map<String, dynamic> json) => _$NoteUpdatedEventFromJson(json);

@override final  String id;
@override@NoteUpdatedEventTypeJsonConverter() final  NoteUpdatedEventType type;
