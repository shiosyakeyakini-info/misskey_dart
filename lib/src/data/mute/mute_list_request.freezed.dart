...
$MuteListRequestCopyWith<MuteListRequest> get copyWith => _$MuteListRequestCopyWithImpl<MuteListRequest>(this as MuteListRequest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MuteListRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
@override
String toString() {
  return 'MuteListRequest(limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate)';
}
...
abstract mixin class $MuteListRequestCopyWith<$Res>  {
  factory $MuteListRequestCopyWith(MuteListRequest value, $Res Function(MuteListRequest) _then) = _$MuteListRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [MuteListRequest].
extension MuteListRequestPatterns on MuteListRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MuteListRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MuteListRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MuteListRequest value)  $default,){
final _that = this;
switch (_that) {
case _MuteListRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MuteListRequest value)?  $default,){
final _that = this;
switch (_that) {
case _MuteListRequest() when $default != null:
return $default(_that);case _:
...
class _MuteListRequest implements MuteListRequest {
  const _MuteListRequest({this.limit = 30, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
  factory _MuteListRequest.fromJson(Map<String, dynamic> json) => _$MuteListRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$MuteListRequestCopyWith<_MuteListRequest> get copyWith => __$MuteListRequestCopyWithImpl<_MuteListRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MuteListRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MuteListRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate));
}
...
/// @nodoc
abstract mixin class _$MuteListRequestCopyWith<$Res> implements $MuteListRequestCopyWith<$Res> {
  factory _$MuteListRequestCopyWith(_MuteListRequest value, $Res Function(_MuteListRequest) _then) = __$MuteListRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate
});
