...
$FederationInstancesRequestCopyWith<FederationInstancesRequest> get copyWith => _$FederationInstancesRequestCopyWithImpl<FederationInstancesRequest>(this as FederationInstancesRequest, _$identity);
...
abstract mixin class $FederationInstancesRequestCopyWith<$Res>  {
  factory $FederationInstancesRequestCopyWith(FederationInstancesRequest value, $Res Function(FederationInstancesRequest) _then) = _$FederationInstancesRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [FederationInstancesRequest].
extension FederationInstancesRequestPatterns on FederationInstancesRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FederationInstancesRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FederationInstancesRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FederationInstancesRequest value)  $default,){
final _that = this;
switch (_that) {
case _FederationInstancesRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FederationInstancesRequest value)?  $default,){
final _that = this;
switch (_that) {
case _FederationInstancesRequest() when $default != null:
return $default(_that);case _:
...
class _FederationInstancesRequest implements FederationInstancesRequest {
  const _FederationInstancesRequest({this.host, this.blocked, this.notResponding, this.suspended, this.silenced, this.federating, this.subscribing, this.publishing, this.limit = 30, this.offset = 0, @JsonKey(unknownEnumValue: FederationInstancesSort.unknown) this.sort});
  factory _FederationInstancesRequest.fromJson(Map<String, dynamic> json) => _$FederationInstancesRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$FederationInstancesRequestCopyWith<_FederationInstancesRequest> get copyWith => __$FederationInstancesRequestCopyWithImpl<_FederationInstancesRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FederationInstancesRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FederationInstancesRequest&&(identical(other.host, host) || other.host == host)&&(identical(other.blocked, blocked) || other.blocked == blocked)&&(identical(other.notResponding, notResponding) || other.notResponding == notResponding)&&(identical(other.suspended, suspended) || other.suspended == suspended)&&(identical(other.silenced, silenced) || other.silenced == silenced)&&(identical(other.federating, federating) || other.federating == federating)&&(identical(other.subscribing, subscribing) || other.subscribing == subscribing)&&(identical(other.publishing, publishing) || other.publishing == publishing)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.offset, offset) || other.offset == offset)&&(identical(other.sort, sort) || other.sort == sort));
}
...
/// @nodoc
abstract mixin class _$FederationInstancesRequestCopyWith<$Res> implements $FederationInstancesRequestCopyWith<$Res> {
  factory _$FederationInstancesRequestCopyWith(_FederationInstancesRequest value, $Res Function(_FederationInstancesRequest) _then) = __$FederationInstancesRequestCopyWithImpl;
@override @useResult
$Res call({
 String? host, bool? blocked, bool? notResponding, bool? suspended, bool? silenced, bool? federating, bool? subscribing, bool? publishing, int? limit, int? offset,@JsonKey(unknownEnumValue: FederationInstancesSort.unknown) FederationInstancesSort? sort
});
