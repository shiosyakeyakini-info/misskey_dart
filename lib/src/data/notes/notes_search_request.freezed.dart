...
mixin _$NotesSearchRequest {
 ...
 String? get query;@NullableEpocTimeDateTimeConverter.withMilliSeconds() DateTime? get rangeStartAt;@NullableEpocTimeDateTimeConverter.withMilliSeconds() DateTime? get rangeEndAt; String? get sinceId; String? get untilId; int? get sinceDate; int? get untilDate; int? get limit; int? get offset; String? get host; String? get userId; String? get channelId;
...
@override
String toString() {
  return 'NotesSearchRequest(query: $query, rangeStartAt: $rangeStartAt, rangeEndAt: $rangeEndAt, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate, limit: $limit, offset: $offset, host: $host, userId: $userId, channelId: $channelId)';
}
...
@useResult
$Res call({
 String? query,@NullableEpocTimeDateTimeConverter.withMilliSeconds() DateTime? rangeStartAt,@NullableEpocTimeDateTimeConverter.withMilliSeconds() DateTime? rangeEndAt, String? sinceId, String? untilId, int? sinceDate, int? untilDate, int? limit, int? offset, String? host, String? userId, String? channelId
});
...
as DateTime?,sinceId: freezed == sinceId ? _self.sinceId : sinceId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? query, @NullableEpocTimeDateTimeConverter.withMilliSeconds()  DateTime? rangeStartAt, @NullableEpocTimeDateTimeConverter.withMilliSeconds()  DateTime? rangeEndAt,  String? sinceId,  String? untilId,  int? sinceDate,  int? untilDate,  int? limit,  int? offset,  String? host,  String? userId,  String? channelId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotesSearchRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? query, @NullableEpocTimeDateTimeConverter.withMilliSeconds()  DateTime? rangeStartAt, @NullableEpocTimeDateTimeConverter.withMilliSeconds()  DateTime? rangeEndAt,  String? sinceId,  String? untilId,  int? sinceDate,  int? untilDate,  int? limit,  int? offset,  String? host,  String? userId,  String? channelId)  $default,) {final _that = this;
switch (_that) {
case _NotesSearchRequest():
return $default(_that.query,_that.rangeStartAt,_that.rangeEndAt,_that.sinceId,_that.untilId,_that.sinceDate,_that.untilDate,_that.limit,_that.offset,_that.host,_that.userId,_that.channelId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? query, @NullableEpocTimeDateTimeConverter.withMilliSeconds()  DateTime? rangeStartAt, @NullableEpocTimeDateTimeConverter.withMilliSeconds()  DateTime? rangeEndAt,  String? sinceId,  String? untilId,  int? sinceDate,  int? untilDate,  int? limit,  int? offset,  String? host,  String? userId,  String? channelId)?  $default,) {final _that = this;
switch (_that) {
case _NotesSearchRequest() when $default != null:
return $default(_that.query,_that.rangeStartAt,_that.rangeEndAt,_that.sinceId,_that.untilId,_that.sinceDate,_that.untilDate,_that.limit,_that.offset,_that.host,_that.userId,_that.channelId);case _:
  return null;
...
class _NotesSearchRequest implements NotesSearchRequest {
  const _NotesSearchRequest({this.query, @NullableEpocTimeDateTimeConverter.withMilliSeconds() this.rangeStartAt, @NullableEpocTimeDateTimeConverter.withMilliSeconds() this.rangeEndAt, this.sinceId, this.untilId, this.sinceDate, this.untilDate, this.limit = 10, this.offset = 0, this.host, this.userId = null, this.channelId = null});
  factory _NotesSearchRequest.fromJson(Map<String, dynamic> json) => _$NotesSearchRequestFromJson(json);

@override final  String? query;
@override@NullableEpocTimeDateTimeConverter.withMilliSeconds() final  DateTime? rangeStartAt;
@override@NullableEpocTimeDateTimeConverter.withMilliSeconds() final  DateTime? rangeEndAt;
...
/// Create a copy of NotesSearchRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? query = freezed,Object? rangeStartAt = freezed,Object? rangeEndAt = freezed,Object? sinceId = freezed,Object? untilId = freezed,Object? sinceDate = freezed,Object? untilDate = freezed,Object? limit = freezed,Object? offset = freezed,Object? host = freezed,Object? userId = freezed,Object? channelId = freezed,}) {
