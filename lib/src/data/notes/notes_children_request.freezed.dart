...
@override
String toString() {
  return 'NotesChildrenRequest(noteId: $noteId, limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate)';
}
...
class _NotesChildrenRequest implements NotesChildrenRequest {
  const _NotesChildrenRequest({this.noteId, this.limit = 10, this.sinceId, this.untilId, this.sinceDate, this.untilDate});
