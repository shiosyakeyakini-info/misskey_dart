...
@freezed
abstract class NotesPollsRecommendationRequest with _$NotesPollsRecommendationRequest {
  ...
  factory NotesPollsRecommendationRequest.fromJson(Map<String, Object?> json) => _$NotesPollsRecommendationRequestFromJson(json);
}
