...
_$_NotesGlobalTimelineRequest _$$_NotesGlobalTimelineRequestFromJson(
...
Map<String, dynamic> _$$_NotesGlobalTimelineRequestToJson(
        _$_NotesGlobalTimelineRequest instance) =>
    <String, dynamic>{
