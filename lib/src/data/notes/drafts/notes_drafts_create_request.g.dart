...
_$NotesDraftsCreateRequestImpl _$$NotesDraftsCreateRequestImplFromJson(
...
Map<String, dynamic> _$$NotesDraftsCreateRequestImplToJson(
        _$NotesDraftsCreateRequestImpl instance) =>
    <String, dynamic>{
