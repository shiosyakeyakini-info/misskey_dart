...
/// Create a copy of DriveFoldersUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? folderId = freezed,Object? name = freezed,Object? parentId = freezed,}) {
...
/// Adds pattern-matching-related methods to [DriveFoldersUpdateRequest].
extension DriveFoldersUpdateRequestPatterns on DriveFoldersUpdateRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DriveFoldersUpdateRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _DriveFoldersUpdateRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DriveFoldersUpdateRequest value)  $default,){
final _that = this;
switch (_that) {
case _DriveFoldersUpdateRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DriveFoldersUpdateRequest value)?  $default,){
final _that = this;
switch (_that) {
case _DriveFoldersUpdateRequest() when $default != null:
return $default(_that);case _:
...
class _DriveFoldersUpdateRequest implements DriveFoldersUpdateRequest {
  const _DriveFoldersUpdateRequest({this.folderId, this.name, this.parentId});
...
/// Create a copy of DriveFoldersUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? folderId = freezed,Object? name = freezed,Object? parentId = freezed,}) {
