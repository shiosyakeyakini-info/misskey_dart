...
/// Create a copy of DriveFilesMoveBulkRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? fileIds = freezed,Object? folderId = freezed,}) {
...
class _DriveFilesMoveBulkRequest implements DriveFilesMoveBulkRequest {
  const _DriveFilesMoveBulkRequest({final  List<String>? fileIds, this.folderId}): _fileIds = fileIds;
...
/// Create a copy of DriveFilesMoveBulkRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? fileIds = freezed,Object? folderId = freezed,}) {
