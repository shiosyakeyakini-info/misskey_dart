...
mixin _$AdminEmojiAddAliasesBulkRequest {
  ...
  $AdminEmojiAddAliasesBulkRequestCopyWith<AdminEmojiAddAliasesBulkRequest>
      get copyWith => _$AdminEmojiAddAliasesBulkRequestCopyWithImpl<
              AdminEmojiAddAliasesBulkRequest>(
          this as AdminEmojiAddAliasesBulkRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminEmojiAddAliasesBulkRequest &&
...
abstract mixin class $AdminEmojiAddAliasesBulkRequestCopyWith<$Res> {
  factory $AdminEmojiAddAliasesBulkRequestCopyWith(
          AdminEmojiAddAliasesBulkRequest value,
          $Res Function(AdminEmojiAddAliasesBulkRequest) _then) =
      _$AdminEmojiAddAliasesBulkRequestCopyWithImpl;
  @useResult
...
/// @nodoc
@JsonSerializable()
class _AdminEmojiAddAliasesBulkRequest
    implements AdminEmojiAddAliasesBulkRequest {
  const _AdminEmojiAddAliasesBulkRequest(
      {final List<String>? ids, final List<String>? aliases})
      : _ids = ids,
        _aliases = aliases;
  factory _AdminEmojiAddAliasesBulkRequest.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminEmojiAddAliasesBulkRequestCopyWith<_AdminEmojiAddAliasesBulkRequest>
      get copyWith => __$AdminEmojiAddAliasesBulkRequestCopyWithImpl<
          _AdminEmojiAddAliasesBulkRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminEmojiAddAliasesBulkRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminEmojiAddAliasesBulkRequest &&
...
/// @nodoc
abstract mixin class _$AdminEmojiAddAliasesBulkRequestCopyWith<$Res>
    implements $AdminEmojiAddAliasesBulkRequestCopyWith<$Res> {
  factory _$AdminEmojiAddAliasesBulkRequestCopyWith(
          _AdminEmojiAddAliasesBulkRequest value,
          $Res Function(_AdminEmojiAddAliasesBulkRequest) _then) =
      __$AdminEmojiAddAliasesBulkRequestCopyWithImpl;
  @override
  @useResult
  $Res call({List<String>? ids, List<String>? aliases});
}
