...
mixin _$AdminRolesUsersRequest {
  ...
  $AdminRolesUsersRequestCopyWith<AdminRolesUsersRequest> get copyWith =>
      _$AdminRolesUsersRequestCopyWithImpl<AdminRolesUsersRequest>(
          this as AdminRolesUsersRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminRolesUsersRequest &&
...
abstract mixin class $AdminRolesUsersRequestCopyWith<$Res> {
  factory $AdminRolesUsersRequestCopyWith(AdminRolesUsersRequest value,
          $Res Function(AdminRolesUsersRequest) _then) =
      _$AdminRolesUsersRequestCopyWithImpl;
  @useResult
  $Res call(
      {String? roleId,
      String? sinceId,
...
class _AdminRolesUsersRequest implements AdminRolesUsersRequest {
  const _AdminRolesUsersRequest(
      ...
      this.untilDate,
      this.limit = 10});
  factory _AdminRolesUsersRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminRolesUsersRequestCopyWith<_AdminRolesUsersRequest> get copyWith =>
      __$AdminRolesUsersRequestCopyWithImpl<_AdminRolesUsersRequest>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminRolesUsersRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminRolesUsersRequest &&
            (identical(other.roleId, roleId) || other.roleId == roleId) &&
            (identical(other.sinceId, sinceId) || other.sinceId == sinceId) &&
            (identical(other.untilId, untilId) || other.untilId == untilId) &&
            (identical(other.sinceDate, sinceDate) ||
...
/// @nodoc
abstract mixin class _$AdminRolesUsersRequestCopyWith<$Res>
    implements $AdminRolesUsersRequestCopyWith<$Res> {
  factory _$AdminRolesUsersRequestCopyWith(_AdminRolesUsersRequest value,
          $Res Function(_AdminRolesUsersRequest) _then) =
      __$AdminRolesUsersRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? roleId,
