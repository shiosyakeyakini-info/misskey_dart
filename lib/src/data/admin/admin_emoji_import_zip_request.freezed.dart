...
mixin _$AdminEmojiImportZipRequest {
  ...
  $AdminEmojiImportZipRequestCopyWith<AdminEmojiImportZipRequest>
      get copyWith =>
          _$AdminEmojiImportZipRequestCopyWithImpl<AdminEmojiImportZipRequest>(
              this as AdminEmojiImportZipRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminEmojiImportZipRequest &&
...
abstract mixin class $AdminEmojiImportZipRequestCopyWith<$Res> {
  factory $AdminEmojiImportZipRequestCopyWith(AdminEmojiImportZipRequest value,
          $Res Function(AdminEmojiImportZipRequest) _then) =
      _$AdminEmojiImportZipRequestCopyWithImpl;
  @useResult
...
class _AdminEmojiImportZipRequest implements AdminEmojiImportZipRequest {
  ...
  factory _AdminEmojiImportZipRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminEmojiImportZipRequestCopyWith<_AdminEmojiImportZipRequest>
      get copyWith => __$AdminEmojiImportZipRequestCopyWithImpl<
          _AdminEmojiImportZipRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminEmojiImportZipRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminEmojiImportZipRequest &&
            (identical(other.fileId, fileId) || other.fileId == fileId));
  }
...
/// @nodoc
abstract mixin class _$AdminEmojiImportZipRequestCopyWith<$Res>
    implements $AdminEmojiImportZipRequestCopyWith<$Res> {
  factory _$AdminEmojiImportZipRequestCopyWith(
          _AdminEmojiImportZipRequest value,
          $Res Function(_AdminEmojiImportZipRequest) _then) =
      __$AdminEmojiImportZipRequestCopyWithImpl;
  @override
  @useResult
  $Res call({String? fileId});
}
