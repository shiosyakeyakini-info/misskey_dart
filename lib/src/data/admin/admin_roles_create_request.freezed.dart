...
mixin _$AdminRolesCreateRequest {
  ...
  $AdminRolesCreateRequestCopyWith<AdminRolesCreateRequest> get copyWith =>
      _$AdminRolesCreateRequestCopyWithImpl<AdminRolesCreateRequest>(
          this as AdminRolesCreateRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminRolesCreateRequest &&
...
abstract mixin class $AdminRolesCreateRequestCopyWith<$Res> {
  factory $AdminRolesCreateRequestCopyWith(AdminRolesCreateRequest value,
          $Res Function(AdminRolesCreateRequest) _then) =
      _$AdminRolesCreateRequestCopyWithImpl;
  @useResult
  $Res call(
      {String? name,
      String? description,
...
class _AdminRolesCreateRequest implements AdminRolesCreateRequest {
  const _AdminRolesCreateRequest(
      {this.name,
      this.description,
      this.color,
      this.iconUrl,
      ...
      : _condFormula = condFormula,
        _policies = policies;
  factory _AdminRolesCreateRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminRolesCreateRequestCopyWith<_AdminRolesCreateRequest> get copyWith =>
      __$AdminRolesCreateRequestCopyWithImpl<_AdminRolesCreateRequest>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminRolesCreateRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminRolesCreateRequest &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
            (identical(other.color, color) || other.color == color) &&
...
/// @nodoc
abstract mixin class _$AdminRolesCreateRequestCopyWith<$Res>
    implements $AdminRolesCreateRequestCopyWith<$Res> {
  factory _$AdminRolesCreateRequestCopyWith(_AdminRolesCreateRequest value,
          $Res Function(_AdminRolesCreateRequest) _then) =
      __$AdminRolesCreateRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? name,
