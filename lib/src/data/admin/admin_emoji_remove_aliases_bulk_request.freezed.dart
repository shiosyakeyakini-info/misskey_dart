...
mixin _$AdminEmojiRemoveAliasesBulkRequest {
  ...
  $AdminEmojiRemoveAliasesBulkRequestCopyWith<
          AdminEmojiRemoveAliasesBulkRequest>
      get copyWith => _$AdminEmojiRemoveAliasesBulkRequestCopyWithImpl<
              AdminEmojiRemoveAliasesBulkRequest>(
          this as AdminEmojiRemoveAliasesBulkRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminEmojiRemoveAliasesBulkRequest &&
...
abstract mixin class $AdminEmojiRemoveAliasesBulkRequestCopyWith<$Res> {
  factory $AdminEmojiRemoveAliasesBulkRequestCopyWith(
          AdminEmojiRemoveAliasesBulkRequest value,
          $Res Function(AdminEmojiRemoveAliasesBulkRequest) _then) =
      _$AdminEmojiRemoveAliasesBulkRequestCopyWithImpl;
  @useResult
...
/// @nodoc
@JsonSerializable()
class _AdminEmojiRemoveAliasesBulkRequest
    implements AdminEmojiRemoveAliasesBulkRequest {
  const _AdminEmojiRemoveAliasesBulkRequest(
      {final List<String>? ids, final List<String>? aliases})
      : _ids = ids,
        _aliases = aliases;
  factory _AdminEmojiRemoveAliasesBulkRequest.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminEmojiRemoveAliasesBulkRequestCopyWith<
          _AdminEmojiRemoveAliasesBulkRequest>
      get copyWith => __$AdminEmojiRemoveAliasesBulkRequestCopyWithImpl<
          _AdminEmojiRemoveAliasesBulkRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminEmojiRemoveAliasesBulkRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminEmojiRemoveAliasesBulkRequest &&
...
/// @nodoc
abstract mixin class _$AdminEmojiRemoveAliasesBulkRequestCopyWith<$Res>
    implements $AdminEmojiRemoveAliasesBulkRequestCopyWith<$Res> {
  factory _$AdminEmojiRemoveAliasesBulkRequestCopyWith(
          _AdminEmojiRemoveAliasesBulkRequest value,
          $Res Function(_AdminEmojiRemoveAliasesBulkRequest) _then) =
      __$AdminEmojiRemoveAliasesBulkRequestCopyWithImpl;
  @override
  @useResult
  $Res call({List<String>? ids, List<String>? aliases});
}
