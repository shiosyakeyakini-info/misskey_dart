...
@freezed
abstract class AdminEmojiSetAliasesBulkRequest
    with _$AdminEmojiSetAliasesBulkRequest {
  const factory AdminEmojiSetAliasesBulkRequest({
    List<String>? ids,
    List<String>? aliases,
  }) = _AdminEmojiSetAliasesBulkRequest;

  factory AdminEmojiSetAliasesBulkRequest.fromJson(Map<String, Object?> json) =>
