...
@freezed
abstract class AdminSystemWebhookListRequest with _$AdminSystemWebhookListRequest {
  ...
  factory AdminSystemWebhookListRequest.fromJson(Map<String, Object?> json) => _$AdminSystemWebhookListRequestFromJson(json);
}
