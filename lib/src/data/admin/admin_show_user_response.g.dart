...
_AdminShowUserResponse _$AdminShowUserResponseFromJson(
    ...
    _AdminShowUserResponse(
      ...
      notificationRecieveConfig:
          AdminShowUserNotificationRecieveConfig.fromJson(
      ...
      roleAssigns: (json['roleAssigns'] as List<dynamic>)
          .map((e) =>
              AdminShowUserRoleAssignsItem.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$AdminShowUserResponseToJson(
        _AdminShowUserResponse instance) =>
    <String, dynamic>{
