...
abstract class AdminAnnouncementsCreateRequest with _$AdminAnnouncementsCreateRequest {
  const factory AdminAnnouncementsCreateRequest({
    ...
    String? text,
    String? imageUrl,
    @Default(AdminAnnouncementsCreateIcon.info) AdminAnnouncementsCreateIcon? icon,
    @Default(AdminAnnouncementsCreateDisplay.normal) AdminAnnouncementsCreateDisplay? display,
