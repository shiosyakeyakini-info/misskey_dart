...
mixin _$AdminRolesUpdateDefaultPoliciesRequest {
  ...
  $AdminRolesUpdateDefaultPoliciesRequestCopyWith<
          AdminRolesUpdateDefaultPoliciesRequest>
      get copyWith => _$AdminRolesUpdateDefaultPoliciesRequestCopyWithImpl<
              AdminRolesUpdateDefaultPoliciesRequest>(
          this as AdminRolesUpdateDefaultPoliciesRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminRolesUpdateDefaultPoliciesRequest &&
...
abstract mixin class $AdminRolesUpdateDefaultPoliciesRequestCopyWith<$Res> {
  factory $AdminRolesUpdateDefaultPoliciesRequestCopyWith(
          AdminRolesUpdateDefaultPoliciesRequest value,
          $Res Function(AdminRolesUpdateDefaultPoliciesRequest) _then) =
      _$AdminRolesUpdateDefaultPoliciesRequestCopyWithImpl;
  @useResult
...
/// @nodoc
@JsonSerializable()
class _AdminRolesUpdateDefaultPoliciesRequest
    implements AdminRolesUpdateDefaultPoliciesRequest {
  const _AdminRolesUpdateDefaultPoliciesRequest(
      {final Map<String, dynamic>? policies})
      : _policies = policies;
  factory _AdminRolesUpdateDefaultPoliciesRequest.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminRolesUpdateDefaultPoliciesRequestCopyWith<
          _AdminRolesUpdateDefaultPoliciesRequest>
      get copyWith => __$AdminRolesUpdateDefaultPoliciesRequestCopyWithImpl<
          _AdminRolesUpdateDefaultPoliciesRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminRolesUpdateDefaultPoliciesRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminRolesUpdateDefaultPoliciesRequest &&
...
/// @nodoc
abstract mixin class _$AdminRolesUpdateDefaultPoliciesRequestCopyWith<$Res>
    implements $AdminRolesUpdateDefaultPoliciesRequestCopyWith<$Res> {
  factory _$AdminRolesUpdateDefaultPoliciesRequestCopyWith(
          _AdminRolesUpdateDefaultPoliciesRequest value,
          $Res Function(_AdminRolesUpdateDefaultPoliciesRequest) _then) =
      __$AdminRolesUpdateDefaultPoliciesRequestCopyWithImpl;
  @override
  @useResult
  $Res call({Map<String, dynamic>? policies});
}
