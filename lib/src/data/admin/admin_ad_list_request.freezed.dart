...
mixin _$AdminAdListRequest {
  ...
  $AdminAdListRequestCopyWith<AdminAdListRequest> get copyWith =>
      _$AdminAdListRequestCopyWithImpl<AdminAdListRequest>(
          this as AdminAdListRequest, _$identity);
...
abstract mixin class $AdminAdListRequestCopyWith<$Res> {
  factory $AdminAdListRequestCopyWith(
          AdminAdListRequest value, $Res Function(AdminAdListRequest) _then) =
      _$AdminAdListRequestCopyWithImpl;
  @useResult
  $Res call(
      {int? limit,
      String? sinceId,
...
class _AdminAdListRequest implements AdminAdListRequest {
  ...
  factory _AdminAdListRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminAdListRequestCopyWith<_AdminAdListRequest> get copyWith =>
      __$AdminAdListRequestCopyWithImpl<_AdminAdListRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminAdListRequestToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AdminAdListRequestCopyWith<$Res>
    implements $AdminAdListRequestCopyWith<$Res> {
  factory _$AdminAdListRequestCopyWith(
          _AdminAdListRequest value, $Res Function(_AdminAdListRequest) _then) =
      __$AdminAdListRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? limit,
