...
$AdminRelaysAddResponseCopyWith<AdminRelaysAddResponse> get copyWith => _$AdminRelaysAddResponseCopyWithImpl<AdminRelaysAddResponse>(this as AdminRelaysAddResponse, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminRelaysAddResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.inbox, inbox) || other.inbox == inbox)&&(identical(other.status, status) || other.status == status));
}
...
abstract mixin class $AdminRelaysAddResponseCopyWith<$Res>  {
  factory $AdminRelaysAddResponseCopyWith(AdminRelaysAddResponse value, $Res Function(AdminRelaysAddResponse) _then) = _$AdminRelaysAddResponseCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminRelaysAddResponse].
extension AdminRelaysAddResponsePatterns on AdminRelaysAddResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminRelaysAddResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminRelaysAddResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminRelaysAddResponse value)  $default,){
final _that = this;
switch (_that) {
case _AdminRelaysAddResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminRelaysAddResponse value)?  $default,){
final _that = this;
switch (_that) {
case _AdminRelaysAddResponse() when $default != null:
return $default(_that);case _:
...
class _AdminRelaysAddResponse implements AdminRelaysAddResponse {
  const _AdminRelaysAddResponse({required this.id, @UriConverter() required this.inbox, @JsonKey(unknownEnumValue: AdminRelaysAddStatus.unknown) this.status = AdminRelaysAddStatus.requesting});
  factory _AdminRelaysAddResponse.fromJson(Map<String, dynamic> json) => _$AdminRelaysAddResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminRelaysAddResponseCopyWith<_AdminRelaysAddResponse> get copyWith => __$AdminRelaysAddResponseCopyWithImpl<_AdminRelaysAddResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminRelaysAddResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminRelaysAddResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.inbox, inbox) || other.inbox == inbox)&&(identical(other.status, status) || other.status == status));
}
...
/// @nodoc
abstract mixin class _$AdminRelaysAddResponseCopyWith<$Res> implements $AdminRelaysAddResponseCopyWith<$Res> {
  factory _$AdminRelaysAddResponseCopyWith(_AdminRelaysAddResponse value, $Res Function(_AdminRelaysAddResponse) _then) = __$AdminRelaysAddResponseCopyWithImpl;
@override @useResult
$Res call({
 String id,@UriConverter() Uri inbox,@JsonKey(unknownEnumValue: AdminRelaysAddStatus.unknown) AdminRelaysAddStatus status
});
