...
$AdminServerInfoResponseCopyWith<AdminServerInfoResponse> get copyWith => _$AdminServerInfoResponseCopyWithImpl<AdminServerInfoResponse>(this as AdminServerInfoResponse, _$identity);
...
abstract mixin class $AdminServerInfoResponseCopyWith<$Res>  {
  factory $AdminServerInfoResponseCopyWith(AdminServerInfoResponse value, $Res Function(AdminServerInfoResponse) _then) = _$AdminServerInfoResponseCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminServerInfoResponse].
extension AdminServerInfoResponsePatterns on AdminServerInfoResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminServerInfoResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminServerInfoResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminServerInfoResponse value)  $default,){
final _that = this;
switch (_that) {
case _AdminServerInfoResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminServerInfoResponse value)?  $default,){
final _that = this;
switch (_that) {
case _AdminServerInfoResponse() when $default != null:
return $default(_that);case _:
...
class _AdminServerInfoResponse implements AdminServerInfoResponse {
  const _AdminServerInfoResponse({required this.machine, required this.os, required this.node, required this.psql, required this.cpu, required this.mem, required this.fs, required this.net});
  factory _AdminServerInfoResponse.fromJson(Map<String, dynamic> json) => _$AdminServerInfoResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminServerInfoResponseCopyWith<_AdminServerInfoResponse> get copyWith => __$AdminServerInfoResponseCopyWithImpl<_AdminServerInfoResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminServerInfoResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminServerInfoResponse&&(identical(other.machine, machine) || other.machine == machine)&&(identical(other.os, os) || other.os == os)&&(identical(other.node, node) || other.node == node)&&(identical(other.psql, psql) || other.psql == psql)&&(identical(other.cpu, cpu) || other.cpu == cpu)&&(identical(other.mem, mem) || other.mem == mem)&&(identical(other.fs, fs) || other.fs == fs)&&(identical(other.net, net) || other.net == net));
}
...
/// @nodoc
abstract mixin class _$AdminServerInfoResponseCopyWith<$Res> implements $AdminServerInfoResponseCopyWith<$Res> {
  factory _$AdminServerInfoResponseCopyWith(_AdminServerInfoResponse value, $Res Function(_AdminServerInfoResponse) _then) = __$AdminServerInfoResponseCopyWithImpl;
@override @useResult
$Res call({
 String machine, String os, String node, String psql, AdminServerInfoCpu cpu, AdminServerInfoMem mem, AdminServerInfoFs fs, AdminServerInfoNet net
});
