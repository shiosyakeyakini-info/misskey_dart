...
mixin _$AdminQueueStatsResponse {
  ...
  $AdminQueueStatsResponseCopyWith<AdminQueueStatsResponse> get copyWith =>
      _$AdminQueueStatsResponseCopyWithImpl<AdminQueueStatsResponse>(
          this as AdminQueueStatsResponse, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminQueueStatsResponse &&
...
abstract mixin class $AdminQueueStatsResponseCopyWith<$Res> {
  factory $AdminQueueStatsResponseCopyWith(AdminQueueStatsResponse value,
          $Res Function(AdminQueueStatsResponse) _then) =
      _$AdminQueueStatsResponseCopyWithImpl;
  @useResult
  $Res call(
      {QueueCount deliver,
      QueueCount inbox,
...
class _AdminQueueStatsResponse implements AdminQueueStatsResponse {
  const _AdminQueueStatsResponse(
      {required this.deliver,
      required this.inbox,
      required this.db,
      required this.objectStorage});
  factory _AdminQueueStatsResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminQueueStatsResponseCopyWith<_AdminQueueStatsResponse> get copyWith =>
      __$AdminQueueStatsResponseCopyWithImpl<_AdminQueueStatsResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminQueueStatsResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminQueueStatsResponse &&
            (identical(other.deliver, deliver) || other.deliver == deliver) &&
            (identical(other.inbox, inbox) || other.inbox == inbox) &&
            (identical(other.db, db) || other.db == db) &&
            (identical(other.objectStorage, objectStorage) ||
...
/// @nodoc
abstract mixin class _$AdminQueueStatsResponseCopyWith<$Res>
    implements $AdminQueueStatsResponseCopyWith<$Res> {
  factory _$AdminQueueStatsResponseCopyWith(_AdminQueueStatsResponse value,
          $Res Function(_AdminQueueStatsResponse) _then) =
      __$AdminQueueStatsResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {QueueCount deliver,
