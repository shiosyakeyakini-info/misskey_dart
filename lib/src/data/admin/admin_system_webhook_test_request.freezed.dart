...
$AdminSystemWebhookTestRequestCopyWith<AdminSystemWebhookTestRequest> get copyWith => _$AdminSystemWebhookTestRequestCopyWithImpl<AdminSystemWebhookTestRequest>(this as AdminSystemWebhookTestRequest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminSystemWebhookTestRequest&&(identical(other.webhookId, webhookId) || other.webhookId == webhookId)&&(identical(other.type, type) || other.type == type)&&(identical(other.override_, override_) || other.override_ == override_));
}
...
abstract mixin class $AdminSystemWebhookTestRequestCopyWith<$Res>  {
  factory $AdminSystemWebhookTestRequestCopyWith(AdminSystemWebhookTestRequest value, $Res Function(AdminSystemWebhookTestRequest) _then) = _$AdminSystemWebhookTestRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminSystemWebhookTestRequest].
extension AdminSystemWebhookTestRequestPatterns on AdminSystemWebhookTestRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminSystemWebhookTestRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminSystemWebhookTestRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminSystemWebhookTestRequest value)  $default,){
final _that = this;
switch (_that) {
case _AdminSystemWebhookTestRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminSystemWebhookTestRequest value)?  $default,){
final _that = this;
switch (_that) {
case _AdminSystemWebhookTestRequest() when $default != null:
return $default(_that);case _:
...
class _AdminSystemWebhookTestRequest implements AdminSystemWebhookTestRequest {
  const _AdminSystemWebhookTestRequest({this.webhookId, @JsonKey(unknownEnumValue: AdminSystemWebhookTestType.unknown) this.type, @JsonKey(name: 'override') this.override_});
  factory _AdminSystemWebhookTestRequest.fromJson(Map<String, dynamic> json) => _$AdminSystemWebhookTestRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminSystemWebhookTestRequestCopyWith<_AdminSystemWebhookTestRequest> get copyWith => __$AdminSystemWebhookTestRequestCopyWithImpl<_AdminSystemWebhookTestRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminSystemWebhookTestRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminSystemWebhookTestRequest&&(identical(other.webhookId, webhookId) || other.webhookId == webhookId)&&(identical(other.type, type) || other.type == type)&&(identical(other.override_, override_) || other.override_ == override_));
}
...
/// @nodoc
abstract mixin class _$AdminSystemWebhookTestRequestCopyWith<$Res> implements $AdminSystemWebhookTestRequestCopyWith<$Res> {
  factory _$AdminSystemWebhookTestRequestCopyWith(_AdminSystemWebhookTestRequest value, $Res Function(_AdminSystemWebhookTestRequest) _then) = __$AdminSystemWebhookTestRequestCopyWithImpl;
@override @useResult
$Res call({
 String? webhookId,@JsonKey(unknownEnumValue: AdminSystemWebhookTestType.unknown) AdminSystemWebhookTestType? type,@JsonKey(name: 'override') AdminSystemWebhookTestOverride? override_
});
