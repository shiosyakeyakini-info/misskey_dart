...
mixin _$AdminAvatarDecorationsUpdateRequest {
  ...
  $AdminAvatarDecorationsUpdateRequestCopyWith<
          AdminAvatarDecorationsUpdateRequest>
      get copyWith => _$AdminAvatarDecorationsUpdateRequestCopyWithImpl<
              AdminAvatarDecorationsUpdateRequest>(
          this as AdminAvatarDecorationsUpdateRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminAvatarDecorationsUpdateRequest &&
  ...
  @override
  String toString() {
    return 'AdminAvatarDecorationsUpdateRequest(id: $id, name: $name, description: $description, url: $url, roleIdsThatCanBeUsedThisDecoration: $roleIdsThatCanBeUsedThisDecoration)';
  }
}

/// @nodoc
abstract mixin class $AdminAvatarDecorationsUpdateRequestCopyWith<$Res> {
  factory $AdminAvatarDecorationsUpdateRequestCopyWith(
          AdminAvatarDecorationsUpdateRequest value,
          $Res Function(AdminAvatarDecorationsUpdateRequest) _then) =
      _$AdminAvatarDecorationsUpdateRequestCopyWithImpl;
  @useResult
  $Res call(
      {String? id,
      String? name,
...
/// @nodoc
@JsonSerializable()
class _AdminAvatarDecorationsUpdateRequest
    implements AdminAvatarDecorationsUpdateRequest {
  const _AdminAvatarDecorationsUpdateRequest(
      {this.id,
      this.name,
      this.description,
      this.url,
      ...
      : _roleIdsThatCanBeUsedThisDecoration =
            roleIdsThatCanBeUsedThisDecoration;
  factory _AdminAvatarDecorationsUpdateRequest.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminAvatarDecorationsUpdateRequestCopyWith<
          _AdminAvatarDecorationsUpdateRequest>
      get copyWith => __$AdminAvatarDecorationsUpdateRequestCopyWithImpl<
          _AdminAvatarDecorationsUpdateRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminAvatarDecorationsUpdateRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminAvatarDecorationsUpdateRequest &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
...
/// @nodoc
abstract mixin class _$AdminAvatarDecorationsUpdateRequestCopyWith<$Res>
    implements $AdminAvatarDecorationsUpdateRequestCopyWith<$Res> {
  factory _$AdminAvatarDecorationsUpdateRequestCopyWith(
          _AdminAvatarDecorationsUpdateRequest value,
          $Res Function(_AdminAvatarDecorationsUpdateRequest) _then) =
      __$AdminAvatarDecorationsUpdateRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? id,
