...
$AdminAbuseUserReportsRequestCopyWith<AdminAbuseUserReportsRequest> get copyWith => _$AdminAbuseUserReportsRequestCopyWithImpl<AdminAbuseUserReportsRequest>(this as AdminAbuseUserReportsRequest, _$identity);
...
abstract mixin class $AdminAbuseUserReportsRequestCopyWith<$Res>  {
  factory $AdminAbuseUserReportsRequestCopyWith(AdminAbuseUserReportsRequest value, $Res Function(AdminAbuseUserReportsRequest) _then) = _$AdminAbuseUserReportsRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminAbuseUserReportsRequest].
extension AdminAbuseUserReportsRequestPatterns on AdminAbuseUserReportsRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminAbuseUserReportsRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminAbuseUserReportsRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminAbuseUserReportsRequest value)  $default,){
final _that = this;
switch (_that) {
case _AdminAbuseUserReportsRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminAbuseUserReportsRequest value)?  $default,){
final _that = this;
switch (_that) {
case _AdminAbuseUserReportsRequest() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$AdminAbuseUserReportsRequestCopyWith<_AdminAbuseUserReportsRequest> get copyWith => __$AdminAbuseUserReportsRequestCopyWithImpl<_AdminAbuseUserReportsRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminAbuseUserReportsRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminAbuseUserReportsRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.sinceId, sinceId) || other.sinceId == sinceId)&&(identical(other.untilId, untilId) || other.untilId == untilId)&&(identical(other.sinceDate, sinceDate) || other.sinceDate == sinceDate)&&(identical(other.untilDate, untilDate) || other.untilDate == untilDate)&&(identical(other.state, state) || other.state == state)&&(identical(other.reporterOrigin, reporterOrigin) || other.reporterOrigin == reporterOrigin)&&(identical(other.targetUserOrigin, targetUserOrigin) || other.targetUserOrigin == targetUserOrigin));
}
...
/// @nodoc
abstract mixin class _$AdminAbuseUserReportsRequestCopyWith<$Res> implements $AdminAbuseUserReportsRequestCopyWith<$Res> {
  factory _$AdminAbuseUserReportsRequestCopyWith(_AdminAbuseUserReportsRequest value, $Res Function(_AdminAbuseUserReportsRequest) _then) = __$AdminAbuseUserReportsRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, String? sinceId, String? untilId, int? sinceDate, int? untilDate, String? state,@JsonKey(unknownEnumValue: AdminAbuseUserReportsReporterOrigin.unknown) AdminAbuseUserReportsReporterOrigin? reporterOrigin,@JsonKey(unknownEnumValue: AdminAbuseUserReportsTargetUserOrigin.unknown) AdminAbuseUserReportsTargetUserOrigin? targetUserOrigin
});
