...
mixin _$AdminQueueJobsRequest {
  ...
  $AdminQueueJobsRequestCopyWith<AdminQueueJobsRequest> get copyWith =>
      _$AdminQueueJobsRequestCopyWithImpl<AdminQueueJobsRequest>(
          this as AdminQueueJobsRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminQueueJobsRequest &&
...
abstract mixin class $AdminQueueJobsRequestCopyWith<$Res> {
  factory $AdminQueueJobsRequestCopyWith(AdminQueueJobsRequest value,
          $Res Function(AdminQueueJobsRequest) _then) =
...
class _AdminQueueJobsRequest implements AdminQueueJobsRequest {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminQueueJobsRequestCopyWith<_AdminQueueJobsRequest> get copyWith =>
      __$AdminQueueJobsRequestCopyWithImpl<_AdminQueueJobsRequest>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminQueueJobsRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminQueueJobsRequest &&
            (identical(other.queue, queue) || other.queue == queue) &&
...
/// @nodoc
abstract mixin class _$AdminQueueJobsRequestCopyWith<$Res>
    implements $AdminQueueJobsRequestCopyWith<$Res> {
  factory _$AdminQueueJobsRequestCopyWith(_AdminQueueJobsRequest value,
          $Res Function(_AdminQueueJobsRequest) _then) =
      __$AdminQueueJobsRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(unknownEnumValue: AdminQueueJobsQueue.unknown)
