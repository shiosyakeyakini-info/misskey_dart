...
mixin _$AdminRolesUpdateRequest {
  ...
  $AdminRolesUpdateRequestCopyWith<AdminRolesUpdateRequest> get copyWith =>
      _$AdminRolesUpdateRequestCopyWithImpl<AdminRolesUpdateRequest>(
          this as AdminRolesUpdateRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminRolesUpdateRequest &&
...
abstract mixin class $AdminRolesUpdateRequestCopyWith<$Res> {
  factory $AdminRolesUpdateRequestCopyWith(AdminRolesUpdateRequest value,
          $Res Function(AdminRolesUpdateRequest) _then) =
      _$AdminRolesUpdateRequestCopyWithImpl;
  @useResult
  $Res call(
      {String? roleId,
      String? name,
...
class _AdminRolesUpdateRequest implements AdminRolesUpdateRequest {
  const _AdminRolesUpdateRequest(
      {this.roleId,
      this.name,
      this.description,
      this.color,
      ...
      : _condFormula = condFormula,
        _policies = policies;
  factory _AdminRolesUpdateRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminRolesUpdateRequestCopyWith<_AdminRolesUpdateRequest> get copyWith =>
      __$AdminRolesUpdateRequestCopyWithImpl<_AdminRolesUpdateRequest>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminRolesUpdateRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminRolesUpdateRequest &&
            (identical(other.roleId, roleId) || other.roleId == roleId) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
...
/// @nodoc
abstract mixin class _$AdminRolesUpdateRequestCopyWith<$Res>
    implements $AdminRolesUpdateRequestCopyWith<$Res> {
  factory _$AdminRolesUpdateRequestCopyWith(_AdminRolesUpdateRequest value,
          $Res Function(_AdminRolesUpdateRequest) _then) =
      __$AdminRolesUpdateRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? roleId,
