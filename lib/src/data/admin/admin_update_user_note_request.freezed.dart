...
mixin _$AdminUpdateUserNoteRequest {
  ...
  $AdminUpdateUserNoteRequestCopyWith<AdminUpdateUserNoteRequest>
      get copyWith =>
          _$AdminUpdateUserNoteRequestCopyWithImpl<AdminUpdateUserNoteRequest>(
              this as AdminUpdateUserNoteRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminUpdateUserNoteRequest &&
...
abstract mixin class $AdminUpdateUserNoteRequestCopyWith<$Res> {
  factory $AdminUpdateUserNoteRequestCopyWith(AdminUpdateUserNoteRequest value,
          $Res Function(AdminUpdateUserNoteRequest) _then) =
      _$AdminUpdateUserNoteRequestCopyWithImpl;
  @useResult
...
class _AdminUpdateUserNoteRequest implements AdminUpdateUserNoteRequest {
  ...
  factory _AdminUpdateUserNoteRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminUpdateUserNoteRequestCopyWith<_AdminUpdateUserNoteRequest>
      get copyWith => __$AdminUpdateUserNoteRequestCopyWithImpl<
          _AdminUpdateUserNoteRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminUpdateUserNoteRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminUpdateUserNoteRequest &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.text, text) || other.text == text));
  }
...
/// @nodoc
abstract mixin class _$AdminUpdateUserNoteRequestCopyWith<$Res>
    implements $AdminUpdateUserNoteRequestCopyWith<$Res> {
  factory _$AdminUpdateUserNoteRequestCopyWith(
          _AdminUpdateUserNoteRequest value,
          $Res Function(_AdminUpdateUserNoteRequest) _then) =
      __$AdminUpdateUserNoteRequestCopyWithImpl;
  @override
  @useResult
  $Res call({String? userId, String? text});
}
