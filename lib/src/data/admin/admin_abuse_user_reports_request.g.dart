...
_AdminAbuseUserReportsRequest _$AdminAbuseUserReportsRequestFromJson(
...
Map<String, dynamic> _$AdminAbuseUserReportsRequestToJson(
  _AdminAbuseUserReportsRequest instance,
) => <String, dynamic>{
  ...
  'targetUserOrigin':
      _$AdminAbuseUserReportsTargetUserOriginEnumMap[instance.targetUserOrigin],
};
