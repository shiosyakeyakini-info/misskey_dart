...
part of 'admin_show_user_response.dart';
...
mixin _$AdminShowUserResponse {
  ...
  AdminShowUserNotificationRecieveConfig get notificationRecieveConfig;
  bool get isModerator;
  bool get isSilenced;
  bool get isSuspended;
  bool get isHibernated;
  String? get lastActiveDate;
  String get moderationNote;
  List<Signin> get signins;
  RolePolicies get policies;
  List<Role> get roles;
  List<AdminShowUserRoleAssignsItem> get roleAssigns;

  /// Create a copy of AdminShowUserResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AdminShowUserResponseCopyWith<AdminShowUserResponse> get copyWith =>
      _$AdminShowUserResponseCopyWithImpl<AdminShowUserResponse>(
          this as AdminShowUserResponse, _$identity);

  /// Serializes this AdminShowUserResponse to a JSON map.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminShowUserResponse &&
            ...
            (identical(other.isHibernated, isHibernated) ||
                other.isHibernated == isHibernated) &&
            ...
            const DeepCollectionEquality().equals(other.signins, signins) &&
            (identical(other.policies, policies) ||
                other.policies == policies) &&
            const DeepCollectionEquality().equals(other.roles, roles) &&
            const DeepCollectionEquality()
                .equals(other.roleAssigns, roleAssigns));
  }
...
abstract mixin class $AdminShowUserResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      AdminShowUserNotificationRecieveConfig notificationRecieveConfig,
      bool isModerator,
      bool isSilenced,
      bool isSuspended,
      bool isHibernated,
      ...
      List<Role> roles,
      List<AdminShowUserRoleAssignsItem> roleAssigns});

  $AdminShowUserNotificationRecieveConfigCopyWith<$Res>
      get notificationRecieveConfig;
  $RolePoliciesCopyWith<$Res> get policies;
}

/// @nodoc
class _$AdminShowUserResponseCopyWithImpl<$Res>
    implements $AdminShowUserResponseCopyWith<$Res> {
  _$AdminShowUserResponseCopyWithImpl(this._self, this._then);

  final AdminShowUserResponse _self;
  final $Res Function(AdminShowUserResponse) _then;
    ...
    return _then(_self.copyWith(
      ...
      notificationRecieveConfig: null == notificationRecieveConfig
          ...
          : notificationRecieveConfig // ignore: cast_nullable_to_non_nullable
              as AdminShowUserNotificationRecieveConfig,
      ...
      isSuspended: null == isSuspended
          ...
          : isSuspended // ignore: cast_nullable_to_non_nullable
              as bool,
      isHibernated: null == isHibernated
          ? _self.isHibernated
          : isHibernated // ignore: cast_nullable_to_non_nullable
              as bool,
      ...
      moderationNote: null == moderationNote
          ...
          : moderationNote // ignore: cast_nullable_to_non_nullable
              as String,
      signins: null == signins
          ? _self.signins
          : signins // ignore: cast_nullable_to_non_nullable
              as List<Signin>,
      ...
      roles: null == roles
          ...
          : roles // ignore: cast_nullable_to_non_nullable
              as List<Role>,
      roleAssigns: null == roleAssigns
          ? _self.roleAssigns
          : roleAssigns // ignore: cast_nullable_to_non_nullable
  ...
  $AdminShowUserNotificationRecieveConfigCopyWith<$Res>
      get notificationRecieveConfig {
    return $AdminShowUserNotificationRecieveConfigCopyWith<$Res>(
...
/// @nodoc
@JsonSerializable()
class _AdminShowUserResponse implements AdminShowUserResponse {
  const _AdminShowUserResponse(
      {this.email,
      ...
      required final List<dynamic> mutedWords,
      required final List<String> mutedInstances,
      required this.notificationRecieveConfig,
      required this.isModerator,
      required this.isSilenced,
      required this.isSuspended,
      required this.isHibernated,
      this.lastActiveDate,
      required this.moderationNote,
      required final List<Signin> signins,
      required this.policies,
      required final List<Role> roles,
      required final List<AdminShowUserRoleAssignsItem> roleAssigns})
      : _mutedWords = mutedWords,
        _mutedInstances = mutedInstances,
        _signins = signins,
        _roles = roles,
        _roleAssigns = roleAssigns;
  factory _AdminShowUserResponse.fromJson(Map<String, dynamic> json) =>
      _$AdminShowUserResponseFromJson(json);
  ...
  @override
  final AdminShowUserNotificationRecieveConfig notificationRecieveConfig;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminShowUserResponseCopyWith<_AdminShowUserResponse> get copyWith =>
      __$AdminShowUserResponseCopyWithImpl<_AdminShowUserResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminShowUserResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminShowUserResponse &&
            (identical(other.email, email) || other.email == email) &&
            (identical(other.emailVerified, emailVerified) ||
                other.emailVerified == emailVerified) &&
            (identical(other.followedMessage, followedMessage) ||
            ...
            (identical(other.moderationNote, moderationNote) ||
                other.moderationNote == moderationNote) &&
            const DeepCollectionEquality().equals(other._signins, _signins) &&
            (identical(other.policies, policies) ||
                other.policies == policies) &&
            const DeepCollectionEquality().equals(other._roles, _roles) &&
            const DeepCollectionEquality()
                .equals(other._roleAssigns, _roleAssigns));
  }
  ...
  int get hashCode => Object.hashAll([
        ...
        lastActiveDate,
        moderationNote,
        const DeepCollectionEquality().hash(_signins),
        policies,
...
/// @nodoc
abstract mixin class _$AdminShowUserResponseCopyWith<$Res>
    implements $AdminShowUserResponseCopyWith<$Res> {
  factory _$AdminShowUserResponseCopyWith(_AdminShowUserResponse value,
          $Res Function(_AdminShowUserResponse) _then) =
      __$AdminShowUserResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? email,
...
/// @nodoc
class __$AdminShowUserResponseCopyWithImpl<$Res>
    implements _$AdminShowUserResponseCopyWith<$Res> {
  __$AdminShowUserResponseCopyWithImpl(this._self, this._then);

  final _AdminShowUserResponse _self;
  final $Res Function(_AdminShowUserResponse) _then;
  ...
  $Res call({
    ...
    return _then(_AdminShowUserResponse(
      email: freezed == email
          ? _self.email
          : email // ignore: cast_nullable_to_non_nullable
              as String?,
