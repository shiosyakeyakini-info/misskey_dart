...
part 'admin_update_meta_request.freezed.dart';
part 'admin_update_meta_request.g.dart';

@freezed
abstract class AdminUpdateMetaRequest with _$AdminUpdateMetaRequest {
  const factory AdminUpdateMetaRequest({
    ...
    AdminUpdateMetaSensitiveMediaDetectionSensitivity? sensitiveMediaDetectionSensitivity,
