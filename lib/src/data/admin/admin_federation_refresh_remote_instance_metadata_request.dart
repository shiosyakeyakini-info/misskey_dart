...
@freezed
abstract class AdminFederationRefreshRemoteInstanceMetadataRequest
    with _$AdminFederationRefreshRemoteInstanceMetadataRequest {
  const factory AdminFederationRefreshRemoteInstanceMetadataRequest({
    String? host,
  }) = _AdminFederationRefreshRemoteInstanceMetadataRequest;

  factory AdminFederationRefreshRemoteInstanceMetadataRequest.fromJson(
