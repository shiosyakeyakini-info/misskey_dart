...
$AdminShowUsersRequestCopyWith<AdminShowUsersRequest> get copyWith => _$AdminShowUsersRequestCopyWithImpl<AdminShowUsersRequest>(this as AdminShowUsersRequest, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminShowUsersRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.offset, offset) || other.offset == offset)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.state, state) || other.state == state)&&(identical(other.origin, origin) || other.origin == origin)&&(identical(other.username, username) || other.username == username)&&(identical(other.hostname, hostname) || other.hostname == hostname));
}
...
abstract mixin class $AdminShowUsersRequestCopyWith<$Res>  {
  factory $AdminShowUsersRequestCopyWith(AdminShowUsersRequest value, $Res Function(AdminShowUsersRequest) _then) = _$AdminShowUsersRequestCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [AdminShowUsersRequest].
extension AdminShowUsersRequestPatterns on AdminShowUsersRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminShowUsersRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminShowUsersRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminShowUsersRequest value)  $default,){
final _that = this;
switch (_that) {
case _AdminShowUsersRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminShowUsersRequest value)?  $default,){
final _that = this;
switch (_that) {
case _AdminShowUsersRequest() when $default != null:
return $default(_that);case _:
...
class _AdminShowUsersRequest implements AdminShowUsersRequest {
  const _AdminShowUsersRequest({this.limit = 10, this.offset = 0, @JsonKey(unknownEnumValue: AdminShowUsersSort.unknown) this.sort, @JsonKey(unknownEnumValue: AdminShowUsersState.unknown) this.state = AdminShowUsersState.all, @JsonKey(unknownEnumValue: AdminShowUsersOrigin.unknown) this.origin = AdminShowUsersOrigin.combined, this.username = null, this.hostname = null});
  factory _AdminShowUsersRequest.fromJson(Map<String, dynamic> json) => _$AdminShowUsersRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminShowUsersRequestCopyWith<_AdminShowUsersRequest> get copyWith => __$AdminShowUsersRequestCopyWithImpl<_AdminShowUsersRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminShowUsersRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminShowUsersRequest&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.offset, offset) || other.offset == offset)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.state, state) || other.state == state)&&(identical(other.origin, origin) || other.origin == origin)&&(identical(other.username, username) || other.username == username)&&(identical(other.hostname, hostname) || other.hostname == hostname));
}
...
/// @nodoc
abstract mixin class _$AdminShowUsersRequestCopyWith<$Res> implements $AdminShowUsersRequestCopyWith<$Res> {
  factory _$AdminShowUsersRequestCopyWith(_AdminShowUsersRequest value, $Res Function(_AdminShowUsersRequest) _then) = __$AdminShowUsersRequestCopyWithImpl;
@override @useResult
$Res call({
 int? limit, int? offset,@JsonKey(unknownEnumValue: AdminShowUsersSort.unknown) AdminShowUsersSort? sort,@JsonKey(unknownEnumValue: AdminShowUsersState.unknown) AdminShowUsersState? state,@JsonKey(unknownEnumValue: AdminShowUsersOrigin.unknown) AdminShowUsersOrigin? origin, String? username, String? hostname
});
