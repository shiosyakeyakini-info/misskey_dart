...
$AdminAnnouncementsUpdateRequestCopyWith<AdminAnnouncementsUpdateRequest> get copyWith => _$AdminAnnouncementsUpdateRequestCopyWithImpl<AdminAnnouncementsUpdateRequest>(this as AdminAnnouncementsUpdateRequest, _$identity);
...
abstract mixin class $AdminAnnouncementsUpdateRequestCopyWith<$Res>  {
  factory $AdminAnnouncementsUpdateRequestCopyWith(AdminAnnouncementsUpdateRequest value, $Res Function(AdminAnnouncementsUpdateRequest) _then) = _$AdminAnnouncementsUpdateRequestCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of AdminAnnouncementsUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = freezed,Object? text = freezed,Object? imageUrl = freezed,Object? icon = freezed,Object? display = freezed,Object? forExistingUsers = freezed,Object? silence = freezed,Object? needConfirmationToRead = freezed,Object? isActive = freezed,}) {
...
/// Adds pattern-matching-related methods to [AdminAnnouncementsUpdateRequest].
extension AdminAnnouncementsUpdateRequestPatterns on AdminAnnouncementsUpdateRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminAnnouncementsUpdateRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminAnnouncementsUpdateRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminAnnouncementsUpdateRequest value)  $default,){
final _that = this;
switch (_that) {
case _AdminAnnouncementsUpdateRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminAnnouncementsUpdateRequest value)?  $default,){
final _that = this;
switch (_that) {
case _AdminAnnouncementsUpdateRequest() when $default != null:
return $default(_that);case _:
...
class _AdminAnnouncementsUpdateRequest implements AdminAnnouncementsUpdateRequest {
  const _AdminAnnouncementsUpdateRequest({this.id, this.title, this.text, this.imageUrl, @JsonKey(unknownEnumValue: AdminAnnouncementsUpdateIcon.unknown) this.icon, @JsonKey(unknownEnumValue: AdminAnnouncementsUpdateDisplay.unknown) this.display, this.forExistingUsers, this.silence, this.needConfirmationToRead, this.isActive});
  factory _AdminAnnouncementsUpdateRequest.fromJson(Map<String, dynamic> json) => _$AdminAnnouncementsUpdateRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminAnnouncementsUpdateRequestCopyWith<_AdminAnnouncementsUpdateRequest> get copyWith => __$AdminAnnouncementsUpdateRequestCopyWithImpl<_AdminAnnouncementsUpdateRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminAnnouncementsUpdateRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminAnnouncementsUpdateRequest&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.text, text) || other.text == text)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.display, display) || other.display == display)&&(identical(other.forExistingUsers, forExistingUsers) || other.forExistingUsers == forExistingUsers)&&(identical(other.silence, silence) || other.silence == silence)&&(identical(other.needConfirmationToRead, needConfirmationToRead) || other.needConfirmationToRead == needConfirmationToRead)&&(identical(other.isActive, isActive) || other.isActive == isActive));
}
...
/// @nodoc
abstract mixin class _$AdminAnnouncementsUpdateRequestCopyWith<$Res> implements $AdminAnnouncementsUpdateRequestCopyWith<$Res> {
  factory _$AdminAnnouncementsUpdateRequestCopyWith(_AdminAnnouncementsUpdateRequest value, $Res Function(_AdminAnnouncementsUpdateRequest) _then) = __$AdminAnnouncementsUpdateRequestCopyWithImpl;
@override @useResult
$Res call({
 String? id, String? title, String? text, String? imageUrl,@JsonKey(unknownEnumValue: AdminAnnouncementsUpdateIcon.unknown) AdminAnnouncementsUpdateIcon? icon,@JsonKey(unknownEnumValue: AdminAnnouncementsUpdateDisplay.unknown) AdminAnnouncementsUpdateDisplay? display, bool? forExistingUsers, bool? silence, bool? needConfirmationToRead, bool? isActive
});
...
/// Create a copy of AdminAnnouncementsUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = freezed,Object? text = freezed,Object? imageUrl = freezed,Object? icon = freezed,Object? display = freezed,Object? forExistingUsers = freezed,Object? silence = freezed,Object? needConfirmationToRead = freezed,Object? isActive = freezed,}) {
