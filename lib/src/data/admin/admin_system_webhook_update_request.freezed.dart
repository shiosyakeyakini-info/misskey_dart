...
mixin _$AdminSystemWebhookUpdateRequest {
  ...
  String? get name;
  @JsonKey(name: 'on')
  List<AdminSystemWebhookUpdateOnItem>? get on_;
  String? get url;
  String? get secret;
  ...
  $AdminSystemWebhookUpdateRequestCopyWith<AdminSystemWebhookUpdateRequest>
      get copyWith => _$AdminSystemWebhookUpdateRequestCopyWithImpl<
              AdminSystemWebhookUpdateRequest>(
          this as AdminSystemWebhookUpdateRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminSystemWebhookUpdateRequest &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, isActive, name,
...
abstract mixin class $AdminSystemWebhookUpdateRequestCopyWith<$Res> {
  factory $AdminSystemWebhookUpdateRequestCopyWith(
          AdminSystemWebhookUpdateRequest value,
          $Res Function(AdminSystemWebhookUpdateRequest) _then) =
      _$AdminSystemWebhookUpdateRequestCopyWithImpl;
  @useResult
  $Res call(
      {String? id,
      bool? isActive,
    ...
    return _then(_self.copyWith(
      ...
      on_: freezed == on_
          ...
          : on_ // ignore: cast_nullable_to_non_nullable
              as List<AdminSystemWebhookUpdateOnItem>?,
      url: freezed == url
          ? _self.url
...
/// @nodoc
@JsonSerializable()
class _AdminSystemWebhookUpdateRequest
    implements AdminSystemWebhookUpdateRequest {
  const _AdminSystemWebhookUpdateRequest(
      {this.id,
      this.isActive,
      this.name,
      @JsonKey(name: 'on') final List<AdminSystemWebhookUpdateOnItem>? on_,
      this.url,
      this.secret = ""})
      : _on_ = on_;
  factory _AdminSystemWebhookUpdateRequest.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminSystemWebhookUpdateRequestCopyWith<_AdminSystemWebhookUpdateRequest>
      get copyWith => __$AdminSystemWebhookUpdateRequestCopyWithImpl<
          _AdminSystemWebhookUpdateRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminSystemWebhookUpdateRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminSystemWebhookUpdateRequest &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.isActive, isActive) ||
                other.isActive == isActive) &&
            (identical(other.name, name) || other.name == name) &&
...
/// @nodoc
abstract mixin class _$AdminSystemWebhookUpdateRequestCopyWith<$Res>
    implements $AdminSystemWebhookUpdateRequestCopyWith<$Res> {
  factory _$AdminSystemWebhookUpdateRequestCopyWith(
          _AdminSystemWebhookUpdateRequest value,
          $Res Function(_AdminSystemWebhookUpdateRequest) _then) =
      __$AdminSystemWebhookUpdateRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? id,
