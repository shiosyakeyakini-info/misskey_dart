...
class MisskeyInvite {
  ...
  Future<InviteCode> create() async {
    final response =
        await _apiService.post<Map<String, dynamic>>("invite/create", {});
  ...
  Future<InviteLimitResponse> limit() async {
    final response =
        await _apiService.post<Map<String, dynamic>>("invite/limit", {});
  ...
  Future<Iterable<InviteCode>> list(InviteListRequest request) async {
    final response =
        await _apiService.post<List>("invite/list", request.toJson());
